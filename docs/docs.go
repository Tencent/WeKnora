...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/knowledge-bases/{id}/feedback/chunk-stats": {
            "get": {
                "security": [
                    {
                        "Bearer": []
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "排序：positive_rate_asc/positive_rate_desc/feedback_count_desc/last_feedback_desc",
                        "name": "sort_by",
                        "in": "query"
                    },
                    {
                        "type": "boolean",
                        "description": "只看低质片段（好评率低于 needs-optimization 阈值）",
                        "name": "low_quality",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "按内容预览模糊匹配",
                        "name": "keyword",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "按文档 ID 过滤",
                        "name": "knowledge_id",
                        "in": "query"
                    }
                ],
        ...
        "/knowledge-bases/{id}/feedback/reset": {
            "post": {
                "security": [
                    {
                        "Bearer": []
        ...
        "/knowledge-bases/{id}/feedback/weight-logs": {
            "get": {
                "security": [
                    {
                        "Bearer": []
        ...
        "/sessions/{session_id}/messages/{message_id}/feedback": {
            "put": {
                ...
                "description": "对助手消息提交点赞、点踩或取消评价。\"none\" 等同于取消当前评价。\nrating=dislike 时可附带 reasons（白名单内原因）与 comment。",
                "consumes": [
                    "application/json"
                ],
                "produces": [
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_handler.SetMessageFeedbackRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "github_com_Tencent_WeKnora_internal_types.Message": {
            ...
            "properties": {
                ...
                "user_feedback": {
                    "description": "UserFeedback is the current caller's rating of this assistant message,\nhydrated by MessageFeedbackService.AttachUserFeedback on load. Empty\nwhen the message is not an assistant message or the caller has not\nrated it. Not persisted.",
                    "allOf": [
                        {
                            "$ref": "#/definitions/github_com_Tencent_WeKnora_internal_types.MessageFeedbackView"
                        }
                    ]
                }
            }
        ...
        "github_com_Tencent_WeKnora_internal_types.MessageFeedbackView": {
            "type": "object",
            "properties": {
                "comment": {
                    "type": "string"
        ...
        "github_com_Tencent_WeKnora_internal_types.RetrievalConfig": {
            ...
            "properties": {
                ...
                "feedback_boost_factor": {
                    "description": "FeedbackBoostFactor multiplies candidate scores of boosted chunks\n(\u003e= 1, default: 1.2).",
                    "type": "number"
                },
                "feedback_boost_threshold": {
                    "description": "FeedbackBoostThreshold is the positive rate at or above which a chunk's\nrecall weight is boosted (0-1, default: 0.8).",
                    "type": "number"
                },
                "feedback_min_samples": {
                    "description": "FeedbackMinSamples is the minimum number of ratings a chunk needs\nbefore its weight deviates from neutral (default: 3). Without this\nfloor a single early rating could swing retrieval.",
                    "type": "integer"
                },
                "feedback_needs_optimization_threshold": {
                    "description": "FeedbackNeedsOptimizationThreshold is the positive rate below which a\nchunk is flagged as needing optimization in the admin stats panel\n(0-1, default: 0.2). Must not exceed FeedbackPenaltyThreshold.",
                    "type": "number"
                },
                "feedback_penalty_factor": {
                    "description": "FeedbackPenaltyFactor multiplies candidate scores of penalized chunks\n(\u003c 1, default: 0.8).",
                    "type": "number"
                },
                "feedback_penalty_threshold": {
                    "description": "FeedbackPenaltyThreshold is the positive rate below which a chunk's\nrecall weight is penalized (0-1, default: 0.5).",
                    "type": "number"
                },
                "feedback_ranking_enabled": {
                    "description": "FeedbackRankingEnabled gates whether stored chunk recall weights (from\nanswer like/dislike feedback) are applied to retrieval candidate\nordering. Weights are always maintained; this only controls application,\nso enabling later takes effect immediately. Default: false.",
                    "type": "boolean"
                },
                "keyword_threshold": {
        ...
        "internal_handler.SetMessageFeedbackRequest": {
            "type": "object",
            "required": [
                "rating"
            ],
