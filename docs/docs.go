...
const docTemplate = `{
    ...
    "paths": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/github_com_Tencent_WeKnora_internal_handler_dto.DataSourceResponse"
                            }
                        }
                    },
                    "400": {
        ...
        "/datasource/preview-resources": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "type, credentials, settings, and optional parent_id",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/datasource/{id}/reconfigure": {
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "data_source and credentials",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
    ...
    "definitions": {
        ...
        "github_com_Tencent_WeKnora_internal_handler_dto.CredentialFieldMetadata": {
            "type": "object",
            "properties": {
                "configured": {
                    "type": "boolean"
        ...
        "github_com_Tencent_WeKnora_internal_handler_dto.DataSourceConfigDTO": {
            "type": "object",
            "properties": {
                "resource_ids": {
                    "type": "array",
        ...
        "github_com_Tencent_WeKnora_internal_handler_dto.DataSourceResponse": {
            "type": "object",
            "properties": {
                "config": {
                    "$ref": "#/definitions/github_com_Tencent_WeKnora_internal_handler_dto.DataSourceConfigDTO"
                },
                "conflict_strategy": {
                    "type": "string"
                },
                ...
                "credentials": {
                    "description": "Single logical credential field. DataSource credentials are a\nper-connector atomic map, so \"configured?\" applies to the whole set.",
                    "type": "object",
                    "additionalProperties": {
                        "$ref": "#/definitions/github_com_Tencent_WeKnora_internal_handler_dto.CredentialFieldMetadata"
                    }
                },
                "error_message": {
                    "type": "string"
