    ...
    "paths": {
        ...
        "/knowledge/{id}/preview": {
            "get": {
                ...
                "description": "返回知识文件预览。Legacy DOC 复用后台生成的 DOCX 副本；原文件下载保持不变。\n生成中返回 202 preview_pending，按 Retry-After 秒数轮询。旧文件首次预览触发补建。\n转换失败返回 415；retry=1 可在失败冷却60秒后重新生成。存储暂时不可用返回503。",
                "consumes": [
                    "application/json"
                ],
                "produces": [
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "type": "string",
                        "description": "显式重试失败的 DOC 预览；冷却期间仍返回415",
                        "name": "retry",
                        "in": "query"
                    }
                ],
                "responses": {
                    ...
                    "202": {
                        "description": "preview_pending；retry_after 为建议等待秒数",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        },
                    ...
                    "404": {
                        "description": "preview_not_found：原文件已不存在",
                        "schema": {
                            "type": "object",
                            "additionalProperties": {
                                "type": "string"
                    ...
                    "415": {
                        "description": "preview_unsupported",
                        "schema": {
                            "type": "object",
                            "additionalProperties": {
                                "type": "string"
                    ...
                    "503": {
                        "description": "preview_unavailable：暂时无法读取预览",
                        "schema": {
                            "type": "object",
                            "additionalProperties": {
                                "type": "string"
