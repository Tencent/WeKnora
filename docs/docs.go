...
const docTemplate = `{
    ...
    "paths": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_handler.embedChannelRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/embed-channels/{channel_id}/preview-session": {
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "session_token, expires_in",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/embed/{channel_id}/sessions/{session_id}/mcp-services/{id}/oauth/authorize-url": {
            "post": {
        ...
        "/embed/{channel_id}/sessions/{session_id}/mcp-services/{id}/oauth/status": {
            "get": {
        ...
        "/models/{id}/credentials": {
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "凭证字段（api_key / app_secret）",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_handler.modelCredentialsPutRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "internal_handler.embedChannelRequest": {
            "type": "object",
            "properties": {
                "agent_id": {
                    "type": "string"
        ...
        "internal_handler.modelCredentialsPutRequest": {
            "type": "object",
            "properties": {
                "api_key": {
                    "type": "string"
