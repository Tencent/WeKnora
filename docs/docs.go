    ...
    "paths": {
        ...
        "/sandbox-configs/{id}/skills": {
            ...
            "post": {
                ...
                "description": "Install a skill onto this sandbox config's image. Send a zip\nas multipart form field \"file\", or JSON {\"source\":\"...\"} to\npull from ClawHub, SkillHub, skills.sh, GitHub, GitLab, or a\ndirect archive URL. The source must be readable anonymously.\nThe install boots a sandbox and runs for minutes, so the\nrequest is only accepted; follow it via the install-events\nstream.",
                "consumes": [
                    "application/json",
                    "multipart/form-data"
                ],
