...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/sessions/{id}/sandbox/files": {
            ...
            "patch": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "源路径与目标路径",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_handler_session.renameLiveFileRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/sessions/{id}/sandbox/files/content": {
            "get": {
                "security": [
                    {
                        "Bearer": []
    ...
    "definitions": {
        ...
        "internal_handler_session.renameLiveFileRequest": {
            "type": "object",
            "required": [
                "source",
                "target"
