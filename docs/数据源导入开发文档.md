...
1. 创建飞书自建应用，开通 `wiki:wiki:readonly`、`drive:drive:readonly`、`drive:export:readonly`、`docx:document:readonly`。
...
**权限：** `wiki:wiki:readonly`、`drive:drive:readonly`、`drive:export:readonly`、`docx:document:readonly`。把应用加为该文档协作者即可，不必进群分享整库/整夹。
