...
| 容器 | 镜像 | 说明 |
|------|------|------|
| frontend | `tree-rag-ui:v0.8.21` | Web UI |
| app | `tree-rag-app:v0.8.21` | API |
| docreader | `tree-rag-docreader:v0.8.21` | 文档解析 |
...
# 或打成一个总包
tar -C deploy -cvf treerag-offline-intranet-v0.8.21.tar offline-intranet
```
