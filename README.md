...
| Retrieval Strategies | BM25 sparse / Dense retrieval / GraphRAG / parent-child chunking / HNSW-accelerated pgvector (index built per embedding dimension) / multi-dimensional indexing |
