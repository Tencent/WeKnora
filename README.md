...
| Vector DB Integration | ✅ PostgreSQL (pgvector), Elasticsearch, milvus | Support for mainstream vector index backends, flexible switching for different retrieval scenarios |
