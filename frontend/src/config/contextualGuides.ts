...
export const GLOBAL_USER_GUIDE_KEY = 'gridora:new-user-guide-done:v1'
export const OPEN_NEW_USER_GUIDE_EVENT = 'gridora:open-new-user-guide'

export function openNewUserGuide() {
  window.dispatchEvent(new CustomEvent(OPEN_NEW_USER_GUIDE_EVENT))
}

export const KB_EDITOR_FOCUS_SECTION_EVENT = 'gridora:kb-editor-focus-section'
export const AGENT_EDITOR_FOCUS_SECTION_EVENT = 'gridora:agent-editor-focus-section'
...
export const CONTEXTUAL_GUIDE_TOURS: Record<ContextualGuideTourId, ContextualGuideTourConfig> = {
  kbList: {
    storageKey: 'gridora:contextual-guide-kb-list:v2',
  ...
  kbCreate: {
    storageKey: 'gridora:contextual-guide-kb-create:v3',
  ...
  tenantModels: {
    storageKey: 'gridora:contextual-guide-tenant-models:v1',
    stepI18nPrefix: 'contextualGuide.tenantModels.steps',
    openDelayMs: 500,
    steps: [],
  },
  kbDetail: {
    storageKey: 'gridora:contextual-guide-kb-detail:v1',
  ...
  chat: {
    storageKey: 'gridora:contextual-guide-chat:v1',
  ...
  agentList: {
    storageKey: 'gridora:contextual-guide-agent-list:v1',
  ...
  agentCreate: {
    storageKey: 'gridora:contextual-guide-agent-create:v1',
