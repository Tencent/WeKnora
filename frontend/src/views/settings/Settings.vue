                ...
                <template v-for="group in navGroups" :key="group.key">
                  ...
                  <template v-for="item in group.items" :key="item.key">
                    <div :class="['nav-item', {
                      ...
                      <!-- GRIDORA Cloud 使用自定义 W 图标 -->
                      <svg v-else-if="item.key === 'gridoracloud'" width="17" height="17" viewBox="0 0 18 18"
            ...
            <div class="settings-content">
              <div class="content-wrapper" :class="{
                ...
                <template v-else>
                  ...
                  <!-- GRIDORA Cloud -->
                  <div v-if="currentSection === 'gridoracloud'" class="section">
                    <GRIDORACloudSettings />
                  </div>
...
import GRIDORACloudSettings from './GRIDORACloudSettings.vue'
...
const navItems = computed(() => {
  ...
  const all: NavItem[] = [
    ...
    { key: 'gridoracloud', icon: '', label: 'GRIDORA Cloud' },
...
const navGroups = computed<NavGroup[]>(() => {
  ...
  return [
    ...
    },
    {
      ...
      items: pickItems(['models', 'ollama', 'gridoracloud']),
    },
    {
      key: 'integrations',
