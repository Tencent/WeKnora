...
const exampleData: FAQEntryPayload[] = [
  {
    standard_question: '什么是 GRIDORA？',
    answers: ['GRIDORA 是一个智能知识库管理系统', '它支持多种知识库类型和导入方式'],
    similar_questions: ['GRIDORA 是什么？', '介绍一下 GRIDORA'],
    negative_questions: ['这不是 GRIDORA', '与 GRIDORA 无关'],
    tag_name: '产品介绍',
  },
  {
