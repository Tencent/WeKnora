...
const emit = defineEmits<{
  ...
  (e: 'action', action: 'download' | 'edit' | 'view-trace' | 'reparse' | 'cancel-parse' | 'move' | 'move-folder' | 'batch-manage' | 'delete' | 'metadata', item: KnowledgeCard): void;
...
// --- Action handlers ---
const handleAction = (action: 'download' | 'edit' | 'view-trace' | 'reparse' | 'cancel-parse' | 'move' | 'move-folder' | 'batch-manage' | 'delete' | 'metadata', item: KnowledgeCard) => {
