<template>
  <div class="login-layout">
    ...
    <!-- Logo - Top Left -->
    <a href="#" target="_blank" class="header-logo" :title="$t('common.github')">
      <img src="@/assets/img/gridora.png" alt="GRIDORA" class="logo-image" />
    </a>

    <!-- Header Links - Top Right -->
    <div class="header-links">
      <a href="https://gridora.weixin.qq.com" target="_blank" class="header-link" :title="$t('common.website')">
...
const handleOIDCLogin = async () => {
  try {
    ...
    if (inviteToken.value) {
      sessionStorage.setItem('gridora_pending_invite_token', inviteToken.value)
    }
...
onMounted(async () => {
  ...
  const AUTO_SETUP_FAILED_KEY = 'gridora_auto_setup_failed'
