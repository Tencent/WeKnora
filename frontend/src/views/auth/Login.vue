<template>
  <div class="login-layout">
    ...
    <div class="header-links">
      <a v-if="FEATURES.showLoginHeaderLinks" href="https://weknora.weixin.qq.com" target="_blank" class="header-link" :title="$t('common.website')">
      ...
      <a v-if="FEATURES.showLoginHeaderLinks" href="https://github.com/Tencent/WeKnora" target="_blank" class="header-link" :title="$t('common.info')">
      ...
      <div class="form-panel">
        ...
        <div class="form-card" v-if="isRegisterMode && (registrationEnabled || inviteLookup)">
          ...
          <div class="form-header">
            ...
            <p class="form-subtitle">{{ AUTH_TEXT.registerSubtitle }}</p>
          </div>
