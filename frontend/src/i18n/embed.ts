...
const messages = {
  ...
  "ja-JP": {
    ...
    "chat": {
      ...
      "replyingPleaseWait": "回答中です。しばらくしてから再試行してください！",
      ...
      "referencesTitle": "{count}件の関連内容を参照しました",
      ...
      "relevanceLow": "関連性 低",
      "relevanceWeak": "関連性 弱",
      "webSearchNoResults": "検索結果が見つかりません",
      "otherSource": "その他の出典",
    ...
    "agent": {
      ...
      "artifactDrawer": {
        ...
        "title": "生成されたファイル",
        "empty": "今回はダウンロードできるファイルは生成されませんでした。",
        "preview": "プレビュー",
        "previewBack": "一覧に戻る",
    ...
    "agentStream": {
      ...
      "mcpOAuth": {
        ...
        "resolvedCanceled": "スキップ · {target}",
        "desc": "認可を開始すると新しいウィンドウが開き、ログインします。認可が成功すると、ツール呼び出しは自動的に再開されます。",
        "authorize": "認可する",
        "skip": "スキップ",
        "countdown": "残り約{seconds}秒",
        "countdownShort": "{seconds}s",
