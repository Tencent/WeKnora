...
const messages = {
  ...
  "zh-TW": {
    "embedPublish": {
      "title": "網頁嵌入",
      "description": "將智慧體嵌入到您的網頁，訪客可透過頁面內聊天視窗或右下角浮窗發起對話。",
      "create": "新建嵌入渠道",
      "empty": "暫無嵌入渠道",
      "unnamed": "未命名渠道",
      "agent": "智慧體",
      ...
      "originsLabel": "域名白名單（每行一個，留空表示不限制）",
      "originsPlaceholder": "https://shop.example.com",
      "rateLimitLabel": "每分鐘請求上限",
      "debug": "除錯預覽",
      "createdDebugHint": "嵌入渠道已建立，可點選「除錯預覽」在新標籤頁體驗",
      "primaryColor": "主題色",
      "pageTitle": "頁面標題",
      "pageTitlePlaceholder": "AI 客服",
      ...
      "positionTopRight": "右上角",
      "positionTopLeft": "左上角",
      "publishToken": "釋出 Token",
      "publishTokenHelp": "釋出 Token（em_…）是嵌入渠道的長期金鑰，相當於 API Key。開啟渠道詳情即可檢視並複製；輪換後舊 Token 立即失效。",
      "sessionTokenHelp": "訪客開啟聊天後，iframe 會用釋出 Token 換取短期會話 Token（ems_…，約 30 分鐘），後續請求使用會話 Token，避免在 URL 中長期暴露釋出 Token。",
      "rotateTokenHelp": "輪換會作廢舊釋出 Token，所有已部署的嵌入程式碼需同步更新，否則第三方站點將無法訪問。",
      "revealToken": "顯示",
      "hideToken": "隱藏",
      "copyToken": "複製 Token",
      ...
      "defaultChatTitle": "AI 助手",
      "newChat": "新建對話",
      "rotateConfirmTitle": "確認輪換 Token？",
      "rotateConfirmBody": "輪換後舊 Token 立即失效，已釋出的嵌入程式碼需全部更新。",
      "tokenRequiredForPreview": "需要釋出 Token 才能預覽。請先建立渠道，或點選「輪換 Token」獲取新 Token。",
    },
    "chat": {
      "title": "對話",
      "newChat": "新對話",
      ...
      "unableToGetKnowledgeBaseId": "無法獲取知識庫ID",
    ...
    "agentStream": {
      "toolApproval": {
        "banner": "該 MCP 工具已標記為「需人工稽核」，確認參數後再執行",
        "waiting": "等待稽核 · {target}",
        "waitingStatus": "等待稽核",
        "targetWithTool": "{service} › {tool}",
        "titleWithTarget": "人工稽核 · {service} › {tool}",
        "resolvedApproved": "已透過 · {target}",
    ...
    "input": {
      ...
      "webSearch": {
        ...
        "toggleOn": "開啟網路搜尋",
        "toggleOff": "關閉網路搜尋",
        "agentDisabled": "當前智慧體未啟用聯網搜尋",
      },
      "imageUpload": {
        "label": "上傳圖片",
        "tooltip": "上傳圖片",
        "agentDisabled": "當前智慧體未啟用圖片上傳",
      },
      "fileUpload": {
        "label": "上傳附件",
        "tooltip": "上傳文件等附件",
        "tooMany": "最多上傳 5 個附件",
        "tooLarge": "附件超過 20MB 限制",
      },
      "messages": {
        "enterContent": "請先輸入內容!",
        ...
        "agentDisabled": "Agent 模式已禁用",
        "agentNotReadyDetail": "Agent 未就緒，需要配置以下內容：{reasons}",
