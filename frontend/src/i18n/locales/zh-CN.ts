export default {
  ...
  knowledgeBase: {
    ...
    hideFolderTree: "收起目录树",
    searchWholeKb: "全库搜索：{q}",
    folderBreadcrumbLabel: "文件夹路径",
    breadcrumbCollapsedItems: "已折叠 {count} 个层级",
    emptyFolderTree: "暂无文件夹",
    emptyFolderTreeHint: "新建文件夹后将显示在此",
    // Task 9: 搜索态筛选提示与空状态文案
    searchFiltersApplyOnlyToDocs: "其他筛选仅作用于文件",
    emptyFolderHint: "此文件夹为空",
    searchNoResults: "未找到相关结果",
    emptyRootViewer: "当前知识库暂无内容",
    newFolder: "新建文件夹",
    folderActions: "文件夹操作",
    folderActionAddSubfolder: "新建子文件夹",
    folderActionRename: "重命名",
    folderActionDelete: "删除",
    folderActionMoveTo: "移动到文件夹…",
    folderActionDeleteConfirm: "删除文件夹「{name}」将同时删除其所有子文件夹和文档，确定删除吗？",
    folderDocumentCount: "{count} 篇文档",
    folderCardType: "文件夹",
    // Inline folder editing (Task 6): UX pre-validation + backend error mapping.
    folderNameRequired: "请输入文件夹名称",
    folderNameInvalid: "文件夹名称不能为 \".\"、\"..\"，也不能包含 \"/\" 或 \"\\\"",
    folderNameConflict: "同名文件夹已存在，请使用其他名称",
    folderDepthExceeded: "文件夹层级过深，无法在此位置创建",
    folderActionFailed: "文件夹操作失败，请重试",
    expandFolder: "展开",
    collapseFolder: "收起",
    // Move-to-folder picker (Task 7): same-KB move + cross-KB transfer split.
    transferToKnowledgeBase: "转移到其他知识库…",
    folderPickerTitle: "移动到文件夹",
    folderPickerTargetLabel: "目标位置",
    folderPickerSelectHint: "请选择目标文件夹",
    folderPickerDisabledHint: "不能移动到该文件夹",
    folderPickerConfirm: "移动到此处",
    folderPickerEmpty: "暂无可选文件夹",
    folderMoveSuccess: "已移动到所选文件夹",
    folderMoveFailed: "移动失败，请重试",
    // Recursive folder delete (Task 8): impact display + submitted (not done) messaging.
    folderDeleteTitle: "删除文件夹",
    folderDeleteEmptyConfirm: "删除文件夹「{name}」？该文件夹为空，将仅删除文件夹本身。",
    folderDeleteRecursiveConfirm: "删除文件夹「{name}」将同时删除其所有子文件夹和文档，确定继续吗？",
    folderDeleteImpact: "将一并删除 {folderCount} 个子文件夹及 {docCount} 篇文档",
    folderDeleteImpactFolders: "将一并删除 {folderCount} 个子文件夹",
    folderDeleteAsyncNote: "删除操作将在后台异步执行，完成后列表会自动刷新。",
    folderDeleteSubmitted: "删除任务已提交，后台正在异步处理",
    folderDeleteFailed: "删除失败，请重试",
    folderReparseLimit: "单次最多重建 200 篇文档，请减少选择数量",
    reparseFolderUnsupported: "重新解析仅支持文档，请取消选中的文件夹",
    // Folder load errors + invalid folder_id recovery (spec §4.1 / §12)
    folderLoadFailed: "文件夹加载失败",
    folderRetry: "重试",
    folderNotFoundTitle: "文件夹不可访问",
    folderNotFoundHint: "该文件夹可能已被删除或移动，已为您返回根目录",
    folderTreeLoadFailed: "目录树加载失败",
    folderTreeRetry: "重试加载",
    detail: "知识库详情",
    accessInfo: {
      myRole: "我的身份",
      roleOwner: "创建者",
