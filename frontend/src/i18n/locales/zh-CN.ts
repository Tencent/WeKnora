export default {
  ...
  knowledgeBase: {
    ...
    batchReparseSuccess: '已提交 {count} 个重建任务',
     ...
     confirmBatchCancelParseDocument: '确认停止选中的 {count} 个正在处理的文档？未处理中的文档会自动跳过。',
     confirmBatchCancelParse: '确认停止解析',
     batchCancelParseSuccess: '已停止 {count} 个文档的解析',
     batchCancelParseFailed: '部分文档停止解析失败',
     batchCancelParseSkipped: '已跳过 {count} 个未在处理中的文档',
     batchCancelParseNone: '选中的文档中没有正在处理的任务',
     statusCompleted: '已完成',
