export default {
  ...
  settings: {
    ...
    sandbox: {
      ...
      templateLoadHint: '填写集群连接后刷新模板。没有官方标准模板或桌面模板时，会从 Docker Hub 镜像自动构建。改 DNS 或镜像后在对应卡片上点「重建」。',
      ...
      templateStepHint: '进入此步会列出集群模板；若还没有官方标准模板或桌面模板，会从 Docker Hub 镜像自动构建。改 DNS 或镜像后在对应卡片上点「重建」。选好并就绪后才能继续。',
