export default {
  ...
  agentEditor: {
    ...
    im: {
      ...
      fileStrategyDirect: "直接加入对话",
      fileStrategyKB: "上传至知识库",
      fileProcessingStrategyHint: "直接加入对话：解析文件内容并注入到当前对话中分析；上传至知识库：保存文件到指定知识库并异步解析",
      fileKnowledgeBaseRequired: "文件处理策略为「上传至知识库」时，需要选择一个知识库",
      sessionMode: "会话模式",
