export default {
  ...
  taskCenter: {
    title: "任务中心",
    subtitle: "查看用户发起任务、重试失败任务，并检查执行历史。",
    searchPlaceholder: "搜索任务名或 ID",
    empty: "暂无任务",
    retryAllConfirm: "重试当前筛选下所有可重放的失败或已取消任务？",
    cancelConfirm: "取消该任务？",
    deleteRecordsConfirm: "删除 30 天前的终态任务记录？",
    summary: {
      queued: "排队中",
      processing: "处理中",
      succeeded: "已完成",
      failedOrCanceled: "失败 / 已终止",
    },
    tabs: {
      all: "全部",
      queued: "排队中",
    ...
    messages: {
      loadFailed: "任务加载失败",
      detailFailed: "任务详情加载失败",
      retryStarted: "已开始重试",
      retryAllStarted: "已开始重试 {count} 个任务",
      retryFailed: "重试失败",
      cancelled: "任务已取消",
      cancelFailed: "取消失败",
