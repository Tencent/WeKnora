export default {
  ...
  knowledgeStages: {
    ...
    detail: {
      ...
      graphSummary: "知识图谱结果",
      graphPartialHint: "部分实体或关系处理失败，其余有效数据已经保留并写入。",
      graphNodes: "实体",
      graphRelations: "关系",
      graphSucceeded: "成功",
      graphFailed: "失败",
      graphFailureDetails: "失败明细（共 {n} 条）",
      graphNoFailureDetails: "本次记录没有可展示的单条失败详情，请查看服务端日志。",
      graphChunk: "分块 #{n}",
      graphItem: "第 {n} 项",
      graphItemUnknown: "未知项目",
      graphValidation: "解析校验",
      graphWrite: "Neo4j 写入",
      graphChunkFailure: "分块任务",
      graphUnknownStage: "未知阶段",
      graphUnknownReason: "未记录失败原因",
    },
    stage: {
      docreader: "文档解析",
      chunking: "分块",
  ...
  knowledgeEditor: {
    ...
    wikiBrowser: {
      ...
      logActionManualCreate: "手动创建",
      logActionManualEdit: "手动编辑",
      logActionManualDelete: "手动删除",
      logActionRevert: "版本回滚",
      newPageBtn: "新建页面",
