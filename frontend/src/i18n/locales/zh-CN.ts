export default {
  ...
  datasource: {
    ...
    deleteConfirmOneDrive: '确定删除该 OneDrive 数据源及其同步产生的知识？此操作不可撤销。',
    ...
    oauthAuthorization: 'Microsoft 授权',
    oauthAuthorized: 'OneDrive 已授权',
    oauthUnauthorized: '尚未连接 OneDrive',
    oauthReauthorizationRequired: '授权已失效，请重新授权',
    oauthConnect: '连接 OneDrive',
    oauthReconnect: '重新授权',
    oauthConnecting: '等待授权…',
    oauthConnected: 'OneDrive 授权成功',
    oauthNotCompleted: '未完成 OneDrive 授权',
    oauthDisconnect: '断开连接',
    oauthDisconnected: '已断开 OneDrive 连接',
    oauthDisconnectFailed: '断开 OneDrive 连接失败',
    oauthDisconnectConfirm: '断开后将暂停同步、清空选择，并删除该连接同步产生的知识。确定继续？',
    oauthReplaceAccount: '更换账号',
    oauthReplaceConfirm: '更换账号会重置同步游标，并删除原连接的同步索引及其同步产生的知识。确定继续？',
    oauthPopupFallback: '授权窗口未打开？点击此处继续',
    oauthPermissionHint: '仅申请读取文件和离线续期权限；WeKnora 不会获得 OneDrive 写入权限。',
    isRequired: '为必填项',
    credentialsLabel: '凭证',
    ...
    prereqBarText_onedrive: '首次使用？点击查看 OneDrive 授权说明',
    prereqStep1Brief_onedrive: '由部署管理员注册 Microsoft Entra 应用',
    prereqStep1Desc_onedrive: 'Redirect URI 必须与服务端 ONEDRIVE_REDIRECT_URL 完全一致',
    prereqStep2Brief_onedrive: '配置最小委托权限',
    prereqStep2Desc_onedrive: '仅需 Files.Read；offline_access 用于定时同步时刷新授权',
    prereqStep3Brief_onedrive: '在 Microsoft 页面完成登录与 MFA',
    prereqStep3Desc_onedrive: 'WeKnora 不会读取或保存密码、Authenticator 验证码',
    ...
    connectorDesc: {
      ...
      yuque: '同步语雀知识库中的文档',
      onedrive: '通过 Microsoft 授权同步 OneDrive 中选定的文件夹和文件',
