export default {
  ...
  agentStream: {
    ...
    skillCards: {
      ...
      temporaryNotice: '{name} 只是临时加载到了本次对话的沙箱里，并没有安装到空间：它不在技能列表里，其他对话用不了，沙箱重建后就会消失。',
      temporaryNoticeUnnamed: '这个技能只是临时加载到了本次对话的沙箱里，并没有安装到空间：它不在技能列表里，其他对话用不了，沙箱重建后就会消失。',
      official: '官方',
      downloads: '{count} 次下载',
      installs: '{count} 次安装',
      files: '{count} 个文件',
