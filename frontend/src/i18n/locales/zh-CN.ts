export default {
  ...
  knowledgeEditor: {
    ...
    wikiBrowser: {
      ...
      issueBrokenLink: '断链',
      issueOrphanPage: '孤立页面',
      issueEmptyContent: '内容过少',
      issueStaleRef: '失效引用',
      issueMissingCrossRef: '缺少交叉引用',
      issueLintScan: '规则巡检',
      healthDrawerFilterType: '问题类型',
      healthDrawerFilterTypeAll: '全部类型',
      healthDrawerFilterSource: '来源',
      healthDrawerFilterSourceAll: '全部来源',
      healthDrawerFilterSourceLint: '规则巡检',
      healthDrawerFilterSourceAgent: 'AI 巡检',
      healthDrawerFilterStatus: '状态',
      healthDrawerFilterStatusActionable: '待处理',
      healthDrawerFilterStatusIgnored: '已忽略',
      healthDrawerFilterStatusResolved: '已解决',
      healthStatsPages: '{count} 页',
      healthStatsLinks: '{count} 链接',
      healthStatsOrphans: '{count} 孤立页',
      healthMetricPages: '页面',
      healthMetricLinks: '链接',
      healthMetricOrphans: '孤立页',
      healthCardViewPage: '查看页面',
      healthDrawerActiveRepairs: '{count} 项正在修复',
      healthDrawerViewRepair: '查看进度',
      issueSeverityError: '严重',
      issueSeverityWarning: '警告',
      issueSeverityInfo: '提示',
      issueRepairModeDeterministic: '规则自动',
      issueRepairModeAgent: 'AI 修复',
      issueRepairModeManual: '仅手动',
      issueEvidenceTarget: '关联目标',
      issueLastSeen: '最近扫描 {time}',
      issueOccurrenceCount: '出现 {count} 次',
      issueDetectedVersion: '发现于 v{version}',
      healthDrawerResolvedEmptyTitle: '暂无已解决问题',
      healthDrawerResolvedEmptyHint: '已修复或巡检不再检出的问题会显示在这里。',
      lintRuleVersion: '规则 {version}',
      lintFinishedAt: '完成于 {time}',
      lintDuration: '耗时 {seconds}s',
      healthDrawerSelectAll: '全选',
      healthDrawerBatchIgnore: '忽略选中',
      healthDrawerBatchRepair: '修复选中',
      healthDrawerBatchIgnoreAll: '忽略全部',
      healthDrawerBatchRestore: '恢复选中',
      healthDrawerBatchRestoreAll: '恢复全部',
      healthDrawerIgnoreAllConfirmTitle: '忽略全部待处理问题？',
      healthDrawerIgnoreAllConfirmBody: '将忽略当前筛选条件下的 {count} 个问题，此操作不可撤销。',
      healthDrawerBatchIgnoreDone: '已忽略 {count} 个问题',
      healthDrawerBatchIgnoreFailed: '批量忽略失败，请重试',
      healthDrawerRestoreAllConfirmTitle: '恢复全部已忽略问题？',
      healthDrawerRestoreAllConfirmBody: '将把当前筛选条件下的 {count} 个问题恢复为待处理。',
      healthDrawerBatchRestoreDone: '已恢复 {count} 个问题',
      healthDrawerBatchRestoreFailed: '批量恢复失败，请重试',
      healthDrawerIgnoredEmptyTitle: '暂无已忽略问题',
      healthDrawerIgnoredEmptyHint: '被忽略的问题会显示在这里，可随时恢复为待处理。',
      healthDrawerViewIgnored: '查看已忽略问题',
      healthDrawerBatchRepairHint: '已启动首个修复任务，其余 {count} 项请逐个处理',
      healthDrawerLoadingMore: '加载更多…',
      healthDrawerAllLoaded: '已加载全部 {count} 项',
      ...
      lintCompleted: '规则巡检完成',
      lintFailed: '巡检失败',
      lintCompletedClean: '规则巡检完成，未发现新问题',
      lintFindings: '本次发现 {count} 项待处理问题',
      lintFindingsPartial: '本次扫描 {detected} 项，其中 {actionable} 项待处理',
      lintFindingsAllIgnored: '本次扫描 {count} 项，均已忽略，不会重新进入待处理列表',
      healthDrawerAllIgnoredTitle: '扫描结果均已忽略',
      healthDrawerAllIgnoredHint: '本次规则巡检再次发现 {count} 项已知问题，但此前已全部忽略。可点击下方按钮或切换到「已忽略」查看，并恢复为待处理。',
      loadMoreIssues: '加载更多（{loaded}/{total}）',
      issueFixSuggestions: '内容优化建议 ({count})',
      pageIssuesTitle: '本页问题 ({count})',
      pageIssuesSubtitle: '规则巡检发现的内容问题，可按类型查看处理建议',
      issueSourceLintReport: '规则巡检',
      issueRepairManualOnly: '该问题不支持自动修复，请按说明手动处理',
      issueOrphanManualHint: '孤立页面需在其他 Wiki 页面添加指向本页的链接，无法一键 AI 修复',
      issueFixSingle: '修复',
