export default {
  ...
  knowledgeEditor: {
    ...
    wikiBrowser: {
      ...
      linkedFrom: "被链接",
      sources: "来源文档",
      sourceDrawerTitle: "页面来源",
      paragraphSourceCount: "本页共 {count} 条来源",
      openParagraphSource: "查看来源 [{number}]",
      tableRowSource: "表格第 {index} 行",
      listItemSource: "列表第 {index} 项",
      blockProvenanceComplete: "来源覆盖：完整",
      blockProvenancePartial: "来源覆盖：部分",
      blockProvenanceUnsupported: "未建立块级来源",
      blockProvenanceLegacy: "旧版推断来源",
      blockProvenancePending: "来源覆盖待确认",
      blockSourceManual: "人工编辑",
      blockSourceAgent: "智能体编辑",
      sourceChunk: "证据片段 {chunk}",
      sourceEvidenceUnavailable: "暂无可显示的证据原文",
      openSourceDocument: "打开来源文档",
      sourceStatusVerified: "已验证",
      sourceStatusLocated: "证据原文已定位",
      sourceStatusInvalid: "来源已失效",
      sourceStatusPartial: "部分支持",
      sourceStatusUnsupported: "不支持",
      sourceStatusPending: "待验证",
      recentActivity: "最近活动",
      graphEmpty: "加载图谱中...",
      fitView: "适应屏幕",
      indexTitle: '索引',
