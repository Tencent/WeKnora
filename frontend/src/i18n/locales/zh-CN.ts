export default {
  ...
  knowledgeEditor: {
    ...
    wikiBrowser: {
      ...
      learningUnseen: '知识盲区',
      learningTitle: '证据式学习导航',
      learningSummary: '熟悉 {familiar} · 探索 {exploring} · 盲区 {unseen}',
      learningEvidenceNote: '文档引用只点亮对应摘要节点，最高 80 分；不是大模型主观评分。',
      learningNext: '下一步建议',
      learningReason: '连接 {count} 个熟悉节点',
      learningNodeScore: '证据分 {score}（最高 80）',
      learningNodeEvidence: '来自 {sources} 个资料来源，共观察到 {count} 次回答引用。',
