export default {
  ...
  knowledgeBase: {
    ...
    chunkStats: {
      tab: "片段统计",
      title: "片段统计",
      maxPositiveRate: "最大好评率",
      onlyNeedsOptimization: "仅待优化",
      needsOptimization: "待优化",
      ok: "正常",
      noReasons: "无",
      viewLogs: "日志",
      reset: "重置",
      resetConfirm: "确认重置该片段的赞踩数据与权重？",
      editWeight: "编辑权重",
      editWeightTitle: "编辑片段权重",
      editWeightLabel: "权重值（0.5 ~ 2.0）",
      weightUpdated: "权重已更新",
      logsTitle: "权重变更日志",
      knowledgeTitle: "文档",
      chunkIndex: "片段",
  ...
  chat: {
    ...
    like: "点赞",
    dislike: "点踩",
    dislikeReasonTitle: "点踩原因",
    dislikeReasonsLabel: "选择原因（可多选）",
    dislikeReasonInaccurate: "答案不准确",
    dislikeReasonOutdated: "信息已过时",
    dislikeReasonIrrelevant: "与问题无关",
    dislikeReasonIncomplete: "回答不完整",
    dislikeReasonCiteError: "引用错误",
    dislikeReasonOther: "其他",
    dislikeSupplementLabel: "补充说明（可选）",
    dislikeSupplementPlaceholder: "如有更多意见，请在此补充说明（最多 200 字）",
    dislikeReasonRequired: "请选择至少一个原因或填写补充说明",
    feedbackSaved: "已提交反馈",
