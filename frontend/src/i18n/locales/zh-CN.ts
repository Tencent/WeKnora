export default {
  ...
  knowledgeBase: {
    ...
    createUnderRoot: "新建于：根目录",
    createUnderFolder: "新建于：{name}",
    moveFolder: "移动文件夹",
    moveFolderTitle: "移动文件夹",
    moveFolderBody: "将“{name}”移动到：",
    moveFolderRoot: "根目录（顶层）",
    moveFolderSuccess: "文件夹已移动",
    moveFolderFailed: "文件夹移动失败",
    moveFolderIntoSelf: "不能移动到自身或其子目录",
    moveFolderConfirm: "确定移动",
  },
  uploadConfirm: {
    title: "上传文档确认",
    fileList: "待上传文件",
