export default {
  ...
  agentEditor: {
    ...
    tools: {
      ...
      wikiListSourceChunks: '列出知识点原文块',
      wikiListSourceChunksDesc: '按 Wiki 页面展开其关联的全部原文分块，无需再扫整篇文档',
  ...
  knowledgeEditor: {
    ...
    wiki: {
      ...
      contentInstructionsTip: '一两句话说明页面怎么写就行，不必写完整规范。引用和防幻觉由系统处理。改完后需重新解析才影响已有内容。',
      contentInstructionsPlaceholder: '例如：给写需求和立项用，先写结论和依据，少写空话…',
      extractionInstructionsLabel: 'Wiki 提取重点',
      extractionInstructionsTip: '用口语说希望多留下什么即可。目录怎么归类由系统处理，不必自己设计分类表。',
      extractionInstructionsPlaceholder: '例如：多留用户、竞品、假设和约束，方便写文档时引用…',
    ...
    basic: {
      ...
      descriptionWikiTip: '一句话说这个库干什么就行，例如「给产品立项和写需求用」。'
    },
    errors: {
