  ...
  knowledgeEditor: {
    ...
    wikiBrowser: {
      ...
      statistics: {
        ...
        totalLikes: '总点赞数',
        totalDislikes: '总点踩数',
        averageLikeRate: '平均好评率',
        pendingOptimization: '待优化',
        searchPlaceholder: '搜索内容...',
        filterByPending: '按状态筛选',
        pendingOnly: '仅显示待优化',
        sortBy: '排序方式',
        sortByLikeRate: '好评率',
        sortByLikeCount: '点赞数',
        sortByDislikeCount: '点踩数',
        sortByWeight: '召回权重',
        batchAdjust: '批量调整权重',
        likes: '点赞',
        dislikes: '点踩',
        ...
        recallWeight: '召回权重',
        normal: '正常',
        pendingOptimizationTag: '待优化',
        dislikeReasons: '点踩原因分布',
        weightLogs: '权重变更日志',
        triggerType: '触发类型',
        triggerReason: '原因',
        oldWeight: '原权重',
        newWeight: '新权重',
        createdAt: '时间',
        noDislikeReasons: '暂无点踩原因记录',
        reasonInaccurate: '内容不准确',
        reasonIncomplete: '内容不完整',
        reasonIrrelevant: '不相关',
        reasonOther: '其他',
        triggerUserFeedback: '用户反馈',
        triggerAutoAdjust: '自动调整',
        triggerManualReset: '手动重置',
        triggerBatchUpdate: '批量更新',
        loadFailed: '加载统计数据失败',
        resetSuccess: '片段重置成功',
        resetFailed: '片段重置失败',
        adjustSuccess: '权重调整成功',
        adjustFailed: '权重调整失败',
      },
