export default {
  ...
  settings: {
    ...
    sandbox: {
      ...
      backendDescriptions: {
        ...
        docker: '每次在当前 SAI 主机启动一个短生命周期容器执行脚本',
        local: '直接在 SAI 服务进程所在环境执行脚本',
      },
      addConfig: '添加沙箱后端',
      ...
      localRuntimeWarning: '本地进程会直接在 SAI 服务器上执行技能脚本，不具备容器或 MicroVM 隔离。仅建议在可信的开发空间使用。',
      ...
      templateStepHint: '集群缺少标准模板时，SAI 会自动创建；模板就绪后才能继续。',
  ...
  newUserGuide: {
    ...
    steps: {
      ...
      knowledge: {
        title: '创建你的知识库',
        desc: '知识库是一切的起点：上传文档、网页或 FAQ，{brand} 会自动解析并建立索引。点击这里进入知识库。'
      },
      welcome: {
        title: '欢迎使用 {brand}',
