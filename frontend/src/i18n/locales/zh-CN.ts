export default {
  ...
  datasource: {
    ...
    noResourcesDesc_dingtalk: "钉钉应用需要获得文档访问权限后才能拉取内容",
    ...
    guideStep1_dingtalk: "打开你想同步的钉钉文档或知识库空间",
    guideStep2_dingtalk: "在钉钉开放平台为应用授予文档读取权限",
    guideStep3_dingtalk: "发布或启用应用后，回到这里点重新加载",
    permissionDocLink: "查看飞书知识库权限配置文档",
    permissionDocLink_dingtalk: "查看钉钉文档权限配置文档",
    ...
    field: {
      ...
      dingtalkBaseUrl: "Base URL（可选）",
      dingtalkBaseUrlHint: "留空将使用钉钉 OpenAPI（https://api.dingtalk.com）。",
      dingtalkOperatorId: "Operator Union ID",
      dingtalkOperatorIdHint: "用于列出和读取知识库的钉钉用户 unionId。钉钉知识库 API 要求提供该操作人身份。",
      feedUrls: "订阅源地址",
    ...
    prereqStep1Desc_dingtalk: "打开钉钉开放平台，创建或选择企业内部应用，并复制 App Key 与 App Secret。",
    prereqStep2Brief_dingtalk: "授予文档读取权限",
    prereqStep2Desc_dingtalk: "为应用开通文档空间和文档内容读取权限，然后发布或启用应用。",
    prereqStep3Brief_dingtalk: "确认文档访问范围",
    prereqStep3Desc_dingtalk: "确保应用可访问需要同步的钉钉文档或知识库空间。",
