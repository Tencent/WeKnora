export default {
  ...
  integrations: {
    ...
    api: {
      ...
      kbPermissionPerKB: "逐库授权",
      kbPermissionUniform: "统一授权",
      kbPermissionHint: "每个库的权限同时受 Key 能力和当前共享权限限制。管理共享库不代表拥有该库，也不包含修改共享关系。",
      kbPermissionSelect: "选择本工作空间或共享空间的知识库",
      kbPermissionEmpty: "不允许访问任何知识库",
      kbPermissionRead: "读取 / 检索",
      kbPermissionWrite: "读取及写入内容",
      kbPermissionManage: "管理知识库",
      kbPermissionOwn: "本工作空间",
      kbPermissionUnavailable: "知识库不可用或已取消共享；请移除此项后保存。",
      kbPermissionUniformHint: "所选本工作空间的库使用相同能力；留空保持原有的不限制知识库范围的行为。授权共享库请使用逐库授权。",
      kbPermissionLoadFailed: "部分知识库选项加载失败，请重试后再调整授权。",
