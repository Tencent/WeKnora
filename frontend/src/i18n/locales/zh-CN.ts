export default {
  ...
  knowledgeBase: {
    ...
    folder: {
      ...
      createUnder: '将创建在「{name}」下',
      created: '文件夹已创建',
      renamed: '文件夹已重命名',
      moved: '文件夹已移动',
      deleted: '文件夹已删除',
      deleteConfirm: '确定删除文件夹「{name}」吗？',
      deletePromote: '将其中的文档和子文件夹上移到父级（不会删除任何文档）',
      deleteNotEmpty: '文件夹非空，请先移出内容或勾选内容上移',
      organizeByPath: '路径文件整理',
      organizeConfirm: '将文件名携带路径的存量文档按路径归入文件夹，可重复执行。',
      organizeResult: '已整理 {organized} 个文档，新建 {folders} 个文件夹',
      askInFolder: '在此文件夹内问答',
      pickTarget: '选择文件夹',
      noFolders: '暂无文件夹',
      moveDocsTo: '移动 {count} 个文档到…',
      movedDocs: '已移动 {count} 个文档',
      searchPlaceholder: '搜索文件夹',
      newSubfolder: '新建子文件夹',
      moveIntoSelf: '不能将文件夹移动到自身或其子级',
      moveConfirmTitle: '确认移动',
      moveConfirm: '将该文件夹移动到「{target}」？',
      noMatchedFolders: '没有匹配的文件夹',
    },
    tagManageTitle: '管理标签',
