export default {
  ...
  backup: {
    title: '备份与恢复',
    description: '全实例备份:数据库、上传文件与配置。仅系统管理员可用。',
    privacyNotice: '备份包含所有空间的数据与加密凭据(模型 API Key 等),请妥善保管备份文件。',
    exportNow: '导出备份',
    createSnapshot: '创建快照',
    refresh: '刷新',
    loading: '正在加载…',
    ...
    cancel: '取消',
    restoreWarning: '恢复将替换整个数据库(当前数据会被覆盖),并自动创建回滚快照;完成后需要重启实例。',
    restoreDone: '恢复完成,请重启实例使配置生效',
    rollbackPoint: '回滚快照',
    restoreFailed: '恢复失败',
    exportFailed: '导出失败',
