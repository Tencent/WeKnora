export default {
  ...
  webSearchSettings: {
    ...
    configFields: {
      searchEngine: '搜索引擎',
      searchStd: 'Standard · ¥0.01/次',
      searchPro: 'Pro · ¥0.03/次',
      searchSogou: 'Sogou · ¥0.05/次',
      searchQuark: 'Quark · ¥0.05/次',
      searchEngineDesc: '选择智谱搜索引擎及单次请求计费档位。',
      contentSize: '内容篇幅',
      contentMedium: 'Medium',
      contentHigh: 'High',
      contentSizeDesc: 'Medium 返回精简摘要；High 返回更多上下文。',
      metasoScope: '搜索范围',
      metasoScopeDesc: '选择 Metaso 的搜索范围。',
      metasoScopeWebpage: '网页',
      metasoScopeDocument: '文库',
      metasoScopeScholar: '学术',
      metasoScopeImage: '图片',
      metasoScopeVideo: '视频',
      metasoScopePodcast: '播客',
      metasoConciseSnippet: '返回精简的原文匹配信息',
      metasoConciseSnippetDesc: '开启后返回精简的原文匹配信息，关闭则返回完整片段。',
      metasoIncludeSummary: '通过网页摘要进行召回增强',
      metasoIncludeSummaryDesc: '开启后通过网页的摘要信息进行召回增强。',
    },
    toasts: {
