  ...
  knowledgeEditor: {
    ...
    advanced: {
      ...
      multimodal: {
        ...
        vllmChainLabel: 'VLLM 模型顺序',
        vllmChainDescription: '按顺序尝试图片理解模型，前一个失败、超时或返回空白时自动切换下一个',
        vllmChainPrimaryLabel: '主 VLLM 模型',
        vllmChainFallbackLabel: '备用模型',
        fallbackVllmPlaceholder: '请选择备用 VLLM 模型',
        vllmChainAdd: '添加备用模型',
        vllmChainHint: '按顺序尝试，最多 {max} 个；报错、超时或空白响应会自动切到下一个',
        vllmChainMoveUp: '上移',
        vllmChainMoveDown: '下移',
        vllmChainRemove: '删除',
        vllmChainDuplicate: '该 VLLM 模型已在顺序列表中',
