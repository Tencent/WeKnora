export default {
  ...
  integrations: {
    ...
    api: {
      ...
      apiKeyKnowledgePermissionsHint: '默认跟随上方已勾选的可读 / 可编辑 / 可管理能力。可按知识库去掉勾选；取消可读会从名单中移除该库。',
      kbPermissionRead: '可读',
      kbPermissionEdit: '可编辑',
      kbPermissionManage: '可管理',
      apiKeyKnowledgeScopeSummary: '{total} 个（可编辑 {editable} / 可管理 {manageable}）',
