export default {
  ...
  webSearchSettings: {
    ...
    proxyUrlPlaceholder: "例如 http://127.0.0.1:7890 或 socks5://127.0.0.1:1080（可选）",
  ...
  agent: {
    ...
    editor: {
      ...
      webSearchProxyUrl: "网络搜索代理",
      webSearchProxyUrlPlaceholder: "可选，如 https://host:port",
  ...
  agentEditor: {
    ...
    desc: {
      ...
      webSearchProxyUrl: "仅对该智能体生效，覆盖搜索引擎配置中的代理；留空则使用提供方已配置的代理",
