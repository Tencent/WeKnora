export default {
  ...
  agentEditor: {
    ...
    tools: {
      ...
      wikiSourcePreviewLabel: '源文档预览',
      wikiSourcePreviewDesc: '在 Wiki 阅读结果中展示当前可访问源文档的预览入口',
  ...
  envVarSettings: {
    ...
    retry: '重试',
    noConfigTitle: '还没有沙盒',
    noConfigDescription: '这个空间还没有配置沙盒后端，暂时没有可设置的变量。',
    sandboxTitle: '沙盒变量',
    sandboxHint: '你在这个沙盒上运行的任何东西都会带上，不限于技能。',
    sandboxEmpty: '你在这个沙盒上还没有变量。',
    skillTitle: '技能凭据',
    skillHint: '各技能声明自己需要的变量，只在该技能运行时带上。',
    requiredTag: '必填',
    statusUnset: '未设置',
    ...
    saveFailed: '保存失败。',
    delete: '删除',
    deleteConfirm: '删除 {name}？之后在这个沙盒上运行的东西都不会再带上它。',
    deleteSuccess: '变量已删除。',
    clear: '清除我的值',
