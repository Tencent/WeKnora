export default {
  ...
  knowledgeFolder: {
    ...
    root: "根目录",
    actions: "文件夹操作",
    createTopLevel: "新建一级文件夹",
    createChild: "新建子文件夹",
    rename: "重命名",
    delete: "删除",
    startKnowledgeBaseChat: "从此知识库开始对话",
    startFolderChat: "从此文件夹开始对话",
    folderNamePlaceholder: "请输入文件夹名称",
    deleteConfirm: "确定删除文件夹“{name}”吗？",
    notEmpty: "该文件夹下仍有文件或子文件夹，请先清空后再删除。",
    ...
    loadFailed: "文件夹加载失败",
    retry: "重试",
    resizeLabel: "调整文件夹侧栏宽度",
    breadcrumbLabel: "文件夹路径",
    ensurePathsFailed: "创建文件夹路径失败",
    expandFolder: "展开{name}",
    collapseFolder: "收起{name}",
  },
  knowledgeScope: {
    selectedCount: "已选 {count} 项",
    fileOwnershipUnavailable: "无法确认所选文件所属知识库，请重新选择文件后再试。",
  },
  knowledgeBase: {
    title: "知识库",
    list: "知识库列表",
