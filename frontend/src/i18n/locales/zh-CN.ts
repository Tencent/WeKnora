export default {
  ...
  settings: {
    ...
    sandbox: {
      title: '沙箱后端',
      description: '配置多份沙箱后端，智能体可各自选用其中一份。未填写的项沿用 .env 中的全局默认值。',
      loading: '加载沙箱配置...',
      loadFailed: '加载沙箱配置失败',
      backend: '沙箱后端',
      backendHint: '留空表示沿用全局默认',
      addConfig: '添加沙箱后端',
      viewDeployDefaults: '查看部署默认配置',
      deployDefaultsTitle: '部署默认配置',
      deployDefaultsHint: '来自 .env 的全局配置。配置里留空的项即沿用这里的值。',
      deployDefaultBackend: '默认后端',
      ...
      createTitle: '添加沙箱后端',
      editTitle: '编辑沙箱后端',
      noConfigs: '还没有沙箱后端配置。智能体将使用部署默认配置运行技能脚本。',
      ...
      legacyConfig: '已废弃',
      namedBackendHint: '具名配置支持 CubeSandbox 与 E2B。',
      fieldRequired: '必填',
      ...
      testConnection: '测试连接',
      deepCheck: '完整验证',
      deepCheckConfirm: '完整验证会真实创建并销毁一个沙箱，消耗少量沙箱时长，是否继续？',
      checkPassed: '检测通过',
      checkFailed: '检测未通过',
  ...
  agent: {
    ...
    editor: {
      ...
      sandboxBackend: '沙箱后端',
      sandboxBackendDefault: '使用部署默认配置',
      sandboxBackendHint: '仅在启用技能执行时生效。所选配置被删除后，该智能体的技能执行会失败。',
      sandboxBackendMissing: '配置已删除',
      sandboxNoConfigs: '当前空间还没有具名沙箱后端配置，技能脚本将运行在部署默认配置上。可在「设置 - 沙箱后端」中添加。',
  ...
  knowledgeBase: {
    ...
    confirmDeleteDocument: '确认删除文档"{fileName}"？待更新版本会同时取消，删除后无法恢复。',
    confirmDelete: '确认删除',
    viewModeGrid: '卡片视图',
    viewModeList: '列表视图',
    viewModeToggle: '切换视图',
    ...
    statusReplacing: '正在替换文件',
    fileUpdateActive: '正在更新文件',
    fileUpdatePending: '有待更新 v{version}',
    fileUpdateFailed: '文件更新失败',
    retryFileUpdate: '重试最新版本',
    retryFileUpdateSubmitted: '文件更新已重新提交',
    retryFileUpdateFailed: '文件更新重试失败',
    discardFileUpdate: '丢弃待更新',
    discardFileUpdateConfirm: '确认丢弃失败版本及其最新待更新文件？',
    discardFileUpdateSubmitted: '已丢弃待更新版本',
    discardFileUpdateFailed: '丢弃待更新版本失败',
    statusFailed: '失败',
    statusCancelled: '已取消',
    statusDraft: '草稿',
    noDescription: '无描述',
