export default {
  ...
  datasource: {
    ...
    noResourcesDesc_dingtalk: "钉钉应用需要开通知识库和文档读取权限，并且操作人对目标空间具有读取权限。",
    ...
    guideStep1_dingtalk: "在钉钉开放平台创建或选择一个企业内部应用",
    guideStep2_dingtalk: "开通知识库空间、节点与文件读取权限，创建版本并发布",
    guideStep3_dingtalk: "确认操作人可以访问目标知识库，然后回到这里重新加载",
    permissionDocLink: "查看飞书知识库权限配置文档",
    permissionDocLink_dingtalk: "查看钉钉开放平台文档",
    ...
    syncError: {
      ...
      dingtalk_auth_or_permission: "钉钉应用鉴权或权限不足，请检查凭证、应用权限和操作人访问权限",
      dingtalk_rate_limited: "钉钉接口限流，下次同步时将重试",
      dingtalk_timeout: "钉钉接口请求超时，下次同步时将重试",
      dingtalk_server_unavailable: "钉钉服务暂时不可用，下次同步时将重试",
    ...
    field: {
      ...
      operatorIdHint: "填写一个对目标钉钉知识库有读取权限的用户 unionId；钉钉知识库接口要求提供该参数。",
    ...
    prereqStep2Brief_dingtalk: "开通知识库与文档读取权限",
    prereqStep2Desc_dingtalk: "启用 Wiki.Workspace.Read、Wiki.Node.Read 和 Storage.File.Read，创建版本并发布。",
    prereqStep3Brief_dingtalk: "准备操作人 UnionID",
    prereqStep3Desc_dingtalk: "填写一个对目标知识库空间和文档具有读取权限的用户 unionId。",
