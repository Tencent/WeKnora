export default {
  ...
  agentStream: {
    userInput: {
      ...
      remaining: "剩余 {count} 个问题",
	  dynamicProgress: "已完成 {completed} 项 / 剩余 {remaining} 个问题",
      other: "其他",
      otherPlaceholder: "请填写其他情况",
      skip: "跳过",
      continue: "继续",
      continuing: "已提交，正在继续处理",
      answered: "已回答",
      answeredWith: "已回答：{answer}",
      skipped: "已跳过",
      timedOut: "等待已超时，请重新发起问题",
      canceled: "本次等待已取消，请重新发起问题",
