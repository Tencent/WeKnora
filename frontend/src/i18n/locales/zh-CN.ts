export default {
  ...
  datasource: {
    ...
    prereqStep3Desc_feishu_links: "为应用开通 wiki:wiki:readonly, drive:drive:readonly, drive:export:readonly, docx:document:readonly 权限",
    ...
    prereqStep3Desc_lark_links: "为应用开通 wiki:wiki:readonly, drive:drive:readonly, drive:export:readonly, docx:document:readonly 权限",
