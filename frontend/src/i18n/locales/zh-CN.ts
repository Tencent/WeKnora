export default {
  ...
  knowledgeBase: {
    ...
    batchMetadata: '批量编辑元数据',
    batchMetadataDialogHeading: '批量编辑文档元数据',
    batchMetadataSubtitle: '为选中的 {count} 个文档替换自定义元数据',
    batchMetadataHint: '下方元数据会替换所有选中文档的现有自定义元数据；留空并保存可清空全部字段。',
    batchMetadataEmpty: '暂无元数据字段，可添加字段，或直接保存以清空元数据。',
    batchMetadataSuccess: '已更新 {count} 个文档的元数据',
    batchMetadataFailed: '批量编辑元数据失败',
