export default {
  ...
  datasource: {
    ...
    feishu: {
      authModeApp: "应用授权",
      authModeUser: "个人授权",
      authModeAppHint: "以企业自建应用身份读取，仅能访问已显式授权给该应用的知识库与文档。",
      authModeUserHint: "以你本人的飞书身份读取，可导出你本人有权访问的全部文档（需完成下方授权）。",
      authorize: "去飞书授权",
      reauthorize: "重新授权",
      authorized: "已完成飞书个人授权",
      authorizeHint: "将打开飞书授权页面，请使用本人账号登录并同意授权。需先填写上方 App ID 与 App Secret。",
      authSuccess: "飞书个人授权成功",
      authFailed: "飞书授权失败，请重试",
      authRequired: "请先完成飞书个人授权",
      appCredsRequired: "请先填写 App ID 和 App Secret",
    ...
    prereqOAuthCallbackBrief_feishu: "配置个人授权回调地址",
    prereqOAuthCallbackDesc_feishu: "在飞书开放平台 → 安全设置 → 重定向 URL 中添加以下完整地址：",
