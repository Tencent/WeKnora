export default {
  ...
  settings: {
    ...
    sandbox: {
      ...
      forceDelete: '强制删除',
      disableScripts: '禁用脚本执行',
      enableScripts: '启用脚本执行',
      disableScriptsConfirm: '禁用后，未指定具名沙箱后端的智能体将无法执行技能脚本（仍可阅读技能内容）。已指向 Cube/E2B 具名配置的智能体不受影响。是否继续？',
      scriptsDisabled: '已禁用工作区默认脚本执行',
      scriptsEnabled: '已恢复工作区默认脚本执行',
      policySaveFailed: '更新脚本执行策略失败',
      legacyConfig: '已废弃',
      namedBackendHint: '具名配置支持 CubeSandbox 与 E2B。',
      inheritedValue: '全局默认：{value}',
      inheritedSecret: '全局已配置密钥，留空即沿用',
      backends: {
        disabled: '禁用',
        local: '本地进程',
        docker: 'Docker',
