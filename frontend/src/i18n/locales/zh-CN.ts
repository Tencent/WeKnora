export default {
  ...
  settings: {
    ...
    pluginService: '插件服务',
    pluginServiceDesc: '外部插件在服务启动时扫描一次。新增、修改或移除插件后，点击"刷新插件"按钮即可触发重新扫描，无需重启服务。',
    refreshPlugins: '刷新插件',
    refreshPluginsFailed: '刷新失败',
    rescanSummaryAdded: '新增 {count}',
    rescanSummarySkipped: '已存在 {count}',
    rescanSummaryChanged: '已变更 {count}',
    rescanSummaryErrors: '错误 {count}',
    rescanSummaryEmpty: '没有可扫描的插件目录',
    pluginTrustLevel: '运行方式',
    pluginTrustOffline: '离线（不联网）',
    pluginTrustTrusted: '可信（按声明联网）',
    pluginTrustIsolated: '隔离（容器）',
    pluginTrustSaved: '已保存，刷新插件后生效',
    pluginTrustSaveFailed: '保存失败',
    pluginRestart: '重启插件',
    pluginRestartConfirmTitle: '重启插件',
    pluginRestartConfirmBody: '重启将中断「{name}」正在处理的请求，确认重启？',
    pluginRestarted: '「{name}」已重启',
    pluginRestartFailed: '重启失败',
    pluginAllEffective: '所有插件配置已生效',
    pluginPendingTip: '以下插件配置待生效：{names}',
    pluginEmpty: '暂无插件',
    pluginState_running: '运行中',
    pluginState_stopped: '已停止',
    pluginState_failed: '失败',
    pluginState_unhealthy: '不健康',
    pluginState_degraded: '降级',
    pluginState_starting: '启动中',
    pluginState_draining: '排空中',
    pluginState_discovered: '已发现',
