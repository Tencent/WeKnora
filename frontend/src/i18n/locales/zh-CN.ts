export default {
  ...
  knowledgeBase: {
    ...
    batchMoveToFolder: '移动到文件夹',
    moveToFolder: '移动到文件夹',
    moveToFolderHeading: '移动到文件夹',
    moveToFolderSubtitle: '将选中的 {count} 个文档移动到指定文件夹',
    moveToFolderPickHint: '请选择目标文件夹',
    folderPanelTitle: '文件夹',
    folderExpandPanel: '展开文件夹面板',
    folderCollapsePanel: '收起文件夹面板',
    folderNewRoot: '新建文件夹',
    folderNewChild: '新建子文件夹',
    folderRename: '重命名',
    folderDelete: '删除文件夹',
    folderActions: '文件夹操作',
    folderAllDocuments: '全部文档',
    folderUnfiled: '未归档',
    folderNamePlaceholder: '输入文件夹名称',
    folderSearchPlaceholder: '搜索文件夹',
    folderSearchEmpty: '没有匹配的文件夹',
    folderEmptyHint: '暂无文件夹，点击右上角新建',
    folderIncludeSubfolders: '包含子文件夹',
    folderDeleteConfirm: '确认删除文件夹「{name}」？',
    folderDeleteNotEmpty: '该文件夹下有 {count} 个文档，删除后这些文档将移至上级文件夹（文档本身不会被删除）。',
    folderDeleteReparent: '删除并上移文档',
    ...
    folderMoveIntoSelf: '不能将文件夹移动到它自己或其子文件夹中',
    folderMoveSuccess: '文件夹移动成功',
    folderMoveFailed: '文件夹移动失败',
    folderMoveDocsSuccess: '已移动 {count} 个文档',
    folderMoveDocsFailed: '文档移动失败',
