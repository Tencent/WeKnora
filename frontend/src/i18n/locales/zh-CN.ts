export default {
  ...
  knowledgeBase: {
    ...
    retryFailedDocuments: "重试失败文档",
    retryFailedDocumentsCounting: "正在统计失败文档",
    retryFailedDocumentsDisabled: "当前没有失败文档",
    retryFailedDocumentsCountTip: "当前有 {count} 篇失败文档",
    retryFailedDocumentsConfirmTitle: "重试失败文档",
    retryFailedDocumentsConfirm: "当前知识库有 {count} 篇解析失败文档，是否批量提交重试？",
    retryFailedDocumentsConfirmButton: "批量重试",
    retryFailedDocumentsNoFailed: "当前没有失败文档需要重试",
    retryFailedDocumentsSubmittedStart: "重试提交任务已开始",
    retryFailedDocumentsSubmitted: "已提交 {count} 篇失败文档的重试任务",
    retryFailedDocumentsPartial: "提交完成：成功 {processed} 篇，跳过 {skipped} 篇，失败 {failed} 篇",
    retryFailedDocumentsFailed: "重试失败文档提交失败",
    retryFailedDocumentsProgressTitle: "重试提交进度",
    retryFailedDocumentsProgressText: "正在提交重试任务：{done}/{total}",
    retryFailedDocumentsProcessed: "已提交 {count}",
    retryFailedDocumentsSkipped: "已跳过 {count}",
    retryFailedDocumentsSubmitFailed: "提交失败 {count}",
    cancelParse: "停止解析",
