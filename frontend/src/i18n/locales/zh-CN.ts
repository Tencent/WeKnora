export default {
  ...
  settings: {
    ...
    sandbox: {
      ...
      pageHintTitle: '什么是代码沙箱？',
      pageHint: '代码沙箱是智能体执行技能脚本的隔离环境。一个空间可以添加多份配置（Docker、E2B、CubeSandbox 或本地进程），每个智能体选择一份；未选择时不会执行技能脚本。',
  ...
  agent: {
    ...
    editor: {
      ...
      sandboxNoConfigs: '当前空间还没有沙箱配置，技能脚本不会执行。可在「设置 - 代码沙箱」中添加。',
