export default {
  ...
  input: {
    ...
    folderScope: {
      ...
      entireKnowledgeBaseHint: '包含直属文件和全部后代文件夹',
      selectFolderForKb: '为 {name} 选择多个文件夹',
      selectedFolderSingle: '已选择 1 个文件夹',
      selectedFolderCount: '已选择 {count} 个文件夹',
      removeCurrentFolder: '移除当前文件夹',
      loading: '文件夹范围加载中',
      loadingShort: '加载中',
      loadFailed: '文件夹范围加载失败',
      loadFailedShort: '加载失败',
      partialInvalid: '部分文件夹范围已失效，请移除或重新选择失效文件夹',
      partialInvalidShort: '部分文件夹已失效',
      noFolders: '无可用文件夹',
      searchPlaceholder: '搜索文件夹',
      toggleFolder: '展开或收起文件夹',
      sendBlockedInvalid: '以下知识库的文件夹范围已失效：{names}'
    },
    webSearch: {
      toggleOn: '开启网络搜索',
      toggleOff: '关闭网络搜索',
  ...
  knowledgeFolderMove: {
    folderTitle: '移动目录',
    knowledgeTitle: '移动文件到目录',
    batchTitle: '批量移动文件到目录',
    moveFolder: '移动目录',
    moveKnowledge: '移动到目录',
    moveSelected: '移动到目录',
    selectTarget: '选择目标目录；根目录也是可用目标。',
    current: '当前位置',
    invalidTarget: '目标目录无效',
    cycleConflict: '无法将目录移动到自身或其子目录',
    nameConflict: '目标目录中已存在同名目录',
    moveConflict: '目录状态已变化，无法完成移动',
    resourceChanged: '文件或目录已不存在，目录数据已刷新',
    folderMoved: '目录已移动',
    knowledgeMoved: '文件已移动',
    batchMoved: '已移动 {count} 个文件',
    batchMoveFailed: '批量移动失败，请稍后重试',
    selectionChanged: '已选文件已变化，请刷新后重新选择',
    searchResultPath: '文件路径：{path}',
  ...
  knowledgeFolder: {
    ...
    noFolders: '暂无子目录',
    create: '新建目录',
    createInCurrent: '在当前目录新建',
    rename: '重命名目录',
    delete: '删除目录',
    namePlaceholder: '请输入目录名称',
    nameRequired: '请输入目录名称',
    invalidName: '目录名称无效',
    nameConflict: '当前目录下已存在同名目录',
    notEmpty: '目录非空，请先移除其中的文档和子目录',
    operationFailed: '目录操作失败，请稍后重试',
    createSuccess: '目录已创建',
    renameSuccess: '目录已重命名',
    deleteSuccess: '目录已删除',
    deleteConfirm: '确定要删除目录“{name}”吗？',
    deleteEmptyOnly: '只能删除空目录；不会删除或移动其中的文档和子目录。',
    createTarget: '目标目录：{name}',
    emptyKnowledge: '“{name}”中暂无文档',
    invalidLocation: '目录地址无效，已返回根目录',
    locationUnavailable: '目录不存在或不可访问，已返回安全目录',
    resizeSidebar: '调整目录侧栏宽度',
    resizeSidebarHint: '拖动调整宽度，双击恢复默认宽度'
  },
  resourceOrigin: {
    mine: '我创建',
    mineTooltip: '由当前用户创建',
