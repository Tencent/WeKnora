export default {
  ...
  datasource: {
    ...
    noResourcesDesc_dingtalk: "应用需要获得钉钉文档空间访问权限才能拉取内容",
    ...
    guideStep1_dingtalk: "在钉钉开放平台创建企业内部应用，并获取 App Key 与 App Secret",
    guideStep2_dingtalk: "为应用开通钉钉文档空间和文档内容读取权限，并发布到目标企业",
    guideStep3_dingtalk: "确认应用所在企业可访问目标文档空间，然后回到这里点重新加载",
    ...
    field: {
      ...
      dingtalkBaseUrlHint: "留空将使用钉钉开放平台 https://api.dingtalk.com；私有化或代理部署可填写自定义 API 地址",
      feedUrls: "订阅源地址",
    ...
    prereqStep1Desc_dingtalk: "登录钉钉开放平台 → 应用开发 → 企业内部应用 → 创建应用，获取 App Key 和 App Secret",
    prereqStep2Brief_dingtalk: "开通文档读取权限",
    prereqStep2Desc_dingtalk: "为应用开通钉钉文档空间读取和文档内容读取权限，并发布到目标企业",
    prereqStep3Brief_dingtalk: "确认文档空间访问范围",
    prereqStep3Desc_dingtalk: "确认应用所在企业可访问目标文档空间，然后回到这里测试连接并选择同步范围",
