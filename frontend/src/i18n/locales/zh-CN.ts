export default {
  ...
  datasource: {
    ...
    prereqBarText_dingtalk: "首次使用？点击查看钉钉 App 配置指引",
    prereqStep1Brief_dingtalk: "创建钉钉企业内部应用",
    prereqStep1Desc_dingtalk: "登录钉钉开放平台 → 创建应用 → 获取 Client ID 和 Client Secret",
    prereqStep2Brief_dingtalk: "为应用开通文档权限",
    prereqStep2Desc_dingtalk: "开通「钉钉文档」相关 API 读权限",
    prereqStep3Brief_dingtalk: "在钉钉 AI 应用中心开启钉钉文档 MCP",
    prereqStep3Desc_dingtalk: "登录 aihub.dingtalk.com → 搜索「钉钉文档」MCP → 开启并复制 MCP Server URL 填入凭证",
    prereqStep4Brief_dingtalk: "在企业后台查看你的用户 ID",
    prereqStep4Desc_dingtalk: "登录 oa.dingtalk.com → 通讯录 → 点击你的头像 → 复制「员工工号」或「userid」填入凭证",
