export default {
  ...
  knowledgeBase: {
    ...
    batchReparseSkippedInFlight: "已跳过 {count} 个正在解析中的文档",
      batchReparseNoEligibleDocuments: "没有可提交重建的文档，正在解析的文档已跳过",
      batchReparseLimitExceeded: "一次批量重建最多包含 {count} 个文档，请缩小筛选范围后重试",
      batchReparsePartial: "已提交 {submitted} 个重建任务，另有 {failed} 个文档未能提交，请稍后重试",
    selectAllFilteredDocuments: "选择全部 {count} 个筛选结果",
    allFilteredDocumentsSelected: "已选择全部 {count} 个筛选结果",
    statusCompleted: "已完成",
  ...
  knowledgeEditor: {
    ...
    activity: {
      ...
      actions: {
        ...
        'knowledge.batch_deleted': "批量删除知识", 'knowledge.batch_reparsed': "批量重建知识完成", 'knowledge.reparse_started': "开始重新解析",
