export default {
  ...
  knowledgeBase: {
    ...
    crawlEnabledLabel: '自动爬取子页面',
    crawlDepthLabel: '爬取深度',
    crawlDepth1: '1 级 (仅当前页)',
    crawlDepth2: '2 级 (含一跳链接)',
    crawlDepth3: '3 级 (含两跳链接)',
    crawlTip: '爬取子页面将自动提取页面内的链接并抓取内容，最多爬取指定级数内的所有页面',
    crawlingPages: '正在爬取子页面...',
    crawlFailed: '爬取失败，已回退为仅导入当前页面',
    crawlCompleted: '爬取完成，发现 {count} 个页面',
    typeURL: '网页',
    typeManual: '手动创建',
    typeFile: '文件',
    channelLabel: '来源渠道',
