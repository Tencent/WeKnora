export default {
  ...
  datasource: {
    ...
    noResourcesDesc_dingtalk: "当前 UnionId 没有可访问的钉钉知识库，或应用尚未获得文档读取权限",
    ...
    guideStep1_dingtalk: "确认应用已开通钉钉文档读取相关 API 权限并发布",
    guideStep2_dingtalk: "确认填写的是操作人的 UnionId，而不是企业内 userId",
    guideStep3_dingtalk: "确认该操作人已加入需要同步的知识库，然后回到这里重新加载",
    ...
    field: {
      ...
      operatorUnionId: "操作人 UnionId",
      operatorUnionIdHint: "必须填写可访问目标知识库的钉钉用户 UnionId，请勿填写企业内 userId",
      baseUrl: "Base URL（可选）",
    ...
    prereqStep1Brief_dingtalk: "创建企业内部应用并发布",
    prereqStep1Desc_dingtalk: "在钉钉开放平台创建企业内部应用，获取 AppKey 和 AppSecret，并发布应用版本",
    prereqStep2Brief_dingtalk: "开通文档只读权限",
    prereqStep2Desc_dingtalk: "为应用开通获取用户相关知识库、获取知识库节点列表和查询文档块元素等只读 API 权限",
    prereqStep3Brief_dingtalk: "准备有访问权的操作人 UnionId",
    prereqStep3Desc_dingtalk: "操作人必须能访问待同步知识库；配置时填写其 UnionId（不是企业内 userId）",
