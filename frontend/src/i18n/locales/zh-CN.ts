export default {
  ...
  knowledgeBase: {
    ...
    invalidURLsSkipped: '已跳过 {count} 个无效链接',
    urlImportSuccess: 'URL导入成功！',
    urlImportFailed: 'URL导入失败！',
    urlExists: '该URL已存在',
    urlLabel: 'URL地址',
    urlPlaceholder: '可输入一个或多个网页链接，每行一个，例如：\nhttps://example.com/article',
    urlTip: '支持一次粘贴多个网页链接，每行一个，系统会自动提取和解析网页中的文本内容。导入 YouTube 视频或播放列表请使用“导入 YouTube”',
    youtubeImporting: '正在导入 {count} 个 YouTube 链接…',
    youtubeImportSuccess: '已加入 {count} 个 YouTube 视频',
    youtubeImportDuplicates: '{count} 个视频已在该知识库中',
    youtubeImportFailures: '{count} 个链接或视频未能导入',
    youtubeImportTruncated: '已达到单次导入视频数量上限，仅导入了前面的视频',
    youtubeImportFailed: 'YouTube 导入失败',
    importYouTube: '导入 YouTube',
    importYouTubeTitle: '导入 YouTube',
    youtubeUrlLabel: 'YouTube 链接',
    youtubeUrlPlaceholder: '每行一个 YouTube 链接，例如：\nhttps://www.youtube.com/watch?v=VIDEO_ID\nhttps://www.youtube.com/playlist?list=PLAYLIST_ID',
    youtubeUrlTip: '仅支持 YouTube 视频和播放列表链接。每行粘贴一个链接；每个视频会成为一篇独立文档，每个播放列表会导入到以列表名称命名的文件夹中。带有 &list= 的视频链接只导入该视频，导入整个列表请使用播放列表链接。优先使用视频字幕，无字幕时用知识库的语音识别模型转写音频',
    noYouTubeURLs: '请至少输入一个 YouTube 视频或播放列表链接',
    nonYouTubeURLsSkipped: '已跳过 {count} 行非 YouTube 链接',
    typeURL: '网页',
    typeManual: '手动创建',
    typeFile: '文件',
    channelLabel: '来源渠道',
