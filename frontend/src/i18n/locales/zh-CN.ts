export default {
  learning: {
    newPractice: '开始新练习', previousPractice: '上次练习', yourAnswer: '你的答案',
    tools: {
      profile: '学习概览', profileDesc: '查看当前空间自有 Wiki 知识库中的个人学习概览。',
      recommend: '推荐练习', recommendDesc: '根据个人练习记录和有来源依据的 Wiki 页面推荐主题。',
      quiz: '准备练习测验', quizDesc: '生成有来源依据的测验，答案仅通过学习面板提交。',
    },
    title: '引导学习', consent: '个人学习记录', enabled: '已开启', disabled: '已关闭',
    overview: '学习概览', topicCount: '{count} 个主题', recommendations: '推荐练习',
    noRecommendations: '暂无推荐', practice: '练习', startPractice: '练习当前页面',
    openPage: '打开页面', pending: '测验已排队', running: '正在准备测验', cancelPolling: '停止等待',
    paused: '已暂停状态检查', checkAgain: '再次检查', failed: '测验准备失败',
    sourceStale: '来源已变更，需要重新生成测验。', regenerate: '生成新测验',
    refresh: '刷新', retry: '重试', submit: '提交答案', retryAnswer: '重新提交',
    correct: '回答正确', incorrect: '回答错误', correctAnswer: '正确答案', answered: '已作答',
    source: '来源 {index}', noQuestions: '暂无题目',
    familiar: '已接触', familiarTooltip: '阅读和来源引用仅表示接触过，不代表掌握。',
    masteryLegend: '根据已评估答案估算掌握情况',
    masteryTooltip: '已评估 {count} 次作答。模型估算：{probability}%（未经校准）。',
    privacy: '学习数据', exportKB: '导出当前知识库（JSON）', exportAll: '导出全部学习数据（JSON）',
    clearKB: '清除当前知识库记录', clearAll: '清除全部学习数据', clearTitle: '清除学习数据？',
    clearKBConfirm: '永久删除你在当前知识库中的练习记录、测验和掌握情况？',
    clearAllConfirm: '永久删除你在当前空间中的全部练习记录、测验和掌握情况？',
    confirmClear: '永久删除', cancel: '取消',
    cleared: '已删除 {attempts} 条作答、{topics} 条主题记录和 {quizzes} 份测验。',
    states: { unseen: '未评估', learning: '学习中', mastered: '已掌握', review_due: '待复习' },
    reasons: {
      practice: '需要练习', source_changed: '来源已变更', source_backed: '有来源依据', explore: '探索新主题',
      review_due: '复习已到期', review_need: '需要复习', graph_frontier: '相关主题',
      interest_match: '符合你的兴趣', content_quality: '来源质量',
      cold_start: '起始主题', exploration: '探索新主题', related_topic: '相关主题',
    },
    errors: {
      request: '无法加载学习数据。', unavailable: '当前场景暂不支持学习功能。',
      disabled: '学习功能已关闭。', notFound: '该学习内容已不可用。',
      stale: '来源已变更，请生成新测验。', conflict: '此答案已提交，刷新可查看已保存的结果。',
      busy: '学习服务繁忙，请稍后重试。', evidence: '经验证的来源证据不足，无法生成测验。',
      notReady: '测验尚未准备好。',
    },
  },
  platformApiKeys: {
