export default {
  ...
  chat: {
    feedback: {
      like: "点赞",
      dislike: "点踩",
      dialogTitle: "告诉我们哪里不满意",
      submit: "提交",
      cancelBtn: "取消",
      commentPlaceholder: "补充说明（选填）",
      submitted: "感谢你的反馈",
      canceled: "已取消评价",
      failed: "反馈提交失败，请稍后重试",
      reason: {
  ...
  kbFeedback: {
    title: "反馈统计",
    description: "查看问答点赞点踩沉淀到知识片段的统计与召回权重变化",
    entryTooltip: "反馈统计",
    tabStats: "片段统计",
    tabWeightLogs: "权重日志",
    needsOptOnly: "仅看待优化",
    rateFilterAll: "全部好评率",
    rateFilterLow: "低好评率（<50%）",
    rateFilterHigh: "高好评率（≥80%）",
    resetAction: "重置反馈数据",
    resetConfirm: "将清零本知识库全部片段的赞踩计数与召回权重，历史评价不再计入统计。确认重置？",
    resetSuccess: "已重置 {count} 个片段的反馈数据",
  ...
  retrievalSettings: {
    feedback: {
      enabledLabel: "反馈权重调整",
      enabledDescription: "开启后，问答点赞点踩沉淀的片段召回权重将参与检索候选排序：高好评率片段优先命中，低好评率片段降低命中概率。",
      boostThresholdLabel: "提权好评率阈值",
      boostThresholdDescription: "好评率达到该阈值的片段将被提升召回权重",
      penaltyThresholdLabel: "降权好评率阈值",
      penaltyThresholdDescription: "好评率低于该阈值的片段将被降低召回权重",
      boostFactorLabel: "提权系数",
      penaltyFactorLabel: "降权系数",
      minSamplesLabel: "最小评价数",
      minSamplesDescription: "片段累计评价数达到该值后，权重调整才生效，避免单次评价影响检索",
      needsOptThresholdLabel: "待优化标记阈值",
      needsOptThresholdDescription: "好评率低于该阈值的片段将被自动标记为待优化，提醒人工整改",
    },
    title: "搜索设置",
