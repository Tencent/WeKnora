export default {
  ...
  organization: {
    ...
    settings: {
      ...
      permissionCalcFormula: '空间权限为共享时给该空间设定的权限；我的实际权限 = min(空间权限, 我在本空间的角色)；由共享智能体带入的知识库需到智能体配置界面删除。',
      permissionCalcTip: '生效权限取共享空间权限与你的共享空间角色中较低值；只读成员对此库最多只读。',
      directKbSource: '直接共享',
      agentKbSource: '由{name}智能体带入',
      directAndAgentKbSource: '直接共享且由{name}智能体带入',
      inviteMembers: '邀请成员',
