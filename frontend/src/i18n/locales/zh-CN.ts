export default {
  ...
  knowledgeBase: {
    ...
    fileTypeLabel: "文件类型",
    importTypeLabel: "导入形式",
    contentTypeLabel: "内容类型",
    contentTypeUnclassified: "未识别",
    editContentType: "设置内容类型",
    batchSetContentType: "批量设置内容类型",
    contentTypePlaceholder: "请选择内容类型",
    contentTypeRequired: "请选择内容类型",
    contentTypeUpdateSuccess: "内容类型已更新",
    contentTypeUpdateFailed: "内容类型更新失败",
    batchContentTypeSuccess: "已更新 {count} 个文档的内容类型",
    renameDocument: "重命名",
    renamePlaceholder: "请输入新名称",
    renameRequired: "名称不能为空",
    renameInvalid: "名称过长或包含非法字符",
    renameSuccess: "重命名成功",
    renameFailed: "重命名失败",
    contentTypes: {
      article: "文章", book: "图书", webpage: "网页", meeting_notes: "会议纪要",
      report: "报告", presentation: "演示文稿", spreadsheet: "电子表格", manual: "手册", other: "其他",
    },
    statusCompleted: "已完成",
  ...
  knowledgeStages: {
    ...
    retry: "重新解析",
    rebuild: "重建",
    rebuildDialogTitle: "选择重建范围",
    rebuildSubmit: "提交重建",
    rebuildFull: "完整重建",
    rebuildPartial: "局部重建",
    rebuildSelectOne: "至少选择一个重建环节",
    rebuildSubmitted: "重建任务已提交",
    rebuildFailed: "重建提交失败",
    stageEmbedding: "嵌入索引",
    stageSummary: "摘要",
    stageQuestions: "问题生成",
    stageGraph: "知识图谱",
    stageWiki: "Wiki",
    stageJournalRank: "期刊等级",
    stageContentType: "内容类型",
    refresh: "立即刷新",
    copy: "复制",
    copyDetails: "复制详情",
    copied: "已复制到剪贴板",
  ...
  settings: {
    ...
    parser: {
      ...
      easyScholarSection: "期刊等级（EasyScholar）",
  ...
  webSearchSettings: {
    ...
    serpApiEngineLabel: "搜索引擎",
    serpApiEngineHelp: "选择 SerpApi 使用的结果类型，默认使用 Google 网页搜索。",
    serpApiEngines: {
      google: "Google 网页",
