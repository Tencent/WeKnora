export default {
  ...
  settings: {
    ...
    sandbox: {
      ...
      skillUploadHint: '上传后会在当前镜像上安装该技能并生成新快照，可能需要数分钟。已打开的会话会在下次使用沙盒时重建；进行中的工具调用可能中断，会话工作区草稿会清空。',
      ...
      skillDeleteHint: '删除会从镜像中移除该技能目录并生成新快照。已打开的会话会在下次使用沙盒时重建；进行中的工具调用可能中断，会话工作区草稿会清空。',
      imageInfoTitle: '当前镜像',
