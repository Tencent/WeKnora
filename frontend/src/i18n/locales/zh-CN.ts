...
export default {
  ...
  modelSettings: {
    ...
    observability: {
      cachePricingTitle: "缓存令牌价格（可选）",
      cacheReadPrice: "缓存读取/百万",
      cacheWrite5mPrice: "缓存写入 · 5 分钟/百万",
      cacheWrite1hPrice: "缓存写入 · 1 小时/百万",
      cachePricingHint: "未填写表示价格未知，填写 0 表示免费。价格单位与基础输入/输出价格一致。",
      unknownPrice: "未知",
      callStatus: "调用状态",
      started: "进行中",
      success: "成功",
  ...
  evaluation: {
    ...
    allStatuses: '全部状态',
    dataset: '数据集',
    datasetPlaceholder: '数据集 ID',
    datasetVersion: '数据集版本',
    versionPlaceholder: '版本 ID',
    model: '模型',
    modelPlaceholder: '模型 ID',
    startedFrom: '开始时间下界',
    startedTo: '开始时间上界',
    labels: '标签',
    labelsPlaceholder: '生产, 夜间任务',
    reset: '重置',
    apply: '应用筛选',
    runs: '实验运行',
    refresh: '刷新运行列表',
    ...
    comparison: '对比结果',
    backToDetail: '返回运行详情',
    parameterDifferences: '稳定参数差异',
    parameter: '参数',
    missing: '缺失',
    metricDifferences: '指标差异',
    questionSuccess: '问题成功率',
    compatible: '可兼容',
    incompatible: '不兼容',
    runDetails: '运行详情',
    progress: '进度',
    ...
    loadingQuestions: '正在加载问题证据…',
    noQuestions: '当前没有问题结果。',
    ...
    appendRating: '追加修订',
    savingRating: '正在保存…',
    noRatings: '暂无人工评分修订记录。',
    ratingSaved: '评分修订已追加',
    loadMoreQuestions: '加载更多问题',
    detailEmpty: '选择一个实验运行',
    detailEmptyHint: '此处展示运行溯源、指标、问题证据和导出控件。',
    loadingDetail: '正在加载运行详情…',
    selectAtMostTen: '最多选择 10 个运行。',
    selectAtLeastTwo: '至少选择 2 个运行。',
    labelsSaved: '标签已保存',
    unknownError: '评测请求执行失败。',
    status: {
      pending: '等待中',
      running: '运行中',
      success: '成功',
