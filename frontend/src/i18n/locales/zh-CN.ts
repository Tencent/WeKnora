export default {
    ...
    globalSettings: {
      ...
      audit: {
        ...
        action: {
          ...
          'system.cross_tenant_access_granted': '授予全租户访问',
          'system.cross_tenant_access_revoked': '撤销全租户访问',
      ...
      crossTenantAccess: {
        label: '全租户访问账号',
        description: '可访问所有空间的用户。仅同时拥有系统管理员和全租户访问权限的账号可以维护此列表；当前账号不在列表中显示，也不能撤销自己的权限。',
        placeholder: '输入用户邮箱并回车',
        loadFailed: '加载全租户访问账号失败',
        saveSuccess: '已更新全租户访问账号',
        saveFailed: '更新全租户访问账号失败',
        confirm: {
          grant: {
            body: '确认授予 {email} 全租户访问权限？',
            confirmBtn: '确认授予'
          },
          revoke: {
            body: '确认撤销 {email} 的全租户访问权限？',
            confirmBtn: '确认撤销'
          }
        }
      },
  ...
  settings: {
    ...
    sandbox: {
      ...
      skillRolloutNextTurn: '已有会话在下一轮提问时重建沙盒',
      skillRolloutNewSession: '已有会话保持原沙盒，仅新会话使用新镜像',
      skillRolloutSaveFailed: '保存生效方式失败',
      skillUploadClick: '点击上传技能压缩包',
      skillUploadDrag: '或将 .zip 拖到此处',
      skillUploadHint: '上传后会在当前镜像上安装该技能并生成新快照，可能需要数分钟。当前这一轮对话不会中断；下一轮提问时才会按新镜像重建沙盒，会话工作区草稿会在那时清空。',
      skillUploadHintNewSession: '上传后会在当前镜像上安装该技能并生成新快照，可能需要数分钟。已打开的会话继续使用原沙盒，直到该会话结束；只有新打开的会话才会带上这次安装的技能。',
      ...
      skillDeleteHint: '删除会从镜像中移除该技能目录并生成新快照。当前这一轮对话不会中断；下一轮提问时才会按新镜像重建沙盒，会话工作区草稿会在那时清空。',
      skillDeleteHintNewSession: '删除会从镜像中移除该技能目录并生成新快照。已打开的会话继续使用原沙盒，直到该会话结束；只有新打开的会话才会去掉该技能。',
      imageInfoTitle: '当前镜像',
