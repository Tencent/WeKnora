export default {
  ...
  chat: {
    feedback: {
      rateHelpful: '赞一下这个回答',
      rateUnhelpful: '踩一下这个回答',
      rated: '已评价',
      dislikeTitle: '点踩原因',
      submit: '提交',
      otherReason: '其他原因',
      reasonPlaceholder: '请简单描述问题（可选）',
      reasonInaccurate: '内容不准确',
      reasonOutdated: '内容已过时',
      reasonIrrelevant: '答非所问',
      reasonIncomplete: '回答不完整',
      reasonNoReference: '缺少引用来源',
      reasonRequired: '请选择或填写点踩原因',
      cancelled: '已取消评价',
      likeSuccess: '感谢你的点赞反馈',
      dislikeSuccess: '感谢你的反馈，我们会持续优化',
  ...
  knowledgeEditor: {
    ...
    feedback: {
      title: '片段反馈统计',
      description: '查看知识库片段在问答中的点赞/点踩反馈、好评率与召回权重，筛选低质片段并管理权重自动调整配置。',
      retry: '重试',
      loadFailed: '片段反馈数据加载失败',
      keywordPlaceholder: '搜索片段内容',
      approvalPlaceholder: '好评率',
      approvalAll: '全部片段',
      approvalHigh: '好评率 ≥ 80%',
      approvalNormal: '好评率 50% - 80%',
      approvalLow: '好评率 < 50%',
      approvalNeedsOptimization: '仅看待优化',
      apply: '筛选',
      resetSelected: '重置选中',
      reset: '重置',
      detail: '详情',
      totalCount: '共 {count} 个片段',
      empty: '暂无片段反馈数据',
      statusNeedsOptimization: '待优化',
      statusNormal: '正常',
      sortApprovalRate: '按好评率',
      sortLikeCount: '按点赞数',
      sortDislikeCount: '按点踩数',
      sortRecallWeight: '按召回权重',
      sortSessionCount: '按关联会话',
      sortFeedbackCount: '按反馈数',
      columns: {
        content: '片段内容',
        likeCount: '点赞',
        dislikeCount: '点踩',
      ...
      drawer: {
        ...
        relatedSessions: '关联问答会话',
        noReasons: '暂无点踩原因',
        noSessions: '暂无关联问答会话',
        sessionMessages: '{count} 条消息'
      },
      resetConfirmTitle: '重置片段反馈',
      resetConfirmBody: '确定要重置选中的 {count} 个片段吗？将清空点赞/点踩数据并将召回权重恢复为 1.0，此操作不可撤销。',
      resetConfirm: '确认重置',
      resetSuccess: '片段反馈已重置',
      resetFailed: '重置失败',
      config: {
        title: '权重自动调整配置',
        description: '根据片段好评率自动调整问答检索召回权重，好评率越高权重越大，极低好评率自动标记待优化。',
        tenantHint: '该配置作用于当前租户下的所有知识库。',
        save: '保存配置',
        saved: '配置已保存',
        saveFailed: '配置保存失败',
        loadFailed: '配置加载失败',
        boostThreshold: '提升阈值',
        boostThresholdTip: '好评率 ≥ 该值时提升召回权重',
        degradeThreshold: '降低阈值',
        degradeThresholdTip: '好评率 < 该值时降低召回权重',
        optimizeThreshold: '待优化阈值',
        optimizeThresholdTip: '好评率 < 该值时标记待优化',
        minVotes: '最少评价数',
        minVotesTip: '评价数达到该值后才调整权重',
        weightStep: '权重步长',
        weightStepTip: '每次调整权重的增减幅度',
        maxWeight: '最大权重',
        maxWeightTip: '召回权重上限',
        minWeight: '最小权重',
        minWeightTip: '召回权重下限'
      ...
      logs: {
        title: '权重变更日志',
        description: '查看片段召回权重的调整历史与触发来源。',
        loadFailed: '权重日志加载失败',
        empty: '暂无权重变更记录',
        sourceAll: '全部来源',
        sourceFeedback: '用户反馈',
        sourceManualReset: '手动重置',
        sourceManualAdjust: '手动调整',
        columns: {
          time: '时间',
          chunk: '片段',
          oldWeight: '原权重',
