export default {
  ...
  knowledgeBase: {
    ...
    urlTip: '支持导入各类网页内容，系统会自动提取和解析网页中的文本内容。支持 YouTube 视频和播放列表链接：优先使用字幕，无字幕时通过语音识别转写',
    youtubePlaylistImporting: '正在读取 YouTube 播放列表…',
    youtubePlaylistImportSuccess: '已从「{title}」加入 {count} 个视频',
    youtubePlaylistImportDuplicates: '{count} 个视频已在该知识库中',
    youtubePlaylistImportFailures: '{count} 个视频未能加入',
    youtubePlaylistTruncated: '仅导入了该播放列表的前 {count} 个视频',
    youtubePlaylistImportFailed: 'YouTube 播放列表导入失败',
    typeURL: '网页',
    typeManual: '手动创建',
    typeFile: '文件',
    channelLabel: '来源渠道',
