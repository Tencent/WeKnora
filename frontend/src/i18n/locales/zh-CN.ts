export default {
  ...
  skillOutput: {
    exitSuccess: "成功",
    exitFailed: "失败 (code: {code})",
    outputFiles: "输出文件 ({count})",
    download: "下载",
    downloading: "下载中...",
    preview: "预览",
    copy: "复制",
    copied: "已复制",
    truncated: "内容已截断（总大小: {total}）",
  ...
  skills: {
    hub: {
      title: "Skills Hub",
      subtitle: "管理和配置 Agent Skills，安装新技能或导出已有技能",
      install: "安装",
      upload: "上传",
      export: "导出",
      uninstall: "卸载",
      ...
      noSearchResults: "未找到匹配的 Skills",
      exportSkill: "导出 Skill",
      uninstallSkill: "卸载 Skill",
      installFromUrl: "从 URL 安装 Skill",
      uploadSkill: "上传安装 Skill",
      skillName: "Skill 名称",
      skillNamePlaceholder: "输入 Skill 名称（如 my-skill）",
      skillUrl: "下载 URL",
      skillUrlPlaceholder: "输入 Skill 归档文件的 URL（支持 zip/tar.gz）",
      skillFile: "Skill 文件",
      fillRequired: "请填写所有必填项",
      loadFailed: "加载 Skills 失败",
      refreshSuccess: "Skills 已刷新",
      refreshFailed: "刷新 Skills 失败",
      loadDetailFailed: "加载 Skill 详情失败",
      installSuccess: "Skill 安装成功",
      installFailed: "Skill 安装失败",
      uploadSuccess: "Skill 上传安装成功",
      uploadFailed: "Skill 上传安装失败",
      uninstallSuccess: "Skill 已卸载",
      uninstallFailed: "Skill 卸载失败",
      exportFailed: "Skill 导出失败",
    },
  },
};
