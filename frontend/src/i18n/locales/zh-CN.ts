export default {
  ...
  knowledgeBase: {
    ...
    clearSelection: "取消选择",
    buildProgress: "知识构建进度",
    buildProgressAria: "知识构建进度 {percentage}%，已结束 {settled} 项，共 {total} 项",
    buildProgressTotal: "已结束 {settled} / 共 {total}",
    batchStatusInFlight: "进行中 {count}",
    batchStatusCompleted: "已完成 {count}",
    batchStatusFailed: "失败 {count}",
    batchStatusCancelled: "已取消 {count}",
    batchStatusDraft: "草稿 {count}",
    batchCancelParse: "停止解析",
    confirmBatchCancelParse: "确认停止选中的 {count} 个进行中任务？已写入的分块会保留。",
    batchCancelParseSuccess: "已停止 {count} 个解析任务",
    batchCancelParseFailed: "批量停止解析失败",
    batchCancelParseSkipped: "有 {count} 个任务状态已变化或停止失败",
    batchDelete: "批量删除",
