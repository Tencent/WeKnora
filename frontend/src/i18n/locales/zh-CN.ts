export default {
  ...
  feedback: {
    like: "点赞",
    dislike: "点踩",
    dislikeHeader: "告诉我们哪里可以改进",
    dislikeHint: "选择不符合的原因，可补充更多细节：",
    commentPlaceholder: "补充说明（可选）",
    commentRequiredWhenOther: "选择「其他」时，请填写具体说明",
    saveSuccess: "反馈已保存",
    cancelSuccess: "已取消反馈",
    saveError: "反馈保存失败，请稍后重试",
    reasons: {
      inaccurate: "信息不准确",
      irrelevant: "答非所问",
      outdated: "内容过时",
    ...
    kbStats: {
      title: "反馈分析",
      lowQualityOnly: "只看低质片段",
      reset: "重置反馈",
      resetConfirm: "确定要重置该知识库的全部反馈吗？历史用户反馈将不再计入统计，但不会被删除。",
      resetSuccess: "反馈已重置",
      sortPositiveRateAsc: "好评率升序",
      sortPositiveRateDesc: "好评率降序",
      sortFeedbackCountDesc: "反馈数降序",
      sortLastFeedbackDesc: "最近反馈降序",
      columnChunk: "片段",
      columnLikeCount: "点赞",
      columnDislikeCount: "点踩",
      columnSessionCount: "会话数",
      columnPositiveRate: "好评率",
      columnLastFeedback: "最近反馈",
      columnDislikeReasons: "点踩原因",
      weightLogTitle: "权重变更日志",
    ...
    retrieval: {
      sectionTitle: "反馈驱动排序",
      enable: "启用反馈驱动的召回排序",
      description: "根据用户对回答的点赞/点踩自动调整知识片段在检索时的优先级。",
      boostThreshold: "好评率提升阈值",
      penaltyThreshold: "好评率惩罚阈值",
      boostFactor: "提升倍数",
      penaltyFactor: "惩罚倍数",
      minSamples: "最小反馈样本数",
      needsOptimizationThreshold: "需要优化阈值",
      validationError: "反馈策略参数不合法：{message}",
      recomputing: "正在重新计算反馈权重…",
      recomputeSuccess: "反馈权重已重新计算（{count} 个片段）",
    },
  },
  agent: {
    taskLabel: "任务:",
