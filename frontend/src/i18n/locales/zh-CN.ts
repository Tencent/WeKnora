export default {
  ...
  datasource: {
    ...
    field: {
      ...
      operatorUnionIdHint: "钉钉文档接口要求传入操作人的 unionId；该用户需要能访问要同步的知识库。",
      baseUrl: "Base URL（可选）",
    ...
    prereqStep2Desc_dingtalk: "至少开通 Wiki.Workspace.Read、Wiki.Node.Read、Storage.File.Read",
    prereqStep3Brief_dingtalk: "填写操作人 unionId",
    prereqStep3Desc_dingtalk: "操作人需要能访问要同步的钉钉知识库，接口会以这个用户身份读取文档",
