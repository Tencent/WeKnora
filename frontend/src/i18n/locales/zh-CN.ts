export default {
  ...
  settings: {
    ...
    skills: {
      ...
      upgradeTitle: '升级技能',
      upgradeDrawerDesc: '把「{name}」在所选沙箱上的旧版本升级到目录中的当前版本。升级会重新安装一次，完成前该沙箱上的这个技能暂不可用。',
      upgradeAvailable: '可升级',
      upgradeFromTo: '可升级 {from} → {to}',
      upgradeAccepted: '已开始升级',
      noSandboxToUpgrade: '没有需要升级的沙箱。',
      upgradeRowTitle: '有新版本',
      upgradeRowHint: '此沙箱上的版本与目录不同。升级会重新安装，完成前该技能在此沙箱上暂不可用。',
      upgradeRowHintVersions: '此沙箱是 {from}，目录是 {to}。升级会重新安装，完成前该技能在此沙箱上暂不可用。',
      loadFailed: '加载失败',
    },
    mcpService: 'MCP服务',
    versionInfo: '版本信息',
