export default {
  ...
  knowledgeBase: {
    ...
    childChunk: "子块",
    feedbackOnlyWithFeedback: "仅看有反馈",
    feedbackOnlyNeedsOptimization: "仅看待优化",
    feedbackSortDefault: "默认排序",
    feedbackSortLowPositiveRate: "低好评率优先",
    feedbackSortMostLikes: "点赞最多",
    feedbackSortMostDislikes: "点踩最多",
    feedbackSortRecent: "最近反馈",
    feedbackLikes: "赞",
    feedbackDislikes: "踩",
    feedbackPositiveRate: "好评率",
    feedbackRecallWeight: "权重",
    feedbackSessionCount: "关联会话",
    feedbackDislikeReasons: "点踩原因",
    feedbackNeedsOptimization: "待优化",
    feedbackReset: "重置",
    feedbackResetTitle: "重置分块反馈",
    feedbackResetConfirmBody: "将清空该分块的累计点赞、点踩、好评率和待优化标记，并把召回权重恢复为默认值。",
    feedbackResetSuccess: "反馈统计已重置",
    feedbackWeightLogs: "权重日志",
    feedbackWeightLogTitle: "权重变更日志",
    feedbackWeightLogsRefreshed: "权重日志已刷新",
    feedbackCurrentWeight: "当前权重",
    feedbackNoWeightLogs: "暂无权重变更记录",
    feedbackTriggerAdminReset: "管理员重置",
    feedbackTriggerUserFeedback: "用户反馈",
    feedbackRefreshLogs: "刷新日志",
