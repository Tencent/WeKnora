export default {
  ...
  knowledgeEditor: {
    ...
    wikiBrowser: {
      ...
      structuralFix: "整理",
      structuralFixTooltip: "扫描并自动整理孤儿页面、失效引用、断链等结构问题",
      structuralFixConfirmTitle: "整理 wiki？",
      structuralFixConfirmBody: "将自动归档 source_refs 已空的 entity/concept 页面、剥离指向已删除文档的引用、修复指向不存在页面的链接。index/log 等全局页不受影响。",
      structuralFixDone: "已整理 {count} 项",
      structuralFixNothing: "wiki 已经是干净状态，无需整理",
      structuralFixFailed: "整理失败",
      resetLog: "重置日志",
      resetLogTooltip: "清空 Wiki Operation Log 的所有历史记录（不可逆）",
      resetLogConfirmTitle: "重置 Wiki 日志？",
      resetLogConfirmBody: "将清空 Wiki Operation Log 的全部历史记录（每次 ingest / retract / dedup 决策的累积日志）。此操作不可逆。Index 等其他页面不受影响。",
      resetLogConfirm: "确认重置",
      resetLogDone: "Wiki 日志已重置",
      resetLogFailed: "重置日志失败",
    },
    buttons: {
      create: "创建知识库",
      save: "保存配置",
