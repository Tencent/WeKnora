export default {
  ...
  knowledgeEditor: {
    ...
    wikiBrowser: {
      ...
      profileEmpty: '暂无行为证据。浏览、引用或点赞后，这里会生成你的知识画像。',
      profileExport: '导出 HTML',
      profileExportSuccess: '画像已导出',
      profileExportFailed: '导出失败',
      profileDelete: '删除画像',
      profileDeleteConfirm: '将清空你的全部个人知识状态，图谱回到初始灰色；不影响知识库内容、其他用户与检索个性化。此操作不可撤销，确定删除？',
      profileDeleteSuccess: '画像已删除',
      profileDeleteFailed: '删除失败',
      profileLoadFailed: '加载个人画像失败',
