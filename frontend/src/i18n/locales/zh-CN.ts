export default {
  ...
  datasource: {
    ...
    prereqStep1Desc_dingtalk: "在钉钉开放平台打开内部应用，复制 Client ID / AppKey 和 Client Secret",
    prereqStep2Brief_dingtalk: "开通文档和知识库读取权限",
    prereqStep2Desc_dingtalk: "至少开通成员信息读权限、Wiki.Workspace.Read、Wiki.Node.Read、Storage.File.Read",
    prereqStep3Brief_dingtalk: "填写操作人 userId",
    prereqStep3Desc_dingtalk: "操作人需要能访问要同步的钉钉知识库，系统会先根据 userId 查询 unionId，再以这个用户身份读取文档",
