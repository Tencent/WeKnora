export default {
  ...
  processingDashboard: {
    title: "知识处理看板",
    subtitle: "实时查看各处理阶段正在执行和等待的知识",
    primaryGroup: "主处理流程",
    enrichmentGroup: "内容增强流程",
    running: "正在处理",
    queued: "排队等待",
    retrying: "重试中",
    viewQueue: "查看队列",
    noRunning: "当前无正在处理的知识",
    noActiveTasks: "当前没有正在处理或等待的知识任务",
    updatedAt: "数据生成时间",
    queueDataUnavailable: "队列数据暂不可用，运行进度仍来自处理轨迹",
    queueDataPartial: "队列规模较大，计数为近似值",
    autoRefresh: "自动刷新",
    manualRefresh: "刷新",
    filterKnowledgeBase: "知识库筛选",
    searchPlaceholder: "搜索标题或文件名",
    refresh: { off: "关闭" },
    stage: {
      docreader: { title: "文档解析", description: "读取原始文档并提取正文" },
      chunking: { title: "文档分块", description: "切分文本并准备索引单元" },
      embedding: { title: "索引构建", description: "写入向量和关键词检索索引" },
      multimodal: { title: "多模态识别", description: "识别图片中的文字与语义" },
      postprocess: { title: "后处理编排", description: "扇出摘要、问题、图谱和 Wiki 任务" },
      summary: { title: "摘要生成", description: "生成知识摘要" },
      question: { title: "问题生成", description: "生成可检索问题" },
      graph: { title: "图谱抽取", description: "抽取实体关系并写入知识图谱" },
      wiki: { title: "Wiki 合成", description: "合成 Wiki 页面和目录结构" },
    },
    state: {
      not_reached: "未到达",
      queued: "排队等待",
