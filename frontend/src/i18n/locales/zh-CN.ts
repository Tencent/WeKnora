export default {
  ...
  datasource: {
    ...
    prereqStep2Brief_dingtalk: "开通知识库相关权限",
    prereqStep2Desc_dingtalk: "在应用权限中开通：知识库读权限、知识库节点读权限、企业存储文件读权限",
    prereqStep3Brief_dingtalk: "获取 Client ID、Client Secret 和操作人 unionId",
    prereqStep3Desc_dingtalk: "在应用凭证与基础信息页面获取 Client ID 和 Client Secret；在通讯录成员详情中获取 unionId",
