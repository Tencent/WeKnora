export default {
  ...
  datasource: {
    ...
    field: {
      ...
      jiraBaseUrl: 'Jira 地址',
      jiraUsername: '用户名或邮箱',
      jiraPassword: 'Server/DC 密码或 PAT',
      jiraApiToken: 'Cloud API 令牌',
      jiraJql: '补充 JQL 过滤（可选）',
      jiraJqlHint: '例如 status in (Resolved, Closed) 或 priority = High，将与勾选的项目合并过滤',
      jiraIncludeComments: '同步工单评论',
      jiraIncludeCommentsHint: '包含工单解决过程中的排障分析与回复记录',
      clientId: 'Client ID',
