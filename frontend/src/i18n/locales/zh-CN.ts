export default {
  ...
  knowledgeFolder: {
    ...
    folderDescriptionPlaceholder: "请输入文件夹描述（可选）",
    selectFolder: "选择文件夹",
    selectTargetFolder: "选择目标文件夹",
    moveToFolder: "移动到文件夹",
    uploadToFolder: "上传到 {folder}",
    currentFolder: "当前文件夹",
    parentFolder: "上级文件夹",
    subfolders: "子文件夹",
    itemCount: "{count} 项",
    ...
    folderCreatedFailed: "文件夹创建失败",
    folderUpdatedSuccess: "文件夹更新成功",
    folderUpdatedFailed: "文件夹更新失败",
    folderDeletedSuccess: "文件夹已删除",
    folderDeletedFailed: "文件夹删除失败",
    folderMovedSuccess: "文件夹已移动",
    folderMovedFailed: "文件夹移动失败",
    confirmDeleteFolder: '确定要删除文件夹"{name}"吗？',
    confirmDeleteFolderWithContent: '文件夹“{name}”包含 {count} 个项目。删除文件夹后，其中内容会移动到根目录。是否继续？',
    forceDelete: "删除文件夹并将内容移动到根目录",
    batchMoveSuccess: "已移动 {count} 个文件",
    batchMoveFailed: "批量移动失败",
    viewModeList: "列表视图",
    viewModeGrid: "宫格视图",
    navigationHint: "双击文件夹进入",
    selectFolderHint: '选择目标文件夹，或选择"根目录"移动到顶层',
    folderPathSeparator: " / ",
    loading: "加载中...",
    loadingFolders: "加载文件夹中...",
    loadingBreadcrumb: "加载路径中...",
    cannotMoveToSelf: "不能移动到自身或其子文件夹",
    cannotMoveToDescendant: "不能移动到自己的子文件夹",
    folderNameRequired: "请输入文件夹名称",
    folderNameTooLong: "文件夹名称不能超过 255 个字符",
