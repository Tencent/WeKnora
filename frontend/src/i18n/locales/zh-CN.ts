export default {
  ...
  agentEditor: {
    ...
    im: {
      ...
      messageStorage: '自动将每轮问答保存到知识库',
      messageStorageHint: '文本、文件和图片会先进入正常问答流程，再在回答完成后异步保存。',
      fileKnowledgeBase: '存储目标知识库',
      fileKnowledgeBasePlaceholder: '选择知识库',
      fileKnowledgeBaseHint: '目标知识库会保留为预设；仅在开启消息存储时写入。',
      fileKnowledgeBaseRequired: '开启消息存储后请选择目标知识库',
      sessionMode: '会话模式',
