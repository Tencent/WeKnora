export default {
  ...
  embedPublish: {
    ...
    tokenHint: "Token 仅在创建或轮换时显示，请点击「轮换 Token」获取嵌入代码",
    created: "嵌入渠道已创建",
    updated: "嵌入渠道已更新",
    deleted: "已删除",
    ...
    publishTokenHelp: "发布 Token（em_…）是嵌入渠道的长期密钥，相当于 API Key。创建或轮换时只显示一次，需写入第三方网站的浮窗脚本；列表接口不会返回，防止泄露。",
  ...
  agentEditor: {
    ...
    embed: {
      title: "Web 嵌入",
      description: "将此智能体以 iframe 或浮窗形式发布到第三方网站，知识库范围跟随本智能体配置。",
    },
    im: {
      title: "IM 集成",
