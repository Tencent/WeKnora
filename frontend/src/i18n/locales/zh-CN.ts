export default {
  ...
  settings: {
    ...
    eventWebhooks: {
      ...
      payloadLabel: '载荷示例',
      payloadDesc: '按事件类型查看实际 body 结构（示例已脱敏）。',
      payloadHintCreated: '创建后立刻投递；此时通常还不可检索，可用下载票拉源文件。',
      payloadHintParsed: '解析完成、可检索。可能早于 created 到达。',
      payloadHintParseFailed: '解析失败；查看 data.error_message。',
      payloadHintDeleted: '单条知识删除。',
      payloadHintBatchDeleted: '同库批量删除；超过 100 条会拆成多条，按 delete_batch_id 合并。',
      payloadHintKbCreated: '知识库已创建。',
      payloadHintKbDeleted: '整库删除；cascade_knowledge=true，不要再等逐条 knowledge.deleted。',
      payloadHintMemberAdded: '本工作空间成员加入。',
      payloadHintMemberRemoved: '本工作空间成员移除或离开。',
      payloadHintTest: '设置页「发送测试」产生；可忽略 data。',
      copy: '复制',
      copied: '已复制',
      copyFailed: '复制失败',
    },
