export default {
  ...
  knowledgeBase: {
    ...
    folderRoot: "全部文档",
    folderCreate: "新建文件夹",
    folderCreateRoot: "新建根文件夹",
    folderCreateChild: "新建子文件夹",
    folderRename: "重命名",
    folderRelocate: "移动文件夹",
    folderRelocateTitle: "选择上级文件夹",
    folderMoved: "文件夹已移动",
    folderMoveFolderFailed: "移动文件夹失败",
    folderNamePlaceholder: "请输入文件夹名称",
    folderAsk: "询问此文件夹",
    folderItemCount: "{count} 项",
    folderReparseAll: "全量重解析",
    folderDeleteAll: "全量删除",
    folderReparseTitle: "全量重解析文件夹",
    folderReparseConfirm: "将递归重解析文件夹“{name}”及其子文件夹中的 {count} 个项目，确定继续吗？",
    folderReparseSubmitted: "已提交 {count} 个项目的重解析任务",
    folderReparseFailed: "提交文件夹重解析任务失败",
    folderDeleteRecursiveTitle: "全量删除文件夹",
    folderDeleteRecursiveConfirm: "将递归删除文件夹“{name}”、所有子文件夹及其中 {count} 个项目。此操作不可撤销，确定继续吗？",
    folderDeleteRecursiveSubmitted: "已提交 {count} 个项目的删除任务",
    folderDeleteRecursiveFailed: "删除文件夹失败",
    folderEmpty: "暂无文件夹",
    folderSaved: "文件夹已保存",
    folderSaveFailed: "保存文件夹失败",
    folderUploadDepthExceeded: "上传目录超过文件夹最大嵌套层级（10 层）",
    folderLoadFailed: "加载文件夹失败",
    folderDeleteTitle: "删除文件夹",
    folderDeleteConfirm: "确定删除文件夹“{name}”吗？文件夹必须为空。",
    folderDeleted: "文件夹已删除",
    folderDeleteFailed: "删除文件夹失败",
    folderMove: "移动到文件夹",
    folderMoveTitle: "移动所选文档",
    folderMoveSuccess: "文档已移动",
    folderMoveFailed: "移动文档失败",
    title: "知识库",
    list: "知识库列表",
    fileContent: "文件内容",
    detail: "知识库详情",
