export default {
  ...
  chat: {
    ...
    sandbox: {
        ...
        filesRename: '重命名',
        filesDelete: '删除',
        filesDeleteConfirm: '确定删除 {name} 吗？此操作无法撤销。',
        filesInvalidName: '请输入不含路径分隔符的文件名',
        filesLoadFailed: '无法加载沙箱文件',
        filesDownloadFailed: '下载失败',
        filesUploadComplete: '上传完成',
        filesUploadFailed: '上传失败',
        filesRenameFailed: '重命名失败',
        filesDeleteFailed: '删除失败',
        filesPaused: '沙箱已暂停。请先在终端中启动后再浏览文件，以免自动唤醒产生费用。',
        filesTooLarge: '文件超过 16 MiB 限制',
        filesTooMany: '目录条目过多，无法列出或删除',
