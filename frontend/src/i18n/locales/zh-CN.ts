export default {
  ...
  settings: {
    ...
    skills: {
      ...
      addStepRegister: '登记',
      addStepInstall: '安装',
      addStepRegisterDesc: "通过链接、ZIP 或安装指令添加技能。",
      addMethodSource: "来源链接",
      addMethodFile: "上传 ZIP",
      addMethodPrompt: "Prompt 安装",
      promptInstructions: "安装指令",
      promptInstallDesc: "选择目标沙箱后开始执行，可查看进度、补充指令或重试。",
      promptTitle: "填写安装指令",
      promptHint: "填写技能名称、安装文档、命令或需求。选择沙箱后，Agent 会直接读取文档、准备工具、获取技能并完成安装校验。",
      promptPlaceholder: "例如：根据安装文档安装指定 ID 的技能；先检查 CLI，缺少时按文档安装。",
