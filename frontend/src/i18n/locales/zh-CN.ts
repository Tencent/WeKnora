export default {
  ...
  datasource: {
    ...
    prereqBarText: "首次使用？点击查看飞书应用配置指引",
      ...
      prereqStep1Desc_dingtalk: "登录钉钉开放平台 → 应用开发 → 创建企业内部应用",
      prereqStep2Brief_dingtalk: "开通知识库文档读取权限",
      prereqStep2Desc_dingtalk: "在应用权限管理中开通知识库读取和文档读取权限",
      prereqStep3Brief_dingtalk: "获取 AppKey 和 AppSecret",
      prereqStep3Desc_dingtalk: "在应用「凭证与基础信息」页获取 AppKey 和 AppSecret",
