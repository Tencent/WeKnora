export default {
  ...
  integrations: {
    ...
    api: {
      ...
      editApiKeyScope: '编辑知识库范围',
      editApiKeyScopeDesc: '修改 API Key「{name}」可以访问的知识库。',
      editApiKeyScopeHint: '留空表示允许访问本空间的全部知识库。修改保存后立即生效。',
      updateApiKeyScopeSuccess: '知识库范围已更新',
      updateApiKeyScopeFailed: '更新知识库范围失败',
      createdAt: '创建时间',
      actions: '操作',
      deleteApiKey: '删除',
