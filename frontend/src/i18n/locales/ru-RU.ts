export default {
  ...
  knowledgeEditor: {
    ...
    desensitization: {
      ...
      engineLabel: 'Движок',
      engineDescription: 'Встроенный движок — регулярные выражения и контрольные суммы. Presidio пока без дополнительных настроек.',
      engineBuiltin: 'Встроенный (regex + checksum)',
      enginePresidio: 'Presidio',
      ...
      previewDescription: 'Прогоняет текущие правила на образце текста.',
