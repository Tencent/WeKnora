export default {
  ...
  knowledgeBase: {
    ...
    feedbackOnlyWithFeedback: 'Только с отзывами',
    feedbackOnlyNeedsOptimization: 'Только требующие оптимизации',
    feedbackSortDefault: 'Сортировка по умолчанию',
    feedbackSortLowPositiveRate: 'Сначала низкий процент одобрения',
    feedbackSortMostLikes: 'Больше всего лайков',
    feedbackSortMostDislikes: 'Больше всего дизлайков',
    feedbackSortRecent: 'Последние отзывы',
    feedbackLikes: 'Лайки',
    feedbackDislikes: 'Дизлайки',
    feedbackPositiveRate: 'Процент одобрения',
    feedbackRecallWeight: 'Вес',
    feedbackSessionCount: 'Связанные сессии',
    feedbackDislikeReasons: 'Причины дизлайков',
    feedbackNeedsOptimization: 'Требует оптимизации',
    feedbackReset: 'Сбросить',
    feedbackResetTitle: 'Сбросить отзывы фрагмента',
    feedbackResetConfirmBody: 'Это очистит накопленные лайки, дизлайки, процент одобрения и отметку необходимости оптимизации для этого фрагмента, а также вернет вес поиска к значению по умолчанию.',
    feedbackResetSuccess: 'Статистика отзывов сброшена',
    feedbackWeightLogs: 'Журнал веса',
    feedbackWeightLogTitle: 'Журнал изменения веса',
    feedbackWeightLogsRefreshed: 'Журнал веса обновлен',
    feedbackCurrentWeight: 'Текущий вес',
    feedbackNoWeightLogs: 'Записей об изменении веса пока нет',
    feedbackTriggerAdminReset: 'Сброс администратором',
    feedbackTriggerUserFeedback: 'Пользовательский отзыв',
    feedbackRefreshLogs: 'Обновить журнал',
