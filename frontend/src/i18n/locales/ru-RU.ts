export default {
  ...
  graphSettings: {
    ...
    relationsEmptyWarning: 'Сущности извлечены, но отношения отсутствуют: обычно это связано с несовпадением типов отношений с тегами. Убедитесь, что теги добавлены отдельными элементами, а не одной строкой',
