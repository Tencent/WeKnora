export default {
  ...
  settings: {
    ...
    sandbox: {
      ...
      replaceStandardTemplateConfirm: 'Стандартный шаблон WeKnora будет удалён из кластера и собран заново с текущими настройками, включая DNS. Песочницы, которые уже используют этот шаблон, могут больше не запускаться.',
