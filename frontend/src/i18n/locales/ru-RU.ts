...
/example\.(net|org)/`,
  ...
  datasource: {
    ...
    noResourcesDesc_dingtalk: 'Выдайте приложению DingTalk права чтения wiki и документов и убедитесь, что оператор имеет доступ к целевому пространству.',
    ...
    guideStep1_dingtalk: 'Создайте или выберите внутреннее приложение на DingTalk Open Platform',
    guideStep2_dingtalk: 'Выдайте права чтения пространства, узлов и файлов, затем опубликуйте версию приложения',
    guideStep3_dingtalk: 'Убедитесь, что оператор имеет доступ к целевой wiki, и повторите загрузку ресурсов',
    permissionDocLink: 'Документация по настройке прав доступа',
    permissionDocLink_dingtalk: 'Документация DingTalk Open Platform',
    ...
    syncError: {
      ...
      dingtalk_rate_limited: 'Превышен лимит запросов к API DingTalk; повтор при следующей синхронизации',
      dingtalk_timeout: 'Тайм-аут запроса DingTalk; повтор при следующей синхронизации',
      dingtalk_server_unavailable: 'Сервис DingTalk временно недоступен; повтор при следующей синхронизации',
    ...
    connectorDesc: {
      ...
      dingtalk: 'Синхронизация онлайн-документов из wiki DingTalk',
    },
    field: {
      appId: 'App ID',
      ...
      operatorIdHint: 'Укажите unionId пользователя с правом чтения целевой wiki DingTalk; этот параметр обязателен для Wiki API.',
    ...
    prereqStep1Desc_dingtalk: 'Откройте приложение на DingTalk Open Platform и скопируйте Client ID и Client Secret.',
    prereqStep2Brief_dingtalk: 'Выдайте права чтения wiki и документов',
    prereqStep2Desc_dingtalk: 'Включите Wiki.Workspace.Read, Wiki.Node.Read и Storage.File.Read, затем опубликуйте версию приложения.',
    prereqStep3Brief_dingtalk: 'Подготовьте UnionID оператора',
    prereqStep3Desc_dingtalk: 'Используйте unionId пользователя, который может читать целевое пространство wiki и документы.',
