export default {
  ...
  mcpMetadata: {
    ...
    "tools": "Список Tools",
    "cacheHint": "Загружается сохранённый каталог. Подключение к MCP выполняется только при обновлении.",
    "refresh": "Обновить Tools",
    "fetch": "Подключиться и получить Tools",
    ...
    "usageInstructions": "Инструкции по использованию (необязательно)",
    "instructionsPlaceholder": "Укажите сценарии, рекомендации по выбору инструментов или термины.",
