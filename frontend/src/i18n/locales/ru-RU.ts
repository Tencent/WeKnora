export default {
  ...
  knowledgeBase: {
    ...
    columnName: 'Имя',
    columnTag: 'Тег',
    columnJournalRank: 'Рейтинги журнала',
    columnSize: 'Размер',
    columnType: 'Тип',
    ...
    importTypeLabel: 'Тип импорта',
    contentTypeLabel: 'Тип содержимого',
    contentTypeUnclassified: 'Не классифицировано',
    editContentType: 'Задать тип содержимого',
    batchSetContentType: 'Задать тип содержимого',
    contentTypePlaceholder: 'Выберите тип содержимого',
    contentTypeRequired: 'Выберите тип содержимого',
    contentTypeUpdateSuccess: 'Тип содержимого обновлён',
    contentTypeUpdateFailed: 'Не удалось обновить тип содержимого',
    batchContentTypeSuccess: 'Тип содержимого обновлён для {count} документов',
    renameDocument: 'Переименовать',
    renamePlaceholder: 'Введите новое имя',
    renameRequired: 'Имя обязательно',
    renameInvalid: 'Имя слишком длинное или содержит недопустимые символы',
    renameSuccess: 'Переименовано',
    renameFailed: 'Не удалось переименовать',
    contentTypes: {
      article: 'Статья', book: 'Книга', webpage: 'Веб-страница', meeting_notes: 'Протокол встречи',
      report: 'Отчёт', presentation: 'Презентация', spreadsheet: 'Таблица', manual: 'Руководство', other: 'Другое',
    },
  ...
  knowledgeStages: {
    ...
    rebuild: 'Пересобрать',
    rebuildDialogTitle: 'Выберите область пересборки',
    rebuildSubmit: 'Отправить пересборку',
    rebuildFull: 'Полная пересборка',
    rebuildPartial: 'Частичная пересборка',
    rebuildSelectOne: 'Выберите хотя бы один этап пересборки',
    rebuildSubmitted: 'Задача пересборки отправлена',
    rebuildFailed: 'Не удалось отправить пересборку',
    stageEmbedding: 'Индекс эмбеддингов',
    stageSummary: 'Краткое содержание',
    stageQuestions: 'Генерация вопросов',
    stageGraph: 'Граф знаний',
    stageWiki: 'Wiki',
    stageJournalRank: 'Рейтинг журнала',
    stageContentType: 'Тип содержимого',
  ...
  settings: {
    ...
    parser: {
      ...
      easyScholarSection: 'Рейтинг журнала (EasyScholar)',
      easyScholarSecretKey: 'EasyScholar SecretKey',
      easyScholarSecretPlaceholder: 'Введите EasyScholar SecretKey',
  ...
  webSearchSettings: {
    ...
    serpApiEngineLabel: 'Поисковая система',
    serpApiEngineHelp: 'Выберите тип результатов SerpApi. По умолчанию используется Google Web.',
    serpApiEngines: {
      google: 'Google Web',
