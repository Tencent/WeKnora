...
/example\.(net|org)/`,
  ...
  datasource: {
    ...
    field: {
      ...
      operatorIdHint: 'Базы знаний читаются с правами этого пользователя. Получите ID через API сведений о пользователе DingTalk.',
    ...
    prereqBarText_dingtalk: 'Впервые используете? Откройте руководство по настройке DingTalk',
    ...
    prereqStep2Desc_dingtalk: 'Выдайте права Wiki.Workspace.Read, Wiki.Node.Read и Storage.File.Read.',
    prereqStep3Brief_dingtalk: 'Укажите Union ID оператора',
    prereqStep3Desc_dingtalk: 'Укажите Union ID пользователя DingTalk с доступом к целевым базам знаний.',
