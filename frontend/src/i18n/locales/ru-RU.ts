export default {
  ...
  input: {
    ...
    placeholderWithContext: 'Введите вопрос, ответ будет основан на выбранных выше базах знаний/папках/файлах',
  ...
  knowledgeBase: {
    ...
    folderDirectDocuments: 'Документов на этом уровне: {count}',
