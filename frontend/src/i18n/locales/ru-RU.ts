export default {
  learning: {
    newPractice: 'Новая практика', previousPractice: 'Предыдущая практика', yourAnswer: 'Ваш ответ',
    tools: {
      profile: 'Обзор обучения', profileDesc: 'Просмотр личного обзора обучения в Wiki-базе знаний рабочего пространства.',
      recommend: 'Рекомендовать практику', recommendDesc: 'Рекомендация тем по истории практики и Wiki-страницам с источниками.',
      quiz: 'Подготовить учебный тест', quizDesc: 'Подготовка теста на основе источников. Ответы отправляются только через панель обучения.',
    },
    title: 'Обучение', consent: 'Личная история обучения', enabled: 'Включено', disabled: 'Выключено',
    overview: 'Обзор', topicCount: 'Тем: {count}', recommendations: 'Рекомендуемая практика',
    noRecommendations: 'Рекомендаций пока нет', practice: 'Практика', startPractice: 'Практика по этой странице',
    openPage: 'Открыть страницу', pending: 'Тест в очереди', running: 'Подготовка теста', cancelPolling: 'Прекратить ожидание',
    paused: 'Проверка статуса приостановлена', checkAgain: 'Проверить снова', failed: 'Не удалось подготовить тест',
    sourceStale: 'Источники изменились. Нужен новый тест.', regenerate: 'Подготовить новый тест',
    refresh: 'Обновить', retry: 'Повторить', submit: 'Отправить ответ', retryAnswer: 'Повторить отправку',
    correct: 'Верно', incorrect: 'Неверно', correctAnswer: 'Правильный ответ', answered: 'Ответ получен',
    source: 'Источник {index}', noQuestions: 'Нет доступных вопросов',
    familiar: 'Знакомая тема', familiarTooltip: 'Чтение и использование источников означают знакомство с темой, а не её освоение.',
    masteryLegend: 'Освоение по оценённым ответам',
    masteryTooltip: 'Оценено ответов: {count}. Оценка модели: {probability}% (не откалибрована).',
    privacy: 'Данные обучения', exportKB: 'Экспорт этой базы знаний (JSON)', exportAll: 'Экспорт всех данных обучения (JSON)',
    clearKB: 'Удалить записи этой базы знаний', clearAll: 'Удалить все данные обучения', clearTitle: 'Удалить данные обучения?',
    clearKBConfirm: 'Безвозвратно удалить вашу историю практики, тесты и оценки освоения для этой базы знаний?',
    clearAllConfirm: 'Безвозвратно удалить всю вашу историю практики, тесты и оценки освоения в этом рабочем пространстве?',
    confirmClear: 'Удалить навсегда', cancel: 'Отмена',
    cleared: 'Удалено ответов: {attempts}, записей тем: {topics}, тестов: {quizzes}.',
    states: { unseen: 'Не оценено', learning: 'Изучается', mastered: 'Освоено', review_due: 'Пора повторить' },
    reasons: {
      practice: 'Нужна практика', source_changed: 'Источники изменились', source_backed: 'Есть подтверждение источниками', explore: 'Изучение новой темы',
      review_due: 'Пора повторить', review_need: 'Нужно повторение', graph_frontier: 'Связанная тема',
      interest_match: 'Соответствует интересам', content_quality: 'Качество источников',
      cold_start: 'Начальная тема', exploration: 'Изучение новой темы', related_topic: 'Связанная тема',
    },
    errors: {
      request: 'Не удалось загрузить данные обучения.', unavailable: 'Обучение недоступно в этом контексте.',
      disabled: 'Обучение выключено.', notFound: 'Этот учебный материал больше недоступен.',
      stale: 'Источники изменились. Подготовьте новый тест.', conflict: 'Этот ответ уже отправлен. Обновите данные, чтобы увидеть сохранённый результат.',
      busy: 'Сервис обучения занят. Повторите попытку позже.', evidence: 'Недостаточно проверенных подтверждений из источников для теста.',
      notReady: 'Тест ещё не готов.',
    },
  },
  localBrowser: {
