export default {
  ...
  auth: {
    ...
    registerFailed: 'Ошибка регистрации',
    bootstrapAdmin: 'Настроить системного администратора',
    bootstrapFirstTime: 'Первое развёртывание?',
    bootstrapHint: 'Создайте настроенную учётную запись системного администратора для управления этим развёртыванием.',
    bootstrapping: 'Настройка...',
    bootstrapSuccess: 'Системный администратор создан. Добро пожаловать в WeKnora',
    bootstrapFailed: 'Не удалось настроить системного администратора',
