...
/example\.(net|org)/`,
  ...
  knowledgeEditor: {
    ...
    wikiBrowser: {
      ...
      sourceDrawerTitle: 'Источники страницы',
      paragraphSourceCount: 'Источников на странице: {count}',
      openParagraphSource: 'Открыть источник [{number}]',
      tableRowSource: 'Строка таблицы {index}',
      listItemSource: 'Пункт списка {index}',
      blockProvenanceComplete: 'Покрытие источниками: полное',
      blockProvenancePartial: 'Покрытие источниками: частичное',
      blockProvenanceUnsupported: 'Нет источников на уровне блока',
      blockProvenanceLegacy: 'Источники определены старым способом',
      blockProvenancePending: 'Покрытие источниками проверяется',
      blockSourceManual: 'Ручное редактирование',
      blockSourceAgent: 'Редактирование агентом',
      sourceChunk: 'Фрагмент доказательства {chunk}',
      sourceEvidenceUnavailable: 'Текст доказательства недоступен',
      openSourceDocument: 'Открыть исходный документ',
      sourceStatusVerified: 'Проверено',
      sourceStatusLocated: 'Фрагмент найден в источнике',
      sourceStatusInvalid: 'Источник больше не актуален',
      sourceStatusPartial: 'Частично подтверждено',
      sourceStatusUnsupported: 'Не подтверждено',
      sourceStatusPending: 'Ожидает проверки',
