export default {
  ...
  agentStream: {
    ...
    skillCards: {
      ...
      temporaryNotice: 'Навык {name} только загружен в песочницу этого диалога и не установлен в рабочее пространство: его нет в списке навыков, другие диалоги не могут его использовать, и он исчезнет при пересоздании песочницы.',
      temporaryNoticeUnnamed: 'Этот навык только загружен в песочницу этого диалога и не установлен в рабочее пространство: его нет в списке навыков, другие диалоги не могут его использовать, и он исчезнет при пересоздании песочницы.',
