export default {
  sandboxBrowser: {
    ...
    unavailableHint: "В этой песочнице нет навыка браузера. Выберите конфигурацию с поддержкой браузера.",
    reconnectHint: "Соединение с браузером прервано. Попробуйте запустить его снова.",

      "title": "Браузер",
      "controlling": "Вы управляете",
      "viewOnly": "Только просмотр",
      "release": "Вернуть управление",
      "takeControl": "Взять управление",
      "previewHint": "Предпросмотр обновляется раз в две секунды. Агент ждёт, пока вы управляете. Закрытие панели возвращает управление.",
      "address": "Адрес страницы",
      "go": "Перейти",
      "viewport": "Предпросмотр браузера песочницы",
      "emptyHint": "Браузер ещё не запущен. Кнопка ниже запустит песочницу и браузер этой сессии.",
      "start": "Запустить браузер",
      "textHint": "Выберите поле на странице, затем введите текст здесь",
      "insert": "Ввести",
      "commandFailed": "Ошибка действия в браузере"
  },
  skillDiscovery: {
    cardBuiltins: "Предустановленные",
    cardInstalled: "Установлены пользователем",
    cardUnknown: "Сведения о предустановке неизвестны",
    cardNone: "Нет",
    cardLoadFailed: "Не удалось загрузить сведения об установках",
    cardIncompatible: "Ещё {count} с несовместимой версией",
    cardCollapse: "Свернуть",
    cardExpand: "Показать все навыки",
    cardDisabled: "Отключён",
    cardAvailabilityUnknown: "Доступность неизвестна",
    cardNotInImage: "Недоступен в текущем образе",

    canInstallManually: "Предустановка не подтверждена · можно установить вручную",
    alreadyInstalled: "Навык с таким именем уже установлен",
    preinstalledShort: 'Предустановлен',
    preinstalledOnName: 'Предустановлен · {name}',
    preinstalledSandboxCount: 'Предустановлен в {count} песочницах',
    alreadyPreinstalled: "Предустановлено · готово к использованию",
    checkingPreinstalled: "Чтение сведений о встроенных навыках…",
    includedWithTemplate: "Включено в шаблоны",
    invalidManifest: "Неверный формат. Выберите JSON со списком навыков от издателя.",
    clearManifest: "Удалить декларацию",
    importManifest: "Импорт декларации",
    cloudManifestHint: "Если облако не предоставляет список навыков, импортируйте декларацию издателя образа. Сохраняются только метаданные, привязанные к версии шаблона.",
    preinstalledUnknown: "Сведения о встроенных навыках неизвестны. Песочница не запускается, пакеты не устанавливаются.",
    preinstalledMismatch: "Некоторые навыки не соответствуют версии приложения и недоступны.",
    preinstalledReady: "Доступны агентам с этим шаблоном. Установка не нужна.",
    templateBuiltins: "Встроенные навыки",
    activationDetails: "Подробнее",
    activationFailedHint: "Установка не завершена. Проверьте подробности и повторите попытку или проверьте настройки песочницы.",
    activationTitle: "Выберите конфигурации песочницы для {name}",
    activate: "Включить в песочнице",
    activationHint: "Установка только в выбранные песочницы. Для предустановленных навыков повторная установка не нужна.",
    activationAccepted: "Включаем навык",
      "localBrowser": "Локальный браузер · нужно расширение",
      "title": "Каталог навыков",
      "mySkills": "Мои навыки",
      "search": "Поиск навыка, назначения или автора",
      "runtimeHint": "Встроенные навыки готовы к работе в шаблонах. Здесь их можно установить и в другие песочницы.",
      "retry": "Повторить",
      "builtins": "Встроенные навыки",
      "recommended": "Рекомендации",
      "builtinHint": "Навыки для офиса, анализа данных и браузера. Используйте готовый шаблон или установите в другую песочницу.",
      "externalHint": "Ссылки на материалы внешних авторов. Код не включён, навыки не устанавливаются в песочницу, инструкции не передаются агенту автоматически.",
      "linkOnly": "Внешняя ссылка",
      "source": "Источник",
      "manage": "Управление навыком",
      "add": "Включить навык",
      "officialGuide": "Руководство автора",
      "noResults": "Навыки не найдены",
      "loadFailed": "Не удалось загрузить навыки",
      "addFailed": "Не удалось добавить навык",
      "migrateTitle": "Обновление старой песочницы",
      "migrateHint": "Создайте конфигурацию с новым образом и перенесите навыки в исходных версиях.",
      "migrate": "Перенести навыки",
      "migrateDetails": "Сначала создайте конфигурацию с новым образом в настройках песочницы. Перенос проверит исходные архивы и установит их в целевую конфигурацию. Исходная конфигурация и текущие диалоги сохранятся. После установки выберите новую конфигурацию у агента и проверьте её в новом диалоге.",
      "configureSandbox": "Настройки песочницы",
      "sourceSandbox": "Исходная конфигурация",
      "targetSandbox": "Новая конфигурация",
      "preview": "Проверить перенос",
      "startMigration": "Перенести доступные навыки",
      "readyToMigrate": "Исходный архив проверен",
      "noSkillsToMigrate": "В исходной конфигурации нет навыков",
      "migrationStarted": "Запущено установок: {count}. Прогресс доступен в разделе «Мои навыки». Отдельно проверьте учётные данные и пользовательские переменные окружения новой конфигурации.",
      ...
      "blockers": {
          "source_not_ready": "Исходная установка не завершена",
          "source_disabled": "Отключён в источнике; не будет включён",
          "target_name_conflict": "Одноимённый навык в целевой конфигурации сохранён",
          "missing_digest": "В старой записи нет хеша; импортируйте исходный архив",
          "missing_original_archive": "Исходный архив недоступен; новая версия не будет подставлена"
      }
  },
  platformApiKeys: {
  ...
  agent: {
    ...
    editor: {
      ...
      skillsConfig: 'Навыки',
      skillsConfigDesc: 'Выберите песочницу и навыки. Предустановленные навыки готовы к работе; другие можно установить из каталога.',
      skillsSelection: 'Список навыков',
      skillsSelectionDesc: 'Доступны предустановленные навыки и навыки, установленные пользователем.',
      skillsAll: 'Все',
      skillsSelected: 'Выбранные',
      skillsNone: 'Отключено',
      selectSkills: 'Выбрать навыки',
      selectSkillsDesc: 'Выберите навыки агента. Предустановленные навыки не требуют повторной установки.',
      skillsAllListHint: 'Использовать все доступные предустановленные и установленные навыки этой песочницы.',
      skillsGroupAvailable: 'Доступны',
      skillsGroupUnavailable: 'Недоступны',
      noSkillsAvailable: 'В песочнице нет доступных навыков, а каталог рабочего пространства пуст.',
