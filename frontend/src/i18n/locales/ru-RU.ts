export default {
  ...
  backup: {
    ...
    description: 'Полное резервное копирование экземпляра: база данных, загруженные файлы и конфигурация. Только для системного администратора.',
    privacyNotice: 'Архивы содержат данные всех рабочих пространств и зашифрованные учётные данные (API-ключи моделей и т.д.). Храните файлы резервных копий в безопасности.',
    exportNow: 'Экспортировать резервную копию',
    ...
    pickFile: 'Выбрать файл резервной копии…',
    restoreConfirmTitle: 'Подтвердить восстановление?',
    restoreConfirmBtn: 'Восстановить',
    cancel: 'Отмена',
    restoreWarning: 'Восстановление заменяет всю базу данных (текущие данные перезаписываются) и сначала создаёт автоматический снимок отката; после завершения требуется перезапуск.',
    restoreDone: 'Восстановление завершено — перезапустите экземпляр для применения',
    rollbackPoint: 'Снимок отката',
    restoreFailed: 'Ошибка восстановления',
    exportFailed: 'Ошибка экспорта',
    snapshotCreated: 'Снимок создан',
    snapshotFailed: 'Не удалось создать снимок',
    downloadFailed: 'Ошибка скачивания',
    deleteFailed: 'Ошибка удаления',
    deleted: 'Удалено',
    deleteConfirm: 'Удалить снимок {id}?',
