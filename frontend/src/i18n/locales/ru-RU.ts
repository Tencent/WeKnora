...
/example\.(net|org)/`,
  ...
  datasource: {
    ...
    field: {
      ...
      operatorIdHint: 'Найдите unionId в консоли администратора DingTalk → Контакты → данные сотрудника, или получите через API.',
    },
    comingSoon: 'Скоро',
    ...
    prereqStep1Desc_dingtalk: 'DingTalk Open Platform → Разработка приложений → Внутреннее приложение → Создать приложение',
    prereqStep2Brief_dingtalk: 'Включите права базы знаний',
    ...
    prereqStep3Desc_dingtalk: 'Получите Client ID и Client Secret на странице учётных данных приложения; unionId — из данных сотрудника в Контактах.',
