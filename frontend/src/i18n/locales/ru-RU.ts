export default {
  ...
  knowledgeBase: {
    ...
    rebuildAllFailed: 'Пересобрать неудачные ({count})',
    confirmRebuildAllFailed: 'Пересобрать все {count} неудачных документа? Существующее содержимое будет удалено и заново обработано.',
    confirmRebuildAllFailedBtn: 'Пересобрать все',
