export default {
  ...
  settings: {
    ...
    intentPolicy: {
      ...
      description: 'Политики IntentGate оценивают, соответствует ли вызов инструмента агента намерениям пользователя и ограничениям. Новые политики всегда начинаются в режиме observe (только запись, без блокировки).',
      empty: 'Политик намерений пока нет',
      wholeTenant: 'Все рабочее пространство',
      riskHigh: 'Высокий риск',
      riskLow: 'Низкий риск',
      currentBadge: 'Текущая',
      supersededBadge: 'Заменена',
      scopes: {
        tool: 'Инструмент',
        service: 'Сервис MCP',
        agent: 'Агент',
        workspace: 'Рабочее пространство',
        tenant: 'Все пространство',
      },
      modes: {
        observe: 'Наблюдение',
      ...
      actions: {
        create: 'Новая политика',
        edit: 'Изменить',
        history: 'История версий ({count})',
      },
      editor: {
        createTitle: 'Новая политика намерений',
        editTitle: 'Изменение политики (сохранить как v{version})',
      },
      form: {
        scopeType: 'Область',
        scopeRef: 'Ссылка области',
        constraintText: 'Ограничение (естественный язык)',
        constraintPlaceholder: 'Например: возврат не должен превышать 75 за операцию',
        ruleExpr: 'Выражение правила (необязательно)',
        ruleExprPlaceholder: 'Например: value <= 75 - компилируемые ограничения полностью обходят LLM-судью',
        argPath: 'Путь аргумента (необязательно)',
        riskTier: 'Уровень риска',
        mode: 'Режим',
      },
      scopeRefHints: {
        tool: 'service_id:tool_name; поддерживается префиксный wildcard вида *:wiki_*',
        service: 'ID сервиса MCP',
        agent: 'ID агента',
        workspace: 'ID рабочего пространства',
      },
      enforceConfirm: {
        title: 'Переключить в принудительный режим?',
        body: 'Режим enforce реально блокирует вызовы инструментов, нарушающие политику: агент увидит причину отказа и сможет исправиться. Режим observe только записывает вердикты. Продолжить?',
        confirm: 'Принудительно',
      },
      toasts: {
        loadFailed: 'Не удалось загрузить политики намерений',
        enabled: 'Политика включена',
        disabled: 'Политика отключена',
        toggleFailed: 'Не удалось обновить состояние политики',
        created: 'Политика создана',
        updated: 'Новая версия сохранена',
        saveFailed: 'Не удалось сохранить политику',
        constraintRequired: 'Текст ограничения обязателен',
        scopeRefRequired: 'Для этого типа области нужна ссылка',
      },
    },
