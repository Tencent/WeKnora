export default {
  ...
  knowledgeEditor: {
    ...
    wikiBrowser: {
      ...
      blockSources: 'Источники: {count}',
      sourceChunk: 'Фрагмент {index}',
      sourceUnavailable: 'Источник недоступен',
      sourceManualCreated: '[Создано вручную]',
      sourceFallbackUnavailable: 'Не удалось загрузить источники блоков ({reason}); показана вся страница.',
      sourceFallbackNoData: 'Источники на уровне блоков недоступны; показана вся страница.',
      sourceFallbackPageEdited: 'Страница была изменена вручную, агентом или откатом. Источники блоков относятся только к предыдущей версии, поэтому показана вся текущая страница. Источники блоков восстановятся после повторной генерации Wiki.',
      sourceFallbackVersionMismatch: 'Источники не соответствуют версии страницы; показана вся страница.',
      sourceFallbackLegacy: 'Для старой страницы нет проверяемых источников блоков; показана вся страница.',
      sourceFallbackNoBlocks: 'Данные источников неполны (нет блоков фактов); показана вся страница.',
      sourceFallbackMissingSources: 'У некоторых блоков фактов нет подтверждающего источника; показана вся страница.',
      sourceSomeUnavailable: 'Некоторые документы или фрагменты источников больше недоступны; вся страница остаётся видимой, а затронутые источники отмечены.',
      sourceFallbackUnknownError: 'неизвестная ошибка',
