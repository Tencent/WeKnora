export default {
  skillDiscovery: {
    ...
    failedSkills: "Ошибок: {count}",
    viewSkills: "Просмотр навыков",
    ...
    alreadyInstalled: "Этот навык уже установлен",
    ...
    activationHint: "Установка только в выбранные песочницы. Для предустановленных навыков повторная установка не нужна.",
      ...
      "builtinHint": "Навыки для офиса и анализа данных. Используйте готовый шаблон или установите в другую песочницу.",
