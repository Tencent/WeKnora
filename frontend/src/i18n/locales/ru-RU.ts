export default {
    ...
    globalSettings: {
      ...
      audit: {
        ...
        action: {
          ...
          'system.cross_tenant_access_granted': 'Предоставлен доступ ко всем пространствам',
          'system.cross_tenant_access_revoked': 'Отозван доступ ко всем пространствам',
      ...
      crossTenantAccess: {
        label: 'Аккаунты с доступом ко всем пространствам',
        description: 'Пользователи с доступом ко всем пространствам. Управлять списком могут только системные администраторы, у которых уже есть такой доступ. Текущий аккаунт скрыт, отозвать собственные права нельзя.',
        placeholder: 'Введите email пользователя и нажмите Enter',
        loadFailed: 'Не удалось загрузить аккаунты с доступом ко всем пространствам',
        saveSuccess: 'Аккаунты с доступом ко всем пространствам обновлены',
        saveFailed: 'Не удалось обновить аккаунты с доступом ко всем пространствам',
        confirm: {
          grant: {
            body: 'Предоставить {email} доступ ко всем пространствам?',
            confirmBtn: 'Предоставить'
          },
          revoke: {
            body: 'Отозвать у {email} доступ ко всем пространствам?',
            confirmBtn: 'Отозвать'
          }
        }
      },
  ...
  settings: {
    ...
    sandbox: {
      ...
      pageHint: 'Песочница навыков — изолированная среда, в которой выполняются скрипты навыков агента. В пространстве можно создать несколько конфигураций (Docker, E2B, CubeSandbox или локальный процесс); каждый агент выбирает одну. Пока конфигурация не выбрана, скрипты не выполняются.',
  ...
  agent: {
    ...
    editor: {
      ...
      skillsConfig: 'Skills',
      skillsConfigDesc: 'Выберите песочницу для скриптов навыков и настройте Skills, доступные агенту в этой песочнице. Список Skills зависит от выбранной песочницы.',
      skillsSelection: 'Выбор Skills',
      skillsSelectionDesc: 'Выберите диапазон Skills, доступных агенту. Список берётся из навыков, установленных в выбранной выше песочнице.',
      skillsAll: 'Все',
      skillsSelected: 'Выбранные',
      skillsNone: 'Отключено',
      selectSkills: 'Выбрать Skills',
      selectSkillsDesc: 'Выберите Skills для активации',
      noSkillsAvailable: 'В этой песочнице нет предустановленных Skills. Их можно установить в настройках песочницы навыков.',
      skillsNeedSandbox: 'Сначала выберите конфигурацию песочницы. Доступные Skills берутся из навыков, установленных в этой песочнице.',
      goSandboxSettings: 'Настроить в параметрах песочницы навыков',
      sandboxBackend: 'Конфигурация песочницы',
      sandboxBackendDefault: 'Не использовать песочницу',
      sandboxBackendHint: 'Скрипты навыков выполняются в выбранной песочнице. Без выбора они не запускаются; если конфигурация удалена, выполнение навыков завершится ошибкой.',
