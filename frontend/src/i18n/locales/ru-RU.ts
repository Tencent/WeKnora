...
/example\.(net|org)/`,
  ...
  knowledgeEditor: {
    ...
    wikiBrowser: {
      ...
      rebuildWiki: 'Пересобрать Wiki',
      rebuildWikiCooldown: 'Запущено, подождите…',
      rebuildWikiSuccess: 'Пересборка Wiki запущена для {count} документов',
      rebuildWikiFailed: 'Ошибка пересборки Wiki',
