export default {
  localBrowser: {
    ...
    "storeInstall": "Открыть магазин Chrome",
    "manualInstall": "Установить вручную (альтернатива)",
    "storeInstallHint": "Установите BrowserSkill из Интернет-магазина Chrome, затем вернитесь сюда для сопряжения.",
  ...
  datasource: {
    ...
    guideStep1_feishu_links: 'Откройте документ Feishu, «Поделиться» → «Добавить соавторов», найдите приложение и выдайте «Может просматривать»',
    guideStep2_feishu_links: 'Скопируйте ссылку на документ (wiki copylink или /docx/)',
    guideStep3_feishu_links: 'Вставьте ссылки и нажмите «Разобрать ссылки»',
    guideStep1_lark_links: 'Откройте документ Lark, «Поделиться» → «Добавить соавторов», найдите приложение и выдайте Can view',
    guideStep2_lark_links: 'Скопируйте ссылку на документ (wiki copylink или /docx/)',
    guideStep3_lark_links: 'Вставьте ссылки и нажмите «Разобрать ссылки»',
    ...
    prereqBarText_feishu_links: 'Используете впервые? Нажмите, чтобы открыть руководство по настройке приложения Feishu',
    prereqStep1Brief_feishu_links: 'Создать частное приложение Feishu',
    prereqStep1Desc_feishu_links: 'Войдите в Feishu Open Platform → Создать корпоративное частное приложение',
    prereqStep2Brief_feishu_links: 'Добавить возможность бота',
    prereqStep2Desc_feishu_links: 'Open Platform → Ваше приложение → Добавить возможность приложения → Bot',
    prereqStep3Brief_feishu_links: 'Настроить разрешения приложения',
    prereqStep3Desc_feishu_links: 'Включите разрешения: wiki:wiki:readonly, drive:drive.metadata:readonly (или drive:drive), drive:drive:readonly, drive:export:readonly, docx:document:readonly',
    prereqBarText_lark_links: 'Используете впервые? Нажмите, чтобы открыть руководство по настройке приложения Lark',
    prereqStep1Brief_lark_links: 'Создать частное приложение Lark',
    prereqStep1Desc_lark_links: 'Войдите в Lark Open Platform → Создать корпоративное частное приложение',
    prereqStep2Brief_lark_links: 'Добавить возможность бота',
    prereqStep2Desc_lark_links: 'Open Platform → Ваше приложение → Добавить возможность приложения → Bot',
    prereqStep3Brief_lark_links: 'Настроить разрешения приложения',
    prereqStep3Desc_lark_links: 'Включите разрешения: wiki:wiki:readonly, drive:drive.metadata:readonly (или drive:drive), drive:drive:readonly, drive:export:readonly, docx:document:readonly',
    ...
    connectorDesc: {
      ...
      feishu_links: 'Синхронизация отдельных документов Feishu Wiki или облачных документов по ссылкам',
      lark_links: 'Синхронизация отдельных документов Lark Wiki или облачных документов по ссылкам',
    ...
    connector: {
      ...
      feishu_links: 'Список ссылок Feishu',
      lark_links: 'Список ссылок Lark',
      notion: 'Notion',
    ...
    links: {
      ...
      hint: 'По одной ссылке Feishu на строку. Боту нужно право просмотра или редактирования этого документа. Синхронизируется только указанный документ, без дерева вики и папки Drive.',
      placeholder: 'https://xxx.feishu.cn/wiki/...\nhttps://xxx.feishu.cn/docx/...',
      parse: 'Разобрать ссылки',
      urlsRequired: 'Вставьте хотя бы одну ссылку на документ Feishu',
      noneResolved: 'Не удалось разобрать документы. Проверьте ссылки и права приложения на чтение',
      deduped: 'Удалено дублирующихся ссылок: {n}',
      resolvedCount: 'Разобрано документов: {n}',
      error: {
        wiki_space: 'Это ссылка на пространство вики. Используйте коннектор «Feishu» или вставьте ссылку на отдельный документ /wiki/',
        drive_folder: 'Это ссылка на папку Drive. Используйте коннектор «Feishu Drive»',
        unrecognized: 'Неизвестная ссылка. Вставьте ссылку Feishu /wiki, /docx, /docs, /sheets, /base или /file',
        unsupported_type: 'Этот тип документа не поддерживается (например mind notes или слайды)',
        no_permission: 'Приложение не может прочитать документ. Добавьте его соавтором (достаточно «Может просматривать»)',
        not_found: 'Документ не существует или удалён',
        resolve_failed: 'Не удалось разобрать ссылку. Проверьте URL и права приложения',
      },
    },
    syncError: {
  ...
  knowledgeBase: {
    ...
    channelFeishuLinks: 'Ссылки Feishu',
    channelLarkLinks: 'Ссылки Lark',
