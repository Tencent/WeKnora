...
/example\.(net|org)/`,
  ...
  agentStream: {
    ...
    askUser: {
      title: 'Агент ждёт вашего ответа',
      reason: 'Причина',
      placeholder: 'Введите ваш ответ...',
      send: 'Отправить',
      hint: 'Выберите вариант или введите свой ответ',
      hintNoOptions: 'Пожалуйста, введите ваш ответ ниже',
