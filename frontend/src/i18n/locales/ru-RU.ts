export default {
  ...
  settings: {
    ...
    sandbox: {
      ...
      templateLoadHint: 'Введите подключение к кластеру и обновите список. Отсутствующие официальные шаблоны CLI и рабочего стола собираются из образов Hub. После смены DNS или образа пересоберите шаблон на соответствующей карточке.',
      ...
      templateStepHint: 'На этом шаге перечисляются шаблоны кластера; официальные образы CLI и рабочего стола собираются из Hub, если их ещё нет. После смены DNS или образа пересоберите шаблон на соответствующей карточке. Продолжить можно, когда шаблон готов.',
