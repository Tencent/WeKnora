export default {
  ...
  agentStream: {
    ...
    skillCards: {
      ...
      resolved: 'Навык {name} найден',
      notFound: 'Подходящих навыков не найдено',
      unavailable: 'Недоступно: {sources}',
      temporaryNotice: 'Навык {name} только загружен для этого диалога и не установлен в рабочее пространство: его нет в списке навыков, и другие диалоги не могут его использовать.',
      temporaryNoticeUnnamed: 'Этот навык только загружен для этого диалога и не установлен в рабочее пространство: его нет в списке навыков, и другие диалоги не могут его использовать.',
      official: 'Официальный',
      downloads: 'Загрузок: {count}',
      installs: 'Установок: {count}',
      files: 'Файлов: {count}',
      registryLink: 'Ссылка',
      install: 'Установить в пространство',
      reinstall: 'Переустановить',
      retry: 'Повторить',
      copySource: 'Скопировать источник',
      sourceCopied: 'Источник навыка скопирован',
      viewSource: 'Подробнее',
      adminOnly: 'Установить может только администратор пространства. Скопируйте источник и отправьте ему',
      noSandbox: 'У этого диалога нет песочницы для установки навыков',
      alreadyInstalled: 'В этой песочнице уже установлен навык с таким именем; установка заменит его',
      alreadyInstalling: 'В этой песочнице сейчас устанавливается навык с таким именем',
      sameNameInCatalog: 'В пространстве уже есть навык с таким именем; установка заменит его этим источником',
      installing: 'Установка {percent}%',
      ready: 'Установлено. Доступно со следующего сообщения',
      readyNewSession: 'Установлено. Доступно в новых диалогах',
      selectInAgent: 'Этот агент использует только выбранные навыки: выберите его в настройках агента',
      failed: 'Не удалось установить',
      failedWithReason: 'Не удалось установить: {reason}',
      installerModelRequired: 'Сначала выберите модель для установки навыков',
      confirmTitle: 'Установить навык «{name}»?',
      confirmBody: 'Этот сторонний навык будет получен из {source} и установлен в песочницу, которую использует этот диалог. При установке выполняется код, поставляемый с навыком, после чего им смогут пользоваться все диалоги этой песочницы. Затем песочница этого диалога будет пересоздана, а временные файлы в /workspace будут потеряны. Продолжайте, только если доверяете этому источнику.',
      confirmBodyNewSession: 'Этот сторонний навык будет получен из {source} и установлен в песочницу, которую использует этот диалог. При установке выполняется код, поставляемый с навыком. По политике обновления этой песочницы им смогут пользоваться только диалоги, начатые после установки; уже идущие диалоги не изменятся. Продолжайте, только если доверяете этому источнику.'
    },
    skillFiles: {
