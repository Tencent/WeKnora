export default {
  ...
  knowledgeBase: {
    ...
    urlTip: 'Поддерживает импорт различного веб-содержимого. Система автоматически извлечет и проанализирует текстовое содержимое с веб-страницы. Ссылки на видео и плейлисты YouTube импортируются по субтитрам, а при их отсутствии — с помощью распознавания речи',
    youtubePlaylistImporting: 'Чтение плейлиста YouTube…',
    youtubePlaylistImportSuccess: 'Добавлено в очередь видео из «{title}»: {count}',
    youtubePlaylistImportDuplicates: 'Уже есть в базе знаний видео: {count}',
    youtubePlaylistImportFailures: 'Не удалось добавить видео: {count}',
    youtubePlaylistTruncated: 'Импортированы только первые {count} видео плейлиста',
    youtubePlaylistImportFailed: 'Не удалось импортировать плейлист YouTube',
    typeURL: 'URL',
    typeManual: 'Вручную',
    typeFile: 'Файл',
