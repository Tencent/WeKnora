export default {
  ...
  knowledgeBase: {
    ...
    batchDownloadHint: 'ZIP: до 200 документов и 512 МиБ исходных файлов за раз. Выбор всех включает только загруженные в список документы.',
    batchDownloadStarted: 'Началось сохранение ZIP. Распакуйте архив перед загрузкой файлов.',
