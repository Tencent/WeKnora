export default {
  ...
  knowledgeBase: {
    ...
    folderTree: {
      ...
      deleteConfirm: 'Удалить папку «{name}» и {count} документов в ней и вложенных папках? Это действие нельзя отменить.',
      deleteSubmitted: 'Удаление {count} документов поставлено в очередь',
