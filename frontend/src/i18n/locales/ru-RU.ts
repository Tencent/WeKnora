...
/example\.(net|org)/`,
  ...
  kbFeedback: {
    ...
    description: "Статистика лайков/дизлайков по фрагментам и изменения веса отзыва",
    entryTooltip: "Статистика отзывов",
    tabStats: "Фрагменты",
    tabWeightLogs: "Журнал весов",
    needsOptOnly: "Только требующие доработки",
    rateFilterAll: "Все оценки",
    rateFilterLow: "Низкий рейтинг (<50%)",
    rateFilterHigh: "Высокий рейтинг (>=80%)",
    resetAction: "Сбросить данные отзывов",
    resetConfirm: "Все счётчики лайков/дизлайков и веса фрагментов этой базы знаний будут обнулены; прошлые оценки перестанут учитываться. Сбросить?",
    resetSuccess: "Сброшены данные отзывов для {count} фрагментов",
    resetFailed: "Не удалось выполнить сброс, попробуйте позже",
    loadFailed: "Не удалось загрузить данные отзывов",
    needsOptTag: "Требует доработки",
    colChunk: "Фрагмент",
    colDocument: "Документ",
    colLikes: "Лайки",
    colDislikes: "Дизлайки",
    colRate: "Рейтинг",
    colWeight: "Вес",
    colNeedsOpt: "Статус",
    colReasons: "Причины дизлайков",
    colSessions: "Сессии",
    colChunkId: "ID фрагмента",
    colWeightChange: "Изменение веса",
    colTrigger: "Триггер",
    colTime: "Время",
    trigger: {
      feedback: "Отзыв пользователя",
      reset: "Сброс администратором",
      config: "Изменение настроек",
    },
  },
  retrievalSettings: {
    feedback: {
      enabledLabel: "Ранжирование по отзывам",
      enabledDescription: "Если включено, веса фрагментов, полученные из лайков/дизлайков ответов, влияют на порядок кандидатов поиска: фрагменты с высоким рейтингом ранжируются выше, с низким — реже попадают в выдачу.",
      boostThresholdLabel: "Порог рейтинга для повышения",
      boostThresholdDescription: "Фрагменты с рейтингом не ниже порога получают повышенный вес",
      penaltyThresholdLabel: "Порог рейтинга для понижения",
      penaltyThresholdDescription: "Фрагменты с рейтингом ниже порога получают пониженный вес",
      boostFactorLabel: "Коэффициент повышения",
      penaltyFactorLabel: "Коэффициент понижения",
      minSamplesLabel: "Минимум оценок",
      minSamplesDescription: "Корректировка веса применяется только после накопления указанного числа оценок",
      needsOptThresholdLabel: "Порог метки доработки",
      needsOptThresholdDescription: "Фрагменты с рейтингом ниже порога автоматически помечаются для ручной проверки",
    },
  ...
  chat: {
    feedback: {
      like: "Нравится",
      dislike: "Не нравится",
      dialogTitle: "Расскажите, что не так",
      submit: "Отправить",
      cancelBtn: "Отмена",
