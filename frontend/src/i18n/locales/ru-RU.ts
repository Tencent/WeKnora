export default {
  ...
  skillDiscovery: {
    ...
    replaceExistingHint: "В каталоге пространства уже есть навык «{name}» с другим содержимым. Продолжение заменит его определение встроенной версией {version} и установит её в выбранные песочницы. Установки в других песочницах не будут обновлены автоматически.",
    community: 'Дополнительные навыки сообщества',
    communityHint: 'Импортируйте закреплённую версию и выберите песочницу для установки. Эти пакеты не входят в базовый образ.',
    cardUnknownHint: "Для этого образа нет распознанного списка навыков. Проверьте образ или шаблон в настройках песочницы.",
  ...
  settings: {
    ...
    skills: {
      ...
      addStepRegisterDesc: "Добавьте навык по ссылке, из ZIP или по инструкциям.",
      addMethodSource: "Ссылка",
      addMethodFile: "Загрузить ZIP",
      addMethodPrompt: "Установка по запросу",
      promptInstructions: "Инструкции",
      promptInstallDesc: "Выберите песочницы для запуска. Следите за прогрессом, дополняйте инструкции или повторите попытку.",
      promptTitle: "Введите инструкции по установке",
      promptHint: "Укажите название навыка, документацию, команду или требования. После выбора песочниц агент прочитает документацию, подготовит инструменты, получит навык и проверит установку.",
      promptPlaceholder: "Например: установить навык по ID согласно документации, предварительно проверив наличие CLI.",
