export default {
  ...
  knowledgeBase: {
    folders: 'Папки',
    folderRoot: 'Все документы',
    folderCreate: 'Новая папка',
    folderCreateRoot: 'Создать корневую папку',
    folderCreateChild: 'Создать вложенную папку',
    folderRename: 'Переименовать',
    folderRelocate: 'Переместить папку',
    folderRelocateTitle: 'Выберите родительскую папку',
    folderMoved: 'Папка перемещена',
    folderMoveFolderFailed: 'Не удалось переместить папку',
    folderNamePlaceholder: 'Введите имя папки',
    folderAsk: 'Задать вопрос по папке',
    folderItemCount: '{count} элементов',
    folderReparseAll: 'Переразобрать всё',
    folderDeleteAll: 'Удалить всё',
    folderReparseTitle: 'Переразобрать папку',
    folderReparseConfirm: 'Переразобрать {count} элементов в папке «{name}» и всех вложенных папках?',
    folderReparseSubmitted: 'Отправлено на переразбор: {count}',
    folderReparseFailed: 'Не удалось запустить переразбор папки',
    folderDeleteRecursiveTitle: 'Удалить папку целиком',
    folderDeleteRecursiveConfirm: 'Удалить папку «{name}», все вложенные папки и {count} элементов? Это действие нельзя отменить.',
    folderDeleteRecursiveSubmitted: 'Отправлено на удаление: {count}',
    folderDeleteRecursiveFailed: 'Не удалось удалить папку',
    folderEmpty: 'Папок пока нет',
    folderSaved: 'Папка сохранена',
    folderSaveFailed: 'Не удалось сохранить папку',
    folderUploadDepthExceeded: 'Загружаемый каталог превышает ограничение вложенности в 10 уровней',
    folderLoadFailed: 'Не удалось загрузить папки',
    folderDeleteTitle: 'Удалить папку',
    folderDeleteConfirm: 'Удалить папку «{name}»? Папка должна быть пустой.',
    folderDeleted: 'Папка удалена',
    folderDeleteFailed: 'Не удалось удалить папку',
    folderMove: 'Переместить в папку',
    folderMoveTitle: 'Переместить выбранные документы',
    folderMoveSuccess: 'Документы перемещены',
    folderMoveFailed: 'Не удалось переместить документы',
    title: 'База знаний',
