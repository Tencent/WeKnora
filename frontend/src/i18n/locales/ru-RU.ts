export default {
  ...
  chat: {
    ...
    rewind: {
      ...
      confirmTitle: 'Откатить сессию',
      confirmBody: 'Все сообщения после этого будут удалены, а рабочая область откатится к этому моменту. Отменить действие нельзя.',
      ...
      skipSandboxReplaced: 'Диалог откачен, рабочая область не изменена (песочница заменена, старая контрольная точка недоступна)',
    },
