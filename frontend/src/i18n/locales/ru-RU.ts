export default {
  ...
  knowledgeBase: {
    ...
    batchMetadataDialogHeading: 'Пакетное редактирование метаданных',
    batchMetadataSubtitle: 'Заменить пользовательские метаданные у {count} выбранных документов',
    batchMetadataHint: 'Указанные поля заменят текущие пользовательские метаданные всех выбранных документов. Пустое сохранение очистит их.',
    batchMetadataEmpty: 'Полей метаданных нет. Добавьте поле или сохраните, чтобы очистить метаданные.',
    batchMetadataSuccess: 'Метаданные обновлены у документов: {count}',
    batchMetadataFailed: 'Ошибка пакетного обновления метаданных',
