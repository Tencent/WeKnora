export default {
  menu: {
    ...
    knowledgeProcessing: 'Панель обработки',
    chat: 'Диалог',
  ...
  processingDashboard: {
    title: 'Панель обработки знаний',
    subtitle: 'Отслеживайте активные и ожидающие задачи по этапам',
    primaryGroup: 'Основной процесс',
    enrichmentGroup: 'Обогащение контента',
    running: 'В работе',
    queued: 'В очереди',
    retrying: 'Повтор',
    viewQueue: 'Очередь',
    noRunning: 'Нет активных знаний',
    noActiveTasks: 'Нет активных или ожидающих задач',
    updatedAt: 'Создано',
    queueDataUnavailable: 'Данные очереди недоступны; прогресс берется из трассировки',
    queueDataPartial: 'Очередь большая; счетчики приблизительные',
    autoRefresh: 'Автообновление',
    manualRefresh: 'Обновить',
    filterKnowledgeBase: 'Фильтр базы знаний',
    searchPlaceholder: 'Поиск по названию или файлу',
    refresh: { off: 'Выкл.' },
    stage: {
      docreader: { title: 'Разбор документа', description: 'Чтение документа и извлечение текста' },
      chunking: { title: 'Разбиение', description: 'Разбиение текста на индексируемые части' },
      embedding: { title: 'Построение индекса', description: 'Запись векторного и ключевого индекса' },
      multimodal: { title: 'Мультимодальное распознавание', description: 'Распознавание текста и смысла изображений' },
      postprocess: { title: 'Оркестрация', description: 'Запуск задач summary, question, graph и Wiki' },
      summary: { title: 'Сводка', description: 'Генерация краткого описания' },
      question: { title: 'Вопросы', description: 'Генерация поисковых вопросов' },
      graph: { title: 'Граф', description: 'Извлечение сущностей и связей' },
      wiki: { title: 'Wiki', description: 'Синтез Wiki-страниц и структуры' },
    },
    state: {
    ...
    drawer: { title: 'Очередь этапа', empty: 'Нет элементов', loadMore: 'Загрузить ещё', failedChildren: 'ошибочных подзадач' },
    detail: { title: 'Детали обработки', pendingSubtasks: 'Ожидающие подзадачи', rawTrace: 'Исходная трассировка', empty: 'Выберите знание' },
  },
  newUserGuide: {
...
/example\.(net|org)/`,
  ...
  commandPalette: {
    ...
    quick: {
      ...
      knowledgeProcessing: 'Открыть панель обработки',
