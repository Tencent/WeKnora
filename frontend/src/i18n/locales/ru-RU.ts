export default {
  ...
  integrations: {
    ...
    mcpserver: {
      ...
      tools: {
        ...
        get_image: 'Прочитать изображение',
        get_imageDesc: 'Возвращает разрешённое изображение из базы знаний как стандартный MCP-контент',
        ask: 'Задать вопрос',
  ...
  tools: {
    ...
    getImage: 'Прочитать изображение',
