export default {
  ...
  settings: {
    ...
    skills: {
      ...
      upgradeDrawerDesc: 'Обновить «{name}» в выбранных песочницах до версии из каталога. Навык переустанавливается и недоступен в песочнице, пока переустановка не завершится.',
      ...
      upgradeRowHint: 'В этой песочнице версия отличается от каталога. Обновление переустанавливает навык; до его завершения навык здесь недоступен.',
      upgradeRowHintVersions: 'В этой песочнице {from}, в каталоге {to}. Обновление переустанавливает навык; до его завершения навык здесь недоступен.',
