export default {
  ...
  tenantMember: {
    ...
    audit: {
      ...
      description: 'Регистрирует изменения участников, настройки исходящих вебхуков и отказы в доступе в этом пространстве, в обратном хронологическом порядке. Повторные отказы в течение минуты дедуплицируются.',
      refresh: 'Обновить',
      end: 'Конец журнала.',
      ...
      action: {
        ...
        'webhook.endpoint_created': 'Создан исходящий вебхук',
        'webhook.endpoint_updated': 'Изменён исходящий вебхук',
        'webhook.endpoint_deleted': 'Удалён исходящий вебхук'
      },
      columns: {
        time: 'Время',
        actor: 'Инициатор',
    ...
    globalSettings: {
      ...
      keyDescriptions: {
        ...
        asynq: {
          ...
          webhook_concurrency: 'Параллелизм выделенного пула исходящих вебхуков на процесс, изолированного от разбора и Wiki. Минимум 1; требуется перезапуск сервиса.'
        },
        tenant: {
      ...
      keyLabels: {
        ...
        asynq: {
          ...
          webhook_concurrency: 'Параллелизм воркеров вебхуков'
        },
        tenant: {
      ...
      runtime: {
        ...
        tasks: {
          ...
          taskTypes: {
            ...
            webhookDeliver: 'Доставка исходящего вебхука',
            webhookOutboxSweep: 'Сканирование outbox вебхуков',
            webhookDeliveryPrune: 'Очистка журнала доставки вебхуков'
          }
        },
        failedNotice: {
        ...
        poolDescriptions: {
          ...
          webhook: 'Исходящая доставка событий знаний рабочего пространства'
        },
        queueNames: {
        ...
        queueDescriptions: {
          ...
          webhook: 'Исходящая доставка, сканирование outbox, очистка журнала'
        },
        errors: {
  ...
  settings: {
    ...
    eventWebhooks: {
      nav: 'Событийные webhook',
      title: 'Событийные webhook',
      subtitle: 'Отправляйте изменения своих баз знаний, документов и участников на HTTPS-адрес. Это не чат-webhook из встраивания.',
      loading: 'Загрузка...',
      retry: 'Повторить',
      loadFailed: 'Не удалось загрузить webhook',
      noTenant: 'Рабочее пространство не выбрано',
      howItWorks: 'Как это работает',
      hintDeleteKb: 'Удаление базы знаний даёт одно событие kb.deleted, а не knowledge.deleted на каждый документ.',
      hintBatch: 'Пакетное удаление больше 100 документов делится на несколько batch_deleted; идентификаторы не опускаются.',
      hintNoRollback: 'Сбой доставки не откатывает загрузку или удаление.',
      docHint: 'См. документацию: событийные webhook пространства.',
      listLabel: 'URL обратного вызова',
      listDesc: 'До 5 адресов на пространство. В продакшене нужен https.',
      add: 'Добавить webhook',
      empty: 'Webhook ещё нет',
      colName: 'Имя',
      colUrl: 'URL',
      colEvents: 'События',
      colEnabled: 'Вкл.',
      ...
      formHint: 'Секрет используется для HMAC timestamp + "." + raw body и больше не показывается.',
      createHint: 'Укажите URL и секрет. В продакшене нужен HTTPS; для loopback (127.0.0.1 / localhost) допустим HTTP.',
      editHint: 'Секрет сохранён и больше не показывается. Введите новое значение только при смене.',
      fieldName: 'Имя',
      fieldNamePh: 'Синхронизация',
      fieldUrl: 'URL',
      fieldUrlPh: 'https://example.com/hooks/weknora',
      fieldUrlHint: 'Адреса не с loopback должны использовать https.',
      fieldSecret: 'Секрет',
      fieldSecretPh: 'Не менее 16 символов',
      fieldSecretEditPh: 'Оставьте пустым, чтобы не менять',
      fieldSecretHint: 'Для HMAC (timestamp + "." + raw body). После сохранения больше не показывается.',
      fieldSecretEditHint: 'Секрет уже задан. Пустое поле сохраняет его; новое значение — не короче 16 символов.',
      secretConfigured: 'Задан',
      fieldEvents: 'События',
      fieldEventsHint: 'Доставляются только отмеченные типы. Удаление базы знаний даёт kb.deleted, а не knowledge.deleted на каждый документ. События участников — пользователи этого рабочего пространства, а не общего пространства / организации.',
      selectGroup: 'Выбрать все',
      clearGroup: 'Снять',
      eventGroupKnowledge: 'Знания',
      eventGroupKb: 'Базы знаний',
      eventGroupMembers: 'Участники пространства',
      eventGroupMembersHint: 'Пользователи в «Настройки → Пространство → Участники». Добавление пространства в общее пространство / организацию эти события не шлёт.',
      eventGroupOther: 'Другое',
      eventKnowledgeCreated: 'Знание создано',
      eventKnowledgeParsed: 'Разбор завершён',
      eventKnowledgeParseFailed: 'Разбор не удался',
      eventKnowledgeDeleted: 'Знание удалено',
      eventKnowledgeBatchDeleted: 'Пакетное удаление знаний',
      eventKbCreated: 'База знаний создана',
      eventKbDeleted: 'База знаний удалена',
      eventMemberAdded: 'Участник пространства добавлен',
      eventMemberRemoved: 'Участник пространства удалён',
      fieldDesc: 'Заметка',
      fieldDescPh: 'Необязательно',
      fieldEnabled: 'Включено',
      fieldEnabledHint: 'Выключение останавливает доставку, не удаляя настройки.',
      eventsRequired: 'Выберите хотя бы один тип события',
      urlRequired: 'Укажите URL обратного вызова',
      urlInvalid: 'Укажите корректный http(s) URL',
      urlHttpsRequired: 'Адреса не с loopback должны использовать https',
      secretTooShort: 'Секрет должен быть не короче 16 символов',
      saveSuccess: 'Сохранено',
      saveFailed: 'Не удалось сохранить',
      deleteTitle: 'Удалить этот webhook?',
      deleteBody: 'Удалить {name}? Незавершённые доставки остановятся.',
      deleteSuccess: 'Удалено',
      deliveryTitle: 'Недавние доставки',
      sendTest: 'Отправить тест',
      testQueued: 'Тест поставлен в очередь',
      testDelivered: 'Тест доставлен',
      testFailed: 'Тест не удался',
      noDeliveries: 'Доставок пока нет',
      statusPending: 'В очереди',
      statusFailed: 'Ошибка',
      exampleLabel: 'Проверка подписи',
      exampleDesc: 'HMAC — timestamp + "." + raw body. Файлы скачиваются 5-минутным билетом.',
      exampleTab: {
        java: 'Java',
        python: 'Python',
        go: 'Go',
      ...
      payloadLabel: 'Примеры payload',
      payloadDesc: 'Структура реального body по типу события (примеры обезличены).',
      payloadHintCreated: 'Сразу после создания; обычно ещё не в поиске — скачайте файл по билету.',
      payloadHintParsed: 'Парсинг завершён, документ доступен для поиска. Может прийти раньше created.',
      payloadHintParseFailed: 'Парсинг не удался; см. data.error_message.',
      payloadHintDeleted: 'Удалена одна единица знания.',
      payloadHintBatchDeleted: 'Пакетное удаление в одной БЗ; чанки по 100 с общим delete_batch_id.',
      payloadHintKbCreated: 'База знаний создана.',
      payloadHintKbDeleted: 'БЗ удалена целиком; cascade_knowledge=true — не ждите knowledge.deleted по документам.',
      payloadHintMemberAdded: 'Участник добавлен в это пространство.',
      payloadHintMemberRemoved: 'Участник удалён или покинул пространство.',
      payloadHintTest: 'Кнопка «Отправить тест» в настройках; data можно игнорировать.',
      copy: 'Копировать',
      copied: 'Скопировано',
