export default {
  ...
  integrations: {
    ...
    api: {
      ...
      apiKeyKnowledgePermissionsHint: 'По умолчанию следуют отмеченным выше правам чтения / правки / управления. Можно снять флажок у отдельной базы; снятие «Чтение» удаляет базу из списка.',
      kbPermissionRead: 'Чтение',
      kbPermissionEdit: 'Правка',
      kbPermissionManage: 'Управление',
      apiKeyKnowledgeScopeSummary: '{total} (правка {editable} / управление {manageable})',
