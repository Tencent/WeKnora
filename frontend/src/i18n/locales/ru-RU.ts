export default {
  ...
  chat: {
    feedback: {
      ...
      rateUnhelpful: 'Неполезный ответ',
      rated: 'Оценено',
      dislikeTitle: 'Причина негативной оценки',
      submit: 'Отправить',
      otherReason: 'Другое',
      reasonPlaceholder: 'Кратко опишите проблему (необязательно)',
      reasonInaccurate: 'Неточный контент',
      reasonOutdated: 'Устаревший контент',
      reasonIrrelevant: 'Ответ не по теме',
      reasonIncomplete: 'Неполный ответ',
      reasonNoReference: 'Нет ссылок на источники',
      reasonRequired: 'Выберите или укажите причину',
      cancelled: 'Оценка отменена',
      likeSuccess: 'Спасибо за вашу оценку',
      dislikeSuccess: 'Спасибо за вашу оценку, мы продолжим улучшать',
      submitFailed: 'Не удалось отправить оценку, попробуйте позже'
    },
  ...
  knowledgeEditor: {
    ...
    feedback: {
      title: 'Статистика фрагментов',
      description: 'Просмотр оценок и отзывов по фрагментам знаний в вопросах-ответах, фильтрация низкокачественных фрагментов и управление автоматической корректировкой веса поиска.',
      retry: 'Повторить',
      loadFailed: 'Не удалось загрузить данные отзывов',
      keywordPlaceholder: 'Поиск по фрагментам',
      approvalPlaceholder: 'Доля положительных оценок',
      approvalAll: 'Все фрагменты',
      approvalHigh: 'Доля ≥ 80%',
      approvalNormal: 'Доля 50% - 80%',
      approvalLow: 'Доля < 50%',
      approvalNeedsOptimization: 'Только требующие оптимизации',
      apply: 'Фильтр',
      resetSelected: 'Сбросить выбранные',
      reset: 'Сбросить',
      detail: 'Подробнее',
      totalCount: 'Всего фрагментов: {count}',
      empty: 'Данных об оценках фрагментов пока нет',
      statusNeedsOptimization: 'Требует оптимизации',
      statusNormal: 'Норма',
      sortApprovalRate: 'По доле положительных',
      sortLikeCount: 'По лайкам',
      sortDislikeCount: 'По дизлайкам',
      sortRecallWeight: 'По весу поиска',
      sortSessionCount: 'По сеансам',
      sortFeedbackCount: 'По числу оценок',
      columns: {
        content: 'Фрагмент',
        likeCount: 'Лайки',
        dislikeCount: 'Дизлайки',
        approvalRate: 'Доля полож.',
        recallWeight: 'Вес',
        sessionCount: 'Сеансы',
        feedbackCount: 'Оценок',
        status: 'Статус',
        actions: 'Действия'
      },
      drawer: {
        title: 'Детали оценок фрагмента',
        summary: 'Обзор',
        dislikeReasons: 'Причины дизлайков',
        relatedSessions: 'Связанные сеансы',
        noReasons: 'Причин дизлайков пока нет',
        noSessions: 'Связанных сеансов нет',
        sessionMessages: '{count} сообщений'
      },
      resetConfirmTitle: 'Сброс оценок фрагмента',
      resetConfirmBody: 'Сбросить выбранные {count} фрагментов? Данные оценок будут очищены, вес поиска возвращён к 1.0. Действие необратимо.',
      resetConfirm: 'Сбросить',
      resetSuccess: 'Оценки фрагмента сброшены',
      resetFailed: 'Не удалось сбросить',
      config: {
        title: 'Автоматическая корректировка веса',
        description: 'Автоматически корректирует вес поиска по доле положительных оценок; очень низкая доля помечает фрагмент как требующий оптимизации.',
        tenantHint: 'Настройка применяется ко всем базам знаний текущего пространства.',
        save: 'Сохранить',
        saved: 'Настройка сохранена',
        saveFailed: 'Не удалось сохранить',
        loadFailed: 'Не удалось загрузить настройку',
        boostThreshold: 'Порог повышения',
        boostThresholdTip: 'Повышать вес, когда доля ≥ этого значения',
        degradeThreshold: 'Порог понижения',
        degradeThresholdTip: 'Снижать вес, когда доля < этого значения',
        optimizeThreshold: 'Порог оптимизации',
        optimizeThresholdTip: 'Помечать для оптимизации, когда доля < этого значения',
        minVotes: 'Мин. оценок',
        minVotesTip: 'Корректировка после достижения этого числа оценок',
        weightStep: 'Шаг веса',
        weightStepTip: 'Величина изменения за одно событие',
        maxWeight: 'Макс. вес',
        maxWeightTip: 'Верхняя граница веса',
        minWeight: 'Мин. вес',
        minWeightTip: 'Нижняя граница веса'
      },
      logs: {
        title: 'Журнал изменения веса',
        description: 'История корректировок веса поиска и их причины.',
        loadFailed: 'Не удалось загрузить журнал',
        empty: 'Записей об изменении веса пока нет',
        sourceAll: 'Все источники',
        sourceFeedback: 'Оценки пользователей',
        sourceManualReset: 'Ручной сброс',
        sourceManualAdjust: 'Ручная корректировка',
        columns: {
          time: 'Время',
          chunk: 'Фрагмент',
          oldWeight: 'Старый вес',
          newWeight: 'Новый вес',
          source: 'Источник',
          operator: 'Оператор',
          reason: 'Причина'
    ...
    sidebar: {
      feedback: 'Статистика фрагментов',
