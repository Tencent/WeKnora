export default {
  ...
  knowledgeEditor: {
    ...
    wikiBrowser: {
      ...
      learningFamiliar: 'Освоено',
      learningExploring: 'Изучается',
      learningUnseen: 'Пробел в знаниях',
      learningTitle: 'Обучение на основе наблюдаемых данных',
      learningSummary: 'Знакомо: {familiar} · изучается: {exploring} · пробелы: {unseen}',
      learningEvidenceNote: 'Цитирование документа отмечает только его узел-сводку; максимум 80, без оценки LLM.',
      learningNext: 'Что читать дальше',
      learningReason: 'Связано со знакомыми узлами: {count}',
      learningNodeScore: 'Показатель данных: {score} (макс. 80)',
      learningNodeEvidence: 'Наблюдалось обращений: {count}, источников: {sources}.',
