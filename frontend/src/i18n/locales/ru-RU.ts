export default {
  ...
  knowledgeBase: {
    ...
    sort: {
      title: 'Сортировка',
      updatedTime: 'Время обновления',
      updatedTimeDescription: 'По умолчанию. Недавно обработанные, изменённые или сменившие статус файлы показываются первыми.',
      createdTime: 'Время загрузки/создания',
      createdTimeDescription: 'Просматривайте самые новые или самые ранние материалы.',
      fileName: 'Имя файла',
