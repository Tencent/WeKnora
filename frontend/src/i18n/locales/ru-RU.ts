  ...
  knowledgeEditor: {
    ...
    advanced: {
      ...
      multimodal: {
        ...
        imagePipelineSectionLabel: 'Пайплайн обработки изображений',
        imagePipelineSectionDescription:
          'Пока включён мультимодальный режим, каждое изображение обрабатывается выбранным здесь пайплайном. Список пайплайнов и их настраиваемых параметров приходит из реестра бэкенда, поэтому панель только выбирает.',
        imagePipelineLabel: 'Пайплайн',
        imagePipelineDescription:
          'Пайплайны отличаются тем, как они работают с изображением. При переключении пайплайна параметры предыдущего очищаются.',
        imagePipelinePlaceholder: 'Выберите пайплайн',
  ...
  imagePipeline: {
    caption_ocr: {
      ...
      enable_ocr: {
        ...
        description: 'Извлекает текст с каждого изображения независимо от того, есть ли на нём текст.'
      }
    },
    ob_cap_ocr: {
      name: 'Наблюдение атрибутов'
    }
  }
}
