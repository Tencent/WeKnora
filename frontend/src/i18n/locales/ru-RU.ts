export default {
  ...
  organization: {
    ...
    settings: {
      ...
      permissionCalcFormula: 'Права пространства назначаются при предоставлении доступа; мои фактические права = min(права пространства, моя роль в пространстве); базы знаний, добавленные общим агентом, необходимо удалять в настройках агента.',
      ...
      directKbSource: 'Предоставлено напрямую',
      agentKbSource: 'Добавлено агентом {name}',
      directAndAgentKbSource: 'Предоставлено напрямую и добавлено агентом {name}',
