export default {
  ...
  preview: {
    ...
    generating: 'Создаётся предпросмотр документа. Подождите...',
    loadFailed: 'Не удалось загрузить предпросмотр документа',
    generationFailed: 'Не удалось создать предпросмотр документа',
    generationTimedOut: 'Предпросмотр документа ещё создаётся. Повторите попытку позже',
    retry: 'Повторить',
