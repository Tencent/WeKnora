export default {
  ...
  agentEditor: {
    ...
    tools: {
      ...
      wikiSourcePreviewLabel: 'Предпросмотр исходного документа',
      wikiSourcePreviewDesc: 'Показывать доступные исходные документы для предпросмотра в результатах чтения Wiki',
  ...
  chat: {
    ...
    originalDocuments: 'Исходные документы',
    ...
    navigateToDocument: 'Предпросмотр документа',
