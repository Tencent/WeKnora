export default {
  ...
  knowledgeBase: {
    ...
    crawlEnabledLabel: 'Авто-краулер подстраниц',
    crawlDepthLabel: 'Глубина краулинга',
    crawlDepth1: 'Уровень 1 (только текущая страница)',
    crawlDepth2: 'Уровень 2 (ссылки первого уровня)',
    crawlDepth3: 'Уровень 3 (ссылки второго уровня)',
    crawlTip: 'Краулинг подстраниц автоматически извлекает ссылки со страницы и загружает содержимое всех страниц до указанной глубины',
    crawlingPages: 'Краулинг подстраниц выполняется...',
    crawlFailed: 'Краулинг не удался, выполняется откат к импорту только текущей страницы',
    crawlCompleted: 'Краулинг завершён, найдено {count} страниц',
    typeURL: 'URL',
    typeManual: 'Вручную',
    typeFile: 'Файл',
