export default {
  ...
  uploadConfirm: {
    ...
    asrYouTubeHint: 'Видео YouTube без субтитров расшифровываются с помощью распознавания речи. Включите его и выберите модель, иначе такие видео не будут импортированы.',
  ...
  knowledgeBase: {
    ...
    invalidURLsSkipped: 'Пропущено недействительных ссылок: {count}',
    urlImportSuccess: 'URL успешно импортирован!',
    urlImportFailed: 'Ошибка импорта URL!',
    urlExists: 'Этот URL уже существует',
    urlLabel: 'Адрес URL',
    urlPlaceholder: 'Одна или несколько ссылок на веб-страницы, по одной в строке, например:\nhttps://example.com/article',
    urlTip: 'Вставьте одну или несколько ссылок на веб-страницы, по одной в строке. Система извлечет и проанализирует текст каждой страницы. Для видео и плейлистов YouTube используйте «Импорт из YouTube»',
    youtubeImporting: 'Импорт ссылок YouTube: {count}…',
    youtubeImportSuccess: 'Добавлено в очередь видео YouTube: {count}',
    youtubeImportDuplicates: 'Уже есть в базе знаний видео: {count}',
    youtubeImportFailures: 'Не удалось импортировать ссылок или видео: {count}',
    youtubeImportTruncated: 'Достигнут лимит видео на один импорт; импортированы только первые видео',
    youtubeImportFailed: 'Не удалось импортировать YouTube',
    importYouTube: 'Импорт из YouTube',
    importYouTubeTitle: 'Импорт из YouTube',
    youtubeUrlLabel: 'Ссылки YouTube',
    youtubeUrlPlaceholder: 'По одной ссылке YouTube в строке, например:\nhttps://www.youtube.com/watch?v=VIDEO_ID\nhttps://www.youtube.com/playlist?list=PLAYLIST_ID',
    youtubeUrlTip: 'Поддерживаются только ссылки на видео и плейлисты YouTube. Вставляйте по одной ссылке в строке; каждое видео станет отдельным документом, а каждый плейлист будет импортирован в папку с его названием. Ссылка на видео с &list= импортирует только это видео — для всего плейлиста используйте ссылку на плейлист. Используются субтитры, а при их отсутствии аудио расшифровывается моделью распознавания речи базы знаний',
    noYouTubeURLs: 'Введите хотя бы одну ссылку на видео или плейлист YouTube',
    nonYouTubeURLsSkipped: 'Пропущено строк, не являющихся ссылками YouTube: {count}',
    typeURL: 'URL',
    typeManual: 'Вручную',
    typeFile: 'Файл',
