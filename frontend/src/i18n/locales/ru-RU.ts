...
/example\.(net|org)/`,
  ...
  datasource: {
    ...
    feishu: {
      authModeApp: 'Идентификация приложения',
      authModeUser: 'Личная идентификация',
      authModeAppHint: 'Чтение от имени самостоятельно созданного приложения — доступны только вики и документы, явно предоставленные приложению.',
      authModeUserHint: 'Чтение от вашего имени в Feishu — можно экспортировать все документы, к которым у вас есть доступ (завершите авторизацию ниже).',
      authorize: 'Авторизоваться в Feishu',
      reauthorize: 'Повторная авторизация',
      authorized: 'Личная авторизация Feishu завершена',
      authorizeHint: 'Откроется страница согласия Feishu; войдите под своей учётной записью и подтвердите. Сначала заполните App ID и App Secret выше.',
      authSuccess: 'Авторизация Feishu прошла успешно',
      authFailed: 'Не удалось авторизоваться в Feishu, повторите попытку',
      authRequired: 'Сначала завершите личную авторизацию Feishu',
      appCredsRequired: 'Сначала заполните App ID и App Secret',
      popupBlocked: 'Всплывающее окно заблокировано браузером — разрешите всплывающие окна и повторите',
    },
    comingSoon: 'Скоро',
    ...
    prereqOAuthCallbackBrief_feishu: 'Настройте URL обратного вызова для личной авторизации',
    prereqOAuthCallbackDesc_feishu: 'В Feishu Open Platform > Security Settings > Redirect URL добавьте этот точный адрес:',
