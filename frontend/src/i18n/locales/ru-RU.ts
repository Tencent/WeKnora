    ...
    chunking: {
      ...
      strategies: {
        auto: {
          ...
          tooltip: 'Профилировщик документа анализирует структуру и выбирает заголовочное, эвристическое или классическое разбиение для каждой загрузки.'
        },
        heading: {
          label: 'Оптимизировано для Markdown',
          tooltip: 'Разбивает преимущественно по заголовкам Markdown (#, ##, ###). Подходит для чистого Markdown с явной структурой разделов.'
        },
        heuristic: {
          label: 'Умное определение структуры',
          tooltip: 'Определяет разрывы страниц, нумерованные разделы, многоязычные маркеры глав (DE/EN/ZH), заголовки в верхнем регистре. Идеально для PDF без Markdown.'
        },
        legacy: {
          label: 'Классический',
          tooltip: 'Классическое рекурсивное разбиение только по разделителям — оригинальное поведение. Используйте, если новые стратегии работают некорректно.'
        }
      },
      ...
      debug: {
        toggle: 'Проверить на примере текста',
