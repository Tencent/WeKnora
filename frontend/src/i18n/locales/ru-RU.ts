export default {
  ...
  knowledgeFolder: {
    ...
    noFolders: 'Нет вложенных папок',
    create: 'Новая папка',
    createInCurrent: 'Создать в текущей папке',
    rename: 'Переименовать папку',
    delete: 'Удалить папку',
    namePlaceholder: 'Введите имя папки',
    nameRequired: 'Введите имя папки',
    invalidName: 'Недопустимое имя папки',
    nameConflict: 'Папка с таким именем уже существует',
    notEmpty: 'Папка не пуста. Сначала удалите из неё документы и подпапки.',
    operationFailed: 'Не удалось выполнить операцию с папкой. Повторите позже.',
    createSuccess: 'Папка создана',
    renameSuccess: 'Папка переименована',
    deleteSuccess: 'Папка удалена',
    deleteConfirm: 'Удалить папку «{name}»?',
    deleteEmptyOnly: 'Можно удалить только пустую папку. Документы и подпапки не будут удалены или перемещены.',
    createTarget: 'Целевая папка: {name}',
    emptyKnowledge: 'В папке «{name}» нет документов',
    invalidLocation: 'Неверный адрес папки. Выполнен переход в корень.',
    locationUnavailable: 'Папка не существует или недоступна. Выполнен переход в безопасную папку.',
    resizeSidebar: 'Изменить ширину боковой панели папок',
    resizeSidebarHint: 'Перетащите для изменения ширины; двойной щелчок восстановит ширину по умолчанию',
  },
  knowledgeFolderMove: {
    folderTitle: 'Переместить папку',
    knowledgeTitle: 'Переместить документ в папку',
    batchTitle: 'Переместить документы в папку',
    moveFolder: 'Переместить папку',
    moveKnowledge: 'Переместить в папку',
    moveSelected: 'Переместить в папку',
    selectTarget: 'Выберите целевую папку. Корень также доступен.',
    current: 'Текущее расположение',
    invalidTarget: 'Недопустимая целевая папка',
    cycleConflict: 'Нельзя переместить папку в неё саму или в её подпапку',
    nameConflict: 'В целевой папке уже есть папка с таким именем',
    moveConflict: 'Состояние папок изменилось, перемещение невозможно',
    resourceChanged: 'Документ или папка больше не существует. Данные папок обновлены.',
    folderMoved: 'Папка перемещена',
    knowledgeMoved: 'Документ перемещён',
    batchMoved: 'Перемещено документов: {count}',
    batchMoveFailed: 'Не удалось выполнить пакетное перемещение. Повторите позже.',
    selectionChanged: 'Выбранные документы изменились. Обновите список и выберите их снова.',
    searchResultPath: 'Путь к документу: {path}',
    moveFailed: 'Не удалось переместить. Повторите позже.',
  },
  knowledgeFolderDrag: {
    dragHandle: 'Перетащите «{name}», чтобы переместить',
    dropHere: 'Переместить в эту папку',
    cannotDrop: 'Нельзя переместить в эту папку',
    moving: 'Перемещение',
  },
  knowledgeBase: {
    title: 'База знаний',
...
/example\.(net|org)/`,
  ...
  input: {
    ...
    folderScope: {
      ...
      entireKnowledgeBaseHint: 'Включает прямые файлы и все дочерние папки',
      selectFolderForKb: 'Выберите несколько папок для {name}',
      selectedFolderSingle: 'Выбрана 1 папка',
      selectedFolderCount: 'Выбрано папок: {count}',
      removeCurrentFolder: 'Удалить эту папку',
      loading: 'Загрузка области папки',
      loadingShort: 'Загрузка',
      loadFailed: 'Не удалось загрузить область папки',
      loadFailedShort: 'Ошибка загрузки',
      partialInvalid: 'Некоторые области папок недействительны. Удалите или выберите их заново.',
      partialInvalidShort: 'Некоторые папки недействительны',
      noFolders: 'Нет доступных папок',
      searchPlaceholder: 'Поиск папок',
      toggleFolder: 'Развернуть или свернуть папку',
      sendBlockedInvalid: 'Область папки недействительна для: {names}',
    },
    knowledgeBase: 'База знаний',
