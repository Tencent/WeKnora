export default {
  ...
  knowledgeBase: {
    fileVersions: {
      ...
      title: "Версии файла",
      uploadHint: "Документ будет обработан заново. Предыдущие файлы и существующие ссылки сохранятся.",
      processing: "Дождитесь завершения обработки документа перед загрузкой новой версии.",
      selectFile: "Выбрать файл",
      upload: "Загрузить новую версию",
      current: "Текущая версия",
      empty: "История версий пуста",
      loadFailed: "Не удалось загрузить историю версий.",
      uploadFailed: "Не удалось загрузить новую версию.",
      uploaded: "Новая версия загружена. Началась обработка документа.",
      conflict: "Документ изменён, обрабатывается или такой файл уже существует. История обновлена; проверьте её перед повторной попыткой.",
      invalidSize: "Выберите непустой файл размером до {size} МБ.",
    },
