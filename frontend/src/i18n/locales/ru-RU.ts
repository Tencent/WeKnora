export default {
  ...
  knowledgeFolder: {
    ...
    allFiles: 'Все файлы',
    root: 'Корневая папка',
    actions: 'Действия с папкой',
    createTopLevel: 'Создать папку верхнего уровня',
    createChild: 'Создать вложенную папку',
    rename: 'Переименовать',
    delete: 'Удалить',
    startKnowledgeBaseChat: 'Начать чат по этой базе знаний',
    startFolderChat: 'Начать чат по этой папке',
    folderNamePlaceholder: 'Введите название папки',
    deleteConfirm: 'Удалить папку «{name}»?',
    notEmpty: 'В этой папке ещё есть файлы или вложенные папки. Очистите её перед удалением.',
    ...
    loading: 'Загрузка…',
    empty: 'Нет вложенных папок',
    loadFailed: 'Не удалось загрузить папки',
    retry: 'Повторить',
    resizeLabel: 'Изменить ширину боковой панели папок',
    breadcrumbLabel: 'Путь к папке',
    ensurePathsFailed: 'Не удалось создать пути папок',
    expandFolder: 'Развернуть {name}',
    collapseFolder: 'Свернуть {name}',
  },
  knowledgeScope: {
    selectedCount: 'Выбрано: {count}',
    fileOwnershipUnavailable: 'Не удалось определить базу знаний для выбранных файлов. Выберите файлы заново и повторите попытку.',
  },
  knowledgeBase: {
    title: 'База знаний',
