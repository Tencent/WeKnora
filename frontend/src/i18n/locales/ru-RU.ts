...
/example\.(net|org)/`,
  ...
  knowledgeEditor: {
    ...
    wikiBrowser: {
      ...
      statistics: {
        ...
        averageLikeRate: 'Ср. оценка',
        pendingOptimization: 'Требует оптимизации',
        searchPlaceholder: 'Поиск по содержимому...',
        filterByPending: 'Фильтр по статусу',
        pendingOnly: 'Только требующие оптимизации',
        sortBy: 'Сортировка',
        sortByLikeRate: 'По оценке',
        sortByLikeCount: 'По лайкам',
        sortByDislikeCount: 'По дизлайкам',
        sortByWeight: 'По весу',
        batchAdjust: 'Массовая корректировка весов',
        likes: 'Лайки',
        dislikes: 'Дизлайки',
        likeRate: 'Оценка',
        weight: 'Вес',
        ...
        reset: 'Сброс',
        chunkDetail: 'Детали чанка',
        chunkId: 'ID чанка',
        likeCount: 'Лайки',
        dislikeCount: 'Дизлайки',
        recallWeight: 'Вес поиска',
        normal: 'Нормальный',
        pendingOptimizationTag: 'Требует оптимизации',
        dislikeReasons: 'Причины дизлайков',
        weightLogs: 'Журнал изменения весов',
        triggerType: 'Тип триггера',
        triggerReason: 'Причина',
        oldWeight: 'Старый вес',
        newWeight: 'Новый вес',
        createdAt: 'Время',
        noDislikeReasons: 'Нет записей о причинах',
        reasonInaccurate: 'Неточно',
        reasonIncomplete: 'Неполно',
        reasonIrrelevant: 'Не релевантно',
        reasonOther: 'Другое',
        triggerUserFeedback: 'Отзыв пользователя',
        triggerAutoAdjust: 'Автокорректировка',
        triggerManualReset: 'Ручной сброс',
        triggerBatchUpdate: 'Массовое обновление',
        loadFailed: 'Ошибка загрузки статистики',
        resetSuccess: 'Чанк сброшен',
        resetFailed: 'Ошибка сброса чанка',
        adjustSuccess: 'Веса скорректированы',
        adjustFailed: 'Ошибка корректировки весов',
      },
  ...
  chat: {
    ...
    feedback: {
      like: 'Полезно',
      cancelLike: 'Отменить лайк',
      dislike: 'Не полезно',
      cancelDislike: 'Отменить дизлайк',
