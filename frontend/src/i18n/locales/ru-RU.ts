export default {
  ...
  integrations: {
    ...
    api: {
      ...
      kbPermissionPerKB: "По базе знаний",
      kbPermissionUniform: "Общие права",
      kbPermissionHint: "Права ограничены возможностями ключа и текущим доступом рабочего пространства. Управление общей базой не даёт права владения или изменения общего доступа.",
      kbPermissionSelect: "Выберите свои или общие базы знаний",
      kbPermissionEmpty: "Нет доступа к базам знаний",
      kbPermissionRead: "Чтение / поиск",
      kbPermissionWrite: "Чтение и запись содержимого",
      kbPermissionManage: "Управление базой знаний",
      kbPermissionOwn: "Текущее рабочее пространство",
      kbPermissionUnavailable: "База недоступна или доступ отозван. Удалите запись перед сохранением.",
      kbPermissionUniformHint: "Одинаковые возможности для всех выбранных собственных баз. Пустой выбор сохраняет прежнюю неограниченную область доступа. Для общих баз задайте отдельные права.",
      kbPermissionLoadFailed: "Не удалось загрузить часть баз. Повторите попытку перед изменением прав.",
