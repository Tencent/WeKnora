...
/example\.(net|org)/`,
  ...
  feedback: {
    like: 'Нравится',
    dislike: 'Не нравится',
    dislikeHeader: 'Подскажите, что можно улучшить',
    dislikeHint: 'Выберите причину, по которой ответ не подошел. Можно добавить комментарий:',
    commentPlaceholder: 'Добавьте пояснение (необязательно)',
    commentRequiredWhenOther: 'Укажите подробности при выборе "Другое"',
    saveSuccess: 'Отзыв сохранён',
    cancelSuccess: 'Отзыв отменён',
    saveError: 'Не удалось сохранить отзыв, попробуйте ещё раз',
    reasons: {
      inaccurate: 'Неточно',
    ...
    kbStats: {
      ...
      lowQualityOnly: 'Только низкокачественные фрагменты',
      reset: 'Сбросить отзывы',
      resetConfirm: 'Сбросить все отзывы этой базы знаний? Старые оценки больше не будут учитываться в статистике, но сохранятся.',
      resetSuccess: 'Отзывы сброшены',
      sortPositiveRateAsc: 'Положительных (по возрастанию)',
      sortPositiveRateDesc: 'Положительных (по убыванию)',
      sortFeedbackCountDesc: 'Количество отзывов (по убыванию)',
      sortLastFeedbackDesc: 'Последний отзыв (новые сначала)',
      columnChunk: 'Фрагмент',
      columnLikeCount: 'Лайки',
      columnDislikeCount: 'Дизлайки',
      columnSessionCount: 'Сессий',
      columnPositiveRate: 'Положительных',
      columnLastFeedback: 'Последний отзыв',
      columnDislikeReasons: 'Причины дизлайка',
      weightLogTitle: 'Журнал изменения весов',
      needsOptimization: 'Нужна оптимизация',
      lowQuality: 'Низкое качество',
    },
    retrieval: {
      sectionTitle: 'Ранжирование по отзывам',
      enable: 'Включить ранжирование по отзывам',
      description: 'Автоматически переупорядочивать фрагменты знаний на основе лайков/дизлайков пользователей.',
      boostThreshold: 'Порог повышения (пол. оценка)',
      penaltyThreshold: 'Порог понижения (пол. оценка)',
      boostFactor: 'Коэффициент повышения',
      penaltyFactor: 'Коэффициент понижения',
      minSamples: 'Минимум отзывов',
      needsOptimizationThreshold: 'Порог «требует оптимизации»',
      validationError: 'Некорректная политика отзывов: {message}',
      recomputing: 'Пересчёт весов…',
      recomputeSuccess: 'Веса пересчитаны ({count} фрагментов)',
    },
  },
  file: {
    upload: 'Загрузить файл',
