export default {
  ...
  knowledgeEditor: {
    ...
    wikiBrowser: {
      ...
      issueRestore: 'Восстановить как открытую',
      ...
      issueOrphanPage: 'Изолированная страница',
      issueEmptyContent: 'Мало контента',
      issueStaleRef: 'Устаревшая ссылка',
      issueMissingCrossRef: 'Нет перекрёстной ссылки',
      issueLintScan: 'Проверка по правилам',
      healthDrawerFilterType: 'Тип проблемы',
      healthDrawerFilterTypeAll: 'Все типы',
      healthDrawerFilterSource: 'Источник',
      healthDrawerFilterSourceAll: 'Все источники',
      healthDrawerFilterSourceLint: 'Проверка по правилам',
      healthDrawerFilterSourceAgent: 'ИИ-проверка',
      healthDrawerFilterStatus: 'Статус',
      healthDrawerFilterStatusActionable: 'Открытые',
      healthDrawerFilterStatusIgnored: 'Игнорированные',
      healthDrawerFilterStatusResolved: 'Решённые',
      healthStatsPages: '{count} стр.',
      healthStatsLinks: '{count} ссылок',
      healthStatsOrphans: '{count} изолированных',
      healthMetricPages: 'Страницы',
      healthMetricLinks: 'Ссылки',
      healthMetricOrphans: 'Изолированные',
      healthCardViewPage: 'Открыть страницу',
      healthDrawerActiveRepairs: 'Исправляется: {count}',
      healthDrawerViewRepair: 'Смотреть прогресс',
      issueSeverityError: 'Критично',
      issueSeverityWarning: 'Предупреждение',
      issueSeverityInfo: 'Инфо',
      issueRepairModeDeterministic: 'Авто по правилам',
      issueRepairModeAgent: 'ИИ-исправление',
      issueRepairModeManual: 'Только вручную',
      issueEvidenceTarget: 'Связанная цель',
      issueLastSeen: 'Последняя проверка {time}',
      issueOccurrenceCount: 'Встречалось {count} раз',
      issueDetectedVersion: 'Обнаружено в v{version}',
      healthDrawerResolvedEmptyTitle: 'Нет решённых проблем',
      healthDrawerResolvedEmptyHint: 'Исправленные или больше не обнаруживаемые проблемы отображаются здесь.',
      lintRuleVersion: 'Правила {version}',
      lintFinishedAt: 'Завершено {time}',
      lintDuration: 'Заняло {seconds} с',
      healthDrawerSelectAll: 'Выбрать все',
      healthDrawerBatchIgnore: 'Игнорировать выбранные',
      healthDrawerBatchRepair: 'Исправить выбранные',
      healthDrawerBatchIgnoreAll: 'Игнорировать все',
      healthDrawerBatchRestore: 'Восстановить выбранные',
      healthDrawerBatchRestoreAll: 'Восстановить все',
      healthDrawerIgnoreAllConfirmTitle: 'Игнорировать все подходящие проблемы?',
      healthDrawerIgnoreAllConfirmBody: 'Будет проигнорировано {count} проблем по текущим фильтрам. Это нельзя отменить.',
      healthDrawerBatchIgnoreDone: 'Проигнорировано проблем: {count}',
      healthDrawerBatchIgnoreFailed: 'Не удалось выполнить массовое игнорирование. Повторите попытку.',
      healthDrawerRestoreAllConfirmTitle: 'Восстановить все игнорированные проблемы?',
      healthDrawerRestoreAllConfirmBody: 'Будет восстановлено {count} проблем по текущим фильтрам.',
      healthDrawerBatchRestoreDone: 'Восстановлено проблем: {count}',
      healthDrawerBatchRestoreFailed: 'Не удалось выполнить массовое восстановление. Повторите попытку.',
      healthDrawerIgnoredEmptyTitle: 'Нет игнорированных проблем',
      healthDrawerIgnoredEmptyHint: 'Игнорированные проблемы отображаются здесь. Их можно восстановить в открытые.',
      healthDrawerViewIgnored: 'Просмотр игнорированных',
      healthDrawerBatchRepairHint: 'Запущено первое исправление; остальные {count} обработайте по одному.',
      healthDrawerLoadingMore: 'Загрузка…',
      healthDrawerAllLoaded: 'Загружены все {count} проблем',
      ...
      lintCompleted: 'Проверка по правилам завершена',
      lintFailed: 'Ошибка проверки',
      lintCompletedClean: 'Проверка завершена, новых проблем нет',
      lintFindings: 'Найдено открытых проблем: {count}',
      lintFindingsPartial: 'Проверено {detected}, открыты для действия: {actionable}',
      lintFindingsAllIgnored: 'Проверено {count}; все уже были проигнорированы',
      healthDrawerAllIgnoredTitle: 'Результаты проверки проигнорированы',
      healthDrawerAllIgnoredHint: 'Правила снова нашли {count} известных проблем, которые ранее были проигнорированы. Используйте кнопку ниже или переключитесь на «Игнорированные» для просмотра и восстановления.',
      loadMoreIssues: 'Загрузить ещё ({loaded}/{total})',
      issueFixSuggestions: 'Предложения по оптимизации ({count})',
      pageIssuesTitle: 'Проблемы страницы ({count})',
      pageIssuesSubtitle: 'Проблемы контента, найденные правилами проверки, и рекомендации по исправлению',
      issueSourceLintReport: 'Проверка правил',
      issueRepairManualOnly: 'Эту проблему нельзя исправить автоматически — исправьте вручную',
      issueOrphanManualHint: 'Для изолированных страниц нужны входящие ссылки с других Wiki-страниц; AI-исправление недоступно',
