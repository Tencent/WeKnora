export default {
  ...
  webSearchSettings: {
    ...
    configFields: {
      ...
      contentSize: 'Объём контента',
      contentMedium: 'Medium',
      contentHigh: 'High',
      contentSizeDesc: 'Medium возвращает краткие сводки; High — больше контекста.',
      metasoScope: 'Область поиска',
      metasoScopeDesc: 'Выберите область поиска Metaso.',
      metasoScopeWebpage: 'Веб-страницы',
      metasoScopeDocument: 'Документы',
      metasoScopeScholar: 'Научные',
      metasoScopeImage: 'Изображения',
      metasoScopeVideo: 'Видео',
      metasoScopePodcast: 'Подкасты',
      metasoConciseSnippet: 'Краткие совпадения',
      metasoConciseSnippetDesc: 'Включено — возвращать краткие совпадения; выключено — полный фрагмент.',
      metasoIncludeSummary: 'Усиление отзыва через сводку',
      metasoIncludeSummaryDesc: 'Включено — усиливать отзыв, используя сводки веб-страниц.',
    },
    toasts: {
