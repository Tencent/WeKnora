export default {
  ...
  input: {
    ...
    contextUsage: {
      ...
      used: 'Использовано {used} / {window}',
      empty: 'Отправьте сообщение, чтобы увидеть разбивку контекста',
      freeSpace: 'Свободное место',
      expand: 'Показать детализацию',
      collapse: 'Скрыть детализацию',
      thresholdHint: 'За этой линией история сжимается автоматически',
      groups: {
        instructions: 'Инструкции',
        toolDefs: 'Определения инструментов',
        dialogue: 'Диалог',
