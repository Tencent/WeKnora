export default {
  ...
  modelSettings: {
    ...
    analytics: {
      ...
      callsUnit: 'вызовов',
      compositionUnavailable: 'Сумма по типам не совпадает с общим числом вызовов. Состав недоступен.',
      inputDetail: 'Вход {value}',
      outputDetail: 'Выход {value}',
      observedCoverage: 'Учтено {observed} / {applicable} вызовов',
      notObserved: 'Нет наблюдений',
      usageTrend: 'Динамика использования',
      trendDescription: 'Агрегированное сервером использование моделей по времени создания',
      tokens: 'Токены',
      latency: 'Задержка',
      noMetricData: 'Для этого показателя нет наблюдаемых данных.',
      promptCache: 'Кэш Prompt',
      providerCache: 'Кэш Prompt провайдера',
      callHitRate: 'Доля вызовов с попаданием',
      tokenCacheRatio: 'Доля токенов из кэша',
      promptCacheDetail: 'Попадания {hit} · Промахи {miss} · Учитываемые {eligible}',
      embeddingCache: 'Кэш эмбеддингов',
      weknoraCache: 'Кэш эмбеддингов WeKnora',
      inputHitRate: 'Доля входов с попаданием',
      embeddingCacheDetail: 'Попадания {hit} · Промахи {miss} · Учитываемые входы {eligible}',
      loadFailed: 'Не удалось загрузить аналитику использования моделей',
      retry: 'Повторить',
      empty: 'Нет данных об использовании моделей за этот период.',
      modelsLoadFailed: 'Фильтр моделей недоступен. Аналитика по всем моделям всё ещё доступна.'
    },
    copySuffix: ' копия',
