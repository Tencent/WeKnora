...
/example\.(net|org)/`,
  ...
  auth: {
    ...
    loginIdentifier: 'Аккаунт или email',
    loginIdentifierPlaceholder: 'Введите email или имя пользователя',
    loginIdentifierRequired: 'Введите аккаунт или email',
    ...
    loginError: 'Ошибка входа, пожалуйста, проверьте аккаунт или пароль',
