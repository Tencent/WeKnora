  ...
  integrations: {
    ...
    mcpserver: {
      ...
      tools: {
        ...
        ask: 'Задать вопрос',
        askDesc: 'Запускает агента по умолчанию или указанного и возвращает ответ с цитатами; поддерживает продолжение диалога',
      ...
      defaultAgentHint: 'Используется инструментом ask, если клиент не передал agent_id.',
      ...
      showSnippets: 'Показать примеры конфигурации клиента',
