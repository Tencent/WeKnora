...
/example\.(net|org)/`,
  ...
  datasource: {
    ...
    noResourcesDesc_dingtalk: 'Приложению нужен доступ к DingTalk Wiki, а пользователь Operator должен иметь доступ к целевому пространству',
    ...
    guideStep1_dingtalk: 'Убедитесь, что приложению DingTalk выданы API-права на чтение wiki и участников',
    guideStep2_dingtalk: 'Убедитесь, что Operator User ID имеет доступ к целевому пространству DingTalk Wiki',
    guideStep3_dingtalk: 'Вернитесь и нажмите Повторить, затем выберите пространство или папку для синхронизации',
    ...
    connectorDesc: {
      ...
      dingtalk: 'Синхронизация документов из пространств DingTalk Wiki',
    ...
    field: {
      ...
      operatorUserIdHint: 'Используется для чтения DingTalk Wiki от имени этого пользователя; приложение автоматически определяет его Union ID.',
      baseUrl: 'Base URL',
      apiToken: 'API Token',
    ...
    prereqStep1Brief_dingtalk: 'Создайте или откройте внутреннее приложение DingTalk',
    prereqStep1Desc_dingtalk: 'Откройте приложение в DingTalk Open Platform и скопируйте Client ID / AppKey и Client Secret / AppSecret',
    prereqStep2Brief_dingtalk: 'Включите необходимые API-права',
    prereqStep2Desc_dingtalk: 'Включите чтение участников, чтение wiki, чтение узлов wiki и чтение корпоративных файлов',
    prereqStep3Brief_dingtalk: 'Введите Operator User ID',
    prereqStep3Desc_dingtalk: 'Operator должен иметь доступ к целевой wiki; приложение использует эту учётную запись для списка пространств и синхронизации документов.',
