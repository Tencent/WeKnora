...
/example\.(net|org)/`,
  ...
  datasource: {
    ...
    noResourcesDesc_dingtalk: 'Приложению требуется доступ к пространству документов DingTalk для получения контента',
    ...
    guideStep1_dingtalk: 'Создайте внутреннее корпоративное приложение в DingTalk Open Platform и скопируйте App Key и App Secret',
    guideStep2_dingtalk: 'Выдайте приложению права на чтение пространств и содержимого документов DingTalk, затем опубликуйте его в целевой организации',
    guideStep3_dingtalk: 'Убедитесь, что организация приложения имеет доступ к целевому пространству документов, затем вернитесь и нажмите Повторить',
    ...
    connectorDesc: {
      ...
      dingtalk: 'Синхронизация пространств, папок и документов DingTalk',
    ...
    field: {
      ...
      dingtalkBaseUrlHint: 'Оставьте пустым, чтобы использовать DingTalk Open Platform https://api.dingtalk.com. Для приватных развёртываний или прокси укажите свой базовый адрес API.',
    ...
    prereqStep1Desc_dingtalk: 'Войдите в DingTalk Open Platform > App Development > Internal Enterprise App > Create App, затем скопируйте App Key и App Secret',
    prereqStep2Brief_dingtalk: 'Выдайте права на чтение документов',
    prereqStep2Desc_dingtalk: 'Выдайте приложению права на чтение пространств и содержимого документов DingTalk, затем опубликуйте его в целевой организации',
    prereqStep3Brief_dingtalk: 'Проверьте доступ к пространству документов',
    prereqStep3Desc_dingtalk: 'Убедитесь, что организация приложения имеет доступ к целевому пространству документов, затем проверьте подключение и выберите область синхронизации здесь.',
    prereqOpenConsole_dingtalk: 'Открыть DingTalk Open Platform',
    ...
    resourceType: {
      ...
      docSpace: 'Пространство документов DingTalk',
      folder: 'Папка',
      document: 'Документ',
    },
