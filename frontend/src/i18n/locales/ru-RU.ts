export default {
  ...
  agentEditor: {
    ...
    tools: {
      ...
      wikiListSourceChunks: 'Исходные фрагменты страницы',
      wikiListSourceChunksDesc: 'Развернуть все исходные фрагменты, связанные со страницей Wiki',
  ...
  knowledgeEditor: {
    ...
    wiki: {
      ...
      contentInstructionsTip: 'Достаточно пары фраз, как писать страницы. Цитирование и защиту от выдумок система берёт на себя.',
      contentInstructionsPlaceholder: 'Например: для ТЗ и инициации продукта; сначала выводы и факты, без воды…',
      extractionInstructionsLabel: 'Фокус извлечения Wiki',
      extractionInstructionsTip: 'Простыми словами, что оставлять. Раскладку по папкам делает система, таксономию писать не нужно.',
      extractionInstructionsPlaceholder: 'Например: пользователи, конкуренты, допущения и ограничения — чтобы цитировать при написании…',
    ...
    basic: {
      ...
      descriptionWikiTip: 'Достаточно одной фразы, для чего эта база, например: «для инициации продукта и написания требований».'
    },
    errors: {
