...
/example\.(net|org)/`,
  ...
  datasource: {
    ...
    noResourcesDesc_dingtalk: 'Для этого UnionId нет доступных пространств DingTalk или приложению не выданы права чтения документов',
    ...
    guideStep1_dingtalk: 'Убедитесь, что приложению выданы права API на чтение DingTalk Docs и версия опубликована',
    guideStep2_dingtalk: 'Убедитесь, что указан UnionId оператора, а не корпоративный userId',
    guideStep3_dingtalk: 'Убедитесь, что оператор имеет доступ к целевому пространству, затем нажмите Повторить',
    ...
    connectorDesc: {
      ...
      dingtalk: 'Синхронизация онлайн-документов из пространств знаний DingTalk',
    ...
    field: {
      ...
      operatorUnionId: 'UnionId оператора',
      operatorUnionIdHint: 'Укажите UnionId пользователя DingTalk с доступом к целевым пространствам; корпоративный userId не подходит.',
    ...
    prereqStep1Brief_dingtalk: 'Создайте и опубликуйте внутреннее приложение',
    prereqStep1Desc_dingtalk: 'Создайте внутреннее приложение в DingTalk Open Platform, получите AppKey и AppSecret и опубликуйте версию.',
    prereqStep2Brief_dingtalk: 'Выдайте права только на чтение документов',
    prereqStep2Desc_dingtalk: 'Выдайте права API на чтение связанных пространств, узлов каталогов и блоков документов.',
    prereqStep3Brief_dingtalk: 'Подготовьте UnionId оператора с доступом',
    prereqStep3Desc_dingtalk: 'Оператор должен иметь доступ к синхронизируемым пространствам. Укажите UnionId, а не корпоративный userId.',
