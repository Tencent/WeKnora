export default {
  ...
  agentEditor: {
    ...
    im: {
      ...
      feishuAPIBaseURLHint: 'Необязательно. Для внутренних развёртываний укажите URL обратного прокси (например, nginx). Оставьте пустым для публичного облака. Для адресов внутренней сети добавьте имя хоста в переменную SSRF_WHITELIST.',
