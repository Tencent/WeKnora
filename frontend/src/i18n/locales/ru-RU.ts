export default {
  ...
  datasource: {
    ...
    prereqStep3Desc_feishu_links: 'Включите разрешения: wiki:wiki:readonly, drive:drive:readonly, drive:export:readonly, docx:document:readonly',
    ...
    prereqStep3Desc_lark_links: 'Включите разрешения: wiki:wiki:readonly, drive:drive:readonly, drive:export:readonly, docx:document:readonly',
