export default {
  ...
  knowledgeBase: {
    ...
    urlLabel: 'Адрес URL',
    urlPlaceholder: 'Одна или несколько ссылок, по одной в строке, например:\nhttps://example.com/article\nhttps://youtu.be/VIDEO_ID',
    urlTip: 'Можно вставить несколько ссылок, по одной в строке. Веб-страницы загружаются и анализируются; ссылки на видео и плейлисты YouTube импортируются по субтитрам, а при их отсутствии — с помощью распознавания речи',
