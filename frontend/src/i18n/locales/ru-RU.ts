export default {
  ...
  settings: {
    ...
    parser: {
      ...
      notAllowedHint: 'Этот движок отключён через PARSER_ENGINE_ALLOW_LIST и не может быть настроен.',
...
/example\.(net|org)/`,
  ...
  kbSettings: {
    ...
    parser: {
      ...
      unavailable: 'Недоступен',
      notAllowed: 'Не разрешено',
      notAllowedHint: 'Этот движок исключён из белого списка развертывания.',
