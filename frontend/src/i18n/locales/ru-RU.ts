export default {
  ...
  preview: {
    spreadsheet: {
      worksheet: "Лист",
      dimensions: "Строк: {rows} · Столбцов: {columns}",
      previousColumns: "Предыдущие столбцы",
      nextColumns: "Следующие столбцы",
      contents: "Содержимое таблицы",
      rowNumber: "Строка",
      empty: "На этом листе нет данных.",
      valuesOnly: "Значения ячеек показаны постранично. Для просмотра исходного оформления скачайте файл.",
      truncated: "Содержимое некоторых ячеек сокращено. Полный текст доступен в исходном файле.",
      tooLarge: "Файлы размером более {size} МиБ недоступны для предпросмотра. Скачайте исходный файл.",
      timeout: "Превышено время ожидания предпросмотра. Повторите попытку или скачайте исходный файл.",
    },
    tab: 'Предпросмотр',
