export default {
  ...
  agentStream: {
    ...
    like: {
      title: 'Нравится',
      cancelTitle: 'Убрать отметку',
      success: 'Отмечено',
      cancelled: 'Отметка убрана',
      noKnowledge: 'У этого ответа нет связанных знаний'
    },
    mcp: {
  ...
  knowledgeEditor: {
    ...
    wikiBrowser: {
      ...
      tierTouch: 'Касание',
      tierFamiliar: 'Знакомо',
      tierMastered: 'Освоено',
      tierAll: 'Все',
      tierNone: 'Не изучено',
      masteryToggle: 'Гид по знаниям',
      masteryToggleTitle: 'Переключить на режим гида по знаниям',
      exitMastery: 'Выйти из гида',
      recommendNext: 'Продолжить изучение',
      profileEntry: 'Мой профиль',
      profileTitle: 'Профиль знаний',
      profileHint: 'Высота полосы — десятиуровневая освоенность, цвет — диапазон состояния. Удаление профиля очищает только ваше личное состояние знаний и не влияет на содержимое базы знаний или других пользователей.',
      profileEmpty: 'Пока нет поведенческих данных. После просмотров, цитирований или лайков здесь появится ваш профиль знаний.',
      profileExport: 'Экспорт в HTML',
      profileExportSuccess: 'Профиль экспортирован',
      profileExportFailed: 'Не удалось экспортировать',
      profileDelete: 'Удалить профиль',
      profileDeleteConfirm: 'Ваше личное состояние знаний будет полностью очищено, а карта вернётся к исходному серому виду. Это не влияет на содержимое базы знаний, других пользователей и персонализацию поиска. Действие необратимо. Продолжить?',
      profileDeleteSuccess: 'Профиль удалён',
      profileDeleteFailed: 'Не удалось удалить',
