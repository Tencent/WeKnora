export default {
  ...
  knowledgeStages: {
    ...
    detail: {
      ...
      graphSummary: 'Результат графа знаний',
      graphPartialHint: 'Часть сущностей или связей не обработана; остальные корректные данные сохранены.',
      graphNodes: 'Сущности',
      graphRelations: 'Связи',
      graphSucceeded: 'Успешно',
      graphFailed: 'Ошибки',
      graphFailureDetails: 'Сведения об ошибках ({n})',
      graphNoFailureDetails: 'Детали по отдельным элементам не записаны. Проверьте журналы сервера.',
      graphChunk: 'Фрагмент #{n}',
      graphItem: 'Элемент {n}',
      graphItemUnknown: 'Неизвестный элемент',
      graphValidation: 'Проверка',
      graphWrite: 'Запись Neo4j',
      graphChunkFailure: 'Задача фрагмента',
      graphUnknownStage: 'Неизвестный этап',
      graphUnknownReason: 'Причина ошибки не записана',
    },
    stage: {
...
/example\.(net|org)/`,
  ...
  knowledgeEditor: {
    ...
    wikiBrowser: {
      ...
      logActionManualCreate: 'Создано вручную',
      logActionManualEdit: 'Изменено вручную',
      logActionManualDelete: 'Удалено вручную',
      logActionRevert: 'Откат',
