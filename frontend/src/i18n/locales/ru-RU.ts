export default {
  ...
  knowledgeBase: {
    ...
    urlLabel: 'Ссылки',
    urlPlaceholder: 'По одной ссылке в строке, например:\nhttps://example.com/article\nhttps://www.youtube.com/watch?v=VIDEO_ID\nhttps://www.youtube.com/playlist?list=PLAYLIST_ID',
    urlTip: 'Вставьте ссылки на веб-страницы или YouTube, по одной в строке. Веб-страницы загружаются и анализируются. Каждое видео YouTube становится отдельным документом на основе субтитров, а при их отсутствии — распознавания речи; каждый плейлист YouTube импортируется в папку с его названием. Ссылка на видео с &list= импортирует только это видео — для всего плейлиста используйте ссылку на плейлист',
    urlPreviewWebPages: 'Веб-страниц: {count}',
    urlPreviewYouTubeVideos: 'Видео YouTube: {count}',
    urlPreviewYouTubePlaylists: 'Плейлистов YouTube: {count}, каждый в отдельную папку',
    urlPreviewInvalid: 'Недействительных строк: {count}, будут пропущены',
