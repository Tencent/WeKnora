export default {
  ...
  knowledgeEditor: {
    ...
    wikiBrowser: {
      ...
      runLint: 'Запустить полную проверку Wiki',
      lintNotRun: 'Проверка ещё не запускалась',
      lintQueued: 'Проверка поставлена в очередь',
      lintRunning: 'Сканирование и проверка проблем',
      lintCompleted: 'Проверка завершена',
