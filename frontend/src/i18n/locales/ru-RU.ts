export default {
  ...
  settings: {
    ...
    sandbox: {
      ...
      skillUploadHint: 'Загрузка устанавливает навык в текущий образ и создаёт новый снимок. Это может занять несколько минут. Открытые сессии пересоздадут песочницу при следующем использовании; текущие вызовы инструментов могут прерваться, черновики рабочей области сессии будут очищены.',
      ...
      skillDeleteHint: 'Удаление убирает каталог навыка из образа и создаёт новый снимок. Открытые сессии пересоздадут песочницу при следующем использовании; текущие вызовы инструментов могут прерваться, черновики рабочей области сессии будут очищены.',
