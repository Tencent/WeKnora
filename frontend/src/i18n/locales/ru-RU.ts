export default {
  ...
  knowledgeBase: {
    ...
    youtubeUrlsLabel: 'Ссылки YouTube (по одной на строку)',
    youtubeUrlsPlaceholder: 'https://www.youtube.com/watch?v=...\nhttps://www.youtube.com/playlist?list=...',
    youtubeUrlsTip: 'Вставьте ссылки на видео или плейлисты, по одной на строку. Плейлисты автоматически разворачиваются в отдельные видео.',
    youtubeUrlsRequired: 'Пожалуйста, введите хотя бы одну ссылку YouTube',
    youtubeInvalidLines: 'Пропущено {count} строк(и), не являющихся корректными ссылками YouTube',
    youtubeImportSubmitting: 'Импорт из YouTube…',
    youtubeImportResult: 'Импортировано: {success}, ошибок: {failed}',
    youtubeImportAllFailed: 'Не удалось импортировать ни одно видео',
    typeManual: 'Вручную',
    typeFile: 'Файл',
