export default {
  ...
  knowledgeBase: {
    ...
    buildProgress: 'Прогресс построения знаний',
    buildProgressAria: 'Прогресс построения знаний: {percentage}%, завершено {settled} из {total}',
    buildProgressTotal: 'Завершено {settled} из {total}',
    batchStatusInFlight: 'В процессе: {count}',
    batchStatusCompleted: 'Завершено: {count}',
    batchStatusFailed: 'Ошибки: {count}',
    batchStatusCancelled: 'Отменено: {count}',
    batchStatusDraft: 'Черновики: {count}',
    batchCancelParse: 'Остановить разбор',
    confirmBatchCancelParse: 'Остановить выбранные активные задачи ({count})? Уже записанные фрагменты сохранятся.',
    batchCancelParseSuccess: 'Остановлено задач разбора: {count}',
    batchCancelParseFailed: 'Не удалось остановить задачи разбора',
    batchCancelParseSkipped: 'Задач с изменившимся состоянием или ошибкой остановки: {count}',
