...
/example\.(net|org)/`,
  ...
  agentEditor: {
    ...
    im: {
      ...
      fileProcessingStrategy: 'Стратегия обработки файлов',
      fileStrategyDirect: 'Прямо в диалог',
      fileStrategyKB: 'Загрузить в базу знаний',
      fileProcessingStrategyHint: 'Прямо: разобрать содержимое и вставить в текущий диалог; Загрузить: сохранить в базу знаний для асинхронной обработки',
      fileKnowledgeBaseRequired: 'Необходимо выбрать базу знаний при использовании стратегии загрузки',
