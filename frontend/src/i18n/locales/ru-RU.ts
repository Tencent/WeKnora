export default {
  workbench: {
    ...
    limits: 'Ограничения', commandTimeout: 'Время команды', sessionTimeout: 'Время сессии', cpuLimit: 'Время CPU', memoryLimit: 'Память', fileLimit: 'Размер файла',
    terminalUnavailable: 'Терминал недоступен для этой песочницы', filesUnavailable: 'Файлы недоступны для этой песочницы',
    states: { bound: 'Привязано', ready: 'Готово', available: 'Доступно', disabled: 'Рабочая панель отключена', unbound: 'Песочница не привязана', policy_denied: 'Заблокировано политикой рабочего пространства', unavailable: 'Рабочая панель недоступна', unsupported: 'Песочница не поддерживается' },
