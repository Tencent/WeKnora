export default {
  ...
  agentStream: {
    ...
    tools: {
      ...
      readFile: 'Чтение содержимого',
      grepFiles: 'Поиск содержимого',
  ...
  memorySettings: {
    experience: {
      "details": "Опыт и подтверждения",
      "trigger": "Условие",
      "applicability": "Область применения",
      "outcome": "Результат наблюдения",
      "avoid": "Неудачные подходы",
      "source": "Открыть исходный диалог",
      "outcomes": {
        "success": "Успех",
        "failure": "Ошибка",
        "uncertain": "Не проверено"
      }
    },
    title: 'Моя память',
    ...
    kindHints: {
      experience: "Полная процедура загружается при необходимости",
