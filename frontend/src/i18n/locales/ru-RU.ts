...
/example\.(net|org)/`,
  ...
  taskCenter: {
    title: 'Центр задач',
    subtitle: 'Отслеживайте пользовательские задачи, повторяйте сбои и смотрите историю выполнений.',
    searchPlaceholder: 'Поиск по имени задачи или ID',
    empty: 'Задач нет',
    retryAllConfirm: 'Повторить все воспроизводимые сбойные или отменённые задачи в текущем фильтре?',
    cancelConfirm: 'Отменить эту задачу?',
    deleteRecordsConfirm: 'Удалить завершённые записи старше 30 дней?',
    summary: {
      queued: 'В очереди',
      processing: 'В обработке',
      succeeded: 'Завершено',
      failedOrCanceled: 'Сбой / отмена',
    },
    tabs: {
      all: 'Все',
      queued: 'В очереди',
    ...
    kind: {
      ...
      datasource_sync: 'Синхронизация источника',
      datasourceSync: 'Синхронизация источника',
      rebuild_wiki: 'Перестроить Wiki',
      rebuildWiki: 'Перестроить Wiki',
    },
    actions: {
      detail: 'Детали',
      retry: 'Повторить',
    ...
    detail: {
      ...
      retryCount: 'Повторы',
      enqueuedAt: 'Поставлено',
    },
    messages: {
      loadFailed: 'Не удалось загрузить задачи',
      detailFailed: 'Не удалось загрузить детали задачи',
      retryStarted: 'Повтор запущен',
      retryAllStarted: 'Повтор запущен для {count} задач',
      retryFailed: 'Не удалось повторить',
      cancelled: 'Задача отменена',
      cancelFailed: 'Не удалось отменить',
      deleted: 'Удалено записей: {count}',
      deleteFailed: 'Не удалось очистить записи',
    },
  },
}
