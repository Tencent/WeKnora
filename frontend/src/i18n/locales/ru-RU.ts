export default {
  ...
  evaluationSettings: {
    ...
    cacheBenchmarkStart: 'Запустить строгий A/B (6 вызовов)', cacheBenchmarkCostHint: 'Выбранная чат-модель будет вызвана 6 раз, что может расходовать квоту. Страницы Wiki не изменяются.',
