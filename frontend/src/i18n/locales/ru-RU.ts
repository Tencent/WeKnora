export default {
  ...
  settings: {
    ...
    sandbox: {
      ...
      viewSandboxes: 'Кто использует',
      inventoryTitle: 'Кто использует',
      ...
      inventorySummary: 'Эта конфигурация всё ещё занимает {count} песочниц(ы).',
      inventoryEmpty: 'Нет запущенных песочниц.',
      inventorySessions: 'Сессии, удерживающие песочницу',
      inventorySessionsHint: 'Завершение или удаление сессии освобождает песочницу.',
      inventoryAgents: 'Агенты с этой конфигурацией',
      inventoryNoAgents: 'Ни один агент не использует эту конфигурацию.',
      inventoryAgentWarning: 'После удаления конфигурации эти агенты завершат следующее выполнение навыка ошибкой.',
      inventoryOpenSession: 'Открыть',
