export default {
  ...
  knowledgeBase: {
    ...
    // Folder navigation (Task 3): folder tree panel, breadcrumb, actions.
    rootFolder: 'Корень',
    folderTreeTitle: 'Дерево папок',
    showFolderTree: 'Показать дерево папок',
    hideFolderTree: 'Скрыть дерево папок',
    searchWholeKb: 'Поиск по всем: {q}',
    folderBreadcrumbLabel: 'Путь к папке',
    breadcrumbCollapsedItems: 'Свернуто уровней: {count}',
    emptyFolderTree: 'Папок пока нет',
    emptyFolderTreeHint: 'Созданные папки появятся здесь',
    // Task 9: подсказка фильтров в режиме поиска и тексты пустых состояний
    searchFiltersApplyOnlyToDocs: 'Остальные фильтры действуют только для файлов',
    emptyFolderHint: 'Эта папка пуста',
    searchNoResults: 'Ничего не найдено',
    emptyRootViewer: 'В этой базе знаний пока нет содержимого',
    newFolder: 'Новая папка',
    folderActions: 'Действия с папкой',
    folderActionAddSubfolder: 'Новая вложенная папка',
    folderActionRename: 'Переименовать',
    folderActionDelete: 'Удалить',
    folderActionMoveTo: 'Переместить в папку…',
    folderActionDeleteConfirm: 'Удалить папку «{name}»? Это также удалит все её вложенные папки и документы.',
    folderDocumentCount: '{count} документов',
    folderCardType: 'Папка',
    // Inline folder editing (Task 6): UX pre-validation + backend error mapping.
    folderNameRequired: 'Введите имя папки',
    folderNameInvalid: 'Имя папки не может быть ".", ".." или содержать "/" или "\\"',
    folderNameConflict: 'Папка с таким именем уже существует. Выберите другое имя.',
    folderDepthExceeded: 'Достигнут предел вложенности папок. Невозможно создать папку здесь.',
    folderActionFailed: 'Ошибка операции с папкой. Повторите попытку.',
    expandFolder: 'Развернуть',
    collapseFolder: 'Свернуть',
    // Move-to-folder picker (Task 7): same-KB move + cross-KB transfer split.
    transferToKnowledgeBase: 'Перенести в другую базу знаний…',
    folderPickerTitle: 'Переместить в папку',
    folderPickerTargetLabel: 'Место назначения',
    folderPickerSelectHint: 'Выберите папку назначения',
    folderPickerDisabledHint: 'Нельзя переместить в эту папку',
    folderPickerConfirm: 'Переместить сюда',
    folderPickerEmpty: 'Нет папок для выбора',
    folderMoveSuccess: 'Перемещено в выбранную папку',
    folderMoveFailed: 'Не удалось переместить. Повторите попытку.',
    // Recursive folder delete (Task 8): impact display + submitted (not done) messaging.
    folderDeleteTitle: 'Удалить папку',
    folderDeleteEmptyConfirm: 'Удалить папку «{name}»? Папка пуста — будет удалена только сама папка.',
    folderDeleteRecursiveConfirm: 'Удаление папки «{name}» также удалит все её подпапки и документы. Продолжить?',
    folderDeleteImpact: 'Также будут удалены {folderCount} подпапок и {docCount} документов',
    folderDeleteImpactFolders: 'Также будут удалены {folderCount} подпапок',
    folderDeleteAsyncNote: 'Удаление выполняется асинхронно в фоновом режиме; список обновится автоматически по завершении.',
    folderDeleteSubmitted: 'Удаление отправлено; фоновая задача выполняется',
    folderDeleteFailed: 'Не удалось удалить. Повторите попытку.',
    folderReparseLimit: 'За один раз можно пересобрать до 200 документов. Уменьшите выбор.',
    reparseFolderUnsupported: 'Пересборка поддерживается только для документов; снимите выделение с папок.',
    // Folder load errors + invalid folder_id recovery (spec §4.1 / §12)
    folderLoadFailed: 'Не удалось загрузить папку',
    folderRetry: 'Повторить',
    folderNotFoundTitle: 'Папка недоступна',
    folderNotFoundHint: 'Эта папка могла быть удалена или перемещена. Вы возвращены в корневую папку.',
    folderTreeLoadFailed: 'Не удалось загрузить дерево папок',
    folderTreeRetry: 'Повторить',
    ...
    batchMoveFolder: 'Переместить в папку…',
...
/example\.(net|org)/`,
  ...
  agentEditor: {
    ...
    im: {
      ...
      yunzhijiaConsole: 'Консоль роботов Yunzhijia',
