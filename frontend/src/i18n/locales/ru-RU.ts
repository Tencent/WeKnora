export default {
  ...
  agentEditor: {
    ...
    im: {
      ...
      messageStorage: 'Автоматически сохранять каждый раунд Q&A в базу знаний',
      messageStorageHint: 'Текст, файлы и изображения сначала проходят обычный процесс Q&A, затем сохраняются асинхронно после завершения ответа.',
      fileKnowledgeBase: 'Целевая база знаний',
      fileKnowledgeBasePlaceholder: 'Выберите базу знаний',
      fileKnowledgeBaseHint: 'Цель сохраняется как предустановка и используется только при включённом хранении сообщений.',
      fileKnowledgeBaseRequired: 'Чтобы включить хранение сообщений, выберите целевую базу знаний',
