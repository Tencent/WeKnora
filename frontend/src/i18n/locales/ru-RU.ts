export default {
  ...
  settings: {
    ...
    storageBackend: {
      ...
      signatureVersionLabel: 'Версия подписи',
      signatureVersionDesc: 'Выберите V1 для частного/локального OSS, не поддерживающего подпись V4',
      signatureVersionV1: 'V1 (совместимо с частным облаком)',
      signatureVersionV4: 'V4 (по умолчанию)',
      testConnection: 'Проверить подключение',
      localStorage: 'Локальное хранилище',
