export default {
  ...
  datasource: {
    ...
    field: {
      ...
      jiraEdition: 'Версия Jira',
      jiraEditionServer: 'Server / Data Center',
      jiraEditionCloud: 'Cloud',
      jiraBaseUrl: 'URL Jira',
      jiraUsername: 'Имя пользователя или эл. почта',
      jiraPassword: 'Пароль Server/DC или PAT',
      jiraApiToken: 'API-токен Cloud',
      jiraJql: 'Дополнительный фильтр JQL (необязательно)',
      jiraJqlHint: 'Например, status in (Resolved, Closed) или priority = High',
      jiraIncludeComments: 'Синхронизировать комментарии задач',
      jiraIncludeCommentsHint: 'Включать обсуждения и решения из комментариев задач',
      clientId: 'Client ID',
    ...
    connectorDesc: {
      ...
      jira: 'Синхронизация задач и комментариев из проектов Jira',
