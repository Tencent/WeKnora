export default {
  localBrowser: {
    ...
    "clickPage": "Действие на странице",
    ...
    "invalidArguments": "Не хватает аргументов инструмента. Агент должен исправить запрос.",
    "commandInterrupted": "Действие прервано. Проверьте страницу перед продолжением через предпросмотр.",
    "actionFailedHint": "Не удалось завершить действие. Разверните подробности.",
