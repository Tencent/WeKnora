export default {
  ...
  integrations: {
    ...
    api: {
      ...
      editApiKeyScope: 'Изменить область баз знаний',
      editApiKeyScopeDesc: 'Изменить базы знаний, доступные API key «{name}».',
      editApiKeyScopeHint: 'Оставьте пустым, чтобы разрешить все базы знаний рабочего пространства. Изменения применяются сразу.',
      updateApiKeyScopeSuccess: 'Область баз знаний обновлена',
      updateApiKeyScopeFailed: 'Не удалось обновить область баз знаний',
      createdAt: 'Создано',
      actions: 'Действия',
