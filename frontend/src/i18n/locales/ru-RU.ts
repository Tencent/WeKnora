export default {
  ...
  chat: {
    ...
    sandbox: {
        ...
        filesTitle: 'Файлы активной песочницы',
        filesBreadcrumbs: 'Текущая папка',
        filesRoot: 'Вывод',
        filesUpload: 'Загрузить файлы',
        filesRefresh: 'Обновить',
        filesLoading: 'Загрузка файлов…',
        filesEmpty: 'Эта папка пуста',
        filesDirectory: 'Папка',
        filesDownload: 'Скачать',
        filesRename: 'Переименовать',
        filesDelete: 'Удалить',
        filesDeleteConfirm: 'Удалить {name}? Это действие нельзя отменить.',
        filesInvalidName: 'Введите имя файла без разделителей пути',
        filesLoadFailed: 'Не удалось загрузить файлы песочницы',
        filesDownloadFailed: 'Ошибка скачивания',
        filesUploadComplete: 'Загрузка завершена',
        filesUploadFailed: 'Ошибка загрузки',
        filesRenameFailed: 'Ошибка переименования',
        filesDeleteFailed: 'Ошибка удаления',
        filesPaused: 'Песочница приостановлена. Запустите её на вкладке «Терминал», прежде чем просматривать файлы — эта панель не возобновляет её автоматически, чтобы не начислять оплату.',
        filesTooLarge: 'Файл превышает ограничение 16 МиБ',
        filesTooMany: 'В папке слишком много записей для списка или удаления',
