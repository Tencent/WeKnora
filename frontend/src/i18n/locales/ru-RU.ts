...
/example\.(net|org)/`,
  ...
  knowledgeEditor: {
    ...
    wikiBrowser: {
      ...
      structuralFix: 'Упорядочить',
      structuralFixTooltip: 'Сканировать и автоматически упорядочивать страницы-сироты, устаревшие ссылки, битые ссылки',
      structuralFixConfirmTitle: 'Упорядочить вики?',
      ...
      structuralFixDone: 'Упорядочено {count} элементов',
      structuralFixNothing: 'Вики уже в порядке — нечего упорядочивать',
      structuralFixFailed: 'Упорядочивание не удалось',
      resetLog: 'Сбросить журнал',
      resetLogTooltip: 'Очистить все записи в Wiki Operation Log (необратимо)',
      resetLogConfirmTitle: 'Сбросить журнал вики?',
      resetLogConfirmBody: 'Будут удалены все записи Wiki Operation Log (накопительный журнал решений ingest / retract / dedup). Это действие необратимо. Index и другие страницы не затрагиваются.',
      resetLogConfirm: 'Сбросить',
      resetLogDone: 'Журнал вики сброшен',
      resetLogFailed: 'Не удалось сбросить журнал',
    },
    buttons: {
      create: 'Создать базу знаний',
