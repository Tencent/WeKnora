export default {
  ...
  knowledgeBase: {
    ...
    batchCancelParse: 'Остановить выбранные',
    confirmBatchCancelParseDocument: 'Остановить разбор {count} выбранных документов, которые ещё обрабатываются? Остальные будут пропущены.',
    confirmBatchCancelParse: 'Остановить разбор',
    batchCancelParseSuccess: 'Разбор остановлен для документов: {count}',
    batchCancelParseFailed: 'Не удалось остановить разбор некоторых документов',
    batchCancelParseSkipped: 'Пропущено документов, которые не обрабатываются: {count}',
    batchCancelParseNone: 'Среди выбранных нет документов в обработке',
