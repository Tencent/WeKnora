import { evaluationFlowRu as evaluationFlow } from '../evaluationFlow'
...
export default {
  ...
  organization: {
    ...
    avatarClear: 'Clear',
    avatarPickerHint: 'Выберите значок общего пространства',
  ...
  modelSettings: {
    ...
    actions: {
      more: "Действия с моделью",
      addModel: 'Добавить модель',
      debugModel: 'Тест модели',
      usage: 'Использование и цены'
    },
    observability: {
      cachePricingTitle: "Цена токенов кэша (необязательно)",
      cacheReadPrice: "Чтение кэша / млн",
      cacheWrite5mPrice: "Запись кэша · 5 мин / млн",
      cacheWrite1hPrice: "Запись кэша · 1 час / млн",
      cachePricingHint: "Пустое поле означает неизвестную цену; 0 — бесплатно. Единицы совпадают с базовой ценой ввода/вывода.",
      unknownPrice: "Неизвестно",
      callStatus: "Статус вызовов",
      started: "В процессе",
      success: "Успешно",
      error: "Ошибка",
      canceled: "Отменено",
      title: 'Использование моделей и цены',
      description: 'Вызовы провайдеров, стоимость, задержка и независимые показатели кэша провайдера и приложения',
      days: 'дн.',
      empty: 'За выбранный период использование моделей не зарегистрировано',
      calls: 'Вызовы провайдера',
      ...
      pricingDescription: 'Цена задаётся в единицах валюты за миллион входных/выходных токенов и действует с выбранного времени.',
      selectModel: 'Выберите модель',
      inputPrice: 'Вход / миллион',
      outputPrice: 'Выход / миллион',
      currency: 'Валюта',
      validTo: 'Необязательное время окончания',
      addPrice: 'Добавить версию',
      loadFailed: 'Не удалось загрузить использование моделей',
      priceLoadFailed: 'Не удалось загрузить версии цен',
      priceSaved: 'Версия цены добавлена',
      priceSaveFailed: 'Не удалось добавить версию цены',
      allModels: "Все модели",
      customRange: "Период",
      from: "Начало",
      to: "Окончание",
      timezoneHint: "Время отображается и вводится в часовом поясе устройства.",
      invalidRange: "Укажите допустимые даты. Окончание должно быть позже начала.",
      recordedCost: "Учтённая стоимость",
      accountedCalls: "Полностью учтено вызовов: {complete} / {total}",
      validFrom: "Действует с",
      openEnded: "Без окончания",
      invalidPriceDates: "Укажите допустимое время начала. Окончание должно быть позже начала.",
      invalidCurrency: "Код валюты должен содержать три латинские буквы, например USD.",
      invalidPrice: "Цена должна быть конечной и неотрицательной, в пределах безопасного целого числа микроединиц."
    },
    typeShort: {
      chat: 'Чат',
      embedding: 'Embedding',
  ...
  evaluation: {
    filterTitle: 'Фильтры экспериментов',
    summary: {
      retrieval: "Качество поиска",
      generation: "Качество ответов",
      unavailable: "Нет достоверных наблюдений",
      retrievalHint: "Значения взяты из агрегированных метрик этого запуска.",
      generationHint: "Каждая метрика измеряет отдельный аспект. Учитывайте ответы и оценки экспертов.",
      cost: "Учтённая стоимость моделей",
      costHint: "Валюты показаны отдельно. Число учтённых вызовов отражает полноту расчёта.",
      duration: "Общее время задачи",
      execution: "Выполнение оценки",
      durationHint: "Общее время включает подготовку данных, индексацию и выполнение.",
      runtime: "Статистика выполнения"
    },
    eyebrow: 'Аудит экспериментов',
    title: 'Рабочая область оценки',
    subtitle: 'Фильтруйте запуски, проверяйте доказательства, сравнивайте метрики и экспортируйте артефакты.',
    selected: 'Выбрано',
    statusLabel: 'Статус',
    allStatuses: 'Все статусы',
    dataset: 'Набор данных',
    datasetPlaceholder: 'ID набора данных',
    datasetVersion: 'Версия набора',
    versionPlaceholder: 'ID версии',
    model: 'Модель',
    modelPlaceholder: 'ID модели',
    startedFrom: 'Начало с',
    startedTo: 'Начало до',
    labels: 'Метки',
    labelsPlaceholder: 'production, nightly',
    reset: 'Сбросить',
    apply: 'Применить фильтры',
    runs: 'Запуски',
    refresh: 'Обновить запуски',
    selectedRuns: 'запусков выбрано',
    baseline: 'Базовый',
    comparing: 'Сравнение…',
    compare: 'Сравнить',
    loading: 'Загрузка…',
    noRuns: 'Нет запусков по этим фильтрам.',
    loadMore: 'Загрузить ещё',
    selectRun: 'Выбрать запуск {id}',
    runsCompared: 'запусков в сравнении',
    comparison: 'Сравнение',
    backToDetail: 'К деталям',
    parameterDifferences: 'Различия стабильных параметров',
    parameter: 'Параметр',
    missing: 'Нет значения',
    metricDifferences: 'Различия метрик',
    questionSuccess: 'Успешность вопросов',
    ...
    overview: 'Обзор',
    questions: 'Вопросы',
    experiment: 'Снимок эксперимента',
    aggregateMetrics: 'Агрегатные метрики',
    loadingQuestions: 'Загрузка доказательств…',
    noQuestions: 'Нет результатов по вопросам.',
    referenceAnswer: 'Эталонный ответ',
    generatedText: 'Сгенерированный ответ',
    humanRating: 'Оценка человеком',
    viewRevisions: 'Просмотреть версии',
    loadingRatings: 'Загрузка версий оценки…',
    score: 'Оценка',
    ratingGuidance: 'Оценивайте точность, релевантность и обоснованность в целом: 1 — неприемлемо, 3 — приемлемо с заметными недочётами, 5 — все три критерия выполнены.',
    ratingComment: 'Комментарий',
    ratingCommentPlaceholder: 'Необязательная заметка аудита',
    appendRating: 'Добавить версию',
    savingRating: 'Сохранение…',
    noRatings: 'Версий оценки человеком нет.',
    ratingSaved: 'Версия оценки добавлена',
    loadMoreQuestions: 'Загрузить ещё вопросы',
    detailEmpty: 'Выберите запуск',
    detailEmptyHint: 'Здесь отображаются происхождение, метрики, доказательства и экспорт.',
    loadingDetail: 'Загрузка деталей…',
    selectAtMostTen: 'Выберите не более 10 запусков.',
    selectAtLeastTwo: 'Выберите не менее 2 запусков.',
    labelsSaved: 'Метки сохранены',
    unknownError: 'Запрос оценки завершился ошибкой.',
    status: {
      pending: 'Ожидание',
      running: 'Выполняется',
      success: 'Успешно',
