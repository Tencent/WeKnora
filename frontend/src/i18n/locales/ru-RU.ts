export default {
  ...
  knowledgeBase: {
    ...
    batchMoveToFolder: 'Переместить в папку',
    moveToFolder: 'Переместить в папку',
    moveToFolderHeading: 'Перемещение в папку',
    moveToFolderSubtitle: 'Переместить выбранные документы ({count}) в папку',
    moveToFolderPickHint: 'Выберите папку назначения',
    folderPanelTitle: 'Папки',
    folderExpandPanel: 'Развернуть панель папок',
    folderCollapsePanel: 'Свернуть панель папок',
    folderNewRoot: 'Новая папка',
    folderNewChild: 'Новая вложенная папка',
    folderRename: 'Переименовать',
    folderDelete: 'Удалить папку',
    folderActions: 'Действия с папкой',
    folderAllDocuments: 'Все документы',
    folderUnfiled: 'Без папки',
    folderNamePlaceholder: 'Имя папки',
    folderSearchPlaceholder: 'Поиск папок',
    folderSearchEmpty: 'Подходящих папок нет',
    folderEmptyHint: 'Папок пока нет. Создайте её кнопкой выше.',
    folderIncludeSubfolders: 'Включая вложенные папки',
    folderDeleteConfirm: 'Удалить папку «{name}»?',
    folderDeleteNotEmpty: 'В папке {count} документ(ов). Они будут перемещены в родительскую папку; сами документы не удаляются.',
    folderDeleteReparent: 'Удалить и поднять документы',
    folderCreateSuccess: 'Папка создана',
    folderCreateFailed: 'Не удалось создать папку',
    folderRenameFailed: 'Не удалось переименовать папку',
    folderDeleteSuccess: 'Папка удалена',
    folderDeleteFailed: 'Не удалось удалить папку',
    folderMoveIntoSelf: 'Папку нельзя переместить в саму себя или в свою вложенную папку',
    folderMoveSuccess: 'Папка перемещена',
    folderMoveFailed: 'Не удалось переместить папку',
    folderMoveDocsSuccess: 'Перемещено документов: {count}',
    folderMoveDocsFailed: 'Не удалось переместить документы',
