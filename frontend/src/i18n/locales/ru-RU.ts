export default {
  ...
  preview: {
    ...
    tooLarge: 'Эта таблица слишком велика для безопасного предпросмотра',
    tooLargeHint: 'Используйте кнопку скачивания и откройте файл в локальном приложении для таблиц',
    zoomIn: 'Увеличить',
    zoomOut: 'Уменьшить',
