    ...
    advanced: {
      ...
      multimodal: {
        ...
        imagePipelineSectionDescription:
          'Каждое изображение обрабатывается выбранным здесь пайплайном. Список пайплайнов и их настраиваемых параметров приходит из реестра бэкенда, поэтому панель только выбирает. Пустое значение возвращает управление предыдущему переключателю.',
