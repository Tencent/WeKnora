export default {
  ...
  settings: {
    ...
    sandbox: {
      ...
      description: 'Configure several sandbox backends for this workspace; each agent picks the one it runs on. Fields left empty inherit the global defaults from .env.',
      loading: 'Loading sandbox configuration...',
      loadFailed: 'Failed to load sandbox configuration',
      backend: 'Sandbox backend',
      backendHint: 'Leave unset to inherit the global default',
      addConfig: 'Add sandbox backend',
      viewDeployDefaults: 'View deployment defaults',
      deployDefaultsTitle: 'Deployment defaults',
      deployDefaultsHint: 'The global configuration from .env. Fields left empty in a config inherit these values.',
      deployDefaultBackend: 'Default backend',
      ...
      noConfigs: 'No sandbox backend yet. Agents run their skill scripts on the deployment defaults.',
      ...
      namedBackendHint: 'Named configs support CubeSandbox and E2B only. Use WEKNORA_SANDBOX_MODE in deployment settings for Docker or local process.',
      ...
      deepCheckConfirm: 'Full verification creates and destroys a real sandbox, consuming a small amount of sandbox time. Continue?',
  ...
  agent: {
    ...
    editor: {
      ...
      sandboxBackendDefault: 'Use deployment defaults',
      ...
      sandboxNoConfigs: 'This workspace has no named sandbox backend yet, so skill scripts run on the deployment defaults. Add one under Settings - Sandbox Backend.',
  ...
  knowledgeBase: {
    ...
    confirmDeleteDocument: 'Удалить документ "{fileName}"? Ожидающие обновления файла также будут отменены. Восстановление невозможно.',
    confirmDelete: 'Подтвердить удаление',
    viewModeGrid: 'Сетка',
    viewModeList: 'Список',
    ...
    statusReplacing: 'Замена файла',
    fileUpdateActive: 'Обновление файла',
    fileUpdatePending: 'Ожидает обновления v{version}',
    fileUpdateFailed: 'Ошибка обновления файла',
    retryFileUpdate: 'Повторить последнюю версию',
    retryFileUpdateSubmitted: 'Обновление файла отправлено повторно',
    retryFileUpdateFailed: 'Не удалось повторить обновление файла',
    discardFileUpdate: 'Отменить ожидающее обновление',
    discardFileUpdateConfirm: 'Отменить ошибочную версию и последний ожидающий файл?',
    discardFileUpdateSubmitted: 'Ожидающее обновление отменено',
    discardFileUpdateFailed: 'Не удалось отменить ожидающее обновление',
    statusFailed: 'Ошибка',
    ...
    parseStatusReplacing: 'Замена файла',
