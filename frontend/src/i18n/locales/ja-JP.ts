export default {
  ...
  datasource: {
    ...
    connectorDesc: {
      ...
      jira: 'Jiraプロジェクトから課題とコメントを同期します',
    ...
    field: {
      ...
      jiraEdition: 'Jira エディション',
      jiraEditionServer: 'Server / Data Center',
      jiraEditionCloud: 'Cloud',
      jiraBaseUrl: 'Jira URL',
      jiraUsername: 'ユーザー名またはメールアドレス',
      jiraPassword: 'Server/DC パスワードまたは PAT',
      jiraApiToken: 'Cloud API トークン',
      jiraJql: '追加 JQL フィルタ（任意）',
      jiraJqlHint: '例: status in (Resolved, Closed) または priority = High',
      jiraIncludeComments: 'チケットのコメントを同期',
      jiraIncludeCommentsHint: '課題の解決履歴や議論コメントを含めます',
