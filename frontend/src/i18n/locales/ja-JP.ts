export default {
  ...
  knowledgeEditor: {
    ...
    wikiBrowser: {
      ...
      learningFamiliar: '習熟',
      learningExploring: '探索中',
      learningUnseen: '未学習',
      learningTitle: 'エビデンス型学習ガイド',
      learningSummary: '習熟 {familiar} · 探索 {exploring} · 未学習 {unseen}',
      learningEvidenceNote: '文書引用は対応する要約ノードのみを点灯します。上限80点で、LLMの主観評価ではありません。',
      learningNext: '次に読む',
      learningReason: '{count} 個の習熟ノードに接続',
      learningNodeScore: 'エビデンススコア {score}（上限 80）',
      learningNodeEvidence: '{sources} 件の資料から、回答での参照を {count} 回観測しました。',
