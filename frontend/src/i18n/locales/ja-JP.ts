export default {
  ...
  settings: {
    ...
    intentPolicy: {
      title: 'インテントポリシー',
      description: 'IntentGate ポリシーは、エージェントのツール呼び出しがユーザー意図と制約に合致するかを判定します。新規ポリシーは必ず observe（記録のみ・ブロックなし）から開始します。',
      empty: 'インテントポリシーはまだありません',
      wholeTenant: 'ワークスペース全体',
      riskHigh: '高リスク',
      riskLow: '低リスク',
      currentBadge: '現在',
      supersededBadge: '置き換え済み',
      scopes: {
        tool: 'ツール',
        service: 'MCP サービス',
        agent: 'エージェント',
      ...
      actions: {
        create: '新規ポリシー',
        edit: '編集',
        history: 'バージョン履歴（{count}）',
      },
      editor: {
        createTitle: 'インテントポリシーの作成',
        editTitle: 'ポリシー編集（v{version} として保存）',
      },
      form: {
        scopeType: 'スコープ',
        scopeRef: 'スコープ参照',
        constraintText: '制約（自然言語）',
        constraintPlaceholder: '例：1 回の返金は 75 を超えてはいけない',
        ruleExpr: 'ルール式（オプション）',
        ruleExprPlaceholder: '例：value <= 75 —— コンパイル可能な制約は LLM judge を完全にスキップします',
        argPath: '引数パス（オプション）',
        riskTier: 'リスク層',
        mode: 'モード',
      },
      scopeRefHints: {
        tool: 'service_id:tool_name。*:wiki_* のようなプリフィックス wildcard 可',
        service: 'MCP サービス ID',
        agent: 'エージェント ID',
      ...
      enforceConfirm: {
        title: '強制モードに切り替えますか？',
        body: 'enforce モードはポリシー違反のツール呼び出しを実際にブロックします。エージェントは拒否理由を見て自己修正できます。observe モードは判定の記録のみです。続行しますか？',
        confirm: '強制する',
      },
      toasts: {
        loadFailed: 'インテントポリシーの読み込みに失敗しました',
        enabled: 'ポリシーを有効化しました',
        disabled: 'ポリシーを無効化しました',
        toggleFailed: 'ポリシー状態の更新に失敗しました',
        created: 'ポリシーを作成しました',
        updated: '新しいバージョンを保存しました',
        saveFailed: 'ポリシーの保存に失敗しました',
        constraintRequired: '制約テキストは必須です',
        scopeRefRequired: 'このスコープ種別ではスコープ参照が必須です',
      },
    },
    versionInfo: 'バージョン情報',
    taskQueue: 'タスクキュー',
