export default {
  ...
  knowledgeBase: {
    ...
    importYoutubeTitle: 'YouTubeからインポート',
    youtubeUrlsLabel: 'YouTubeのURL（1行に1つ）',
    youtubeUrlsPlaceholder: 'https://www.youtube.com/watch?v=...\nhttps://www.youtube.com/playlist?list=...',
    youtubeUrlsTip: '動画または再生リストのリンクを1行ずつ貼り付けてください。再生リストは自動的に個々の動画に展開されます。',
    youtubeUrlsRequired: '少なくとも1つのYouTubeのURLを入力してください',
    youtubeInvalidLines: '無効なYouTube URLの行を{count}件無視しました',
    youtubeImportSubmitting: 'YouTubeからインポート中…',
    youtubeImportResult: '{success}件成功、{failed}件失敗',
    youtubeImportAllFailed: 'すべての動画のインポートに失敗しました',
    typeManual: '手動作成',
    typeFile: 'ファイル',
