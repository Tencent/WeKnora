export default {
  ...
  backup: {
    title: 'バックアップと復元',
    description: 'インスタンス全体のバックアップ:データベース、アップロードファイル、設定。システム管理者のみ利用できます。',
    privacyNotice: 'バックアップには全ワークスペースのデータと暗号化された認証情報(モデル API キーなど)が含まれます。バックアップファイルは安全に保管してください。',
    exportNow: 'バックアップをエクスポート',
    createSnapshot: 'スナップショットを作成',
    refresh: '更新',
    loading: '読み込み中…',
    empty: 'スナップショットはまだありません',
    colTime: '日時',
    colNote: 'メモ',
    colVersion: 'バージョン',
    colSize: 'サイズ',
    ...
    delete: '削除',
    restore: '復元',
    pickFile: 'バックアップファイルを選択…',
    restoreConfirmTitle: '復元しますか?',
    restoreConfirmBtn: '今すぐ復元',
    cancel: 'キャンセル',
    restoreWarning: '復元するとデータベース全体が置き換えられ(現在のデータは上書き)、復元前に自動でロールバック用スナップショットが作成されます。完了後には再起動が必要です。',
    restoreDone: '復元が完了しました。適用にはインスタンスの再起動が必要です',
    rollbackPoint: 'ロールバックスナップショット',
    restoreFailed: '復元に失敗しました',
    exportFailed: 'エクスポートに失敗しました',
    snapshotCreated: 'スナップショットを作成しました',
    snapshotFailed: 'スナップショットの作成に失敗しました',
    downloadFailed: 'ダウンロードに失敗しました',
    deleteFailed: '削除に失敗しました',
    deleted: '削除しました',
    deleteConfirm: 'スナップショット {id} を削除しますか?',
    loadFailed: '読み込みに失敗しました',
    autoPreRestore: '自動:復元前のロールバックポイント',
