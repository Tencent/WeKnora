export default {
  ...
  datasource: {
    ...
    prereqStep3Desc_feishu_links: 'wiki:wiki:readonly、drive:drive:readonly、drive:export:readonly、docx:document:readonlyの権限を有効にします',
    ...
    prereqStep3Desc_lark_links: 'wiki:wiki:readonly、drive:drive:readonly、drive:export:readonly、docx:document:readonlyの権限を有効にします',
