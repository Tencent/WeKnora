export default {
  ...
  knowledgeEditor: {
    ...
    wikiBrowser: {
      ...
      profileEmpty: 'まだ行動の証拠がありません。閲覧・引用・いいねを行うと、ここにあなたの知識プロフィールが生成されます。',
      profileExport: 'HTML を書き出す',
      profileExportSuccess: 'プロフィールを書き出しました',
      profileExportFailed: '書き出しに失敗しました',
      profileDelete: 'プロフィールを削除',
      profileDeleteConfirm: '個人の知識状態をすべて消去し、マップは初期の灰色に戻ります。ナレッジベースの内容、他のユーザー、検索のパーソナライズには影響しません。この操作は取り消せません。削除しますか？',
      profileDeleteSuccess: 'プロフィールを削除しました',
      profileDeleteFailed: '削除に失敗しました',
  ...
  agentStream: {
    ...
    like: {
      title: 'いいね',
      cancelTitle: 'いいねを取り消す',
      success: 'いいねしました',
      cancelled: 'いいねを取り消しました',
      noKnowledge: 'この回答に紐づくナレッジがないため、いいねできません'
    },
    saveToKb: {
