export default {
  ...
  settings: {
    ...
    skills: {
      ...
      upgradeDrawerDesc: '選択したサンドボックス上の{name}をカタログのバージョンにアップグレードします。再インストールが完了するまで、そのサンドボックスではこのスキルを使えません。',
      ...
      upgradeRowHint: 'このサンドボックスのバージョンはカタログと異なります。アップグレードすると再インストールされ、完了するまでこのサンドボックスではスキルを使えません。',
      upgradeRowHintVersions: 'このサンドボックスは {from}、カタログは {to} です。アップグレードすると再インストールされ、完了するまでこのサンドボックスではスキルを使えません。',
