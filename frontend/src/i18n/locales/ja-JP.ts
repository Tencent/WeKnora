export default {
  ...
  knowledgeBase: {
    ...
    urlTip: 'さまざまなWebページの内容をインポートできます。システムがWebページからテキストを自動で抽出して解析します。YouTube の動画・再生リストのリンクは字幕から取り込み、字幕がない場合は音声認識で文字起こしします',
    youtubePlaylistImporting: 'YouTube 再生リストを読み込んでいます…',
    youtubePlaylistImportSuccess: '「{title}」から {count} 本の動画をキューに追加しました',
    youtubePlaylistImportDuplicates: '{count} 本の動画は既にこのナレッジベースにあります',
    youtubePlaylistImportFailures: '{count} 本の動画を追加できませんでした',
    youtubePlaylistTruncated: 'この再生リストの最初の {count} 本の動画のみ取り込みました',
    youtubePlaylistImportFailed: 'YouTube 再生リストの取り込みに失敗しました',
    typeURL: 'URL',
    typeManual: '手動作成',
    typeFile: 'ファイル',
