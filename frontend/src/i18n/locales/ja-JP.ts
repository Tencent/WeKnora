export default {
  ...
  contextualGuide: {
    ...
    agentCreate: {
      steps: {
        ...
        name: {
          title: '名前と説明',
          desc: '分かりやすい名前を付けてください。スマート推論モードではデフォルト値が入力される場合があり、編集できます。'
        },
        navModel: {
          title: 'チャットモデルを紐付け',
  ...
  knowledgeBase: {
    ...
    tagSearchPlaceholder: '入力してタグを絞り込む',
    ...
    viewParentContext: '親チャンクの文脈を表示',
    parentContextLoadFailed: '親チャンクの文脈の読み込みに失敗しました',
    ...
    diffAddedInCurrent: '現在の内容で追加',
    diffRemovedFromCurrent: '現在の内容から削除',
    noContentChanges: '内容の変更はありません。このリビジョンではステータスのみ変更されました',
    revertRevision: 'このリビジョンに戻す',
    revertRevisionConfirm: 'v{revision}に戻しますか？新しいリビジョンが作成されます。',
  ...
  agent: {
    ...
    shareScope: {
      title: '共有範囲',
      desc: 'スペースのメンバーはこのエージェントを読み取り専用で利用し、現在の設定がそのまま適用されます。エージェントへの変更は共有先のスペースにも反映されます。スペースのメンバーにナレッジベースの内容を編集させたい場合は、ナレッジベースをスペースに共有してください。',
      knowledgeBase: 'ナレッジベース',
      chatModel: 'チャットモデル',
      rerankModel: 'リランクモデル',
      webSearch: 'Web検索',
    ...
    editor: {
      ...
      rerankModelOptionalHint: '現在の範囲にRAG型のナレッジベースがないため任意です。後からRAG型ナレッジベースを追加した場合は、ワークスペースデフォルトのリランクモデルが使用されます。明示的に設定することを推奨します。',
      ...
      skillsInfoContent: 'スキルは知識モジュールで、そのスクリプトは選択したサンドボックスで実行されます。一覧にはそこにインストール済みのスキルが表示されます。セッションのサンドボックスが作成されると、以降の添付ファイル、生成物、破棄はすべて作成時の設定に固定されるため、サンドボックスを変更しても以後の新しいセッションにのみ影響します。'
    },
    selector: {
      title: 'エージェントを選択',
      current: '現在',
  ...
  settings: {
    ...
    sandbox: {
      ...
      envKey: '名前',
      envValue: '値',
      envVarsHint: 'このワークスペースのすべてのサンドボックスに注入されます。値は保存時に暗号化されますが、サンドボックス内で実行されるスクリプトからは参照できます。',
      addRow: '変数を追加',
      removeRow: '削除',
      save: '保存',
      ...
      checkScopeConnection: '今回は制御プレーンのみを検証しました。エンドポイントは応答し、認証情報も有効です。実際にスクリプトが実行できるかどうかはまだ検証されていません。',
      ...
      skipReasons: {
        ...
        control_plane_unreachable: 'スキップ: 制御プレーンに接続できません',
      ...
      skillInstallerModel: 'インストーラーモデル',
      skillInstallerModelHint: '組み込みのインストーラーエージェントが使用します。ツール呼び出しに対応したチャットモデルを選択してください。',
      skillInstallerModelRequired: '先にインストーラーモデルを選択してください',
      skillInstallerModelSaveFailed: 'インストーラーモデルの保存に失敗しました',
      ...
      skillEnv: {
        ...
        valueTooLong: '値は{max}バイトを超えられません。'
      },
    },
    skills: {
      title: 'スキル管理',
      ...
      viewInstallProgress: '進捗を表示',
      manageOnSandbox: '「{name}」上のこのスキルを管理',
      ...
      installPartial: '一部のサンドボックスで開始しました。{failed}では開始できませんでした。',
  ...
  memorySettings: {
    ...
    trackingProgress: '{hits}回質問されました。{threshold}回で長期的な関心になります',
    ...
    consolidateSuccess: '整理しました: {merged}グループを統合し、期限切れの{expired}件をアーカイブし、古い{demoted}件のタスクを降格しました',
    ...
    emptyDescription: '会話で「...を覚えておいて」と伝えるか、上から直接追加してください。',
    kinds: {
      profile: 'あなたについて',
      preference: '好み',
      fact: '事実',
  ...
  envVarSettings: {
    ...
    skillNeedsCount: '{count}項目がここに未保存',
  ...
  auth: {
    ...
    loginSuccessContent: 'おかえりなさい。現在{name}にいます',
    loggingIn: 'ログイン中...',
    register: '登録',
    registering: '登録中...',
    ...
    workspaceOnboarding: {
      ...
      retry: '再読み込み',
      inviteOnlyTitle: 'ワークスペースへの招待を待っています',
  ...
  input: {
    ...
    agentMode: 'スマート推論',
    normalMode: 'クイック回答',
    normalModeDesc: 'ナレッジベースRAGによるQ&A',
    agentModeDesc: '多段階の思考による深い分析',
    agentMissingAllowedTools: '許可ツール',
  ...
  knowledgeList: {
    ...
    detail: {
      title: '共有ナレッジベース',
      sourceType: '取得元',
      sourceTypeKbShare: 'ナレッジベースがこのスペースに直接共有されています',
  ...
  embedPublish: {
    ...
    channelKeyUnavailable: 'キーを取得できません',
    resetKeyTitle: 'チャネルキーをリセット',
    resetKeyConfirmOk: 'リセット',
    resetKeyConfirmBody: 'リセットすると、古いチャネルキーは直ちに失効します。配置済みの埋め込みスニペットは、動作を継続するためにすべて新しいキーを使用する必要があります。この操作は取り消せません。',
    ...
    previewWidgetHint: '模擬ホストページ上でのフローティングウィジェットを表示します。実際のサイトでは、ホストがpostMessageでトークンを渡します。',
    previewMockPage: '模擬ホストページ',
    previewLoading: 'プレビューを読み込み中…',
    previewUnavailable: 'プレビューを利用できません。チャネルが有効で、Redisが利用可能であることを確認してください。',
    ...
    allowWebSearchDesc: '有効にすると、訪問者は入力欄にWeb検索ボタンが表示され、自分でオン・オフを切り替えられます。デフォルトはオフです。このボタンは、紐付けたエージェントでWeb検索が有効な場合のみ表示されます。',
  ...
  knowledgeEditor: {
    activity: {
      title: 'アクティビティ',
      description: 'このナレッジベースの重要な変更とバックグラウンドタスクの入口です。保持期間は監査ログのポリシーに従います。',
      allOutcomes: 'すべての結果',
      allActions: 'すべての操作',
      refresh: '更新',
      retry: '再試行',
      ...
      actions: {
        ...
        'knowledge.move_failed': 'ナレッジの移動が失敗',
        'tag.created': 'タグを作成',
        'tag.updated': 'タグを更新',
        'tag.deleted': 'タグを削除',
        ...
        'datasource.sync_failed': 'データソースの同期が失敗',
    ...
    wiki: {
      ...
      contentInstructionsLabel: 'Wikiコンテンツの指示',
    ...
    indexing: {
      ...
      rebuildSuccess: '{count}件のドキュメントの再構築タスクを送信しました',
    ...
    postCreateHint: {
      ...
      followUpDesc: '左側でデータソースを設定するか、共有管理からスペースに公開してください',
    },
    share: {
      description: 'ナレッジベースをスペースに共有して、メンバーが利用できるようにします',
      hintTitle: '共有に関する注意',
      addShare: '共有',
      unshareConfirm: '「{name}」への共有を解除してもよろしいですか？',
      tip1: '共有すると、スペースのメンバーは付与された権限に応じてこのナレッジベースを利用できます',
    ...
    faq: {
      ...
      indexModeDescription: '質問のみのインデックスは精度が向上し、質問＋回答のインデックスはリコールが向上します。',
      ...
      recommended: 'おすすめ',
      recommendedEnabled: 'おすすめを有効化',
      recommendedDisabled: 'おすすめを無効化',
    ...
    faqImport: {
      ...
      previewMore: '他に{count}件のエントリがあります（非表示）',
  ...
  chat: {
    ...
    memoryHint: 'これはこの回答が参照した長期メモリです。削除すると以降は使用されません。',
    ...
    referencesTitle: '関連する{count}件を参照',
    referencesDocCount: '{count}件のドキュメントを参照',
    referencesWebCount: '{count}件のWeb検索結果を参照',
  ...
  tenant: {
    ...
    switchSuccessContent: '現在は{name}にいます',
    ...
    create: {
      ...
      descriptionPlaceholder: 'このワークスペースの用途を簡単に記入してください',
      submit: '作成',
      cancel: 'キャンセル',
    ...
    globalSettings: {
      ...
      runtime: {
        ...
        queueDescriptions: {
          ...
          chat_attachment: 'セッション単位のチャットアップロードの解析',
  ...
  model: {
    modelName: 'モデル名',
    defaultTag: 'デフォルト',
    addModelInSettings: 'モデルを追加するにはグローバル設定を開いてください',
    ...
    editor: {
      ...
      ollamaNotSupportRerank: 'OllamaはReRankモデルに対応していません。リモートAPIを使用してください',
  ...
  conversationSettings: {
    ...
    maxRounds: {
      desc: 'コンテキストとクエリ書き換えのために保持する会話ターン数'
    },
    embeddingTopK: {
    ...
    enableRewrite: {
      desc: 'マルチターンのクエリを自動的に書き換え、リコールを向上させます'
    },
  ...
  modelSettings: {
    ...
    builtinModels: {
      title: '組み込みモデル',
      description: '組み込みモデルはすべてのワークスペースから利用できます。機密情報は非表示で、編集や削除はできません。',
      descriptionAdmin: '組み込みモデルはすべてのワークスペースから利用できます。システム管理者は設定と認証情報を編集できますが、削除はデプロイ側で管理されます。',
  ...
  ollamaSettings: {
    ...
    toasts: {
      ...
      progressFailed: 'ダウンロードの進捗の取得に失敗しました'
    }
  },
  mcpServiceDialog: {
  ...
  organization: {
    title: '共有スペース',
    subtitle: '共有スペースを作成または参加して、複数のワークスペースでナレッジベースやエージェントを共有し協働できます',
    createOrg: '共有スペースを作成',
    joinOrg: '共有スペースに参加',
    name: '共有スペース名',
    ...
    rbac: {
      ...
      cannotCreate: 'ワークスペースのロールの権限が不足しているため、共有スペースを作成できません',
      cannotJoin: 'ワークスペースのロールの権限が不足しているため、共有スペースへの参加や参加申請ができません',
      cannotManage: 'ワークスペースのロールの権限が不足しているため、この共有スペースを管理できません'
    },
    join: {
      title: '共有スペースに参加',
      ...
      goToOrganizations: '共有スペースへ移動',
      confirmTitle: '共有スペースへの参加の確認',
      confirm: '参加を確認',
      preview: 'プレビューして参加',
    ...
    deleteConfirmMessage: '共有スペース「{name}」を削除してもよろしいですか？すべてのメンバーが削除されます。この操作は取り消せません。',
    ...
    settings: {
      ...
      validity30Days: '30日',
      validityNever: '無期限',
      remainingValidity: '残り{n}日で期限切れ',
      remainingValidityNever: '無期限',
      remainingValidityExpired: '期限切れ',
      removeShareFromOrg: '共有スペースから削除',
      removeShareConfirm: '「{name}」をこの共有スペースから削除しますか？メンバーはこのナレッジベースにアクセスできなくなります。',
      removeAgentShareConfirm: '「{name}」をこの共有スペースから削除しますか？メンバーはこのエージェントにアクセスできなくなります。',
      removeShareSuccess: '共有スペースから削除しました',
      removeShareFailed: '削除に失敗しました。再試行してください',
      requireApproval: '承認を必須にする',
      requireApprovalDesc: '有効にすると、新しいメンバーの参加に管理者の承認が必要になります',
      searchable: '検索を許可',
      searchableDesc: '有効にすると、この共有スペースが「共有スペースに参加」の検索一覧に表示され、招待コードなしで検索・参加申請ができるようになります',
      memberLimit: 'メンバー上限',
      memberLimitDesc: '上限に達すると新しいメンバーを追加できません。0は無制限を意味します',
    ...
    editor: {
      ...
      nameTip: '識別しやすいよう、チーム名やプロジェクト名を使用してください',
    ...
    upgrade: {
      ...
      pending: '確認待ち',
      dialogTitle: '昇格を申請',
      dialogDesc: 'スペースの管理者が承認するとロールが更新されます。',
      currentRole: '現在のロール',
      selectRole: '申請するロール',
      reason: '理由（任意）',
  ...
  agentStream: {
    toolApproval: {
      ...
      titleWithTarget: '確認 · {service} › {tool}',
      argsLabel: '引数',
      argsModified: '変更あり',
    ...
    search: {
      ...
      candidatesBelowThreshold: '{count}件の候補が一致しましたが、関連性が不十分なため使用しません',
  ...
  agentEditor: {
    ...
    im: {
      ...
      yunzhijiaRobotDoc: 'ロボットメッセージのドキュメント',
      ...
      yunzhijiaSendMsgUrlHint: 'ロボットの返信に使用されます。',
      yunzhijiaSecret: '署名シークレット（任意）',
      yunzhijiaSecretPlaceholder: 'Yunzhijiaのロボット設定にあるHmacSHA1署名シークレット',
      ...
      yunzhijiaSendMsgUrlRequired: 'Yunzhijiaのロボット設定にあるメッセージ送信URLを入力してください',
      ...
      wechatRebind: '再連携',
      wechatHint: 'iOS版WeChat 8.0.70以降が必要です。ダイレクトメッセージのみ対応',
    ...
    llmCallTimeout: {
      label: 'LLM呼び出しタイムアウト',
      desc: 'LLMの1回の呼び出しの最大待機時間（秒）。この時間を超えると呼び出しは終了されます',
    ...
    imageUpload: {
      ...
      imageUnderstandingLabel: '添付画像の理解 / スキャンOCR',
    ...
    chatParser: {
      ...
      waitTimeoutDesc: '解析中の添付ファイルを待ってから、完了したものだけで会話を続行するまでの時間です。大きなファイルやスキャンしたドキュメントでは長めに設定してください。0でグローバルのデフォルトを使用します。'
    },
    faq: {
      title: 'FAQ優先戦略',
  ...
  datasource: {
    ...
    guideStep2_notion: '右上の「···」メニューをクリックし、「接続先」または「コネクトを追加」を選択します',
    ...
    syncDeletions: '削除を同期（同期元で削除されたナレッジを削除する）',
  ...
  integrations: {
    ...
    api: {
      ...
      createApiKeyDialogDesc: 'このキーで利用できる機能とナレッジベースの範囲を選択します。',
      noApiKeys: 'APIキーがありません',
      apiKeyName: '名前',
      apiKeyValue: 'APIキー',
      apiKeyNamePlaceholder: '例: MCP読み取り専用アクセス',
      apiKeyNameRequired: 'APIキー名を入力してください',
      apiKeyCapabilitiesRequired: '範囲指定のAPIキーには機能を1つ以上選択してください',
      ...
      capabilityIngestHint: '許可されたナレッジベースにコンテンツを書き込めます（ドキュメントのアップロード、チャンク・FAQ・タグ・Wikiの編集）。ナレッジベースやエージェントの作成、ナレッジベースの全削除はできず、選択したナレッジベースの範囲に限定されます。',
    ...
    boundAgent: 'バインド中のエージェント',
    filterByAgent: 'エージェントで絞り込む',
    filterByAgentWithName: 'エージェントで絞り込む: {name}',
    ...
    claw: {
      ...
      capabilities: {
        ...
        search: {
          title: 'ハイブリッド検索',
          desc: 'ベクトルとキーワードのリコールを組み合わせた、ナレッジベース単位のハイブリッド検索とナレッジベース横断検索。'
        },
        browse: {
          title: 'ナレッジの閲覧',
  ...
  tenantMember: {
    ...
    loading: 'メンバーを読み込み中…',
    retry: '再試行',
    empty: 'メンバーがいません。まずはメンバーを招待しましょう。',
    ...
    remove: {
      button: '削除',
      confirmBody: '{name}をこのワークスペースから削除してもよろしいですか？すぐにアクセスできなくなります。',
      confirm: '削除',
      success: 'メンバーを削除しました'
    },
    leave: {
  ...
  tenantInvitation: {
    ...
    confirmInviteBody: '{email}に招待を送信します（ロール: {role}）。承諾後にワークスペースへ参加します。',
    confirmSend: '送信',
    copyLink: '招待リンクをコピー',
    copied: 'クリップボードにコピーしました',
    ...
    shareLink: {
      ...
      resultBody: '下のリンクをコピーして、任意のプライベートなチャネルで共有してください。リンクは一覧にも保存されるため、後から再コピーや取り消しができます。',
  ...
  platformApiKeys: {
    title: 'プラットフォームAPIキー',
    description: 'ワークスペース横断の自動化のためのプラットフォーム認証情報を作成します。ワークスペースAPIにはX-Tenant-IDを使用します。',
    securityNotice: 'プラットフォームAPIキーは任意のワークスペースを対象にできます。必要な機能のみを付与してください。平文は一度だけ表示されます。',
    create: 'プラットフォームAPIキーを作成',
    createDescription: 'プラットフォームキーは特定のワークスペースに紐づきませんが、機能設定によりすべての操作が制限されます。',
    loading: '読み込み中…',
    ...
    viewAllCapabilities: 'すべての機能を表示',
    capabilityHint: 'ワークスペース機能はX-Tenant-IDで指定した対象に適用され、システム機能はコントロールプレーンAPIに適用されます。',
    lastUsed: '最終使用',
    createdAt: '作成日時',
    actions: '操作',
    never: '未使用',
    ...
    nameRequired: '名前を入力してください',
    capabilityRequired: '機能を1つ以上選択してください',
