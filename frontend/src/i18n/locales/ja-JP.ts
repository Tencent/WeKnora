export default {
  sandboxBrowser: {
    ...
    unavailableHint: "このサンドボックスはブラウザスキルに対応していません。対応する設定を選択してください。",
    reconnectHint: "ブラウザとの接続が切れました。起動を再試行できます。",
      ...
      "release": "操作権を返す",
      "takeControl": "操作を引き継ぐ",
      "previewHint": "プレビューは2秒ごとに更新されます。引き継ぎ中はエージェントが待機し、パネルを閉じると操作権を返します。",
      "address": "ページのURL",
      "go": "移動",
      "viewport": "サンドボックスのブラウザープレビュー",
      "emptyHint": "ブラウザは未起動です。下のボタンでこのセッションのサンドボックスとブラウザを起動します。",
      "start": "ブラウザーを起動",
      "textHint": "ページの入力欄を選択してから、ここに文字を入力",
      "insert": "入力",
      "commandFailed": "ブラウザー操作に失敗しました"
  },
  skillDiscovery: {
    cardBuiltins: "内蔵スキル",
    cardInstalled: "ユーザーがインストール",
    cardUnknown: "内蔵情報は不明",
    cardNone: "なし",
    cardLoadFailed: "インストール情報を取得できません",
    cardIncompatible: "ほか {count} 件はバージョン不一致",
    cardCollapse: "折りたたむ",
    cardExpand: "すべてのスキルを表示",
    cardDisabled: "無効",
    cardAvailabilityUnknown: "利用可否は不明",
    cardNotInImage: "現在のイメージでは利用不可",

    canInstallManually: "内蔵を確認できません・手動インストール可能",
    alreadyInstalled: "同名のスキルをインストール済み",
    preinstalledShort: '導入済み',
    preinstalledOnName: '導入済み · {name}',
    preinstalledSandboxCount: '{count} 個のサンドボックスに導入済み',
    alreadyPreinstalled: "内蔵済み・すぐに利用可能",
    checkingPreinstalled: "内蔵情報を読み込み中…",
    includedWithTemplate: "テンプレートに内蔵",
    invalidManifest: "宣言の形式が無効です。提供元のスキル一覧 JSON を選択してください。",
    clearManifest: "宣言を削除",
    importManifest: "宣言を読み込む",
    cloudManifestHint: "クラウドがスキル一覧を返さない場合、イメージの提供元の宣言を読み込めます。現在のテンプレートのバージョンに紐付けてメタデータだけを保存します。",
    preinstalledUnknown: "内蔵情報は不明です。サンドボックスの起動や自動インストールは行いません。",
    preinstalledMismatch: "一部のスキルは現在のアプリのバージョンと一致しないため利用できません。",
    ...
    activationTitle: "「{name}」を使うサンドボックス設定を選択",
    activate: "サンドボックスで有効化",
    activationHint: "選択したサンドボックスにだけインストールします。内蔵済みの場合、追加のインストールは不要です。",
    activationAccepted: "スキルを有効化しています",
      "localBrowser": "ローカルブラウザー · 拡張機能が必要",
      "title": "スキルを探す",
      "mySkills": "マイスキル",
      "search": "スキル・用途・提供元を検索",
      "runtimeHint": "内蔵テンプレートではすぐに使えます。別のサンドボックスにもここからインストールできます。",
      "retry": "再試行",
      "builtins": "組み込みスキル",
      "recommended": "おすすめ",
      "builtinHint": "Office、データ分析、ブラウザのスキル。内蔵テンプレートを使用するか、別のサンドボックスにインストールできます。",
      "externalHint": "外部提供元の参考リンクです。コードの同梱、サンドボックスへのインストール、指示の自動注入は行いません。",
      "linkOnly": "外部リンク",
      "source": "提供元を見る",
      "manage": "既存スキルを管理",
      "add": "スキルを有効化",
      "officialGuide": "公式ガイド",
      "noResults": "該当するスキルがありません",
      "loadFailed": "スキルを読み込めませんでした",
      "addFailed": "スキルを追加できませんでした",
      "migrateTitle": "旧サンドボックスの更新",
      "migrateHint": "新しいイメージの設定を作成し、元のバージョンでスキルを移行します。",
      "migrate": "スキルを移行",
      "migrateDetails": "先にサンドボックス設定で新しいイメージを使う設定を作成してください。元のアーカイブを検証して移行先にインストールし、移行元と既存の会話は保持します。完了後、エージェント設定で新しい設定を選び、新しい会話で検証してください。",
      "configureSandbox": "サンドボックス設定を開く",
      "sourceSandbox": "移行元の設定",
      "targetSandbox": "新しい設定",
      "preview": "移行内容を確認",
      "startMigration": "移行可能なスキルを移行",
      "readyToMigrate": "元のアーカイブを検証済み",
      "noSkillsToMigrate": "移行元にスキルがありません",
      "migrationStarted": "{count} 件のインストールを開始しました。マイスキルで進行状況を確認できます。新しい設定の認証情報とユーザー環境変数は別途確認してください。",
      ...
      "blockers": {
          "source_not_ready": "移行元のインストールが未完了です",
          "source_disabled": "移行元で無効のため、有効化しません",
          "target_name_conflict": "移行先の同名スキルを保持します",
          "missing_digest": "旧レコードにハッシュがありません。元のアーカイブを追加してください",
          "missing_original_archive": "元のアーカイブがありません。最新版には置き換えません"
      }
  },
  menu: {
  ...
  agent: {
    ...
    editor: {
      ...
      skillsConfig: 'スキル',
      skillsConfigDesc: 'サンドボックスを選び、使用するスキルを選択します。プリインストール済みのスキルはそのまま使えます。',
      skillsSelection: 'スキル一覧',
      skillsSelectionDesc: '利用可能なスキルには、プリインストール済みと追加インストール済みのものが含まれます。',
      skillsAll: 'すべて',
      skillsSelected: '選択中',
      skillsNone: '無効',
      selectSkills: 'スキルを選択',
      selectSkillsDesc: 'このエージェントで使うスキルを選択します。プリインストール済みのスキルは再インストール不要です。',
      skillsAllListHint: 'このサンドボックスで利用可能なプリインストール済み・追加インストール済みスキルをすべて使用します。',
      skillsGroupAvailable: '利用可能',
      skillsGroupUnavailable: '利用不可',
      noSkillsAvailable: 'このサンドボックスには利用可能なスキルがなく、カタログも空です。',
