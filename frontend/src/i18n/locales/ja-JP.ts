export default {
  learning: {
    newPractice: '新しい練習', previousPractice: '前回の練習', yourAnswer: 'あなたの回答',
    tools: {
      profile: '学習の概要', profileDesc: 'ワークスペース所有の Wiki ナレッジベースで個人の学習概要を確認します。',
      recommend: '練習を推薦', recommendDesc: '練習履歴と参照元のある Wiki ページに基づいてトピックを推薦します。',
      quiz: '練習クイズを準備', quizDesc: '参照元に基づくクイズを作成します。回答は学習パネルからのみ送信できます。',
    },
    title: 'ガイド付き学習', consent: '個人の学習履歴', enabled: 'オン', disabled: 'オフ',
    overview: '学習の概要', topicCount: '{count} トピック', recommendations: 'おすすめの練習',
    noRecommendations: 'おすすめはまだありません', practice: '練習', startPractice: 'このページを練習',
    openPage: 'ページを開く', pending: 'クイズは待機中です', running: 'クイズを準備中', cancelPolling: '待機を停止',
    paused: '状態の確認を一時停止しました', checkAgain: '再確認', failed: 'クイズの準備に失敗しました',
    sourceStale: '参照元が変更されました。新しいクイズが必要です。', regenerate: '新しいクイズを作成',
    refresh: '更新', retry: '再試行', submit: '回答を送信', retryAnswer: '送信を再試行',
    correct: '正解', incorrect: '不正解', correctAnswer: '正しい回答', answered: '回答済み',
    source: '参照元 {index}', noQuestions: '問題がありません',
    familiar: '接触済み', familiarTooltip: '閲覧や参照元の利用は接触を示すもので、習得を意味しません。',
    masteryLegend: '評価済みの回答に基づく習得状況',
    masteryTooltip: '評価済みの回答：{count} 件。モデルの推定値：{probability}%（未較正）。',
    privacy: '学習データ', exportKB: 'このナレッジベースをエクスポート（JSON）', exportAll: 'すべての学習データをエクスポート（JSON）',
    clearKB: 'このナレッジベースの記録を削除', clearAll: 'すべての学習データを削除', clearTitle: '学習データを削除しますか？',
    clearKBConfirm: 'このナレッジベース内のあなたの練習履歴、クイズ、習得状況を完全に削除しますか？',
    clearAllConfirm: 'このワークスペース内のあなたの練習履歴、クイズ、習得状況をすべて完全に削除しますか？',
    confirmClear: '完全に削除', cancel: 'キャンセル',
    cleared: '回答 {attempts} 件、トピック記録 {topics} 件、クイズ {quizzes} 件を削除しました。',
    states: { unseen: '未評価', learning: '学習中', mastered: '習得済み', review_due: '復習時期' },
    reasons: {
      practice: '練習が必要', source_changed: '参照元が変更', source_backed: '参照元の裏付けあり', explore: '新しいトピックの探索',
      review_due: '復習の時期', review_need: '復習が必要', graph_frontier: '関連トピック',
      interest_match: '興味に一致', content_quality: '参照元の品質',
      cold_start: '最初のトピック', exploration: '新しいトピックの探索', related_topic: '関連トピック',
    },
    errors: {
      request: '学習データを読み込めませんでした。', unavailable: 'この状況では学習機能を利用できません。',
      disabled: '学習機能はオフです。', notFound: 'この学習項目は利用できなくなりました。',
      stale: '参照元が変更されました。新しいクイズを作成してください。', conflict: 'この回答は送信済みです。更新すると保存された結果を確認できます。',
      busy: '学習サービスが混雑しています。しばらくしてから再試行してください。', evidence: 'クイズの作成に必要な検証済みの根拠が不足しています。',
      notReady: 'クイズの準備がまだ完了していません。',
    },
  },
  menu: {
