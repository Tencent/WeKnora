export default {
  ...
  localBrowser: {
    ...
    "storeInstall": "Chrome ウェブストアへ",
    "manualInstall": "手動インストール（代替手段）",
    "storeInstallHint": "Chrome ウェブストアから BrowserSkill をインストールし、ここに戻ってペアリングしてください。",
  ...
  knowledgeBase: {
    ...
    channelFeishuLinks: 'Feishuリンク',
    channelLarkLinks: 'Larkリンク',
  ...
  settings: {
    ...
    sandbox: {
      ...
      terminalIdleDisconnect: 'ターミナル / デスクトップのアイドル切断（秒）',
      terminalIdleDisconnectHelp: 'ターミナルまたはデスクトップを開いた後、この時間だけ操作がなければ接続を切断し、サンドボックスはTTLに従って一時停止します。ターミナルはキーボードとPTY出力、デスクトップはマウスとキーボードを見ます。空欄の場合は900秒、最短60秒、最長24時間です。',
      envVars: '環境変数',
      envKey: '名前',
      envValue: '値',
  ...
  datasource: {
    ...
    guideStep1_feishu_links: '同期するFeishuドキュメントを開き、共有 → 共同編集者を追加でアプリを検索して追加し、権限を「閲覧可能」にします',
    guideStep2_feishu_links: 'ドキュメントのリンクをコピーします（Wiki copylink または /docx/ どちらでも可）',
    guideStep3_feishu_links: 'リンク一覧に貼り付けて「リンクを解析」をクリックします',
    guideStep1_lark_links: '同期するLarkドキュメントを開き、共有 → 共同編集者を追加でアプリを検索して追加し、権限を Can view にします',
    guideStep2_lark_links: 'ドキュメントのリンクをコピーします（wiki copylink または /docx/ どちらでも可）',
    guideStep3_lark_links: 'リンク一覧に貼り付けて「リンクを解析」をクリックします',
    ...
    connector: {
      ...
      feishu_links: 'Feishuリンクリスト',
      lark_links: 'Larkリンクリスト',
      notion: 'Notion',
    ...
    connectorDesc: {
      ...
      lark_drive: 'Lark Driveのフォルダからドキュメント、スプレッドシート、ファイルを同期します（Feishu国際版）',
      feishu_links: 'ドキュメントURLからFeishu Wikiまたはクラウドドキュメントの個別ページを同期します',
      lark_links: 'ドキュメントURLからLark Wikiまたはクラウドドキュメントの個別ページを同期します（Feishu国際版）',
    ...
    links: {
      title: 'ドキュメントリンク',
      hint: '1行に1つのFeishuドキュメントURLを入力します。ボットはその文書の閲覧または編集権限が必要です。同期するのはリンク先の文書のみで、WikiツリーやDriveフォルダは取り込みません。',
      placeholder: 'https://xxx.feishu.cn/wiki/...\nhttps://xxx.feishu.cn/docx/...',
      parse: 'リンクを解析',
      urlsRequired: 'FeishuドキュメントのURLを1つ以上貼り付けてください',
      noneResolved: '同期できるドキュメントがありません。リンクとアプリの閲覧権限を確認してください',
      deduped: '重複リンクを{n}件削除しました',
      resolvedCount: '{n}件のドキュメントを解析しました',
      error: {
        wiki_space: 'これはWikiスペースのリンクです。「Feishu」データソースを使うか、個別の /wiki/ ドキュメントリンクを貼り付けてください',
        drive_folder: 'これはDriveフォルダのリンクです。「Feishu Drive」データソースを使ってください',
        unrecognized: '認識できないリンクです。Feishuの /wiki、/docx、/docs、/sheets、/base、または /file リンクを貼り付けてください',
        unsupported_type: 'このドキュメント種類は未対応です（マインドノート、スライドなど）',
        no_permission: 'アプリがこのドキュメントを読めません。Feishuでアプリを共同編集者に追加してください（閲覧可能で十分です）',
        not_found: 'ドキュメントが存在しないか、削除されています',
        resolve_failed: '解析に失敗しました。リンクとアプリ権限を確認してください',
      },
    },
    field: {
      clientId: 'Client ID',
    ...
    prereqBarText_feishu_links: '初めてですか？クリックしてFeishuアプリの設定ガイドを表示',
    prereqStep1Brief_feishu_links: 'Feishuのカスタムアプリを作成',
    prereqStep1Desc_feishu_links: 'Feishuオープンプラットフォームにログイン → 企業向けカスタムアプリを作成',
    prereqStep2Brief_feishu_links: 'ボット機能を追加',
    prereqStep2Desc_feishu_links: 'オープンプラットフォーム → 対象アプリ → アプリ機能を追加 → ボット',
    prereqStep3Brief_feishu_links: 'アプリの権限を設定',
    prereqStep3Desc_feishu_links: 'wiki:wiki:readonly、drive:drive.metadata:readonly（または drive:drive）、drive:drive:readonly、drive:export:readonly、docx:document:readonlyの権限を有効にします',
    prereqBarText_lark_links: '初めてですか？クリックしてLarkアプリの設定ガイドを表示',
    prereqStep1Brief_lark_links: 'Larkのカスタムアプリを作成',
    prereqStep1Desc_lark_links: 'Larkオープンプラットフォームにログイン → 企業向けカスタムアプリを作成',
    prereqStep2Brief_lark_links: 'ボット機能を追加',
    prereqStep2Desc_lark_links: 'オープンプラットフォーム → 対象アプリ → アプリ機能を追加 → ボット',
    prereqStep3Brief_lark_links: 'アプリの権限を設定',
    prereqStep3Desc_lark_links: 'wiki:wiki:readonly、drive:drive.metadata:readonly（または drive:drive）、drive:drive:readonly、drive:export:readonly、docx:document:readonlyの権限を有効にします',
