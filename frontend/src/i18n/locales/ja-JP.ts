export default {
  ...
  settings: {
    ...
    sandbox: {
      ...
      templateLoadHint: 'クラスタの接続情報を入力して更新してください。公式のCLIまたはデスクトップテンプレートがない場合はHubイメージから自動構築します。DNSやイメージを変更した場合は、該当カードから再構築してください。',
      ...
      templateStepHint: 'このステップではクラスタのテンプレートを表示し、公式のCLIおよびデスクトップイメージがなければHubから構築します。DNSやイメージを変更した場合は該当カードから「再構築」してください。テンプレートの準備ができたら次へ進めます。',
