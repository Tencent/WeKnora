export default {
  workbench: {
    ...
    states: { bound: '関連付け済み', ready: '準備完了', available: '利用可能', disabled: 'ワークベンチは無効です', unbound: 'サンドボックス未設定', policy_denied: 'ワークスペースのポリシーにより拒否されました', unavailable: 'ワークベンチを利用できません', unsupported: '未対応のサンドボックス' },
