export default {
  ...
  knowledgeBase: {
    ...
    invalidURLsSkipped: '無効なリンク {count} 件をスキップしました',
    urlImportSuccess: 'URLをインポートしました。',
    urlImportFailed: 'URLのインポートに失敗しました。',
    urlExists: 'このURLは既に存在します',
    urlLabel: 'URLアドレス',
    urlPlaceholder: '1 行に 1 つずつ Web ページのリンクを入力してください。例:\nhttps://example.com/article',
    urlTip: 'Web ページのリンクを 1 行に 1 つずつ複数貼り付けられます。各ページのテキストを自動で抽出して解析します。YouTube の動画や再生リストは「YouTube から取り込む」を使用してください',
    youtubeImporting: 'YouTube リンク {count} 件を取り込んでいます…',
    youtubeImportSuccess: 'YouTube 動画 {count} 本をキューに追加しました',
    youtubeImportDuplicates: '{count} 本の動画は既にこのナレッジベースにあります',
    youtubeImportFailures: '{count} 件のリンクまたは動画を取り込めませんでした',
    youtubeImportTruncated: '1 回の取り込み上限に達したため、先頭の動画のみ取り込みました',
    youtubeImportFailed: 'YouTube の取り込みに失敗しました',
    importYouTube: 'YouTube から取り込む',
    importYouTubeTitle: 'YouTube から取り込む',
    youtubeUrlLabel: 'YouTube リンク',
    youtubeUrlPlaceholder: '1 行に 1 つずつ YouTube リンクを入力してください。例:\nhttps://www.youtube.com/watch?v=VIDEO_ID\nhttps://www.youtube.com/playlist?list=PLAYLIST_ID',
    youtubeUrlTip: 'YouTube の動画・再生リストのリンクのみ対応しています。1 行に 1 つずつ貼り付けてください。各動画は個別のドキュメントになり、各再生リストは再生リスト名のフォルダに取り込まれます。&list= を含む動画リンクはその動画のみを取り込むため、再生リスト全体は再生リストのリンクを使用してください。字幕を優先し、字幕がない場合はナレッジベースの音声認識モデルで音声を文字起こしします',
    noYouTubeURLs: 'YouTube の動画または再生リストのリンクを 1 つ以上入力してください',
    nonYouTubeURLsSkipped: 'YouTube リンクではない {count} 行をスキップしました',
    typeURL: 'URL',
    typeManual: '手動作成',
    typeFile: 'ファイル',
  ...
  uploadConfirm: {
    ...
    urlItemLabel: 'URL',
    urlAdded: 'URLを追加しました',
    urlsAdded: '{count} 件の URL を追加しました',
