export default {
  ...
  agentStream: {
    ...
    skillCards: {
      ...
      temporaryNotice: '{name} はこの会話のサンドボックスに一時的に読み込まれただけで、ワークスペースにはインストールされていません。スキル一覧には表示されず、ほかの会話では使えず、サンドボックスが再構築されると消えます。',
      temporaryNoticeUnnamed: 'このスキルはこの会話のサンドボックスに一時的に読み込まれただけで、ワークスペースにはインストールされていません。スキル一覧には表示されず、ほかの会話では使えず、サンドボックスが再構築されると消えます。',
      official: '公式',
