export default {
  ...
  knowledgeBase: {
    ...
    folderTree: {
      ...
      deleteConfirmBody: '「{name}」とサブフォルダ内の{count}件のドキュメントを削除しますか？この操作は元に戻せません。',
      deleteConfirm: '削除',
      deleting: '削除中',
      deleteSubmitted: 'フォルダの削除を開始しました',
      deleteSuccess: 'フォルダを削除しました',
      deleteFailed: 'フォルダを削除できませんでした',
    },
    moveToFolder: {
      action: 'フォルダに移動',
      newFolder: '新しいサブフォルダ',
  ...
  chat: {
    ...
    sandbox: {
        ...
        filesTitle: 'サンドボックスのライブファイル',
        filesBreadcrumbs: '現在のフォルダー',
        filesRoot: '出力',
        filesUpload: 'ファイルをアップロード',
        filesRefresh: '更新',
        filesLoading: 'ファイルを読み込み中…',
        filesEmpty: 'このフォルダーは空です',
        filesDirectory: 'フォルダー',
        filesDownload: 'ダウンロード',
        filesRename: '名前を変更',
        filesDelete: '削除',
        filesDeleteConfirm: '{name} を削除しますか？この操作は取り消せません。',
        filesInvalidName: 'パス区切り文字を含まないファイル名を入力してください',
        filesLoadFailed: 'サンドボックスのファイルを読み込めません',
        filesDownloadFailed: 'ダウンロードに失敗しました',
        filesUploadComplete: 'アップロードが完了しました',
        filesUploadFailed: 'アップロードに失敗しました',
        filesRenameFailed: '名前の変更に失敗しました',
        filesDeleteFailed: '削除に失敗しました',
        filesPaused: 'サンドボックスは一時停止中です。ファイルを閲覧する前にターミナルから起動してください。このパネルは課金を避けるため自動では再開しません。',
        filesTooLarge: 'ファイルが 16 MiB の上限を超えています',
        filesTooMany: 'フォルダーの項目が多すぎて一覧表示または削除できません',
