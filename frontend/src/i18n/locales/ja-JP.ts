export default {
  ...
  evaluationSettings: {
    navLabel: 'RAG評価',
    title: 'RAG評価',
    description: '再現可能な評価を実行し、品質、所要時間、トークン、キャッシュ、コストを比較します。',
    refresh: '更新', newRun: '新しい評価',
    newRunHint: 'データセットを固定し、一度に1つの変数だけを変更して指標変化の原因を明確にします。',
    dataset: 'データセット', knowledgeBase: 'ナレッジベース', chatModel: 'チャットモデル', rerankModel: 'リランクモデル',
    autoSelect: 'システム既定値を使用', adminOnly: 'Viewerは結果を閲覧できます。評価の開始にはAdmin権限が必要です。',
    start: '評価を開始', reset: '条件をリセット', chatRequired: '再現可能な比較のため、チャットモデルを明示的に選択してください。', comparison: '実行結果を比較',
    comparisonHint: '最初の実行をベースラインとして、最大{count}件のモデルまたは設定を比較できます。',
    comparable: '比較可能性チェックに合格しました。チャットモデル以外のデータセット、ナレッジベース、チャンク設定、パイプライン、依存モデルが一致しています。',
    comparabilityUnknown: '完全なスナップショットがない実行があるため、比較可能性を確認できません。', datasetDiffers: 'データセットの内容が異なります。',
    knowledgeBaseDiffers: '参照元のナレッジベースが異なります。', chunkingDiffers: 'チャンク設定が異なります。',
    pipelineDiffers: '検索または生成パイプラインの設定が異なります。', modelDependencyDiffers: '埋め込みモデルまたはリランクモデルが異なります。',
    clear: 'クリア', metric: '指標', base: 'ベースライン', candidate: '候補', delta: '差分',
    duration: 'エンドツーエンド所要時間', cacheHitRate: 'キャッシュヒット率', cost: '推定コスト',
    history: '評価履歴', historyHint: '成功した実行を2～4件選択し、バージョンまたは複数モデルを比較します。',
    total: '全{count}件', pageStatus: '{current} / {total} ページ', empty: '評価の実行履歴はありません。', selectCompare: '比較対象に選択',
    exportEvidence: '証拠をエクスポート', exportSucceeded: '証拠レポートをダウンロードしました。', exportFailed: '証拠レポートのエクスポートに失敗しました。',
    repeatSummary: '反復実行の集計', repeatSummaryHint: 'コード、データ、設定、ナレッジベース、モデルの指紋、呼び出し負荷が完全に一致する成功実行のみを集計します。',
    repeatCount: '一致する実行 {count} 件', medianRecall: 'Recall中央値', medianDuration: '所要時間中央値', p95Duration: '所要時間P95',
    medianTokens: 'トークン中央値', medianCacheHitRate: 'キャッシュヒット率中央値', medianCost: 'コスト中央値', latencyDistribution: '所要時間の中央値とP95の比較', medianShort: '中央値',
    modelValue: 'モデル：{value}', knowledgeBaseValue: 'ナレッジベース：{value}', defaultConfiguration: 'システム既定の設定', unknownValue: '不明',
  ...
  modelSettings: {
    ...
    usage: {
      ...
      tokens: 'トークン',
      cache: 'キャッシュ',
      cacheHitRate: 'キャッシュトークンヒット率',
      cacheCoverage: 'レポート対象率',
      estimatedCost: '推定コスト',
      unpriced: 'このモデルにはトークン単価が設定されていません',
      costUnknown: 'コスト不明',
      range: '利用期間',
      range24h: '過去24時間',
      range7d: '過去7日間',
      range30d: '過去30日間',
      rangeAll: '保持されている全データ',
      details: '用途別詳細',
      hideDetails: '詳細を閉じる',
      partial: '一部のみ価格設定済み',
      partialCost: '単価が設定された呼び出しのみを含み、総コストではありません',
      embeddingCache: 'ベクトルキャッシュ',
      embeddingCacheHint: 'メモリまたは永続キャッシュから直接取得された埋め込み入力の割合',
      embeddingAvoided: '回避した計算',
      embeddingAvoidedHint: 'キャッシュヒットとバッチ内重複排除によって回避された埋め込み計算',
      wikiSummary: 'Wiki集計',
      loading: 'モデル利用状況を更新中…',
      loadFailed: 'モデル利用状況を読み込めませんでした。モデル設定には影響しません。',
      retry: '再試行',
      noData: '選択した期間にはモデル呼び出しまたはベクトルキャッシュのデータがありません。',
      purposes: {
        unspecified: '用途未指定',
        knowledge_qa: 'ナレッジベースQ&A',
        query_rewrite: 'クエリリライト',
        document_summary: 'ドキュメント要約',
        document_auto_tag: 'ドキュメントの自動タグ付け',
        question_generation: '質問生成',
        data_analysis_plan: 'データ分析計画',
        entity_extraction: 'エンティティ抽出',
        wiki_page_modify: 'Wikiページ更新',
        wiki_chunk_citation: 'Wikiチャンク引用',
        wiki_candidate_slug: 'Wikiページスラッグ',
        wiki_summary: 'Wiki要約',
        wiki_knowledge_extract: 'Wikiナレッジ抽出',
        wiki_taxonomy_plan: 'Wiki分類計画',
        wiki_deduplication: 'Wiki重複排除',
        wiki_index_intro: 'Wikiインデックス紹介',
        wiki_generation: 'Wikiコンテンツ生成'
      }
    },
    actions: {
      addModel: 'モデルを追加',
