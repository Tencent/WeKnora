export default {
  ...
  pluginAdmin: {
    ...
    audience: {
      owned: 'スペース {tenant} が登録した独自プラグインで、そのスペースだけに表示されます。',
      title: '公開範囲',
  ...
  pluginCenter: {
    own: {
      ...
      notice: '登録後はこのスペースだけに表示され、このスペースで自動的に有効になります。リモートプラグインのみで、ページは追加できません。',
      tag: 'このスペース',
      manage: '管理',
      update: 'パッケージを更新',
      editUrl: 'サービス URL を変更',
      urlTitle: 'サービス URL を変更',
      remove: '削除',
      removeConfirm: 'このプラグインを削除しますか？連携はすぐに使えなくなります。',
      removed: 'プラグインを削除しました',
  ...
  system: {
    ...
    globalSettings: {
      ...
      keyLabels: {
        ...
        tenant: {
          plugin_remote_enabled: 'スペース独自のプラグイン登録を許可',
      ...
      keyDescriptions: {
        ...
        tenant: {
          plugin_remote_enabled: 'スペース管理者が独自のリモートプラグイン（自社サーバーで動作、ページなし、そのスペースのみ表示）を登録できるかどうか。オフにすると新規登録・更新はできず、登録済みのものは動作し続けます。すぐに反映されます。',
