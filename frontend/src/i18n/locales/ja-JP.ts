export default {
  ...
  integrations: {
    ...
    api: {
      ...
      kbPermissionPerKB: "ナレッジベース別",
      kbPermissionUniform: "一括権限",
      kbPermissionHint: "権限はキーの機能と現在の共有権限によって制限されます。共有KBの管理権限に所有権や共有設定の変更は含まれません。",
      kbPermissionSelect: "所有または共有ナレッジベースを選択",
      kbPermissionEmpty: "ナレッジベースへのアクセスなし",
      kbPermissionRead: "読み取り・検索",
      kbPermissionWrite: "読み取り・内容の書き込み",
      kbPermissionManage: "ナレッジベース管理",
      kbPermissionOwn: "現在のワークスペース",
      kbPermissionUnavailable: "利用不可または共有解除済み。保存前に削除してください。",
      kbPermissionUniformHint: "選択した所有KBに同じ機能を適用します。未選択の場合は従来の無制限の範囲を維持します。共有KBには個別の権限を設定してください。",
      kbPermissionLoadFailed: "一部のKBを読み込めませんでした。権限変更前に再試行してください。",
