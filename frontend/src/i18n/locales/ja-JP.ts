import { evaluationFlowJa as evaluationFlow } from '../evaluationFlow'
...
export default {
  ...
  modelSettings: {
    ...
    "observability": {
      "cachePricingTitle": "キャッシュトークンの料金（任意）",
      "cacheReadPrice": "キャッシュ読み取り／100 万トークン",
      "cacheWrite5mPrice": "キャッシュ書き込み・5 分／100 万トークン",
      "cacheWrite1hPrice": "キャッシュ書き込み・1 時間／100 万トークン",
      "cachePricingHint": "料金が不明な場合は空欄、無料の場合は 0 を入力してください。基本の入出力料金と同じ単位を使用します。",
      "unknownPrice": "不明",
      "callStatus": "呼び出しの状態",
      "started": "開始済み",
      "success": "成功",
      ...
      "canceled": "キャンセル済み",
      "title": "モデルの使用量と料金",
      "description": "プロバイダー呼び出し、費用、遅延、プロバイダーとアプリケーションそれぞれのキャッシュ率を確認します",
      "days": "日",
      "empty": "この期間に記録されたモデル使用量はありません",
      "calls": "プロバイダー呼び出し数",
      "tokens": "総トークン数",
      "latency": "平均遅延",
      "unpriced": "料金未設定の呼び出し数",
      "providerCache": "プロバイダーのプロンプトキャッシュ",
      "applicationCache": "アプリケーションの埋め込みキャッシュ",
      "providerDenominator": "観測されたトークン数：{value}",
      "nameUnavailable": "名前を取得できません",
      "applicationDenominator": "観測されたキー数：{value}・対象外：{bypass}",
      "noPricedCost": "料金設定済みの費用なし",
      "pricingTitle": "変更不能な料金バージョン",
      "pricingDescription": "入出力それぞれ 100 万トークンあたりの料金を通貨単位で指定します。選択した日時から適用されます。",
      "selectModel": "モデルを選択",
      "inputPrice": "入力／100 万トークン",
      "outputPrice": "出力／100 万トークン",
      "currency": "通貨",
      "validTo": "終了日時（任意）",
      "addPrice": "バージョンを追加",
      "loadFailed": "モデル使用量を読み込めませんでした",
      "priceLoadFailed": "料金バージョンを読み込めませんでした",
      "priceSaved": "料金バージョンを追加しました",
      "priceSaveFailed": "料金バージョンを追加できませんでした",
      "allModels": "すべてのモデル",
      "customRange": "期間を指定",
      "from": "開始",
      "to": "終了",
      "timezoneHint": "日時は端末のローカルタイムゾーンで表示・入力します。",
      "invalidRange": "有効な開始日時と終了日時を選択してください。終了は開始より後にしてください。",
      "recordedCost": "記録された費用",
      "accountedCalls": "完全に計上された呼び出し：{complete} / {total}",
      "validFrom": "適用開始日時",
      "openEnded": "終了日時なし",
      "invalidPriceDates": "有効な適用開始日時を入力してください。終了は開始より後にしてください。",
      "invalidCurrency": "USD など、3 文字の通貨コードを使用してください。",
      "invalidPrice": "料金は有限の非負数で、百万分の一通貨単位に換算した値が安全な整数範囲内である必要があります。"
    },
  ...
  "evaluation": {
    ...
    "summary": {
      ...
      "generation": "回答品質",
      "unavailable": "有効な観測なし",
      "retrievalHint": "この実行の集計指標を表示しています。",
      "generationHint": "各指標は異なる側面を測定します。質問ごとの結果と人手評価を併せて確認してください。",
      "cost": "記録されたモデル費用",
      "costHint": "通貨ごとに表示します。計上済みの呼び出し数は費用記録の網羅範囲を示します。",
      "duration": "タスクの総所要時間",
      "execution": "評価処理",
      "durationHint": "総所要時間にはデータ準備、索引化、評価処理が含まれます。",
      "runtime": "実行時統計"
    },
    "eyebrow": "実験検証ワークスペース",
    "title": "評価ワークベンチ",
    "subtitle": "固定した実行記録を絞り込み、質問ごとの証拠を確認し、互換性のある指標を比較して検証資料をエクスポートします。",
    "selected": "選択済み",
    "statusLabel": "状態",
    "allStatuses": "すべての状態",
    "dataset": "データセット",
    "datasetPlaceholder": "データセット ID",
    "datasetVersion": "データセットのバージョン",
    "versionPlaceholder": "バージョン ID",
    "model": "モデル",
    ...
    "runs": "実験の実行記録",
    "refresh": "実行一覧を更新",
    "selectedRuns": "件の実行を選択",
    "baseline": "基準",
    "comparing": "比較中…",
    "compare": "実行結果を比較",
    "loading": "読み込み中…",
    "noRuns": "条件に一致する実行記録がありません。",
    "loadMore": "さらに実行記録を読み込む",
    "selectRun": "実行 {id} を選択",
    "runsCompared": "件の実行を比較",
    "comparison": "比較",
    "backToDetail": "実行詳細に戻る",
    "parameterDifferences": "固定パラメーターの差分",
    "parameter": "パラメーター",
    "missing": "欠落",
    "metricDifferences": "指標の差分",
    "questionSuccess": "質問の処理成功",
    "compatible": "互換性あり",
    "incompatible": "互換性なし",
    "runDetails": "実行詳細",
    "progress": "進捗",
    ...
    "overview": "概要",
    "questions": "質問",
    "experiment": "固定された実験設定",
    "aggregateMetrics": "集計指標",
    "loadingQuestions": "質問ごとの証拠を読み込み中…",
    "noQuestions": "質問の結果がありません。",
    "referenceAnswer": "参照回答",
    "generatedText": "生成された回答",
    "humanRating": "人手評価",
    "viewRevisions": "改訂履歴を表示",
    "loadingRatings": "評価の改訂履歴を読み込み中…",
    "score": "スコア",
    "ratingGuidance": "正確性、関連性、根拠を総合して評価してください。1 は不適切、3 は問題点があるものの許容可能、5 は 3 つの観点すべてで優れた回答です。",
    "ratingComment": "コメント",
    "ratingCommentPlaceholder": "検証メモ（任意）",
    "appendRating": "評価の改訂を追加",
    "savingRating": "保存中…",
    "noRatings": "人手評価の改訂履歴がありません。",
    "ratingSaved": "評価の改訂を追加しました",
    "loadMoreQuestions": "さらに質問を読み込む",
    "detailEmpty": "実験の実行記録を選択",
    "detailEmptyHint": "実行の来歴、指標、質問ごとの証拠、エクスポート操作を表示します。",
    "loadingDetail": "実行詳細を読み込み中…",
    "selectAtMostTen": "選択できる実行記録は 10 件までです。",
    "selectAtLeastTwo": "実行記録を 2 件以上選択してください。",
    "labelsSaved": "ラベルを保存しました",
    "unknownError": "評価リクエストに失敗しました。",
    "status": {
      "pending": "待機中",
      "running": "実行中",
      "success": "成功",
