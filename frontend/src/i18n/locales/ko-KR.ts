export default {
  ...
  pluginOff: {
    label: '플러그인 꺼짐',
    hint: '이 항목을 제공하는 플러그인이 이 워크스페이스에서 꺼져 있습니다. 새로 추가할 수는 없지만 기존 항목은 계속 작동합니다. 관리자는 설정 → 플러그인에서 다시 켤 수 있습니다.'
  },
  pluginToolView: {
    empty: '결과가 없습니다',
    pageUnavailable: '플러그인을 더 이상 사용할 수 없어 이 결과 페이지를 표시할 수 없습니다'
  },
  pluginPages: {
