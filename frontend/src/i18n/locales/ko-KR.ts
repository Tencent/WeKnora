export default {
  localBrowser: {
    ...
    "invalidArguments": "도구 인수가 부족합니다. 에이전트가 수정해야 합니다.",
    "commandInterrupted": "작업이 중단되었습니다. 페이지를 확인한 뒤 미리보기에서 재개하세요.",
    "actionFailedHint": "작업을 완료하지 못했습니다. 자세한 내용을 확인하세요.",
    ...
    "settingsDescription": "Chrome을 한 번 연결하면 여러 대화에서 사용할 수 있습니다.",
    ...
    "copyAgain": "다시 복사",
    "connectionNote": "한 번 연결하면 공간 내 모든 대화에서 공유합니다. 서버 재시작 후 자동으로 다시 연결됩니다.",
    "resumeNote": "중단된 작업은 다시 연결해도 일시정지 상태입니다. 대화 미리보기에서 계속하세요.",
    "privacyNote": "작업은 표시된 탭 그룹을 사용하며 기존 탭에는 권한이 필요합니다. 페이지와 스크린샷은 WeKnora로 전송됩니다.",
    "installHelp": "설치 및 사용 방법",
    "installSteps": "확장 압축을 풀고 Chrome 확장 프로그램 페이지에서 개발자 모드를 켜 로드하세요. 연결 후 대화에서 작업을 요청하고 미리보기를 클릭하면 작업 탭으로 이동합니다.",
    "running": "실행 중",
