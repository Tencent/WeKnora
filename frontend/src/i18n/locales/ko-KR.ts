export default {
  ...
  settings: {
    ...
    eventWebhooks: {
      ...
      payloadLabel: '페이로드 예시',
      payloadDesc: '이벤트 유형별 실제 body 구조를 확인합니다(예시는 마스킹됨).',
      payloadHintCreated: '생성 직후 전송됩니다. 아직 검색 불가일 수 있으며, 다운로드 티켓으로 원본을 받을 수 있습니다.',
      payloadHintParsed: '파싱 완료 후 검색 가능. created보다 먼저 올 수 있습니다.',
      payloadHintParseFailed: '파싱 실패. data.error_message를 확인하세요.',
      payloadHintDeleted: '단일 지식 삭제.',
      payloadHintBatchDeleted: '같은 KB의 일괄 삭제. 100개 단위로 나뉘며 delete_batch_id로 묶습니다.',
      payloadHintKbCreated: '지식 베이스가 생성됨.',
      payloadHintKbDeleted: 'KB 전체 삭제. cascade_knowledge=true이므로 knowledge.deleted를 기다리지 마세요.',
      payloadHintMemberAdded: '이 워크스페이스 멤버 추가.',
      payloadHintMemberRemoved: '이 워크스페이스 멤버 제거 또는 탈퇴.',
      payloadHintTest: '설정 페이지의 테스트 전송. data는 무시해도 됩니다.',
      copy: '복사',
      copied: '복사됨',
      copyFailed: '복사 실패',
    },
