export default {
  ...
  datasource: {
    ...
    noResourcesDesc_dingtalk: "이 UnionId로 접근 가능한 DingTalk 지식 공간이 없거나 앱에 문서 읽기 권한이 없습니다",
    ...
    guideStep1_dingtalk: "앱에 DingTalk 문서 읽기 API 권한이 활성화되고 게시되었는지 확인하세요",
    guideStep2_dingtalk: "조직 범위 userId가 아닌 작업자 UnionId를 입력했는지 확인하세요",
    guideStep3_dingtalk: "작업자가 대상 지식 공간에 접근할 수 있는지 확인한 후 다시 시도하세요",
    ...
    connectorDesc: {
      ...
      dingtalk: "DingTalk 지식 공간의 온라인 문서 동기화",
    ...
    field: {
      ...
      operatorUnionId: "작업자 UnionId",
      operatorUnionIdHint: "대상 지식 공간에 접근할 수 있는 DingTalk 사용자의 UnionId를 입력하세요. 조직 범위 userId는 사용할 수 없습니다.",
    ...
    prereqStep1Brief_dingtalk: "내부 앱 생성 및 게시",
    prereqStep1Desc_dingtalk: "DingTalk Open Platform에서 내부 앱을 만들고 AppKey와 AppSecret을 받은 다음 앱 버전을 게시하세요.",
    prereqStep2Brief_dingtalk: "문서 읽기 전용 권한 부여",
    prereqStep2Desc_dingtalk: "관련 지식 공간, 공간 디렉터리 노드 및 문서 블록을 읽는 API 권한을 부여하세요.",
    prereqStep3Brief_dingtalk: "접근 권한이 있는 작업자 UnionId 준비",
    prereqStep3Desc_dingtalk: "작업자는 동기화할 공간에 접근할 수 있어야 합니다. 조직 범위 userId가 아닌 UnionId를 입력하세요.",
    prereqOpenConsole_dingtalk: "DingTalk Open Platform 열기",
