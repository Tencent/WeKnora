export default {
  ...
  knowledgeBase: {
    ...
    batchReparseSkippedInFlight: "파싱 중인 문서 {count}개를 건너뛰었습니다",
      batchReparseNoEligibleDocuments: "재구축할 수 있는 문서가 없습니다. 이미 처리 중인 문서는 건너뛰었습니다.",
      batchReparseLimitExceeded: "한 번에 재구축할 수 있는 문서는 최대 {count}개입니다. 필터 범위를 좁힌 후 다시 시도하세요.",
      batchReparsePartial: "재구축 작업 {submitted}개를 제출했지만 {failed}개 문서는 제출하지 못했습니다. 나중에 다시 시도하세요.",
    selectAllFilteredDocuments: "필터링된 결과 {count}개 모두 선택",
    allFilteredDocumentsSelected: "필터링된 결과 {count}개 모두 선택됨",
    statusCompleted: "완료",
  ...
  knowledgeEditor: {
    activity: {
      ...
      actions: {
        ...
        'knowledge.batch_deleted': '지식 일괄 삭제', 'knowledge.batch_reparsed': '지식 일괄 재구축 완료', 'knowledge.reparse_started': '재분석 시작',
