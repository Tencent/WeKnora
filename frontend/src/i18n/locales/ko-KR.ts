export default {
  ...
  knowledgeEditor: {
    ...
    wikiBrowser: {
      ...
      structuralFix: "정리",
      structuralFixTooltip: "고아 페이지, 잘못된 참조, 깨진 링크를 스캔하고 자동 정리",
      structuralFixConfirmTitle: "위키를 정리하시겠습니까?",
      ...
      structuralFixDone: "{count} 개 항목을 정리했습니다",
      structuralFixNothing: "위키는 깨끗합니다 — 정리할 항목이 없습니다",
      structuralFixFailed: "정리 실패",
      resetLog: "로그 재설정",
      resetLogTooltip: "Wiki Operation Log 의 모든 기록을 지웁니다 (되돌릴 수 없음)",
      resetLogConfirmTitle: "위키 로그를 재설정하시겠습니까?",
      resetLogConfirmBody: "Wiki Operation Log 의 모든 기록(ingest / retract / dedup 결정의 누적 로그)을 삭제합니다. 이 작업은 되돌릴 수 없습니다. Index 및 기타 페이지는 영향을 받지 않습니다.",
      resetLogConfirm: "재설정",
      resetLogDone: "위키 로그가 재설정되었습니다",
      resetLogFailed: "로그 재설정 실패",
    },
    buttons: {
      create: "지식베이스 생성",
      save: "설정 저장",
