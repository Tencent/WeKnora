export default {
  backup: {
    title: '백업 및 복원',
    description: '전체 인스턴스 백업: 데이터베이스, 업로드 파일, 설정. 시스템 관리자 전용.',
    privacyNotice: '백업 파일에는 모든 워크스페이스의 데이터와 암호화된 자격 증명(모델 API 키 등)이 포함됩니다. 안전하게 보관하세요.',
    exportNow: '백업 내보내기',
    ...
    restoreConfirmBtn: '지금 복원',
    cancel: '취소',
    restoreWarning: '복원은 전체 데이터베이스를 교체하며(현재 데이터 덮어쓰기) 자동 롤백 스냅샷을 먼저 생성합니다; 이후 인스턴스를 재시작해야 합니다.',
    restoreDone: '복원 완료 — 적용하려면 인스턴스를 재시작하세요',
    rollbackPoint: '롤백 스냅샷',
    restoreFailed: '복원 실패',
    exportFailed: '내보내기 실패',
    snapshotCreated: '스냅샷이 생성되었습니다',
    snapshotFailed: '스냅샷 생성 실패',
    downloadFailed: '다운로드 실패',
    deleteFailed: '삭제 실패',
    deleted: '삭제됨',
    deleteConfirm: '스냅샷 {id}을(를) 삭제하시겠습니까?',
    loadFailed: '불러오기 실패',
