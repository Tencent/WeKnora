export default {
  ...
  agentEditor: {
    ...
    tools: {
      ...
      wikiSourcePreviewLabel: '소스 문서 미리보기',
      wikiSourcePreviewDesc: 'Wiki 읽기 결과에 접근 가능한 소스 문서의 미리보기를 표시합니다',
  ...
  envVarSettings: {
    ...
    skillTitle: '스킬 자격 증명',
    skillHint: '각 스킬이 필요하다고 선언한 변수입니다. 그 스킬이 실행될 때만 전달됩니다.',
    requiredTag: '필수',
    statusUnset: '설정되지 않음',
