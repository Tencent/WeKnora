export default {
  ...
  modelSettings: {
    ...
    usage: {
      ...
      partial: '일부 가격만 반영',
      partialCost: '가격이 설정된 호출만 포함하며 전체 비용이 아닙니다',
      embeddingCache: '벡터 캐시',
      embeddingCacheHint: '메모리 또는 영구 캐시에서 직접 제공된 임베딩 입력 비율',
      embeddingAvoided: '절감된 계산',
      embeddingAvoidedHint: '캐시 적중 및 배치 내 중복 제거로 줄인 임베딩 계산 횟수',
      wikiSummary: 'Wiki 전용 요약',
      loading: '모델 사용량을 새로 고치는 중…',
      loadFailed: '모델 사용량을 불러오지 못했습니다. 모델 설정에는 영향이 없습니다.',
      retry: '다시 시도',
      noData: '선택한 기간에 모델 호출 또는 벡터 캐시 데이터가 없습니다.',
      purposes: {
  ...
  evaluationSettings: {
    ...
    total: '총 {count}회', pageStatus: '{current} / {total} 페이지', empty: '평가 실행이 없습니다.', selectCompare: '비교 대상으로 선택',
    exportEvidence: '증거 내보내기', exportSucceeded: '증거 보고서를 다운로드했습니다.', exportFailed: '증거 보고서를 내보내지 못했습니다.',
    repeatSummary: '반복 실행 요약', repeatSummaryHint: '코드, 데이터, 구성, 지식 베이스, 모델 지문 및 호출 작업량이 모두 동일한 성공 실행만 집계합니다.',
    repeatCount: '일치하는 실행 {count}회', medianRecall: 'Recall 중앙값', medianDuration: '소요 시간 중앙값', p95Duration: '소요 시간 P95',
    medianTokens: '토큰 중앙값', medianCacheHitRate: '캐시 적중률 중앙값', medianCost: '비용 중앙값', latencyDistribution: '소요 시간 중앙값과 P95 비교', medianShort: '중앙값',
