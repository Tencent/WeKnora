export default {
  ...
  integrations: {
    ...
    api: {
      ...
      editApiKeyScope: '지식베이스 범위 편집',
      editApiKeyScopeDesc: 'API Key "{name}"이 접근할 수 있는 지식베이스를 변경합니다.',
      editApiKeyScopeHint: '비워 두면 이 워크스페이스의 모든 지식베이스를 허용합니다. 변경 사항은 즉시 적용됩니다.',
      updateApiKeyScopeSuccess: '지식베이스 범위가 업데이트되었습니다',
      updateApiKeyScopeFailed: '지식베이스 범위 업데이트 실패',
      createdAt: '생성일',
      actions: '작업',
      deleteApiKey: '삭제',
