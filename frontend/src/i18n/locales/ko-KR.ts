  ...
  knowledgeEditor: {
    ...
    advanced: {
      ...
      multimodal: {
        ...
        vllmChainLabel: 'VLLM 모델 순서',
        vllmChainDescription: '이미지 이해 모델을 순서대로 시도합니다. 앞의 모델이 실패·시간 초과·빈 응답을 반환하면 자동으로 다음 모델로 전환합니다',
        vllmChainPrimaryLabel: '기본 VLLM 모델',
        vllmChainFallbackLabel: '예비 모델',
        fallbackVllmPlaceholder: '예비 VLLM 모델을 선택해주세요',
        vllmChainAdd: '예비 모델 추가',
        vllmChainHint: '최대 {max}개까지 순서대로 시도하며, 오류·시간 초과·빈 응답 시 다음 모델로 자동 전환됩니다',
        vllmChainMoveUp: '위로',
        vllmChainMoveDown: '아래로',
        vllmChainRemove: '삭제',
        vllmChainDuplicate: '이 VLLM 모델은 이미 순서 목록에 있습니다',
