export default {
  ...
  knowledgeBase: {
    ...
    childChunk: "자식 청크",
    feedbackOnlyWithFeedback: "피드백 있는 항목만",
    feedbackOnlyNeedsOptimization: "최적화 필요 항목만",
    feedbackSortDefault: "기본 정렬",
    feedbackSortLowPositiveRate: "낮은 긍정률 우선",
    feedbackSortMostLikes: "좋아요 많은 순",
    feedbackSortMostDislikes: "싫어요 많은 순",
    feedbackSortRecent: "최근 피드백 순",
    feedbackLikes: "좋아요",
    feedbackDislikes: "싫어요",
    feedbackPositiveRate: "긍정률",
    feedbackRecallWeight: "가중치",
    feedbackSessionCount: "관련 세션",
    feedbackDislikeReasons: "싫어요 사유",
    feedbackNeedsOptimization: "최적화 필요",
    feedbackReset: "초기화",
    feedbackResetTitle: "청크 피드백 초기화",
    feedbackResetConfirmBody:
      "이 청크의 누적 좋아요, 싫어요, 긍정률 및 최적화 필요 표시를 지우고 검색 가중치를 기본값으로 되돌립니다.",
    feedbackResetSuccess: "피드백 통계가 초기화되었습니다",
    feedbackWeightLogs: "가중치 로그",
    feedbackWeightLogTitle: "가중치 변경 로그",
    feedbackWeightLogsRefreshed: "가중치 로그가 새로고침되었습니다",
    feedbackCurrentWeight: "현재 가중치",
    feedbackNoWeightLogs: "아직 가중치 변경 기록이 없습니다",
    feedbackTriggerAdminReset: "관리자 초기화",
    feedbackTriggerUserFeedback: "사용자 피드백",
    feedbackRefreshLogs: "로그 새로고침",
