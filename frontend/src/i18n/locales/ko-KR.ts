export default {
  ...
  agentEditor: {
    ...
    tools: {
      ...
      wikiListSourceChunks: '지식 포인트 원문 청크',
      wikiListSourceChunksDesc: 'Wiki 페이지가 인용한 모든 원문 청크를 펼칩니다',
  ...
  knowledgeEditor: {
    ...
    wiki: {
      ...
      contentInstructionsTip: '페이지를 어떻게 쓸지 한두 문장이면 됩니다. 인용과 할루시네이션 방지는 시스템이 처리합니다.',
      contentInstructionsPlaceholder: '예: 요구사항·기획 문서 작성용. 결론과 근거를 먼저, 빈말은 줄이기…',
      extractionInstructionsLabel: 'Wiki 추출 중점',
      extractionInstructionsTip: '남기고 싶은 것을 편하게 적으면 됩니다. 폴더 분류는 시스템이 하며, 분류표를 직접 설계할 필요는 없습니다.',
      extractionInstructionsPlaceholder: '예: 사용자, 경쟁사, 가정, 제약을 남겨 문서 작성 시 인용하기 쉽게…',
    ...
    basic: {
      ...
      descriptionWikiTip: '이 지식베이스가 무엇을 위한 것인지 한 문장이면 됩니다. 예: 「제품 기획과 요구사항 작성용」.'
    },
    errors: {
