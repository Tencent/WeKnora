export default {
  ...
  datasource: {
    ...
    deleteConfirmOneDrive: "이 OneDrive 데이터 소스와 여기서 동기화한 지식을 삭제할까요? 이 작업은 되돌릴 수 없습니다.",
    ...
    connected: "연결됨",
    connectionFailed: "연결 실패",
    oauthAuthorization: "Microsoft 인증",
    oauthAuthorized: "OneDrive 인증됨",
    oauthUnauthorized: "OneDrive가 연결되지 않음",
    oauthReauthorizationRequired: "인증이 만료되었습니다. 다시 인증해 주세요.",
    oauthConnect: "OneDrive 연결",
    oauthReconnect: "다시 인증",
    oauthConnecting: "인증 대기 중…",
    oauthConnected: "OneDrive가 연결되었습니다",
    oauthNotCompleted: "OneDrive 인증이 완료되지 않았습니다",
    oauthDisconnect: "연결 해제",
    oauthDisconnected: "OneDrive 연결이 해제되었습니다",
    oauthDisconnectFailed: "OneDrive 연결 해제 실패",
    oauthDisconnectConfirm: "연결을 해제하면 동기화가 일시정지되고 선택 범위와 이 연결이 동기화한 지식이 삭제됩니다. 계속할까요?",
    oauthReplaceAccount: "계정 변경",
    oauthReplaceConfirm: "계정을 변경하면 동기화 커서가 초기화되고 이전 연결 인덱스와 동기화된 지식이 삭제됩니다. 계속할까요?",
    oauthPopupFallback: "인증 창이 열리지 않았나요? 여기에서 계속하세요",
    oauthPermissionHint: "파일 읽기 및 오프라인 갱신 권한만 요청합니다. WeKnora는 OneDrive에 쓸 수 없습니다.",
    ...
    connectorDesc: {
      ...
      onedrive: "Microsoft 인증으로 선택한 OneDrive 폴더와 파일 동기화",
    ...
    prereqBarText_onedrive: "처음 사용하시나요? OneDrive 인증 요구 사항을 확인하세요",
    prereqStep1Brief_onedrive: "Microsoft Entra 앱 등록",
    prereqStep1Desc_onedrive: "Redirect URI는 서버의 ONEDRIVE_REDIRECT_URL과 정확히 일치해야 합니다",
    prereqStep2Brief_onedrive: "최소 위임 권한 구성",
    prereqStep2Desc_onedrive: "Files.Read만 필요하며 offline_access는 예약 동기화 인증 갱신에 사용됩니다",
    prereqStep3Brief_onedrive: "Microsoft에서 로그인 및 MFA 완료",
    prereqStep3Desc_onedrive: "WeKnora는 비밀번호나 Authenticator 코드를 읽거나 저장하지 않습니다",
