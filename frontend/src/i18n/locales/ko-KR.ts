export default {
  sandboxBrowser: {
    ...
    unavailableHint: "이 샌드박스에는 브라우저 스킬이 없습니다. 브라우저를 지원하는 설정을 선택하세요.",
    reconnectHint: "브라우저 연결이 끊겼습니다. 시작을 다시 시도할 수 있습니다.",
      ...
      "release": "제어 반환",
      "takeControl": "직접 제어",
      "previewHint": "미리보기는 2초마다 갱신됩니다. 직접 제어 중에는 에이전트가 기다리며, 패널을 닫으면 제어가 반환됩니다.",
      "address": "페이지 주소",
      "go": "이동",
      "viewport": "샌드박스 브라우저 미리보기",
      "emptyHint": "브라우저가 시작되지 않았습니다. 아래 버튼으로 현재 세션의 샌드박스와 브라우저를 시작하세요.",
      "start": "브라우저 시작",
      "textHint": "페이지의 입력란을 선택한 후 여기에 텍스트 입력",
      "insert": "입력",
      "commandFailed": "브라우저 작업 실패"
  },
  skillDiscovery: {
    cardBuiltins: "사전 설치",
    cardInstalled: "사용자 설치",
    cardUnknown: "사전 설치 정보 알 수 없음",
    cardNone: "없음",
    cardLoadFailed: "설치 정보를 불러오지 못했습니다",
    cardIncompatible: "추가 {count}개 버전 불일치",
    cardCollapse: "접기",
    cardExpand: "모든 스킬 보기",
    cardDisabled: "비활성화됨",
    cardAvailabilityUnknown: "사용 가능 여부 알 수 없음",
    cardNotInImage: "현재 이미지에서 사용 불가",

    canInstallManually: "사전 설치 확인 불가 · 수동 설치 가능",
    alreadyInstalled: "같은 이름의 스킬이 설치됨",
    preinstalledShort: '사전 설치됨',
    preinstalledOnName: '사전 설치됨 · {name}',
    preinstalledSandboxCount: '샌드박스 {count}개에 사전 설치됨',
    alreadyPreinstalled: "사전 설치됨 · 바로 사용 가능",
    checkingPreinstalled: "사전 설치 정보 확인 중…",
    includedWithTemplate: "템플릿에 포함",
    invalidManifest: "잘못된 선언입니다. 게시자의 스킬 목록 JSON을 선택하세요.",
    clearManifest: "선언 삭제",
    importManifest: "선언 가져오기",
    cloudManifestHint: "클라우드에서 스킬 목록을 제공하지 않으면 이미지 게시자의 선언을 가져올 수 있습니다. 현재 템플릿 버전에 연결된 메타데이터만 저장합니다.",
    preinstalledUnknown: "사전 설치 정보를 알 수 없습니다. 샌드박스를 시작하거나 자동 설치하지 않습니다.",
    preinstalledMismatch: "일부 스킬이 현재 앱 버전과 일치하지 않아 사용할 수 없습니다.",
    ...
    activationTitle: "「{name}」을 사용할 샌드박스 설정 선택",
    activate: "샌드박스에서 활성화",
    activationHint: "선택한 샌드박스에만 설치합니다. 사전 설치된 환경은 추가 설치 없이 사용할 수 있습니다.",
    activationAccepted: "스킬 활성화 중",
      "localBrowser": "로컬 브라우저 · 확장 프로그램 필요",
      "title": "스킬 찾기",
      "mySkills": "내 스킬",
      "search": "스킬, 용도 또는 게시자 검색",
      "runtimeHint": "내장 템플릿에서는 바로 사용할 수 있습니다. 여기서 다른 샌드박스에도 설치할 수 있습니다.",
      "retry": "다시 시도",
      "builtins": "내장 스킬",
      "recommended": "추천 스킬",
      "builtinHint": "Office, 데이터 분석 및 브라우저 스킬. 내장 템플릿을 사용하거나 다른 샌드박스에 설치하세요.",
      "externalHint": "외부 게시자의 참고 링크입니다. 코드 포함, 샌드박스 설치 또는 지침 자동 주입은 하지 않습니다.",
      "linkOnly": "외부 링크",
      "source": "출처 보기",
      "manage": "기존 스킬 관리",
      "add": "스킬 활성화",
      ...
      "addFailed": "스킬을 추가하지 못했습니다",
      "migrateTitle": "이전 샌드박스 업그레이드",
      "migrateHint": "새 이미지를 사용하는 설정을 만든 다음 원래 버전으로 스킬을 이전하세요.",
      "migrate": "스킬 이전",
      "migrateDetails": "먼저 샌드박스 설정에서 새 이미지를 사용하는 설정을 만드세요. 원본 아카이브를 검증하고 대상에 설치하며 원본 설정과 기존 대화는 유지합니다. 설치 후 에이전트 설정에서 새 설정을 선택하고 새 대화에서 검증하세요.",
      "configureSandbox": "샌드박스 설정 열기",
      "sourceSandbox": "원본 설정",
      "targetSandbox": "새 설정",
      "preview": "이전 내용 확인",
      "startMigration": "사용 가능한 스킬 이전",
      "readyToMigrate": "원본 아카이브 검증 완료",
      "noSkillsToMigrate": "원본 설정에 스킬이 없습니다",
      "migrationStarted": "{count}개 설치를 요청했습니다. 내 스킬에서 진행 상황을 확인하세요. 새 설정의 자격 증명과 사용자 환경 변수는 별도로 확인하세요.",
      "migrationFailed": "이전 실패",
      "categories": {
          "all": "전체 분류",
          "office": "문서",
          "analysis": "데이터 분석",
      ...
      "blockers": {
          "source_not_ready": "원본 스킬 설치가 완료되지 않았습니다",
          "source_disabled": "원본에서 비활성화되어 있어 활성화하지 않습니다",
          "target_name_conflict": "대상에 같은 이름의 스킬이 있어 유지합니다",
          "missing_digest": "이전 기록에 해시가 없습니다. 원본 아카이브를 가져오세요",
          "missing_original_archive": "원본 아카이브가 없습니다. 최신 버전으로 대체하지 않습니다"
      }
  },
  platformApiKeys: {
    title: '플랫폼 API 키',
  ...
  agent: {
    ...
    editor: {
      ...
      skillsConfig: '스킬',
      skillsConfigDesc: '샌드박스를 선택한 후 스킬을 선택하세요. 사전 설치된 스킬은 바로 사용할 수 있습니다.',
      skillsSelection: '스킬 목록',
      skillsSelectionDesc: '사용 가능한 스킬에는 사전 설치 및 직접 설치한 스킬이 포함됩니다.',
      skillsAll: '전체',
      skillsSelected: '지정',
      skillsNone: '비활성화',
      selectSkills: '스킬 선택',
      selectSkillsDesc: '에이전트가 사용할 스킬을 선택하세요. 사전 설치된 스킬은 다시 설치할 필요가 없습니다.',
      skillsAllListHint: '이 샌드박스에서 사용 가능한 모든 사전 설치 및 직접 설치한 스킬을 사용합니다.',
      skillsGroupAvailable: '사용 가능',
      skillsGroupUnavailable: '사용 불가',
      noSkillsAvailable: '샌드박스에 사용 가능한 스킬이 없고 카탈로그도 비어 있습니다.',
