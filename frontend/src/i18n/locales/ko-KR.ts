export default {
  ...
  knowledgeBase: {
    ...
    batchMetadata: '메타데이터 일괄 편집',
    batchMetadataDialogHeading: '문서 메타데이터 일괄 편집',
    batchMetadataSubtitle: '선택한 {count}개 문서의 사용자 메타데이터를 대체합니다',
    batchMetadataHint: '입력한 메타데이터가 선택한 모든 문서의 기존 사용자 메타데이터를 대체합니다. 비워서 저장하면 모두 삭제됩니다.',
    batchMetadataEmpty: '메타데이터 필드가 없습니다. 필드를 추가하거나 저장하여 메타데이터를 삭제하세요.',
    batchMetadataSuccess: '{count}개 문서의 메타데이터가 업데이트되었습니다',
    batchMetadataFailed: '메타데이터 일괄 업데이트 실패',
