export default {
  ...
  datasource: {
    ...
    field: {
      ...
      jiraEdition: 'Jira 에디션',
      jiraEditionServer: 'Server / Data Center',
      jiraEditionCloud: 'Cloud',
      jiraBaseUrl: 'Jira URL',
      jiraUsername: '사용자 이름 또는 이메일',
      jiraPassword: 'Server/DC 비밀번호 또는 PAT',
      jiraApiToken: 'Cloud API 토큰',
      jiraJql: '추가 JQL 필터 (선택)',
      jiraJqlHint: '예: status in (Resolved, Closed) 또는 priority = High',
      jiraIncludeComments: '이슈 댓글 동기화',
      jiraIncludeCommentsHint: '티켓의 해결 과정 및 토론 댓글을 포함합니다',
      clientId: 'Client ID',
