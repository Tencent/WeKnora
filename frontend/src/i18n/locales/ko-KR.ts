export default {
  ...
  agentStream: {
    ...
    skillCards: {
      ...
      temporaryNotice: '{name}은(는) 이 대화의 샌드박스에 임시로 불러온 것일 뿐 워크스페이스에 설치되지 않았습니다. 스킬 목록에 나타나지 않고, 다른 대화에서는 쓸 수 없으며, 샌드박스가 다시 만들어지면 사라집니다.',
      temporaryNoticeUnnamed: '이 스킬은 이 대화의 샌드박스에 임시로 불러온 것일 뿐 워크스페이스에 설치되지 않았습니다. 스킬 목록에 나타나지 않고, 다른 대화에서는 쓸 수 없으며, 샌드박스가 다시 만들어지면 사라집니다.',
      official: '공식',
