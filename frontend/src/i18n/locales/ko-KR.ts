export default {
  ...
  knowledgeFolder: {
    ...
    root: "루트",
    loading: "폴더 불러오는 중",
    loadFailed: "폴더를 불러오지 못했습니다",
    noFolders: "하위 폴더 없음",
    create: "새 폴더",
    createInCurrent: "현재 폴더에 만들기",
    rename: "폴더 이름 변경",
    delete: "폴더 삭제",
    namePlaceholder: "폴더 이름 입력",
    nameRequired: "폴더 이름을 입력하세요",
    invalidName: "유효하지 않은 폴더 이름입니다",
    nameConflict: "현재 위치에 같은 이름의 폴더가 있습니다",
    notEmpty: "폴더가 비어 있지 않습니다. 문서와 하위 폴더를 먼저 제거하세요.",
    operationFailed: "폴더 작업에 실패했습니다. 나중에 다시 시도하세요.",
    createSuccess: "폴더가 생성되었습니다",
    renameSuccess: "폴더 이름이 변경되었습니다",
    deleteSuccess: "폴더가 삭제되었습니다",
    deleteConfirm: "폴더 \"{name}\"을(를) 삭제할까요?",
    deleteEmptyOnly: "빈 폴더만 삭제할 수 있습니다. 문서와 하위 폴더는 삭제되거나 이동되지 않습니다.",
    createTarget: "대상 폴더: {name}",
    emptyKnowledge: "\"{name}\"에 문서가 없습니다",
    invalidLocation: "폴더 주소가 잘못되어 루트로 돌아왔습니다",
    locationUnavailable: "폴더가 없거나 접근할 수 없어 안전한 폴더로 돌아왔습니다",
    resizeSidebar: "폴더 사이드바 너비 조정",
    resizeSidebarHint: "드래그하여 너비를 조정하고 두 번 클릭하여 기본값으로 복원",
  },
  knowledgeFolderMove: {
    folderTitle: "폴더 이동",
    knowledgeTitle: "문서를 폴더로 이동",
    batchTitle: "문서를 폴더로 일괄 이동",
    moveFolder: "폴더 이동",
    moveKnowledge: "폴더로 이동",
    moveSelected: "폴더로 이동",
    selectTarget: "대상 폴더를 선택하세요. 루트도 선택할 수 있습니다.",
    current: "현재 위치",
    invalidTarget: "대상 폴더가 올바르지 않습니다.",
    cycleConflict: "폴더를 자기 자신이나 하위 폴더로 이동할 수 없습니다.",
    nameConflict: "대상 위치에 같은 이름의 폴더가 있습니다.",
    moveConflict: "폴더 상태가 변경되어 이동할 수 없습니다.",
    resourceChanged: "문서 또는 폴더가 더 이상 존재하지 않아 폴더 데이터를 새로 고쳤습니다.",
    folderMoved: "폴더를 이동했습니다.",
    knowledgeMoved: "문서를 이동했습니다.",
    batchMoved: "문서 {count}개를 이동했습니다.",
    batchMoveFailed: "일괄 이동하지 못했습니다. 잠시 후 다시 시도하세요.",
    selectionChanged: "선택한 문서가 변경되었습니다. 새로 고친 후 다시 선택하세요.",
    searchResultPath: "문서 경로: {path}",
    moveFailed: "이동하지 못했습니다. 잠시 후 다시 시도하세요.",
  },
  knowledgeFolderDrag: {
    dragHandle: "“{name}”을(를) 드래그하여 이동",
    dropHere: "이 폴더로 이동",
    cannotDrop: "이 폴더로 이동할 수 없습니다",
    moving: "이동 중",
  },
  knowledgeBase: {
    title: "지식베이스",
  ...
  input: {
    ...
    folderScope: {
      entireKnowledgeBase: "지식베이스 전체",
      entireKnowledgeBaseHint: "직접 파일과 모든 하위 폴더를 포함합니다",
      selectFolderForKb: "{name}의 여러 폴더 선택",
      selectedFolderSingle: "폴더 1개 선택됨",
      selectedFolderCount: "폴더 {count}개 선택됨",
      removeCurrentFolder: "현재 폴더 제거",
      loading: "폴더 범위 로딩 중",
      loadingShort: "로딩 중",
      loadFailed: "폴더 범위 로드 실패",
      loadFailedShort: "로드 실패",
      partialInvalid: "일부 폴더 범위가 유효하지 않습니다. 해당 폴더를 제거하거나 다시 선택하세요.",
      partialInvalidShort: "일부 폴더가 유효하지 않음",
      noFolders: "사용 가능한 폴더가 없습니다",
      searchPlaceholder: "폴더 검색",
      toggleFolder: "폴더 펼치기 또는 접기",
      sendBlockedInvalid: "다음 지식베이스의 폴더 범위가 무효입니다: {names}",
    },
    knowledgeBase: "지식베이스",
