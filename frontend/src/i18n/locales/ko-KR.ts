export default {
  ...
  processingDashboard: {
    title: "지식 처리 대시보드",
    subtitle: "각 처리 단계의 실행 및 대기 지식을 실시간으로 확인합니다",
    primaryGroup: "주 처리 흐름",
    enrichmentGroup: "콘텐츠 강화 흐름",
    running: "처리 중",
    queued: "대기 중",
    retrying: "재시도 중",
    viewQueue: "큐 보기",
    noRunning: "현재 처리 중인 지식이 없습니다",
    noActiveTasks: "현재 처리 중이거나 대기 중인 지식 작업이 없습니다",
    updatedAt: "생성 시간",
    queueDataUnavailable: "큐 데이터를 사용할 수 없습니다. 진행 상태는 처리 추적에서 가져옵니다",
    queueDataPartial: "큐가 커서 카운트는 근사값입니다",
    autoRefresh: "자동 새로고침",
    manualRefresh: "새로고침",
    filterKnowledgeBase: "지식베이스 필터",
    searchPlaceholder: "제목 또는 파일명 검색",
    refresh: { off: "끄기" },
    stage: {
      docreader: { title: "문서 파싱", description: "원본 문서를 읽고 본문을 추출합니다" },
      chunking: { title: "문서 청킹", description: "텍스트를 인덱싱 단위로 나눕니다" },
      embedding: { title: "인덱스 구축", description: "벡터 및 키워드 검색 인덱스를 기록합니다" },
      multimodal: { title: "멀티모달 인식", description: "이미지의 텍스트와 의미를 인식합니다" },
      postprocess: { title: "후처리 오케스트레이션", description: "요약, 질문, 그래프, Wiki 작업을 분기합니다" },
      summary: { title: "요약 생성", description: "지식 요약을 생성합니다" },
      question: { title: "질문 생성", description: "검색 가능한 질문을 생성합니다" },
      graph: { title: "그래프 추출", description: "엔티티와 관계를 추출합니다" },
      wiki: { title: "Wiki 합성", description: "Wiki 페이지와 계층을 합성합니다" },
    },
    state: {
      not_reached: "미도달",
      queued: "대기 중",
      ...
      done_with_errors: "오류 포함 완료",
      failed: "실패",
      skipped: "건너뜀",
      cancelled: "취소됨",
    },
    drawer: { title: "단계 큐", empty: "항목 없음", loadMore: "더 보기", failedChildren: "실패한 하위 항목" },
    detail: { title: "지식 처리 상세", pendingSubtasks: "대기 하위 작업", rawTrace: "원본 처리 추적 보기", empty: "지식을 선택하세요" },
  },
  newUserGuide: {
  ...
  commandPalette: {
    ...
    quick: {
      ...
      knowledgeProcessing: '처리 대시보드 열기',
      agents: '에이전트 열기',
