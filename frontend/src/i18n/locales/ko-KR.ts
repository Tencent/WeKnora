export default {
  ...
  feedback: {
    like: "좋아요",
    dislike: "싫어요",
    dislikeHeader: "개선할 점을 알려주세요",
    dislikeHint: "답변이 어긋난 이유를 선택해 주세요. 자세한 내용을 추가할 수도 있습니다:",
    commentPlaceholder: "상세 설명 추가 (선택)",
    commentRequiredWhenOther: '"기타"를 선택한 경우 상세 설명을 입력해 주세요',
    saveSuccess: "피드백이 저장되었습니다",
    cancelSuccess: "피드백이 취소되었습니다",
    saveError: "피드백 저장에 실패했습니다. 잠시 후 다시 시도해 주세요",
    reasons: {
      inaccurate: "정확하지 않음",
      irrelevant: "관련 없음",
      outdated: "오래된 정보",
    ...
    kbStats: {
      title: "피드백 분석",
      lowQualityOnly: "저품질 청크만 보기",
      reset: "피드백 초기화",
      resetConfirm: "이 지식베이스의 모든 피드백을 초기화하시겠습니까? 과거 사용자 평가가 통계에서 제외되지만 데이터는 삭제되지 않습니다.",
      resetSuccess: "피드백이 초기화되었습니다",
      sortPositiveRateAsc: "긍정률 (오름차순)",
      sortPositiveRateDesc: "긍정률 (내림차순)",
      sortFeedbackCountDesc: "피드백 수 (내림차순)",
      sortLastFeedbackDesc: "최근 피드백 (최신순)",
      columnChunk: "청크",
      columnLikeCount: "좋아요",
      columnDislikeCount: "싫어요",
      columnSessionCount: "세션",
      columnPositiveRate: "긍정률",
      columnLastFeedback: "최근 피드백",
      columnDislikeReasons: "싫어요 이유",
      weightLogTitle: "가중치 변경 로그",
      needsOptimization: "최적화 필요",
      lowQuality: "저품질",
    },
    retrieval: {
      sectionTitle: "피드백 기반 랭킹",
      enable: "피드백 기반 리콜 랭킹 활성화",
      description: "사용자의 좋아요/싫어요에 따라 지식 청크의 검색 순위를 자동으로 조정합니다.",
      boostThreshold: "긍정률 부스트 임계값",
      penaltyThreshold: "긍정률 페널티 임계값",
      boostFactor: "부스트 배수",
      penaltyFactor: "페널티 배수",
      minSamples: "최소 피드백 표본 수",
      needsOptimizationThreshold: "최적화 필요 임계값",
      validationError: "잘못된 피드백 정책: {message}",
      recomputing: "피드백 가중치 재계산 중…",
      recomputeSuccess: "피드백 가중치 재계산 완료 ({count}개 청크)",
    },
  },
  agent: {
    taskLabel: "작업:",
