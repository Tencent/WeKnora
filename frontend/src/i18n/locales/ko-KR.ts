export default {
  ...
  knowledgeEditor: {
    ...
    wikiBrowser: {
      ...
      issueOrphanPage: '고립 페이지',
      issueEmptyContent: '내용 부족',
      issueStaleRef: '만료된 참조',
      issueMissingCrossRef: '교차 참조 누락',
      issueLintScan: '규칙 검사',
      healthDrawerFilterType: '문제 유형',
      healthDrawerFilterTypeAll: '전체 유형',
      healthDrawerFilterSource: '출처',
      healthDrawerFilterSourceAll: '전체 출처',
      healthDrawerFilterSourceLint: '규칙 검사',
      healthDrawerFilterSourceAgent: 'AI 검사',
      healthDrawerFilterStatus: '상태',
      healthDrawerFilterStatusActionable: '처리 대기',
      healthDrawerFilterStatusIgnored: '무시됨',
      healthDrawerFilterStatusResolved: '해결됨',
      healthStatsPages: '{count}페이지',
      healthStatsLinks: '링크 {count}개',
      healthStatsOrphans: '고립 페이지 {count}개',
      healthMetricPages: '페이지',
      healthMetricLinks: '링크',
      healthMetricOrphans: '고립 페이지',
      healthCardViewPage: '페이지 보기',
      healthDrawerActiveRepairs: '{count}건 수정 중',
      healthDrawerViewRepair: '진행 상황 보기',
      issueSeverityError: '심각',
      issueSeverityWarning: '경고',
      issueSeverityInfo: '안내',
      issueRepairModeDeterministic: '규칙 자동',
      issueRepairModeAgent: 'AI 수정',
      issueRepairModeManual: '수동만',
      issueEvidenceTarget: '관련 대상',
      issueLastSeen: '최근 검사 {time}',
      issueOccurrenceCount: '{count}회 발견',
      issueDetectedVersion: 'v{version}에서 발견',
      healthDrawerResolvedEmptyTitle: '해결된 문제 없음',
      healthDrawerResolvedEmptyHint: '수정되었거나 더 이상 검사되지 않는 문제가 여기에 표시됩니다.',
      lintRuleVersion: '규칙 {version}',
      lintFinishedAt: '완료 {time}',
      lintDuration: '소요 {seconds}초',
      healthDrawerSelectAll: '전체 선택',
      healthDrawerBatchIgnore: '선택 항목 무시',
      healthDrawerBatchRepair: '선택 항목 수정',
      healthDrawerBatchIgnoreAll: '전체 무시',
      healthDrawerBatchRestore: '선택 항목 복원',
      healthDrawerBatchRestoreAll: '전체 복원',
      healthDrawerIgnoreAllConfirmTitle: '일치하는 문제를 모두 무시할까요?',
      healthDrawerIgnoreAllConfirmBody: '현재 필터 조건의 {count}개 문제를 무시합니다. 되돌릴 수 없습니다.',
      healthDrawerBatchIgnoreDone: '{count}개 문제를 무시했습니다',
      healthDrawerBatchIgnoreFailed: '일괄 무시에 실패했습니다. 다시 시도해 주세요.',
      healthDrawerRestoreAllConfirmTitle: '무시된 문제를 모두 복원할까요?',
      healthDrawerRestoreAllConfirmBody: '현재 필터 조건의 {count}개 문제를 처리 대기로 복원합니다.',
      healthDrawerBatchRestoreDone: '{count}개 문제를 복원했습니다',
      healthDrawerBatchRestoreFailed: '일괄 복원에 실패했습니다. 다시 시도해 주세요.',
      healthDrawerIgnoredEmptyTitle: '무시된 문제 없음',
      healthDrawerIgnoredEmptyHint: '무시한 문제는 여기에 표시되며, 언제든 처리 대기로 복원할 수 있습니다.',
      healthDrawerViewIgnored: '무시된 문제 보기',
      healthDrawerBatchRepairHint: '첫 번째 수정을 시작했습니다. 나머지 {count}개는 개별 처리해 주세요.',
      healthDrawerLoadingMore: '더 불러오는 중…',
      healthDrawerAllLoaded: '총 {count}개 모두 불러옴',
      ...
      lintCompleted: '규칙 검사 완료',
      lintFailed: '검사 실패',
      lintCompletedClean: '규칙 검사 완료, 새 문제 없음',
      lintFindings: '처리 대기 문제 {count}건 발견',
      lintFindingsPartial: '이번 검사 {detected}건, 처리 대기 {actionable}건',
      lintFindingsAllIgnored: '이번 검사 {count}건, 모두 무시된 상태',
      healthDrawerAllIgnoredTitle: '검사 결과가 모두 무시됨',
      healthDrawerAllIgnoredHint: '규칙 검사가 {count}건의 기존 문제를 다시 찾았지만 이전에 모두 무시되었습니다. 아래 버튼을 누르거나 「무시됨」으로 전환하여 확인하고 복원할 수 있습니다.',
      loadMoreIssues: '더 보기 ({loaded}/{total})',
      issueFixSuggestions: '콘텐츠 최적화 제안 ({count})',
      pageIssuesTitle: '이 페이지 문제 ({count})',
      pageIssuesSubtitle: '규칙 검사에서 발견된 콘텐츠 문제와 처리 제안',
      issueSourceLintReport: '규칙 검사',
      issueRepairManualOnly: '이 문제는 자동 수정할 수 없습니다. 안내에 따라 수동으로 처리하세요',
      issueOrphanManualHint: '고립 페이지는 다른 Wiki 페이지에서 이 페이지로 링크를 추가해야 하며, AI 일괄 수정은 지원되지 않습니다',
      issueFixSingle: '수정',
