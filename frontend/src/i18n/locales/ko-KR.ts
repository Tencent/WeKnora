export default {
  ...
  settings: {
    ...
    sandbox: {
      ...
      skillUploadHint: '업로드하면 현재 이미지에 스킬을 설치하고 새 스냅샷을 만듭니다. 몇 분이 걸릴 수 있습니다. 이미 열린 세션은 다음 샌드박스 사용 시 다시 만들어지며, 진행 중인 도구 호출이 중단되고 세션 작업 공간 초안이 지워질 수 있습니다.',
      ...
      skillDeleteHint: '삭제하면 이미지에서 스킬 디렉터리를 제거하고 새 스냅샷을 만듭니다. 이미 열린 세션은 다음 샌드박스 사용 시 다시 만들어지며, 진행 중인 도구 호출이 중단되고 세션 작업 공간 초안이 지워질 수 있습니다.',
