export default {
  learning: {
    newPractice: '새 연습', previousPractice: '이전 연습', yourAnswer: '내 답안',
    tools: {
      profile: '학습 개요', profileDesc: '워크스페이스가 소유한 Wiki 지식 베이스의 개인 학습 개요를 확인합니다.',
      recommend: '연습 추천', recommendDesc: '연습 기록과 출처가 있는 Wiki 페이지를 바탕으로 주제를 추천합니다.',
      quiz: '연습 퀴즈 준비', quizDesc: '출처에 근거한 퀴즈를 준비합니다. 답안은 학습 패널에서만 제출할 수 있습니다.',
    },
    title: '맞춤 학습', consent: '개인 학습 기록', enabled: '켜짐', disabled: '꺼짐',
    overview: '학습 개요', topicCount: '주제 {count}개', recommendations: '추천 연습',
    noRecommendations: '아직 추천 항목이 없습니다', practice: '연습', startPractice: '이 페이지 연습하기',
    openPage: '페이지 열기', pending: '퀴즈 대기 중', running: '퀴즈 준비 중', cancelPolling: '대기 중지',
    paused: '상태 확인이 일시 중지되었습니다', checkAgain: '다시 확인', failed: '퀴즈 준비에 실패했습니다',
    sourceStale: '출처가 변경되었습니다. 새 퀴즈가 필요합니다.', regenerate: '새 퀴즈 만들기',
    refresh: '새로 고침', retry: '재시도', submit: '답안 제출', retryAnswer: '제출 재시도',
    correct: '정답', incorrect: '오답', correctAnswer: '정답', answered: '답변 완료',
    source: '출처 {index}', noQuestions: '문제가 없습니다',
    familiar: '접한 주제', familiarTooltip: '읽기와 출처 활용은 접한 경험을 나타내며, 숙달을 의미하지 않습니다.',
    masteryLegend: '평가된 답안을 기반으로 한 숙달 상태',
    masteryTooltip: '평가된 답안 {count}개. 모델 추정치: {probability}% (보정되지 않음).',
    privacy: '학습 데이터', exportKB: '이 지식 베이스 내보내기 (JSON)', exportAll: '모든 학습 데이터 내보내기 (JSON)',
    clearKB: '이 지식 베이스 기록 삭제', clearAll: '모든 학습 데이터 삭제', clearTitle: '학습 데이터를 삭제할까요?',
    clearKBConfirm: '이 지식 베이스에 있는 본인의 연습 기록, 퀴즈, 숙달 정보를 영구 삭제할까요?',
    clearAllConfirm: '이 워크스페이스에 있는 본인의 모든 연습 기록, 퀴즈, 숙달 정보를 영구 삭제할까요?',
    confirmClear: '영구 삭제', cancel: '취소',
    cleared: '답안 {attempts}개, 주제 기록 {topics}개, 퀴즈 {quizzes}개를 삭제했습니다.',
    states: { unseen: '미평가', learning: '학습 중', mastered: '숙달', review_due: '복습 시기' },
    reasons: {
      practice: '연습 필요', source_changed: '출처 변경', source_backed: '출처 근거 있음', explore: '새 주제 탐색',
      review_due: '복습 시기 도래', review_need: '복습 필요', graph_frontier: '관련 주제',
      interest_match: '관심사와 일치', content_quality: '출처 품질',
      cold_start: '시작 주제', exploration: '새 주제 탐색', related_topic: '관련 주제',
    },
    errors: {
      request: '학습 데이터를 불러오지 못했습니다.', unavailable: '현재 환경에서는 학습 기능을 사용할 수 없습니다.',
      disabled: '학습 기능이 꺼져 있습니다.', notFound: '이 학습 항목은 더 이상 사용할 수 없습니다.',
      stale: '출처가 변경되었습니다. 새 퀴즈를 만들어 주세요.', conflict: '이미 제출된 답안입니다. 새로 고침하여 저장된 결과를 확인하세요.',
      busy: '학습 서비스가 사용 중입니다. 잠시 후 다시 시도하세요.', evidence: '퀴즈를 만들기에 검증된 출처 근거가 부족합니다.',
      notReady: '퀴즈가 아직 준비되지 않았습니다.',
    },
  },
  localBrowser: {
