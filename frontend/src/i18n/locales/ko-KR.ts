export default {
  ...
  knowledgeBase: {
    ...
    folderRoot: "모든 문서",
    folderCreate: "새 폴더",
    folderCreateRoot: "루트 폴더 만들기",
    folderCreateChild: "하위 폴더 만들기",
    folderRename: "이름 바꾸기",
    folderRelocate: "폴더 이동",
    folderRelocateTitle: "상위 폴더 선택",
    folderMoved: "폴더가 이동되었습니다",
    folderMoveFolderFailed: "폴더 이동 실패",
    folderNamePlaceholder: "폴더 이름을 입력하세요",
    folderAsk: "이 폴더에 질문",
    folderItemCount: "{count}개 항목",
    folderReparseAll: "전체 재분석",
    folderDeleteAll: "전체 삭제",
    folderReparseTitle: "폴더 전체 재분석",
    folderReparseConfirm: "‘{name}’ 폴더와 모든 하위 폴더의 {count}개 항목을 다시 분석하시겠습니까?",
    folderReparseSubmitted: "{count}개 항목의 재분석 작업을 제출했습니다",
    folderReparseFailed: "폴더 재분석 작업 제출에 실패했습니다",
    folderDeleteRecursiveTitle: "폴더 전체 삭제",
    folderDeleteRecursiveConfirm: "‘{name}’ 폴더, 모든 하위 폴더 및 {count}개 항목을 삭제하시겠습니까? 이 작업은 취소할 수 없습니다.",
    folderDeleteRecursiveSubmitted: "{count}개 항목의 삭제 작업을 제출했습니다",
    folderDeleteRecursiveFailed: "폴더 삭제에 실패했습니다",
    folderEmpty: "폴더가 없습니다",
    folderSaved: "폴더가 저장되었습니다",
    folderSaveFailed: "폴더 저장 실패",
    folderUploadDepthExceeded: "업로드 디렉터리가 최대 폴더 중첩 깊이(10단계)를 초과했습니다",
    folderLoadFailed: "폴더 로드 실패",
    folderDeleteTitle: "폴더 삭제",
    folderDeleteConfirm: "폴더 ‘{name}’을 삭제하시겠습니까? 폴더가 비어 있어야 합니다.",
    folderDeleted: "폴더가 삭제되었습니다",
    folderDeleteFailed: "폴더 삭제 실패",
    folderMove: "폴더로 이동",
    folderMoveTitle: "선택한 문서 이동",
    folderMoveSuccess: "문서가 이동되었습니다",
    folderMoveFailed: "문서 이동 실패",
    title: "지식베이스",
    list: "지식베이스 목록",
    fileContent: "파일 내용",
    detail: "지식베이스 상세",
