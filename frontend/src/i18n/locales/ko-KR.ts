export default {
  ...
  datasource: {
    ...
    prereqBarText: "처음 사용하시나요? 클릭하여 Feishu 앱 설정 가이드를 확인하세요",
      ...
      prereqStep1Desc_dingtalk: "DingTalk 오픈 플랫폼 로그인 → 앱 개발 → 기업 내부 앱 생성",
      prereqStep2Brief_dingtalk: "지식베이스 문서 읽기 권한 부여",
      prereqStep2Desc_dingtalk: "앱 권한 관리에서 지식베이스 읽기 및 문서 읽기 권한을 활성화하세요",
      prereqStep3Brief_dingtalk: "AppKey 및 AppSecret 획득",
      prereqStep3Desc_dingtalk: "앱「자격 증명 및 기본 정보」페이지에서 AppKey와 AppSecret를 확인하세요",
