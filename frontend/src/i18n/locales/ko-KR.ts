export default {
  ...
  settings: {
    ...
    intentPolicy: {
      title: '의도 정책',
      description: 'IntentGate 정책은 에이전트의 도구 호출이 사용자 의도와 제약에 맞는지 판정합니다. 새 정책은 항상 observe(기록만, 차단 없음)로 시작합니다.',
      empty: '의도 정책이 아직 없습니다',
      wholeTenant: '전체 작업 공간',
      riskHigh: '고위험',
      riskLow: '저위험',
      currentBadge: '현재',
      supersededBadge: '대첨됨',
      ...
      editor: {
        createTitle: '의도 정책 만들기',
        editTitle: '정책 편집(v{version}으로 저장)',
      },
      form: {
        scopeType: '범위',
        scopeRef: '범위 참조',
        constraintText: '제약(자연어)',
        constraintPlaceholder: '예: 건당 환불은 75를 초과할 수 없습니다',
        ruleExpr: '규칙 표현식(선택)',
        ruleExprPlaceholder: '예: value <= 75 - 컴파일 가능한 제약은 LLM judge를 완전히 걸러냅니다',
        argPath: '인수 경로(선택)',
        riskTier: '위험 등급',
        mode: '모드',
      },
      scopeRefHints: {
        tool: 'service_id:tool_name; *:wiki_* 접두사 와일드카드 지원',
        service: 'MCP 서비스 ID',
        agent: '에이전트 ID',
        workspace: '작업 공간 ID',
      },
      enforceConfirm: {
        title: '강제 모드로 전환하시겠습니까?',
        body: 'enforce 모드는 정책 위반 도구 호출을 실제로 차단합니다. 에이전트는 거절 사유를 보고 스스로 수정할 수 있습니다. observe 모드는 판정 기록만 남깁니다. 계속하시겠습니까?',
        confirm: '강제 적용',
      },
      toasts: {
        loadFailed: '의도 정책을 불러오지 못했습니다',
        enabled: '정책이 활성화되었습니다',
        disabled: '정책이 비활성화되었습니다',
        toggleFailed: '정책 상태 업데이트에 실패했습니다',
        created: '정책이 생성되었습니다',
        updated: '새 버전이 저장되었습니다',
        saveFailed: '정책 저장에 실패했습니다',
        constraintRequired: '제약 텍스트는 필수입니다',
        scopeRefRequired: '이 범위 유형에는 범위 참조가 필요합니다',
      },
    },
    versionInfo: '버전 정보',
    taskQueue: '작업 큐',
