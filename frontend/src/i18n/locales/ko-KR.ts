export default {
  ...
  webSearchSettings: {
    ...
    configFields: {
      searchEngine: '검색 엔진',
      searchStd: 'Standard · ₩0.01/건',
      searchPro: 'Pro · ₩0.03/건',
      searchSogou: 'Sogou · ₩0.05/건',
      searchQuark: 'Quark · ₩0.05/건',
      searchEngineDesc: 'Zhipu 검색 엔진과 건당 과금 등급을 선택합니다.',
      contentSize: '콘텐츠 분량',
      contentMedium: 'Medium',
      contentHigh: 'High',
      contentSizeDesc: 'Medium는 간결한 요약을, High는 더 많은 문맥을 반환합니다.',
      metasoScope: '검색 범위',
      metasoScopeDesc: 'Metaso의 검색 범위를 선택합니다.',
      metasoScopeWebpage: '웹페이지',
      metasoScopeDocument: '문서',
      metasoScopeScholar: '학술',
      metasoScopeImage: '이미지',
      metasoScopeVideo: '동영상',
      metasoScopePodcast: '팟캐스트',
      metasoConciseSnippet: '간결한 일치 정보 반환',
      metasoConciseSnippetDesc: '켜면 간결한 일치 정보를 반환하고, 끄면 전체 발췌를 반환합니다.',
      metasoIncludeSummary: '웹페이지 요약 기반 리콜 강화',
      metasoIncludeSummaryDesc: '켜면 웹페이지 요약 정보로 리콜을 강화합니다.',
    },
    toasts: {
