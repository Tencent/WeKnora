export default {
  ...
  knowledgeEditor: {
    ...
    wikiBrowser: {
      ...
      linkedFrom: "링크 출처",
      sources: "원본 문서",
      blockSources: "출처 {count}",
      sourceChunk: "청크 {index}",
      sourceUnavailable: "출처를 사용할 수 없음",
      sourceManualCreated: "[수동 작성]",
      ...
      sourceFallbackMissingSources: "일부 사실 블록에 근거 출처가 없어 전체 페이지를 표시합니다.",
      sourceSomeUnavailable: "일부 원본 문서 또는 청크를 더 이상 사용할 수 없습니다. 전체 페이지는 계속 표시되며 해당 출처가 표시됩니다.",
      sourceFallbackUnknownError: "알 수 없는 오류",
