export default {
  ...
  knowledgeFolder: {
    ...
    root: "루트",
    actions: "폴더 작업",
    createTopLevel: "최상위 폴더 만들기",
    createChild: "하위 폴더 만들기",
    rename: "이름 변경",
    delete: "삭제",
    startKnowledgeBaseChat: "이 지식베이스에서 대화 시작",
    startFolderChat: "이 폴더에서 대화 시작",
    folderNamePlaceholder: "폴더 이름을 입력하세요",
    deleteConfirm: "“{name}” 폴더를 삭제하시겠습니까?",
    notEmpty: "이 폴더에 파일 또는 하위 폴더가 남아 있습니다. 비운 후 삭제해 주세요.",
    createSuccess: "폴더를 만들었습니다",
    createFailed: "폴더를 만들지 못했습니다",
    renameSuccess: "폴더 이름을 변경했습니다",
    renameFailed: "폴더 이름을 변경하지 못했습니다",
    deleteSuccess: "폴더를 삭제했습니다",
    deleteFailed: "폴더를 삭제하지 못했습니다",
    loadMore: "더 보기",
    loading: "불러오는 중…",
    empty: "하위 폴더가 없습니다",
    loadFailed: "폴더를 불러오지 못했습니다",
    retry: "다시 시도",
    resizeLabel: "폴더 사이드바 너비 조절",
    breadcrumbLabel: "폴더 경로",
    ensurePathsFailed: "폴더 경로를 만들지 못했습니다",
    expandFolder: "{name} 펼치기",
    collapseFolder: "{name} 접기",
  },
  knowledgeScope: {
    selectedCount: "{count}개 선택됨",
    fileOwnershipUnavailable: "선택한 파일의 지식베이스를 확인할 수 없습니다. 파일을 다시 선택한 후 다시 시도해 주세요.",
  },
  knowledgeBase: {
    title: "지식베이스",
    list: "지식베이스 목록",
