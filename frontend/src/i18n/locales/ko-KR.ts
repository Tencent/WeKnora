export default {
  ...
  knowledgeBase: {
    ...
    urlTip: '다양한 웹페이지 콘텐츠를 가져올 수 있으며, 시스템이 자동으로 텍스트를 추출하고 분석합니다. YouTube 동영상 및 재생목록 링크는 자막으로 가져오며, 자막이 없으면 음성 인식으로 변환합니다',
    youtubePlaylistImporting: 'YouTube 재생목록을 읽는 중…',
    youtubePlaylistImportSuccess: '"{title}"에서 동영상 {count}개를 대기열에 추가했습니다',
    youtubePlaylistImportDuplicates: '동영상 {count}개는 이미 이 지식베이스에 있습니다',
    youtubePlaylistImportFailures: '동영상 {count}개를 추가하지 못했습니다',
    youtubePlaylistTruncated: '이 재생목록의 처음 {count}개 동영상만 가져왔습니다',
    youtubePlaylistImportFailed: 'YouTube 재생목록 가져오기에 실패했습니다',
    typeURL: '웹페이지',
    typeManual: '수동 생성',
    typeFile: '파일',
    channelLabel: '출처 채널',
