export default {
  ...
  settings: {
    ...
    skills: {
      ...
      upgradeDrawerDesc: '선택한 샌드박스의 「{name}」을(를) 카탈로그 버전으로 업그레이드합니다. 재설치가 끝날 때까지 해당 샌드박스에서는 이 스킬을 사용할 수 없습니다.',
      ...
      upgradeRowHint: '이 샌드박스의 버전이 카탈로그와 다릅니다. 업그레이드하면 다시 설치되며, 완료될 때까지 이 샌드박스에서는 스킬을 사용할 수 없습니다.',
      upgradeRowHintVersions: '이 샌드박스는 {from}, 카탈로그는 {to}입니다. 업그레이드하면 다시 설치되며, 완료될 때까지 이 샌드박스에서는 스킬을 사용할 수 없습니다.',
