  ...
  knowledgeEditor: {
    ...
    wikiBrowser: {
      ...
      statistics: {
        tabName: '통계',
        totalChunks: '총 청크',
        totalFeedbacks: '총 피드백',
        totalLikes: '총 좋아요',
        totalDislikes: '총 싫어요',
        averageLikeRate: '평균 좋아요율',
        pendingOptimization: '최적화 대기',
        searchPlaceholder: '내용 검색...',
        filterByPending: '상태별 필터',
        pendingOnly: '최적화 대기만 표시',
        sortBy: '정렬 기준',
        sortByLikeRate: '좋아요율',
        sortByLikeCount: '좋아요 수',
        sortByDislikeCount: '싫어요 수',
        sortByWeight: '리콜 가중치',
        batchAdjust: '가중치 일괄 조정',
        likes: '좋아요',
        dislikes: '싫어요',
        likeRate: '좋아요율',
        weight: '가중치',
        ...
        recallWeight: '리콜 가중치',
        normal: '정상',
        pendingOptimizationTag: '최적화 대기',
        dislikeReasons: '싫어요 이유 분포',
        ...
        newWeight: '새 가중치',
        createdAt: '시간',
        noDislikeReasons: '싫어요 이유 기록 없음',
        reasonInaccurate: '정확하지 않음',
        reasonIncomplete: '불완전함',
        reasonIrrelevant: '관련 없음',
        reasonOther: '기타',
        triggerUserFeedback: '사용자 피드백',
        triggerAutoAdjust: '자동 조정',
        triggerManualReset: '수동 초기화',
        triggerBatchUpdate: '일괄 업데이트',
        loadFailed: '통계 로드 실패',
        resetSuccess: '청크 초기화 성공',
        resetFailed: '청크 초기화 실패',
        adjustSuccess: '가중치 조정 성공',
        adjustFailed: '가중치 조정 실패',
      },
