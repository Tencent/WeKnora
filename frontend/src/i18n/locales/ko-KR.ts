export default {
  ...
  datasource: {
    ...
    connectorDesc: {
      ...
      dingtalk: "DingTalk 지식베이스에서 온라인 문서 동기화",
    ...
    field: {
      ...
      operatorIdHint: "이 사용자의 권한으로 지식베이스를 읽습니다. DingTalk 사용자 상세 조회 API에서 확인할 수 있습니다.",
    ...
    prereqStep1Desc_dingtalk: "DingTalk 오픈 플랫폼에서 내부 앱을 만들고 Client ID와 Client Secret을 확인하세요.",
    ...
    prereqStep3Brief_dingtalk: "작업자 Union ID 입력",
    prereqStep3Desc_dingtalk: "대상 지식베이스에 접근 가능한 DingTalk 사용자의 Union ID를 입력하세요.",
