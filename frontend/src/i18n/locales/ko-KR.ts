export default {
  ...
  agentEditor: {
    ...
    im: {
      ...
      messageStorage: '각 Q&A 라운드를 지식 베이스에 자동 저장',
      messageStorageHint: '텍스트, 파일, 이미지는 일반 Q&A 흐름으로 먼저 처리된 뒤 답변 완료 후 비동기로 저장됩니다.',
      fileKnowledgeBase: '저장 대상 지식 베이스',
      fileKnowledgeBasePlaceholder: '지식 베이스 선택',
      fileKnowledgeBaseHint: '대상은 사전 설정으로 유지되며 메시지 저장을 켠 경우에만 사용됩니다.',
      fileKnowledgeBaseRequired: '메시지 저장을 켜려면 대상 지식 베이스를 선택하세요',
      sessionMode: '세션 모드',
