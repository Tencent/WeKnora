export default {
  ...
  knowledgeEditor: {
    ...
    wikiBrowser: {
      ...
      learningFamiliar: '익숙함',
      learningExploring: '탐색 중',
      learningUnseen: '학습 공백',
      learningTitle: '근거 기반 학습 안내',
      learningSummary: '익숙함 {familiar} · 탐색 {exploring} · 공백 {unseen}',
      learningEvidenceNote: '문서 인용은 해당 요약 노드만 표시하며 최대 80점입니다. LLM의 주관적 평가가 아닙니다.',
      learningNext: '다음에 읽을 내용',
      learningReason: '익숙한 노드 {count}개와 연결',
      learningNodeScore: '근거 점수 {score} (최대 80)',
      learningNodeEvidence: '출처 {sources}개에서 답변 인용 {count}회를 관찰했습니다.',
