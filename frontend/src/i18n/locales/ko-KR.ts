export default {
  ...
  auth: {
    ...
    bootstrapAdmin: '시스템 관리자 설정',
    bootstrapFirstTime: '첫 배포인가요?',
    bootstrapHint: '이 배포를 관리할 시스템 관리자 계정을 생성하세요.',
    bootstrapping: '설정 중...',
    bootstrapSuccess: '시스템 관리자가 생성되었습니다. WeKnora에 오신 것을 환영합니다',
    bootstrapFailed: '시스템 관리자 설정에 실패했습니다',
