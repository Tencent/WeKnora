export default {
  ...
  knowledgeBase: {
    ...
    buildProgress: "지식 구축 진행률",
    buildProgressAria: "지식 구축 진행률 {percentage}%, 전체 {total}개 중 {settled}개 종료",
    buildProgressTotal: "전체 {total}개 중 {settled}개 종료",
    batchStatusInFlight: "진행 중 {count}",
    batchStatusCompleted: "완료 {count}",
    batchStatusFailed: "실패 {count}",
    batchStatusCancelled: "취소됨 {count}",
    batchStatusDraft: "초안 {count}",
    batchCancelParse: "파싱 중지",
    confirmBatchCancelParse: "선택한 진행 중 작업 {count}개를 중지하시겠습니까? 이미 저장된 청크는 유지됩니다.",
    batchCancelParseSuccess: "파싱 작업 {count}개를 중지했습니다",
    batchCancelParseFailed: "파싱 작업 일괄 중지 실패",
    batchCancelParseSkipped: "{count}개 작업의 상태가 변경되었거나 중지하지 못했습니다",
    batchDelete: "선택 삭제",
