export default {
  ...
  integrations: {
    ...
    api: {
      ...
      kbPermissionPerKB: "지식 베이스별 권한",
      kbPermissionUniform: "통합 권한",
      kbPermissionHint: "권한은 키의 기능과 현재 공유 권한으로 제한됩니다. 공유 KB 관리에는 소유권이나 공유 설정 변경 권한이 포함되지 않습니다.",
      kbPermissionSelect: "소유 또는 공유 지식 베이스 선택",
      kbPermissionEmpty: "지식 베이스 접근 불가",
      kbPermissionRead: "읽기 / 검색",
      kbPermissionWrite: "읽기 및 콘텐츠 쓰기",
      kbPermissionManage: "지식 베이스 관리",
      kbPermissionOwn: "현재 워크스페이스",
      kbPermissionUnavailable: "사용할 수 없거나 공유가 해제되었습니다. 저장 전에 이 항목을 제거하세요.",
      kbPermissionUniformHint: "선택한 소유 KB에 동일한 기능을 적용합니다. 비워 두면 기존의 제한 없는 범위를 유지합니다. 공유 KB는 개별 권한으로 설정하세요.",
      kbPermissionLoadFailed: "일부 KB 옵션을 불러오지 못했습니다. 권한을 변경하기 전에 다시 시도하세요.",
