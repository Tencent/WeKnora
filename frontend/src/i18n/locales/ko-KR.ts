export default {
  ...
  settings: {
    ...
    sandbox: {
      ...
      templateLoadHint: '클러스터 연결을 입력한 뒤 새로고침하세요. 공식 CLI 또는 데스크톱 템플릿이 없으면 Hub 이미지로 자동 구축합니다. DNS나 이미지를 바꾼 뒤에는 해당 카드에서 재구축하세요.',
      ...
      templateStepHint: '이 단계에서는 클러스터 템플릿을 나열하고, 공식 CLI 및 데스크톱 이미지가 없으면 Hub에서 구축합니다. DNS나 이미지를 바꾼 뒤에는 해당 카드에서 「재구축」을 누르세요. 템플릿이 준비된 뒤에 계속할 수 있습니다.',
