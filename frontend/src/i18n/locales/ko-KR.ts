export default {
  ...
  knowledgeBase: {
    ...
    folder: {
      ...
      createUnder: '"{name}" 아래에 생성됩니다',
      created: '폴더가 생성되었습니다',
      renamed: '폴더 이름이 변경되었습니다',
      moved: '폴더가 이동되었습니다',
      deleted: '폴더가 삭제되었습니다',
      deleteConfirm: '폴더 "{name}"을(를) 삭제하시겠습니까?',
      deletePromote: '내부 문서와 하위 폴더를 상위로 이동 (문서는 삭제되지 않음)',
      deleteNotEmpty: '폴더가 비어 있지 않습니다. 내용을 이동하거나 상위 이동을 선택하세요',
      organizeByPath: '업로드 경로로 정리',
      organizeConfirm: '루트에 있는, 파일명에 상대 경로가 포함된(폴더 업로드로 생성) 문서를 경로에 따라 폴더로 정리합니다. 반복 실행해도 안전합니다.',
      organizeResult: '{organized}개 문서 정리, {folders}개 폴더 생성',
      askInFolder: '이 폴더에서 질문하기',
      pickTarget: '폴더 선택',
      noFolders: '폴더가 없습니다',
