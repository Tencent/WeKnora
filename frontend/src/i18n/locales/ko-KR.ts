export default {
  ...
  chat: {
    feedback: {
      rateHelpful: '이 답변에 추천',
      rateUnhelpful: '이 답변 신고',
      rated: '평가함',
      dislikeTitle: '신고 사유',
      submit: '제출',
      otherReason: '기타',
      reasonPlaceholder: '문제를 간략히 설명해 주세요 (선택)',
      reasonInaccurate: '내용이 부정확함',
      reasonOutdated: '내용이 납시됨',
      reasonIrrelevant: '질문과 무관한 답변',
      reasonIncomplete: '답변이 불완전함',
      reasonNoReference: '참조 출처 부족',
      reasonRequired: '신고 사유를 선택하거나 입력해 주세요',
      cancelled: '평가가 취소되었습니다',
      likeSuccess: '추천 피드백을 보내주셔서 감사합니다',
      dislikeSuccess: '피드백을 보내주셔서 감사합니다. 계속 개선하겠습니다',
  ...
  knowledgeEditor: {
    ...
    feedback: {
      title: '한전 피드백 통계',
      description: '질문답변에서 지식베이스 한전의 추천/비추천 피드백, 지지율, 재호우선 가중치를 확인하고 저질 한전을 사이해 가중치 자동 조정 설정을 관리합니다.',
      retry: '재시도',
      loadFailed: '한전 피드백 데이터를 불러오지 못했습니다',
      keywordPlaceholder: '한전 내용 검색',
      approvalPlaceholder: '지지율',
      approvalAll: '전체 한전',
      approvalHigh: '지지율 ≥ 80%',
      approvalNormal: '지지율 50% - 80%',
      approvalLow: '지지율 < 50%',
      approvalNeedsOptimization: '최적화 필요만',
      apply: '필터',
      resetSelected: '선택 초기화',
      reset: '초기화',
      detail: '상세',
      totalCount: '전체 {count} 개 한전',
      empty: '한전 피드백 데이터가 아직 없습니다',
      statusNeedsOptimization: '최적화 필요',
      statusNormal: '정상',
      sortApprovalRate: '지지율별',
      sortLikeCount: '추천수별',
      sortDislikeCount: '비추천수별',
      sortRecallWeight: '재호우선 가중치별',
      sortSessionCount: '연관 세션별',
      sortFeedbackCount: '피드백수별',
      columns: {
        content: '한전 내용',
        likeCount: '추천',
        dislikeCount: '비추천',
        approvalRate: '지지율',
        recallWeight: '재호우선 가중치',
        sessionCount: '연관 세션',
        feedbackCount: '피드백수',
        status: '상태',
        actions: '작업'
      ...
      drawer: {
        title: '한전 피드백 상세',
        summary: '통계 개요',
        dislikeReasons: '비추천 사유 집계',
        relatedSessions: '연관 질문답변 세션',
        noReasons: '비추천 사유가 없습니다',
        noSessions: '연관 세션이 없습니다',
        sessionMessages: '메시지 {count} 개'
      },
      resetConfirmTitle: '한전 피드백 초기화',
      resetConfirmBody: '선택한 {count} 개 한전을 초기화하시겠습니까? 추천/비추천 데이터를 지우고 재호우선 가중치를 1.0으로 복원합니다. 이 작업은 되돌릴 수 없습니다.',
      resetConfirm: '확인 초기화',
      resetSuccess: '한전 피드백이 초기화되었습니다',
      resetFailed: '초기화 실패',
      config: {
        title: '가중치 자동 조정 설정',
        description: '한전 지지율에 따라 질문답변 검색 재호우선 가중치를 자동으로 조정합니다. 지지율이 높으면 가중치가 상승하고, 매우 낮은 지지율은 최적화 필요로 표시됩니다.',
        tenantHint: '이 설정은 현재 워크스페이스의 모든 지식베이스에 적용됩니다.',
        save: '설정 저장',
        saved: '설정이 저장되었습니다',
        saveFailed: '설정 저장 실패',
        loadFailed: '설정 로드 실패',
        boostThreshold: '상승 임계값',
        boostThresholdTip: '지지율이 이 값 이상이면 재호우선 가중치 상승',
        degradeThreshold: '하락 임계값',
        degradeThresholdTip: '지지율이 이 값 미만이면 재호우선 가중치 하락',
        optimizeThreshold: '최적화 임계값',
        optimizeThresholdTip: '지지율이 이 값 미만이면 최적화 필요로 표시',
        minVotes: '최소 평가수',
        minVotesTip: '평가 수가 이 값에 도달하면 가중치 조정',
        weightStep: '가중치 단계',
        weightStepTip: '조정될 때마다 증감/감소하는 폭',
        maxWeight: '최대 가중치',
        maxWeightTip: '재호우선 가중치 상한',
        minWeight: '최소 가중치',
        minWeightTip: '재호우선 가중치 하한'
      },
      logs: {
        title: '가중치 변경 로그',
        description: '한전 재호우선 가중치 조정 이력과 발생 원인을 확인합니다.',
        loadFailed: '가중치 로그 로드 실패',
        empty: '가중치 변경 기록이 없습니다',
        sourceAll: '전체 원인',
        sourceFeedback: '사용자 피드백',
        sourceManualReset: '수동 초기화',
        sourceManualAdjust: '수동 조정',
        columns: {
          time: '시간',
          chunk: '한전',
          oldWeight: '이전 가중치',
