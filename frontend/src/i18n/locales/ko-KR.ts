export default {
  ...
  knowledgeBase: {
    ...
    urlLabel: '링크',
    urlPlaceholder: '한 줄에 하나씩 링크를 입력하세요. 예:\nhttps://example.com/article\nhttps://www.youtube.com/watch?v=VIDEO_ID\nhttps://www.youtube.com/playlist?list=PLAYLIST_ID',
    urlTip: '웹페이지 또는 YouTube 링크를 한 줄에 하나씩 붙여넣으세요. 웹페이지는 가져와서 분석합니다. 각 YouTube 동영상은 자막(자막이 없으면 음성 인식)을 기반으로 개별 문서가 되며, 각 YouTube 재생목록은 재생목록 이름의 폴더로 가져옵니다. &list=가 포함된 동영상 링크는 해당 동영상만 가져오므로 전체 재생목록은 재생목록 링크를 사용하세요',
    urlPreviewWebPages: '웹페이지 {count}개',
    urlPreviewYouTubeVideos: 'YouTube 동영상 {count}개',
    urlPreviewYouTubePlaylists: 'YouTube 재생목록 {count}개, 각각 별도 폴더로',
    urlPreviewInvalid: '유효하지 않은 줄 {count}개, 건너뜀',
