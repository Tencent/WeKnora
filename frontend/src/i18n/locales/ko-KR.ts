export default {
  ...
  knowledgeBase: {
    ...
    folder: {
      ...
      createUnder: '「{name}」 하위에 생성됩니다',
      created: '폴더가 생성되었습니다',
      renamed: '폴더 이름이 변경되었습니다',
      moved: '폴더가 이동되었습니다',
      deleted: '폴더가 삭제되었습니다',
      deleteConfirm: '폴더 「{name}」을(를) 삭제하시겠습니까?',
      deletePromote: '내부 문서와 하위 폴더를 상위로 이동합니다(문서는 삭제되지 않습니다)',
      deleteNotEmpty: '폴더가 비어 있지 않습니다. 내용을 옮기거나 상위 이동을 선택하세요',
      organizeByPath: '경로 파일 정리',
      organizeConfirm: '이름에 상대 경로가 포함된 기존 문서를 경로에 따라 폴더로 정리합니다. 반복 실행해도 안전합니다.',
      organizeResult: '{organized}개 문서를 정리하고 {folders}개 폴더를 생성했습니다',
      askInFolder: '이 폴더 내에서 질문',
      pickTarget: '폴더 선택',
      noFolders: '폴더가 없습니다',
      moveDocsTo: '{count}개 문서를 이동…',
      movedDocs: '{count}개 문서를 이동했습니다',
      searchPlaceholder: '폴더 검색',
      newSubfolder: '새 하위 폴더',
      moveIntoSelf: '폴더를 자신 또는 하위 폴더로 이동할 수 없습니다',
      moveConfirmTitle: '이동 확인',
      moveConfirm: '이 폴더를 「{target}」(으)로 이동하시겠습니까?',
      noMatchedFolders: '일치하는 폴더가 없습니다',
    },
