export default {
  ...
  settings: {
    ...
    skills: {
      ...
      addStepRegister: '등록',
      addStepInstall: '설치',
      addStepRegisterDesc: "링크, ZIP 또는 설치 지침으로 스킬을 추가합니다.",
      addMethodSource: "소스 링크",
      addMethodFile: "ZIP 업로드",
      addMethodPrompt: "Prompt 설치",
      promptInstructions: "설치 지침",
      promptInstallDesc: "샌드박스를 선택해 시작하세요. 진행 상황 확인, 추가 지침 및 재시도가 가능합니다.",
      promptTitle: "설치 지침 입력",
      promptHint: "스킬 이름, 설치 문서, 명령 또는 요구 사항을 입력하세요. 샌드박스를 선택하면 Agent가 문서를 읽고 도구를 준비해 스킬을 가져오고 설치를 검증합니다.",
      promptPlaceholder: "예: 문서에 따라 지정 ID의 스킬을 설치하고, CLI가 없으면 먼저 설치합니다.",
