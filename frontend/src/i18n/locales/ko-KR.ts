import { evaluationFlowKo as evaluationFlow } from '../evaluationFlow'
...
export default {
  ...
  organization: {
    ...
    avatar: '공유 공간 아바타',
    avatarClear: '지우기',
    avatarPickerHint: '공유 공간 아이콘을 선택하세요',
  ...
  modelSettings: {
    ...
    observability: {
      cachePricingTitle: "캐시 토큰 가격 (선택)",
      cacheReadPrice: "캐시 읽기 / 백만",
      cacheWrite5mPrice: "캐시 쓰기 · 5분 / 백만",
      cacheWrite1hPrice: "캐시 쓰기 · 1시간 / 백만",
      cachePricingHint: "빈칸은 알 수 없는 가격이며, 0은 무료입니다. 단위는 기본 입력/출력 가격과 같습니다.",
      unknownPrice: "알 수 없음",
      callStatus: "호출 상태",
      started: "진행 중",
      success: "성공",
  ...
  evaluation: {
    ...
    allStatuses: '모든 상태',
    dataset: '데이터셋',
    datasetPlaceholder: '데이터셋 ID',
    datasetVersion: '데이터셋 버전',
    versionPlaceholder: '버전 ID',
    model: '모델',
    modelPlaceholder: '모델 ID',
    startedFrom: '시작 시간 하한',
    startedTo: '시작 시간 상한',
    labels: '라벨',
    ...
    runs: '실험 실행',
    refresh: '실행 목록 새로 고침',
    selectedRuns: '개 실행 선택',
    baseline: '기준',
    comparing: '비교 중…',
    compare: '실행 비교',
    loading: '로드 중…',
    noRuns: '필터에 해당하는 실행이 없습니다.',
    loadMore: '실행 더 보기',
    selectRun: '실행 {id} 선택',
    runsCompared: '개 실행 비교',
    comparison: '비교',
    backToDetail: '실행 상세로 돌아가기',
    parameterDifferences: '안정 매개변수 차이',
    parameter: '매개변수',
    missing: '누락',
    metricDifferences: '지표 차이',
    questionSuccess: '질문 성공률',
    compatible: '호환',
    incompatible: '비호환',
    runDetails: '실행 상세',
    progress: '진행률',
    ...
    questions: '질문',
    experiment: '고정 실험',
    aggregateMetrics: '집계 지표',
    loadingQuestions: '질문 근거 로드 중…',
    noQuestions: '질문 결과가 없습니다.',
    referenceAnswer: '참고 답변',
    generatedText: '생성 답변',
    humanRating: '사람 평가',
    ...
    appendRating: '수정 추가',
    savingRating: '저장 중…',
    noRatings: '사람 평가 수정 이력이 없습니다.',
    ratingSaved: '평가 수정이 추가되었습니다',
    loadMoreQuestions: '질문 더 보기',
    detailEmpty: '실험 실행을 선택하세요',
    detailEmptyHint: '여기에 출처, 지표, 질문 근거, 내보내기 제어가 표시됩니다.',
    loadingDetail: '실행 상세 로드 중…',
    selectAtMostTen: '최대 10개의 실행을 선택하세요.',
    selectAtLeastTwo: '최소 2개의 실행을 선택하세요.',
    labelsSaved: '라벨이 저장되었습니다',
    unknownError: '평가 요청이 실패했습니다.',
    status: {
      pending: '대기 중',
      running: '실행 중',
      success: '성공',
