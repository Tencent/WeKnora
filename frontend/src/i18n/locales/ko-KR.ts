export default {
  ...
  knowledgeBase: {
    ...
    fileTypeLabel: "파일 유형",
    importTypeLabel: "가져오기 유형",
    contentTypeLabel: "콘텐츠 유형",
    contentTypeUnclassified: "미분류",
    editContentType: "콘텐츠 유형 설정",
    batchSetContentType: "콘텐츠 유형 설정",
    contentTypePlaceholder: "콘텐츠 유형 선택",
    contentTypeRequired: "콘텐츠 유형을 선택하세요",
    contentTypeUpdateSuccess: "콘텐츠 유형이 업데이트되었습니다",
    contentTypeUpdateFailed: "콘텐츠 유형 업데이트 실패",
    batchContentTypeSuccess: "문서 {count}개의 콘텐츠 유형을 업데이트했습니다",
    renameDocument: "이름 바꾸기",
    renamePlaceholder: "새 이름 입력",
    renameRequired: "이름은 필수입니다",
    renameInvalid: "이름이 너무 길거나 잘못된 문자가 포함되어 있습니다",
    renameSuccess: "이름을 변경했습니다",
    renameFailed: "이름 변경 실패",
    contentTypes: {
      article: "문서", book: "도서", webpage: "웹페이지", meeting_notes: "회의록",
      report: "보고서", presentation: "프레젠테이션", spreadsheet: "스프레드시트", manual: "매뉴얼", other: "기타",
    },
    statusCompleted: "완료",
  ...
  knowledgeStages: {
    ...
    retry: "다시 파싱",
    rebuild: "재구축",
    rebuildDialogTitle: "재구축 범위 선택",
    rebuildSubmit: "재구축 제출",
    rebuildFull: "전체 재구축",
    rebuildPartial: "부분 재구축",
    rebuildSelectOne: "하나 이상의 재구축 단계를 선택하세요",
    rebuildSubmitted: "재구축 작업이 제출되었습니다",
    rebuildFailed: "재구축 제출 실패",
    stageEmbedding: "임베딩 인덱스",
    stageSummary: "요약",
    stageQuestions: "질문 생성",
    stageGraph: "지식 그래프",
    stageWiki: "Wiki",
    stageJournalRank: "저널 등급",
    stageContentType: "콘텐츠 유형",
    refresh: "지금 새로고침",
    copy: "복사",
    copyDetails: "세부정보 복사",
    copied: "클립보드에 복사됨",
  ...
  settings: {
    ...
    parser: {
      ...
      easyScholarSection: '저널 등급 (EasyScholar)',
  ...
  webSearchSettings: {
    ...
    engineIdLabel: "엔진 ID",
    serpApiEngineLabel: "검색 엔진",
    serpApiEngineHelp: "SerpApi 결과 유형을 선택합니다. 기본값은 Google 웹 검색입니다.",
    serpApiEngines: {
      google: "Google 웹",
      googleNews: "Google 뉴스",
      googleScholar: "Google 학술",
      googlePatents: "Google 특허",
      bing: "Bing",
      duckduckgo: "DuckDuckGo",
      googleImages: "Google 이미지",
      googleVideos: "Google 동영상",
      youtube: "YouTube",
    },
