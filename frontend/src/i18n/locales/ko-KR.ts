export default {
  workbench: {
    ...
    states: { bound: '연결됨', ready: '준비됨', available: '사용 가능', disabled: '워크벤치가 비활성화되어 있습니다', unbound: '연결된 샌드박스 없음', policy_denied: '워크스페이스 정책으로 차단됨', unavailable: '워크벤치 사용 불가', unsupported: '지원하지 않는 샌드박스' },
