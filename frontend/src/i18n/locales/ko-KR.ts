export default {
  ...
  datasource: {
    ...
    noResourcesDesc_dingtalk: "앱이 콘텐츠를 가져오려면 DingTalk 문서 공간 접근 권한이 필요합니다",
    ...
    guideStep1_dingtalk: "DingTalk Open Platform에서 내부 기업 앱을 만들고 App Key와 App Secret을 복사하세요",
    guideStep2_dingtalk: "앱에 DingTalk 문서 공간 및 문서 콘텐츠 읽기 권한을 부여하고 대상 조직에 게시하세요",
    guideStep3_dingtalk: "앱이 속한 조직이 대상 문서 공간에 접근할 수 있는지 확인한 후 다시 시도를 클릭하세요",
    ...
    connectorDesc: {
      ...
      dingtalk: "DingTalk 문서 공간, 폴더 및 문서 동기화",
    ...
    field: {
      ...
      dingtalkBaseUrlHint: "비워두면 DingTalk Open Platform https://api.dingtalk.com 을 사용합니다. 사설 배포 또는 프록시를 사용하는 경우 사용자 지정 API 주소를 입력하세요.",
      feedUrls: "피드 주소",
    ...
    prereqStep1Brief_dingtalk: "DingTalk 내부 기업 앱 생성",
    prereqStep1Desc_dingtalk: "DingTalk Open Platform > 앱 개발 > 내부 기업 앱 > 앱 생성에서 App Key와 App Secret을 복사하세요",
    prereqStep2Brief_dingtalk: "문서 읽기 권한 부여",
    prereqStep2Desc_dingtalk: "앱에 DingTalk 문서 공간 및 문서 콘텐츠 읽기 권한을 부여하고 대상 조직에 게시하세요",
    prereqStep3Brief_dingtalk: "문서 공간 접근 범위 확인",
    prereqStep3Desc_dingtalk: "앱이 속한 조직이 대상 문서 공간에 접근할 수 있는지 확인한 후 여기에서 연결을 테스트하고 동기화 범위를 선택하세요.",
