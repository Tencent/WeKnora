export default {
  ...
  datasource: {
    ...
    gitRepo: {
      ...
      webhookDesc: 'GitLab / GitHub 저장소의 Webhook 설정에 위 URL을 등록(Push events)하면 푸시마다 증분 동기화가 자동으로 트리거됩니다. 시크릿 토큰은 관리자가 구성합니다(데이터 소스 webhook_secret 또는 환경 변수 GIT_REPO_WEBHOOK_SECRET).',
    },
