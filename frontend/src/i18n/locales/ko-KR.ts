export default {
  ...
  modelSettings: {
    ...
    analytics: {
      ...
      callsUnit: '회 호출',
      compositionUnavailable: '호출 구성과 총합이 일치하지 않아 표시할 수 없습니다.',
      inputDetail: '입력 {value}',
      outputDetail: '출력 {value}',
      observedCoverage: '관측 {observed} / {applicable}회',
      notObserved: '관측값 없음',
      usageTrend: '사용량 추이',
      trendDescription: '생성 시간 기준 서버 집계 모델 사용량',
      tokens: '토큰',
      latency: '지연 시간',
      noMetricData: '이 지표에 관측된 데이터가 없습니다.',
      promptCache: 'Prompt 캐시',
      providerCache: '제공자 Prompt 캐시',
      callHitRate: '호출 적중률',
      tokenCacheRatio: '토큰 캐시 비율',
      promptCacheDetail: '적중 {hit} · 미적중 {miss} · 판정 가능 {eligible}',
      embeddingCache: 'Embedding 캐시',
      weknoraCache: 'WeKnora Embedding 캐시',
      inputHitRate: '입력 적중률',
      embeddingCacheDetail: '적중 {hit} · 미적중 {miss} · 판정 가능 입력 {eligible}',
      loadFailed: '모델 사용량 분석을 불러오지 못했습니다',
      retry: '다시 시도',
      empty: '이 기간에는 모델 사용량 데이터가 없습니다.',
      modelsLoadFailed: '모델 필터를 사용할 수 없습니다. 모든 모델의 분석은 계속 볼 수 있습니다.'
    },
    copySuffix: ' 사본',
    builtinTag: '기본제공',
