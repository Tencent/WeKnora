export default {
  ...
  datasource: {
    ...
    prereqStep3Desc_feishu_links: "wiki:wiki:readonly, drive:drive:readonly, drive:export:readonly, docx:document:readonly 권한 활성화",
    ...
    prereqStep3Desc_lark_links: "wiki:wiki:readonly, drive:drive:readonly, drive:export:readonly, docx:document:readonly 권한 활성화",
