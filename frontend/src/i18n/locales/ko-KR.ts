export default {
  ...
  integrations: {
    ...
    api: {
      ...
      apiKeyKnowledgePermissionsHint: '기본값은 위에서 선택한 읽기 / 편집 / 관리 권한을 따릅니다. 지식베이스별로 선택을 해제할 수 있으며, 읽기를 해제하면 목록에서 제거됩니다.',
      kbPermissionRead: '읽기',
      kbPermissionEdit: '편집',
      kbPermissionManage: '관리',
      apiKeyKnowledgeScopeSummary: '{total}개 (편집 {editable} / 관리 {manageable})',
