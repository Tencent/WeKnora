export default {
  ...
  datasource: {
    ...
    noResourcesDesc_dingtalk: "DingTalk 앱에 위키 및 문서 읽기 권한을 부여하고 작업 사용자가 대상 공간을 읽을 수 있는지 확인하세요.",
    ...
    guideStep1_dingtalk: "DingTalk Open Platform에서 내부 앱을 만들거나 선택합니다",
    guideStep2_dingtalk: "위키 공간, 노드 및 파일 읽기 권한을 부여한 뒤 앱 버전을 배포합니다",
    guideStep3_dingtalk: "작업 사용자가 대상 위키에 접근할 수 있는지 확인한 후 여기서 다시 불러옵니다",
    permissionDocLink: "페이슈 위키 권한 설정 문서 보기",
    permissionDocLink_dingtalk: "DingTalk Open Platform 문서 보기",
    ...
    syncError: {
      ...
      dingtalk_auth_or_permission: "DingTalk 인증 또는 권한 부족: 자격 증명, 앱 권한 및 작업자 접근 권한을 확인하세요",
      dingtalk_rate_limited: "DingTalk API 요청 제한, 다음 동기화 시 다시 시도합니다",
      dingtalk_timeout: "DingTalk 요청 시간 초과, 다음 동기화 시 다시 시도합니다",
      dingtalk_server_unavailable: "DingTalk 서비스가 일시적으로 사용 불가, 다음 동기화 시 다시 시도합니다",
    ...
    connectorDesc: {
      ...
      dingtalk: "DingTalk 위키의 온라인 문서를 동기화합니다",
    },
    field: {
      appId: "App ID",
      ...
      operatorId: "작업 사용자 UnionID",
      operatorIdHint: "대상 DingTalk 위키를 읽을 수 있는 사용자의 unionId를 입력하세요. 위키 API에 필요한 값입니다.",
    ...
    prereqBarText_dingtalk: "처음 사용하시나요? DingTalk 앱 설정 안내 보기",
    prereqStep1Brief_dingtalk: "DingTalk 내부 앱 만들기",
    prereqStep1Desc_dingtalk: "DingTalk Open Platform에서 앱을 열고 Client ID와 Client Secret을 복사합니다.",
    prereqStep2Brief_dingtalk: "위키 및 문서 읽기 권한 부여",
    prereqStep2Desc_dingtalk: "Wiki.Workspace.Read, Wiki.Node.Read, Storage.File.Read를 활성화하고 앱 버전을 배포합니다.",
    prereqStep3Brief_dingtalk: "작업 사용자 UnionID 준비",
    prereqStep3Desc_dingtalk: "대상 위키 공간과 문서를 읽을 수 있는 사용자의 unionId를 입력합니다.",
