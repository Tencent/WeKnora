export default {
  ...
  agent: {
    ...
    editor: {
      ...
      promptsConfig: "지침 및 동작",
      promptsConfigDesc: "비즈니스 지침과 구조화된 동작을 설정합니다. 검색·도구·출력 프로토콜은 시스템에서 관리합니다.",
      modelConfig: "모델 구성",
      ...
      webSearchConfig: "웹 검색",
      webSearchConfigDesc: "웹 소스 사용 가능 여부와 빠른 답변 검색 정책을 설정합니다.",
      webSearchModeOff: "끄기",
      webSearchModeOnDemand: "필요할 때 보완(권장)",
      webSearchModeAlways: "항상 통합 검색",
      configuration: "구성 항목",
      agentId: "에이전트 ID",
  ...
  agentEditor: {
    ...
    promptProtocol: {
      managedNotice: '시스템 관리 프롬프트 프로토콜 v{version}이 적용됩니다. 검색 라우팅, 도구, 안전, 인용 및 출력 계약은 에이전트 지침으로 재정의할 수 없습니다.',
      userInstructions: '사용자 지침',
      userInstructionsDesc: '역할, 어조, 대상 사용자, 응답 선호 및 비즈니스 규칙을 정의합니다. 관리형 프로토콜은 재정의할 수 없습니다.',
      userInstructionsPlaceholder: '예: 신규 직원을 돕는 제품 도우미입니다. 먼저 결론을 제시한 뒤 단계를 설명하세요.',
      managedFallback: '모델 폴백 판단과 생성 규칙은 시스템에서 관리되며 프로토콜 버전과 함께 업그레이드됩니다.',
    },
    selection: {
      all: '전체',
      selected: '지정',
