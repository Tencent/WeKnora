export default {
  ...
  datasource: {
    ...
    feishu: {
      authModeApp: "앱 인증",
      authModeUser: "개인 인증",
      authModeAppHint: "자체 제작 앱 신원으로 읽으며, 앱에 명시적으로 공유된 위키와 문서만 접근할 수 있습니다.",
      authModeUserHint: "본인 Feishu 신원으로 읽으며, 본인이 접근 권한을 가진 모든 문서를 내보낼 수 있습니다(아래에서 인증을 완료하세요).",
      authorize: "Feishu 인증하기",
      reauthorize: "다시 인증",
      authorized: "Feishu 개인 인증 완료",
      authorizeHint: "Feishu 동의 페이지가 열립니다. 본인 계정으로 로그인하고 승인하세요. 먼저 위의 App ID와 App Secret을 입력하세요.",
      authSuccess: "Feishu 인증 성공",
      authFailed: "Feishu 인증 실패, 다시 시도하세요",
      authRequired: "먼저 Feishu 개인 인증을 완료하세요",
      appCredsRequired: "먼저 App ID와 App Secret을 입력하세요",
      popupBlocked: "브라우저에서 팝업이 차단되었습니다. 팝업을 허용한 후 다시 시도하세요",
    },
    comingSoon: "곧 지원 예정",
    ...
    prereqOAuthCallbackBrief_feishu: "개인 인증 콜백 URL 설정",
    prereqOAuthCallbackDesc_feishu: "Feishu 오픈 플랫폼 → 보안 설정 → 리디렉션 URL에 아래 주소를 정확히 추가하세요:",
