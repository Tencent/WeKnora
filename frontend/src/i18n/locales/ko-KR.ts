export default {
  ...
  knowledgeBase: {
    ...
    rootFolder: "루트",
    folderTreeTitle: "폴더 트리",
    showFolderTree: "폴더 트리 표시",
    hideFolderTree: "폴더 트리 숨기기",
    searchWholeKb: "전체 검색: {q}",
    folderBreadcrumbLabel: "폴더 경로",
    breadcrumbCollapsedItems: "{count}개 레벨 축소됨",
    emptyFolderTree: "폴더 없음",
    emptyFolderTreeHint: "생성한 폴더가 여기에 표시됩니다",
    // Task 9: 검색 모드 필터 힌트 및 빈 상태 문구
    searchFiltersApplyOnlyToDocs: "기타 필터는 파일에만 적용됩니다",
    emptyFolderHint: "이 폴더는 비어 있습니다",
    searchNoResults: "결과를 찾을 수 없습니다",
    emptyRootViewer: "이 지식 베이스에 아직 콘텐츠가 없습니다",
    newFolder: "새 폴더",
    folderActions: "폴더 작업",
    folderActionAddSubfolder: "새 하위 폴더",
    folderActionRename: "이름 변경",
    folderActionDelete: "삭제",
    folderActionMoveTo: "폴더로 이동…",
    folderActionDeleteConfirm: "폴더 \"{name}\"을(를) 삭제하시겠습니까? 모든 하위 폴더와 문서도 함께 삭제됩니다.",
    folderDocumentCount: "문서 {count}개",
    folderCardType: "폴더",
    // Inline folder editing (Task 6): UX pre-validation + backend error mapping.
    folderNameRequired: "폴더 이름을 입력하세요",
    folderNameInvalid: "폴더 이름은 \".\", \"..\"일 수 없으며 \"/\" 또는 \"\\\"를 포함할 수 없습니다",
    folderNameConflict: "같은 이름의 폴더가 이미 있습니다. 다른 이름을 사용하세요.",
    folderDepthExceeded: "폴더 깊이 제한에 도달했습니다. 이 위치에 폴더를 만들 수 없습니다.",
    folderActionFailed: "폴더 작업에 실패했습니다. 다시 시도하세요.",
    expandFolder: "확장",
    collapseFolder: "축소",
    // Move-to-folder picker (Task 7): same-KB move + cross-KB transfer split.
    transferToKnowledgeBase: "다른 지식베이스로 이전…",
    folderPickerTitle: "폴더로 이동",
    folderPickerTargetLabel: "대상 위치",
    folderPickerSelectHint: "대상 폴더를 선택하세요",
    folderPickerDisabledHint: "이 폴더로 이동할 수 없습니다",
    folderPickerConfirm: "이곳으로 이동",
    folderPickerEmpty: "선택할 폴더가 없습니다",
    folderMoveSuccess: "선택한 폴더로 이동했습니다",
    folderMoveFailed: "이동에 실패했습니다. 다시 시도하세요.",
    // Recursive folder delete (Task 8): impact display + submitted (not done) messaging.
    folderDeleteTitle: "폴더 삭제",
    folderDeleteEmptyConfirm: "폴더 \"{name}\"을(를) 삭제하시겠습니까? 폴더가 비어 있어 폴더 자체만 삭제됩니다.",
    folderDeleteRecursiveConfirm: "폴더 \"{name}\"을(를) 삭제하면 모든 하위 폴더와 문서도 함께 삭제됩니다. 계속하시겠습니까?",
    folderDeleteImpact: "하위 폴더 {folderCount}개와 문서 {docCount}개가 함께 삭제됩니다",
    folderDeleteImpactFolders: "하위 폴더 {folderCount}개가 함께 삭제됩니다",
    folderDeleteAsyncNote: "삭제는 백그라운드에서 비동기로 실행되며, 완료되면 목록이 자동으로 새로고침됩니다.",
    folderDeleteSubmitted: "삭제 작업이 제출되었으며 백그라운드에서 처리 중입니다",
    folderDeleteFailed: "삭제에 실패했습니다. 다시 시도하세요.",
    folderReparseLimit: "한 번에 최대 200개의 문서까지 재처리할 수 있습니다. 선택 수를 줄여주세요.",
    reparseFolderUnsupported: "재처리는 문서에만 지원됩니다. 폴더 선택을 취소해 주세요.",
    // Folder load errors + invalid folder_id recovery (spec §4.1 / §12)
    folderLoadFailed: "폴더를 불러오지 못했습니다",
    folderRetry: "다시 시도",
    folderNotFoundTitle: "폴더에 접근할 수 없습니다",
    folderNotFoundHint: "이 폴더는 삭제되었거나 이동되었을 수 있습니다. 루트 폴더로 돌아갑니다.",
    folderTreeLoadFailed: "폴더 트리를 불러오지 못했습니다",
    folderTreeRetry: "다시 시도",
    detail: "지식베이스 상세",
    accessInfo: {
      myRole: "내 정체성",
      roleOwner: "소유자",
  ...
  agentEditor: {
    ...
    im: {
      ...
      yunzhijiaConsole: "Yunzhijia 로봇 콘솔",
