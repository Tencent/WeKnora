export default {
  ...
  datasource: {
    ...
    gitRepo: {
      ...
      addRepo: '저장소 추가',
      webhookTitle: '푸시 자동 동기화 (Webhook)',
      webhookCopy: 'URL 복사',
      webhookCopied: 'Webhook URL이 복사되었습니다',
      webhookSecret: 'Webhook 시크릿',
      webhookSecretHint: '선택 사항. GitLab Secret token / GitHub webhook secret으로 사용합니다. 비워 두면 GIT_REPO_WEBHOOK_SECRET을 쓰고, 둘 다 없으면 webhook은 동작하지 않습니다. 시크릿은 API 응답에 포함되지 않습니다.',
      webhookDesc: 'GitLab / GitHub 저장소의 Webhook 설정에 위 URL을 등록하세요(Push events). 시크릿은 이전 단계의 자격 증명에 입력하거나 관리자가 GIT_REPO_WEBHOOK_SECRET을 설정합니다. 시크릿은 화면에 다시 표시되지 않습니다.',
    },
