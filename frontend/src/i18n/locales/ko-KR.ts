export default {
  ...
  knowledgeBase: {
    ...
    batchCancelParse: '선택 항목 파싱 중지',
    confirmBatchCancelParseDocument: '처리 중인 선택 문서 {count}개의 파싱을 중지하시겠습니까? 처리 중이 아닌 문서는 건너뜁니다.',
    confirmBatchCancelParse: '파싱 중지',
    batchCancelParseSuccess: '{count}개 문서의 파싱이 중지되었습니다',
    batchCancelParseFailed: '일부 문서의 파싱을 중지하지 못했습니다',
    batchCancelParseSkipped: '처리 중이 아닌 문서 {count}개를 건너뛰었습니다',
    batchCancelParseNone: '선택한 문서 중 처리 중인 작업이 없습니다',
    statusCompleted: '완료',
