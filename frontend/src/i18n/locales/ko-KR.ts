export default {
  ...
  chat: {
    feedback: {
      like: "좋아요",
      dislike: "싫어요",
      dialogTitle: "어떤 점이 아쉬웠나요?",
      submit: "제출",
      cancelBtn: "취소",
      commentPlaceholder: "추가 의견 (선택)",
      submitted: "피드백 감사합니다",
      canceled: "평가가 취소되었습니다",
  ...
  kbFeedback: {
    title: "피드백 통계",
    description: "답변 좋아요/싫어요가 청크에 반영된 통계와 검색 가중치 변경 이력",
    entryTooltip: "피드백 통계",
    tabStats: "청크 통계",
    tabWeightLogs: "가중치 로그",
    needsOptOnly: "개선 필요 항목만",
    rateFilterAll: "전체 평가율",
    rateFilterLow: "낮은 평가율 (<50%)",
    rateFilterHigh: "높은 평가율 (>=80%)",
    resetAction: "피드백 데이터 초기화",
    resetConfirm: "이 지식 베이스의 모든 청크 좋아요/싫어요 수와 가중치가 초기화되며, 이전 평가는 통계에 반영되지 않습니다. 초기화할까요?",
    resetSuccess: "{count}개 청크의 피드백 데이터를 초기화했습니다",
  ...
  retrievalSettings: {
    feedback: {
      enabledLabel: "피드백 기반 랭킹",
      enabledDescription: "활성화하면 답변 좋아요/싫어요에서 파생된 청크 가중치가 검색 후보 정렬에 반영됩니다. 평가가 좋은 청크는 우선 검색되고, 낮은 청크는 검색 확률이 낮아집니다.",
      boostThresholdLabel: "가중치 상향 기준 긍정률",
      boostThresholdDescription: "긍정률이 이 기준 이상인 청크는 가중치가 상향됩니다",
      penaltyThresholdLabel: "가중치 하향 기준 긍정률",
      penaltyThresholdDescription: "긍정률이 이 기준 미만인 청크는 가중치가 하향됩니다",
      boostFactorLabel: "상향 계수",
      penaltyFactorLabel: "하향 계수",
      minSamplesLabel: "최소 평가 수",
      minSamplesDescription: "청크의 누적 평가 수가 이 값에 도달해야 가중치 조정이 적용됩니다",
      needsOptThresholdLabel: "개선 필요 표시 기준",
      needsOptThresholdDescription: "긍정률이 이 기준 미만인 청크는 자동으로 개선 필요로 표시됩니다",
    },
    title: "검색 설정",
