export default {
  ...
  agentEditor: {
    ...
    im: {
      ...
      replyLanguage: '응답 언어',
      replyLanguageFixed: '고정 언어',
      replyLanguageFollowUser: '사용자 언어 따르기',
      replyLanguageFollowHint: '메시지마다 언어를 감지합니다. 짧거나 불분명한 메시지는 이 대화에서 마지막으로 감지한 언어를 사용하고, 없으면 배포 기본 언어를 사용합니다.',
