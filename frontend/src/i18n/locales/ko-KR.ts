export default {
  ...
  datasource: {
    ...
    noResourcesDesc_dingtalk: "앱에 DingTalk 위키 접근 권한이 필요하며 Operator 사용자가 대상 위키 공간에 접근할 수 있어야 합니다",
    ...
    guideStep1_dingtalk: "DingTalk 앱에 위키 및 멤버 읽기 API 권한이 있는지 확인하세요",
    guideStep2_dingtalk: "Operator User ID가 대상 DingTalk 위키 공간에 접근할 수 있는지 확인하세요",
    guideStep3_dingtalk: "돌아와서 다시 시도를 클릭한 후 동기화할 위키 공간 또는 폴더를 선택하세요",
    ...
    connectorDesc: {
      ...
      dingtalk: "DingTalk 위키 공간에서 문서 동기화",
    ...
    field: {
      ...
      operatorUserIdHint: "이 사용자 권한으로 DingTalk 위키 콘텐츠를 읽습니다. 앱이 Union ID를 자동으로 확인합니다.",
      baseUrl: "Base URL",
      apiToken: "API Token",
    ...
    prereqStep1Brief_dingtalk: "DingTalk 내부 앱 생성 또는 열기",
    prereqStep1Desc_dingtalk: "DingTalk Open Platform에서 앱을 열고 Client ID / AppKey 및 Client Secret / AppSecret을 복사하세요",
    prereqStep2Brief_dingtalk: "필요한 API 권한 활성화",
    prereqStep2Desc_dingtalk: "멤버 정보 읽기, 위키 읽기, 위키 노드 읽기, 기업 파일 읽기 권한을 활성화하세요",
    prereqStep3Brief_dingtalk: "Operator User ID 입력",
    prereqStep3Desc_dingtalk: "Operator는 대상 위키에 접근할 수 있어야 하며, 앱은 이 신원으로 공간을 나열하고 문서를 동기화합니다.",
    prereqOpenConsole_dingtalk: "DingTalk Open Platform으로 이동",
