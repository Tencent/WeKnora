export default {
  ...
  knowledgeBase: {
    ...
    typeURL: '웹페이지',
    importYoutube: 'YouTube에서 가져오기',
    importYoutubeTitle: 'YouTube에서 가져오기',
    youtubeUrlsLabel: 'YouTube URL (한 줄에 하나씩)',
    youtubeUrlsPlaceholder: 'https://www.youtube.com/watch?v=...\nhttps://www.youtube.com/playlist?list=...',
    youtubeUrlsTip: '동영상 또는 재생목록 링크를 한 줄에 하나씩 붙여넣으세요. 재생목록은 자동으로 개별 동영상으로 확장됩니다.',
    youtubeUrlsRequired: '최소 하나의 YouTube URL을 입력하세요',
    youtubeInvalidLines: '유효하지 않은 YouTube URL {count}줄을 무시했습니다',
    youtubeImportSubmitting: 'YouTube에서 가져오는 중…',
    youtubeImportResult: '{success}개 가져오기 성공, {failed}개 실패',
    youtubeImportAllFailed: '모든 동영상 가져오기에 실패했습니다',
    typeManual: '수동 생성',
    typeFile: '파일',
    channelLabel: '출처 채널',
    channelWeb: '웹',
