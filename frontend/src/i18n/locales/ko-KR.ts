export default {
  ...
  chat: {
    ...
    sandbox: {
        ...
        filesTitle: '라이브 샌드박스 파일',
        filesBreadcrumbs: '현재 폴더',
        filesRoot: '출력',
        filesUpload: '파일 업로드',
        filesRefresh: '새로 고침',
        filesLoading: '파일 불러오는 중…',
        filesEmpty: '이 폴더는 비어 있습니다',
        filesDirectory: '폴더',
        filesDownload: '다운로드',
        filesRename: '이름 바꾸기',
        filesDelete: '삭제',
        filesDeleteConfirm: '{name}을(를) 삭제할까요? 이 작업은 되돌릴 수 없습니다.',
        filesInvalidName: '경로 구분자가 없는 파일 이름을 입력하세요',
        filesLoadFailed: '샌드박스 파일을 불러오지 못했습니다',
        filesDownloadFailed: '다운로드 실패',
        filesUploadComplete: '업로드 완료',
        filesUploadFailed: '업로드 실패',
        filesRenameFailed: '이름 변경 실패',
        filesDeleteFailed: '삭제 실패',
        filesPaused: '샌드박스가 일시 중지되었습니다. 이 패널은 과금을 피하기 위해 자동으로 재개하지 않으니, 파일을 보기 전에 터미널에서 시작하세요.',
        filesTooLarge: '파일이 16 MiB 제한을 초과합니다',
        filesTooMany: '폴더 항목이 너무 많아 나열하거나 삭제할 수 없습니다',
  ...
  knowledgeBase: {
    ...
    folderTree: {
      ...
      deleteConfirmBody: '“{name}” 및 하위 폴더의 문서 {count}개를 삭제하시겠습니까? 이 작업은 취소할 수 없습니다.',
      deleteConfirm: '삭제',
      deleting: '삭제 중',
      deleteSubmitted: '폴더 삭제를 시작했습니다',
      deleteSuccess: '폴더를 삭제했습니다',
