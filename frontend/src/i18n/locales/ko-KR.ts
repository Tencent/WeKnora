export default {
  ...
  knowledgeEditor: {
    ...
    wikiBrowser: {
      ...
      linkedFrom: "링크 출처",
      sources: "원본 문서",
      sourceDrawerTitle: "페이지 출처",
      paragraphSourceCount: "이 페이지의 출처 {count}개",
      openParagraphSource: "출처 [{number}] 보기",
      tableRowSource: "표 {index}행",
      listItemSource: "목록 {index}항목",
      blockProvenanceComplete: "출처 범위: 전체",
      blockProvenancePartial: "출처 범위: 일부",
      blockProvenanceUnsupported: "블록 단위 출처 없음",
      blockProvenanceLegacy: "이전 방식으로 추정된 출처",
      blockProvenancePending: "출처 범위 확인 대기",
      blockSourceManual: "수동 편집",
      blockSourceAgent: "에이전트 편집",
      sourceChunk: "근거 청크 {chunk}",
      sourceEvidenceUnavailable: "표시할 근거 원문이 없습니다",
      openSourceDocument: "원본 문서 열기",
      sourceStatusVerified: "검증됨",
      sourceStatusLocated: "근거 원문 확인됨",
      sourceStatusInvalid: "출처가 더 이상 유효하지 않음",
      sourceStatusPartial: "부분 지원",
      sourceStatusUnsupported: "지원되지 않음",
      sourceStatusPending: "검증 대기",
