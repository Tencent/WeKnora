export default {
  localBrowser: {
    ...
    "storeInstall": "Chrome 웹 스토어 열기",
    "manualInstall": "수동 설치 (대안)",
    "storeInstallHint": "Chrome 웹 스토어에서 BrowserSkill을 설치한 후 여기로 돌아와 페어링하세요.",
  ...
  datasource: {
    ...
    guideStep1_feishu_links: '동기화할 Feishu 문서를 열고 공유 → 협업자 추가에서 앱을 검색해 추가한 뒤 권한을 「읽기 가능」으로 설정하세요',
    guideStep2_feishu_links: '해당 문서 링크를 복사하세요 (위키 copylink 또는 /docx/ 링크 모두 가능)',
    guideStep3_feishu_links: '링크 목록에 붙여넣고 「링크 해석」을 클릭하세요',
    guideStep1_lark_links: '동기화할 Lark 문서를 열고 공유 → 협업자 추가에서 앱을 검색해 추가한 뒤 권한을 Can view 로 설정하세요',
    guideStep2_lark_links: '해당 문서 링크를 복사하세요 (wiki copylink 또는 /docx/ 링크 모두 가능)',
    guideStep3_lark_links: '링크 목록에 붙여넣고 「링크 해석」을 클릭하세요',
    ...
    prereqBarText_feishu_links: '처음 사용하시나요? 클릭하여 Feishu 앱 설정 가이드를 확인하세요',
    prereqStep1Brief_feishu_links: "Feishu 커스텀 앱 생성",
    prereqStep1Desc_feishu_links: "Feishu Open Platform 로그인 → 엔터프라이즈 커스텀 앱 생성",
    prereqStep2Brief_feishu_links: "봇 기능 추가",
    prereqStep2Desc_feishu_links: "Open Platform → 앱 → 앱 기능 추가 → 봇",
    prereqStep3Brief_feishu_links: "앱 권한 구성",
    prereqStep3Desc_feishu_links: "wiki:wiki:readonly, drive:drive.metadata:readonly (또는 drive:drive), drive:drive:readonly, drive:export:readonly, docx:document:readonly 권한 활성화",
    prereqBarText_lark_links: '처음 사용하시나요? 클릭하여 Lark 앱 설정 가이드를 확인하세요',
    prereqStep1Brief_lark_links: "Lark 커스텀 앱 생성",
    prereqStep1Desc_lark_links: "Lark Open Platform 로그인 → 엔터프라이즈 커스텀 앱 생성",
    prereqStep2Brief_lark_links: "봇 기능 추가",
    prereqStep2Desc_lark_links: "Open Platform → 앱 → 앱 기능 추가 → 봇",
    prereqStep3Brief_lark_links: "앱 권한 구성",
    prereqStep3Desc_lark_links: "wiki:wiki:readonly, drive:drive.metadata:readonly (또는 drive:drive), drive:drive:readonly, drive:export:readonly, docx:document:readonly 권한 활성화",
    ...
    connectorDesc: {
      ...
      feishu_links: '문서 링크로 Feishu 위키 또는 클라우드 문서의 개별 페이지를 동기화',
      lark_links: '문서 링크로 Lark 위키 또는 클라우드 문서의 개별 페이지를 동기화',
    ...
    connector: {
      ...
      feishu_links: 'Feishu 링크 목록',
      lark_links: 'Lark 링크 목록',
      notion: 'Notion',
    ...
    links: {
      title: '문서 링크',
      hint: '한 줄에 하나의 Feishu 문서 링크를 입력하세요. 봇이 해당 문서를 읽거나 편집할 수 있어야 합니다. 링크가 가리키는 문서만 동기화되며 위키 트리나 드라이브 폴더는 가져오지 않습니다.',
      placeholder: 'https://xxx.feishu.cn/wiki/...\nhttps://xxx.feishu.cn/docx/...',
      parse: '링크 해석',
      urlsRequired: 'Feishu 문서 링크를 하나 이상 붙여넣으세요',
      noneResolved: '동기화할 문서를 찾지 못했습니다. 링크와 앱 읽기 권한을 확인하세요',
      deduped: '중복 링크 {n}개를 제거했습니다',
      resolvedCount: '문서 {n}개를 해석했습니다',
      error: {
        wiki_space: '위키 공간 링크입니다. 「Feishu」 데이터 소스를 사용하거나 개별 /wiki/ 문서 링크를 붙여넣으세요',
        drive_folder: '드라이브 폴더 링크입니다. 「Feishu Drive」 데이터 소스를 사용하세요',
        unrecognized: '인식할 수 없는 링크입니다. Feishu /wiki, /docx, /docs, /sheets, /base 또는 /file 링크를 붙여넣으세요',
        unsupported_type: '지원하지 않는 문서 유형입니다 (마인드노트, 슬라이드 등)',
        no_permission: '앱이 이 문서를 읽을 수 없습니다. Feishu에서 앱을 협업자로 추가하세요 (읽기 가능이면 충분합니다)',
        not_found: '문서가 없거나 삭제되었습니다',
        resolve_failed: '해석에 실패했습니다. 링크와 앱 권한을 확인하세요',
      },
    },
    syncError: {
  ...
  knowledgeBase: {
    ...
    channelFeishuLinks: "Feishu 링크",
    channelLarkLinks: "Lark 링크",
