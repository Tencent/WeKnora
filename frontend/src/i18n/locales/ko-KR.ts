export default {
  ...
  knowledgeBase: {
    ...
    batchMoveToFolder: '폴더로 이동',
    moveToFolder: '폴더로 이동',
    moveToFolderHeading: '폴더로 이동',
    moveToFolderSubtitle: '선택한 문서 {count}개를 폴더로 이동합니다',
    moveToFolderPickHint: '대상 폴더를 선택하세요',
    folderPanelTitle: '폴더',
    folderExpandPanel: '폴더 패널 펼치기',
    folderCollapsePanel: '폴더 패널 접기',
    folderNewRoot: '새 폴더',
    folderNewChild: '새 하위 폴더',
    folderRename: '이름 변경',
    folderDelete: '폴더 삭제',
    folderActions: '폴더 작업',
    folderAllDocuments: '전체 문서',
    folderUnfiled: '미분류',
    folderNamePlaceholder: '폴더 이름',
    folderSearchPlaceholder: '폴더 검색',
    folderSearchEmpty: '일치하는 폴더가 없습니다',
    folderEmptyHint: '폴더가 없습니다. 위의 버튼으로 만드세요.',
    folderIncludeSubfolders: '하위 폴더 포함',
    folderDeleteConfirm: '폴더 ‘{name}’을(를) 삭제할까요?',
    folderDeleteNotEmpty: '이 폴더에 문서 {count}개가 있습니다. 상위 폴더로 이동되며 문서 자체는 삭제되지 않습니다.',
    folderDeleteReparent: '삭제 후 문서 상위 이동',
    folderCreateSuccess: '폴더가 생성되었습니다',
    folderCreateFailed: '폴더 생성 실패',
    folderRenameFailed: '폴더 이름 변경 실패',
    folderDeleteSuccess: '폴더가 삭제되었습니다',
    folderDeleteFailed: '폴더 삭제 실패',
    folderMoveIntoSelf: '폴더를 자기 자신이나 하위 폴더로 이동할 수 없습니다',
    folderMoveSuccess: '폴더를 이동했습니다',
    folderMoveFailed: '폴더 이동 실패',
    folderMoveDocsSuccess: '문서 {count}개를 이동했습니다',
    folderMoveDocsFailed: '문서 이동 실패',
