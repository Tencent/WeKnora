export default {
  ...
  knowledgeStages: {
    ...
    detail: {
      ...
      graphSummary: "지식 그래프 결과",
      graphPartialHint: "일부 엔터티 또는 관계 처리에 실패했으며 나머지 유효한 데이터는 저장되었습니다.",
      graphNodes: "엔터티",
      graphRelations: "관계",
      graphSucceeded: "성공",
      graphFailed: "실패",
      graphFailureDetails: "실패 상세 ({n}건)",
      graphNoFailureDetails: "항목별 실패 상세가 기록되지 않았습니다. 서버 로그를 확인하세요.",
      graphChunk: "청크 #{n}",
      graphItem: "항목 {n}",
      graphItemUnknown: "알 수 없는 항목",
      graphValidation: "파싱 검증",
      graphWrite: "Neo4j 쓰기",
      graphChunkFailure: "청크 작업",
      graphUnknownStage: "알 수 없는 단계",
      graphUnknownReason: "실패 이유가 기록되지 않았습니다",
    },
    stage: {
      docreader: "문서 파싱",
      chunking: "청킹",
  ...
  knowledgeEditor: {
    ...
    wikiBrowser: {
      ...
      logActionManualCreate: "수동 생성",
      logActionManualEdit: "수동 편집",
      logActionManualDelete: "수동 삭제",
      logActionRevert: "롤백됨",
      newPageBtn: "새 페이지",
