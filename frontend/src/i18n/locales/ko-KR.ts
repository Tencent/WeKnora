export default {
  ...
  datasource: {
    ...
    field: {
      ...
      operatorIdHint: "딩톡 관리 콘솔 → 주소록 → 구성원 상세에서 unionId를 확인하거나 API로 가져올 수 있습니다",
    },
    comingSoon: "곧 지원 예정",
    ...
    prereqStep1Brief_dingtalk: "DingTalk 기업 내부 앱 생성",
    prereqStep1Desc_dingtalk: "DingTalk 오픈 플랫폼 → 앱 개발 → 기업 내부 앱 → 앱 생성",
    prereqStep2Brief_dingtalk: "지식베이스 권한 활성화",
    prereqStep2Desc_dingtalk: "지식베이스 읽기, 지식베이스 노드 읽기, 기업 저장소 파일 읽기 권한을 활성화하세요",
    prereqStep3Brief_dingtalk: "Client ID, Client Secret 및 운영자 unionId 가져오기",
    prereqStep3Desc_dingtalk: "앱 인증 정보 페이지에서 Client ID 및 Client Secret을 가져오고, 주소록 구성원 상세에서 unionId를 확인하세요",
