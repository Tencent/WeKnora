export default {
  ...
  knowledgeBase: {
    ...
    confirmDeleteDocument: '"{fileName}" 문서를 삭제하시겠습니까? 대기 중인 파일 업데이트도 취소되며 복구할 수 없습니다.',
    confirmDelete: '삭제 확인',
    viewModeGrid: '카드 보기',
    viewModeList: '목록 보기',
    ...
    statusReplacing: '파일 교체 중',
    fileUpdateActive: '파일 업데이트 중',
    fileUpdatePending: '업데이트 대기 v{version}',
    fileUpdateFailed: '파일 업데이트 실패',
    retryFileUpdate: '최신 버전 다시 시도',
    retryFileUpdateSubmitted: '파일 업데이트를 다시 제출했습니다',
    retryFileUpdateFailed: '파일 업데이트 재시도 실패',
    discardFileUpdate: '대기 업데이트 삭제',
    discardFileUpdateConfirm: '실패한 버전과 최신 대기 파일을 삭제하시겠습니까?',
    discardFileUpdateSubmitted: '대기 업데이트를 삭제했습니다',
    discardFileUpdateFailed: '대기 업데이트 삭제 실패',
    statusFailed: '실패',
    statusCancelled: '취소됨',
    statusDraft: '초안',
    noDescription: '설명 없음',
