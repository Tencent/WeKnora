export default {
  ...
  knowledgeBase: {
    ...
    crawlEnabledLabel: '하위 페이지 자동 크롤링',
    crawlDepthLabel: '크롤링 깊이',
    crawlDepth1: '1단계 (현재 페이지만)',
    crawlDepth2: '2단계 (1단계 링크 포함)',
    crawlDepth3: '3단계 (2단계 링크 포함)',
    crawlTip: '하위 페이지 크롤링은 페이지 내 링크를 자동으로 추출하여 지정된 깊이까지의 모든 페이지를 가져옵니다',
    crawlingPages: '하위 페이지 크롤링 중...',
    crawlFailed: '크롤링 실패, 현재 페이지만 가져오는 것으로 되돌아갑니다',
    crawlCompleted: '크롤링 완료, {count}개 페이지 발견',
    typeURL: '웹페이지',
    typeManual: '수동 생성',
    typeFile: '파일',
    channelLabel: '출처 채널',
