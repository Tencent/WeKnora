export default {
  ...
  taskCenter: {
    title: "작업 센터",
    subtitle: "사용자가 시작한 작업을 확인하고 실패한 작업을 재시도하며 실행 기록을 봅니다.",
    searchPlaceholder: "작업 이름 또는 ID 검색",
    empty: "작업이 없습니다",
    retryAllConfirm: "현재 필터의 재실행 가능한 실패/취소 작업을 모두 재시도하시겠습니까?",
    cancelConfirm: "이 작업을 취소하시겠습니까?",
    deleteRecordsConfirm: "30일 이전의 완료된 작업 기록을 삭제하시겠습니까?",
    summary: {
      queued: "대기 중",
      processing: "처리 중",
      succeeded: "완료됨",
      failedOrCanceled: "실패 / 취소됨",
    },
    tabs: {
      all: "전체",
      queued: "대기 중",
    ...
    kind: {
      ...
      upload: "업로드",
      reparse: "재분석",
      datasource_sync: "데이터 소스 동기화",
      datasourceSync: "데이터 소스 동기화",
      rebuild_wiki: "Wiki 재생성",
      rebuildWiki: "Wiki 재생성",
    },
    actions: {
      detail: "상세",
      retry: "재시도",
    ...
    messages: {
      ...
      detailFailed: "작업 상세를 불러오지 못했습니다",
      retryStarted: "재시도를 시작했습니다",
      retryAllStarted: "{count}개 작업 재시도를 시작했습니다",
      retryFailed: "재시도 실패",
      cancelled: "작업이 취소되었습니다",
      cancelFailed: "취소 실패",
      deleted: "{count}개 기록을 삭제했습니다",
      deleteFailed: "기록 정리 실패",
    },
  },
};
