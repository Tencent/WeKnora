export default {
  ...
  uploadConfirm: {
    ...
    urlsAdded: 'URL {count}개가 추가되었습니다',
  ...
  knowledgeBase: {
    ...
    invalidURLsSkipped: '유효하지 않은 링크 {count}개를 건너뛰었습니다',
    urlImportSuccess: 'URL 가져오기 성공!',
    urlImportFailed: 'URL 가져오기 실패!',
    urlExists: '해당 URL이 이미 존재합니다',
    urlLabel: 'URL 주소',
    urlPlaceholder: '하나 이상의 웹페이지 링크를 한 줄에 하나씩 입력하세요. 예:\nhttps://example.com/article',
    urlTip: '웹페이지 링크를 한 줄에 하나씩 여러 개 붙여넣을 수 있으며, 시스템이 각 페이지의 텍스트를 추출하고 분석합니다. YouTube 동영상이나 재생목록은 \'YouTube 가져오기\'를 사용하세요',
    youtubeImporting: 'YouTube 링크 {count}개를 가져오는 중…',
    youtubeImportSuccess: 'YouTube 동영상 {count}개를 대기열에 추가했습니다',
    youtubeImportDuplicates: '동영상 {count}개는 이미 이 지식베이스에 있습니다',
    youtubeImportFailures: '링크 또는 동영상 {count}개를 가져오지 못했습니다',
    youtubeImportTruncated: '1회 가져오기 동영상 한도에 도달하여 앞쪽 동영상만 가져왔습니다',
    youtubeImportFailed: 'YouTube 가져오기에 실패했습니다',
    importYouTube: 'YouTube 가져오기',
    importYouTubeTitle: 'YouTube 가져오기',
    youtubeUrlLabel: 'YouTube 링크',
    youtubeUrlPlaceholder: '한 줄에 하나씩 YouTube 링크를 입력하세요. 예:\nhttps://www.youtube.com/watch?v=VIDEO_ID\nhttps://www.youtube.com/playlist?list=PLAYLIST_ID',
    youtubeUrlTip: 'YouTube 동영상 및 재생목록 링크만 지원합니다. 한 줄에 하나씩 붙여넣으세요. 각 동영상은 개별 문서가 되며, 각 재생목록은 재생목록 이름의 폴더로 가져옵니다. &list=가 포함된 동영상 링크는 해당 동영상만 가져오므로 전체 재생목록은 재생목록 링크를 사용하세요. 자막을 우선 사용하고, 자막이 없으면 지식베이스의 음성 인식 모델로 오디오를 변환합니다',
    noYouTubeURLs: 'YouTube 동영상 또는 재생목록 링크를 하나 이상 입력하세요',
    nonYouTubeURLsSkipped: 'YouTube 링크가 아닌 {count}줄을 건너뛰었습니다',
    typeURL: '웹페이지',
    typeManual: '수동 생성',
    typeFile: '파일',
    channelLabel: '출처 채널',
