export default {
  ...
  agentEditor: {
    ...
    im: {
      ...
      fileProcessingStrategy: "파일 처리 전략",
      fileStrategyDirect: "대화에 직접 추가",
      fileStrategyKB: "지식 베이스에 업로드",
      fileProcessingStrategyHint: "직접: 파일 내용을 구문 분석하여 현재 대화에 주입; 업로드: 파일을 지식 베이스에 저장하여 비동기 처리",
      fileKnowledgeBaseRequired: "업로드 전략 사용 시 지식 베이스를 선택해야 합니다",
      sessionMode: "세션 모드",
