export default {
  ...
  knowledgeBase: {
    ...
    batchReparseSkippedInFlight: 'Skipped {count} document(s) still being parsed',
      batchReparseNoEligibleDocuments: 'No documents can be rebuilt; documents already being parsed were skipped',
      batchReparseLimitExceeded: 'A batch rebuild can include at most {count} documents. Narrow the filter and try again.',
      batchReparsePartial: 'Submitted {submitted} rebuild task(s); {failed} document(s) could not be submitted. Try again later.',
    selectAllFilteredDocuments: 'Select all {count} filtered results',
    allFilteredDocumentsSelected: 'All {count} filtered results selected',
  ...
  knowledgeEditor: {
    activity: {
      ...
      actions: {
        ...
        'knowledge.batch_deleted': 'Knowledge batch deleted', 'knowledge.batch_reparsed': 'Knowledge batch rebuild completed', 'knowledge.reparse_started': 'Reparse started',
