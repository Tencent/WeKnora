...
\
  ...
  chat: {
    ...
    like: 'Like',
    dislike: 'Dislike',
    dislikeReasonTitle: 'Please tell us what went wrong',
    dislikeReason: {
      irrelevant: 'Irrelevant content',
      incorrect: 'Incorrect information',
      notHelpful: 'Not helpful',
      tooLong: 'Answer too long',
      outdated: 'Outdated information',
      other: 'Other reason',
      detailPlaceholder: 'Please provide more detail (optional)',
      selectPrompt: 'Please select a reason',
    },
