export default {
  ...
  settings: {
    ...
    sandbox: {
      ...
      skillsDrawerTitle: 'Manage skills',
      ...
      skillUploadHint: 'Upload installs the skill onto the current image and takes a new snapshot. This can take several minutes.',
      ...
      skillDeleteHint: 'Delete = remove the skill directory from the image and take a new snapshot. Changes take effect on the session\'s next execution.',
      ...
      skillTranscriptTitle: '{name} · install run',
