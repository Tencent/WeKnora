export default {
  ...
  knowledgeBase: {
    ...
    rebuildAllFailed: 'Rebuild Failed ({count})',
    confirmRebuildAllFailed: 'Confirm rebuilding all {count} failed documents? Existing content will be cleared and re-parsed.',
    confirmRebuildAllFailedBtn: 'Rebuild All',
