export default {
  ...
  knowledgeBase: {
    ...
    folderTree: {
      ...
      deleteConfirmBody: 'Delete “{name}” and {count} documents in it and its sub-folders? This cannot be undone.',
      deleteConfirm: 'Delete',
      deleting: 'Deleting',
      deleteSubmitted: 'Folder deletion submitted',
  ...
  chat: {
    ...
    sandbox: {
        ...
        filesTitle: 'Live sandbox files',
        filesBreadcrumbs: 'Current folder',
        filesRoot: 'output',
        ...
        filesInvalidName: 'Enter a filename without path separators',
        filesLoadFailed: 'Could not load sandbox files',
        filesDownloadFailed: 'Download failed',
        filesUploadComplete: 'Upload complete',
        filesUploadFailed: 'Upload failed',
        filesRenameFailed: 'Rename failed',
        filesDeleteFailed: 'Delete failed',
        filesPaused: 'The sandbox is paused. Start it from the Terminal tab before browsing files so this panel does not resume it and incur charges.',
        filesTooLarge: 'File exceeds the 16 MiB limit',
        filesTooMany: 'This folder has too many entries to list or delete',
