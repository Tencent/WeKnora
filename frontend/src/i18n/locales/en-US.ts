export default {
  ...
  settings: {
    ...
    parser: {
      ...
      notAllowedHint: 'This engine is disabled by PARSER_ENGINE_ALLOW_LIST and cannot be configured.',
...
\
  ...
  kbSettings: {
    ...
    parser: {
      ...
      unavailable: 'Unavailable',
      notAllowed: 'Not allowed',
      notAllowedHint: 'This engine is excluded by the deployment allow list.',
