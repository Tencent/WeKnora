export default {
  ...
  knowledgeBase: {
    ...
    batchCancelParse: 'Stop selected',
    confirmBatchCancelParseDocument: 'Stop parsing for {count} selected in-flight document(s)? Documents that are not processing will be skipped.',
    confirmBatchCancelParse: 'Stop parsing',
    batchCancelParseSuccess: 'Stopped parsing for {count} document(s)',
    batchCancelParseFailed: 'Some documents could not be stopped',
    batchCancelParseSkipped: 'Skipped {count} document(s) that are not processing',
    batchCancelParseNone: 'None of the selected documents are processing',
