export default {
  ...
  knowledgeEditor: {
    ...
    wikiBrowser: {
      ...
      structuralFix: 'Tidy',
      structuralFixTooltip: 'Scan and tidy orphan pages, stale references, broken links',
      structuralFixConfirmTitle: 'Tidy wiki?',
      ...
      structuralFixDone: 'Tidied {count} item(s)',
      structuralFixNothing: 'Wiki is already clean — nothing to tidy',
      structuralFixFailed: 'Tidy failed',
      resetLog: 'Reset Log',
      resetLogTooltip: 'Clear all entries from the Wiki Operation Log (irreversible)',
      resetLogConfirmTitle: 'Reset wiki log?',
      resetLogConfirmBody: 'Will erase all entries from the Wiki Operation Log (the cumulative record of every ingest / retract / dedup decision). This action is irreversible. Index and other pages are not affected.',
      resetLogConfirm: 'Reset',
      resetLogDone: 'Wiki log reset',
      resetLogFailed: 'Reset log failed',
    },
    buttons: {
      create: 'Create Knowledge Base',
