export default {
  localBrowser: {
    ...
    "invalidArguments": "Browser tool arguments are incomplete. The agent must correct them before proceeding.",
    "commandInterrupted": "The browser action was interrupted. Check the page before resuming from the preview.",
    "actionFailedHint": "This browser action could not finish. Expand for details.",
    ...
    "settingsDescription": "Connect your Chrome once and use it across conversations.",
