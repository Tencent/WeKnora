export default {
  ...
  knowledgeFolder: {
    ...
    create: 'New Folder',
    createInCurrent: 'Create in current folder',
    rename: 'Rename Folder',
    delete: 'Delete Folder',
    namePlaceholder: 'Enter folder name',
    nameRequired: 'Enter a folder name',
    invalidName: 'Invalid folder name',
    nameConflict: 'A folder with this name already exists here',
    notEmpty: 'The folder is not empty. Remove its documents and subfolders first.',
    operationFailed: 'Folder operation failed. Try again later.',
    createSuccess: 'Folder created',
    renameSuccess: 'Folder renamed',
    deleteSuccess: 'Folder deleted',
    deleteConfirm: 'Delete folder "{name}"?',
    deleteEmptyOnly: 'Only empty folders can be deleted. Documents and subfolders will not be removed or moved.',
    createTarget: 'Target folder: {name}',
    emptyKnowledge: 'No documents in "{name}"',
    invalidLocation: 'The folder URL is invalid. Returned to root.',
    locationUnavailable: 'The folder no longer exists or is unavailable. Returned to a safe folder.',
    resizeSidebar: 'Resize folder sidebar',
    resizeSidebarHint: 'Drag to resize; double-click to restore the default width',
  },
  knowledgeFolderMove: {
    folderTitle: 'Move Folder',
    knowledgeTitle: 'Move Document to Folder',
    batchTitle: 'Move Documents to Folder',
    moveFolder: 'Move Folder',
    moveKnowledge: 'Move to Folder',
    moveSelected: 'Move to Folder',
    selectTarget: 'Select a destination folder. Root is also available.',
    current: 'Current',
    invalidTarget: 'The destination folder is invalid',
    cycleConflict: 'A folder cannot be moved into itself or one of its descendants',
    nameConflict: 'A folder with the same name already exists at the destination',
    moveConflict: 'The folder state changed and the move could not be completed',
    resourceChanged: 'The document or folder no longer exists. Folder data was refreshed.',
    folderMoved: 'Folder moved',
    knowledgeMoved: 'Document moved',
    batchMoved: 'Moved {count} documents',
    batchMoveFailed: 'Batch move failed. Try again later.',
    selectionChanged: 'The selected documents changed. Refresh and select them again.',
    searchResultPath: 'Document path: {path}',
    moveFailed: 'Move failed. Try again later.',
  },
  knowledgeFolderDrag: {
    dragHandle: 'Drag “{name}” to move it',
    dropHere: 'Move to this folder',
    cannotDrop: 'Cannot move to this folder',
    moving: 'Moving',
  },
  knowledgeBase: {
  ...
  input: {
    ...
    folderScope: {
      ...
      entireKnowledgeBaseHint: 'Includes direct files and all descendant folders',
      selectFolderForKb: 'Select folders for {name}',
      selectedFolderSingle: '1 folder selected',
      selectedFolderCount: '{count} folders selected',
      removeCurrentFolder: 'Remove this folder',
      loading: 'Loading folder scope',
      loadingShort: 'Loading',
      loadFailed: 'Failed to load folder scope',
      loadFailedShort: 'Load failed',
      partialInvalid: 'Some folder scopes are invalid. Remove or reselect the invalid folders.',
      partialInvalidShort: 'Some folders are invalid',
      noFolders: 'No available folders',
      searchPlaceholder: 'Search folders',
      toggleFolder: 'Expand or collapse folder',
      sendBlockedInvalid: 'Folder scope is invalid for: {names}',
    },
    knowledgeBase: 'Knowledge Base',
