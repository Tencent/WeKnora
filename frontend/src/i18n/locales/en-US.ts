export default {
  ...
  newUserGuide: {
    ...
    steps: {
      ...
      knowledge: {
        ...
        desc: 'Everything starts here: upload documents, web pages or FAQs and TreeRAG parses and indexes them automatically. Click here to open knowledge bases.',
      },
      chat: {
  ...
  knowledgeBase: {
    ...
    folderTree: {
      title: 'Folders',
      rootRow: 'Root',
      rootRowTip: 'All documents in this knowledge base; open a folder on the left to browse',
    ...
    loadDocumentsFailed: 'Failed to load documents. Please refresh and try again',
  ...
  settings: {
    ...
    weknoraCloud: {
      title: 'TreeRAG Cloud',
      description: 'Configure TreeRAG Cloud APPID and APPSECRET credentials. Credentials are used for model services and document parsing engine.',
      viewDocs: 'View Docs',
      unconfigured: 'Credentials not configured. Please fill in APPID and APPSECRET.',
      configured: 'Credentials configured and working.',
      expired: 'TreeRAG Cloud credentials expired',
      ...
      appIdLabel: 'APPID',
      appIdDesc: 'TreeRAG Cloud application ID',
      appIdPlaceholder: 'Enter APPID',
      appSecretLabel: 'APPSECRET',
      appSecretDesc: 'TreeRAG Cloud application secret',
      ...
      credentialConfigured: 'TreeRAGCloud credentials configured.',
      credentialExpired: 'Credentials expired. Please reconfigure.',
      credentialUnconfigured: 'TreeRAGCloud credentials not configured. Please set up APPID and APPSECRET first.',
      checkingStatus: 'Checking credential status...',
      goToSettings: 'Go to Settings',
      modelHintConfigured: 'TreeRAGCloud credentials configured. See supported models in',
      modelHintDocsLink: 'API docs',
      modelsSection: {
        title: 'Cloud Models',
        descReady: 'Register the four standard TreeRAG Cloud models for chat, retrieval, reranking, and vision.',
  ...
  kbSettings: {
    ...
    parser: {
      ...
      engines: {
        ...
        weknoracloud: {
          name: 'TreeRAG Cloud',
          desc: 'Document parsing via TreeRAG Cloud',
        },
        markitdown: {
          name: 'MarkItDown',
  ...
  agentEditor: {
    ...
    logs: {
      ...
      source: 'Source',
      sourceAll: 'All',
      sourceGuest: 'Guest link',
      sourceIm: 'IM',
      statEmbed: 'Embed',
      statGuest: 'Guest link',
      statIm: 'IM',
    ...
    publish: {
      ...
      apiHint: 'These keys belong to the current workspace; pass agent_id={agentId} to target this agent',
      ...
      types: {
        ...
        wechatDesc: 'Connect WeChat Official Accounts via API',
  ...
  datasource: {
    ...
    resumeFailed: 'Failed to resume data source',
  },
  integrations: {
    cli: {
      title: 'TreeRAG CLI',
    ...
    api: {
      ...
      capabilityManageModelsHint: 'Manage model definitions, credentials, connectivity checks, and TreeRAGCloud credentials.',
      ...
      hmacSecretDesc: 'Same secret stored in TreeRAG; used only on your backend to sign JWTs—never send it as a request header.',
    ...
    chrome: {
      ...
      subtitle: 'For self-hosted TreeRAG: ask questions in a sidebar, clip web pages, and save Markdown notes into your knowledge bases while you browse.',
      ...
      steps: {
        ...
        port: {
          ...
          desc: 'On TreeRAG Desktop, set a fixed API port (e.g. 37841) in API Info so the URL stays stable across restarts.',
        },
        install: {
    ...
    claw: {
      title: 'TreeRAG Skill',
      subtitle: 'Import documents and run hybrid retrieval (vector + keyword) via the TreeRAG REST API—for uploads, URL imports, Markdown entries, and cross-KB search.',
