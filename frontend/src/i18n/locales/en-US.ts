export default {
  ...
  knowledgeBase: {
    ...
    urlTip: 'Supports importing various webpage contents. The system will automatically extract and parse text content from the webpage. YouTube video and playlist links are imported from their captions, or transcribed with speech recognition when a video has none',
    youtubePlaylistImporting: 'Reading the YouTube playlist…',
    youtubePlaylistImportSuccess: 'Queued {count} video(s) from "{title}"',
    youtubePlaylistImportDuplicates: '{count} video(s) are already in this knowledge base',
    youtubePlaylistImportFailures: '{count} video(s) could not be queued',
    youtubePlaylistTruncated: 'Only the first {count} videos of this playlist were imported',
    youtubePlaylistImportFailed: 'YouTube playlist import failed',
    typeURL: 'URL',
    typeManual: 'Manual',
    typeFile: 'File',
