export default {
  ...
  knowledgeEditor: {
    ...
    basic: {
      ...
      descriptionWikiTip: 'One sentence on what this knowledge base is for is enough, e.g. “for product proposals and writing requirements”.'
    },
    wiki: {
      title: 'Wiki Settings',
      ...
      contentInstructionsTip: 'A sentence or two on how pages should read is enough. Citation and factuality stay system-owned. Reprocess to apply to existing content.',
      contentInstructionsPlaceholder: 'For example: for writing PRDs and requirements; lead with conclusions and evidence, skip fluff…',
      extractionInstructionsLabel: 'Wiki Extraction Focus',
      extractionInstructionsTip: 'Say in plain language what to keep. Filing into folders is handled by the system; you do not need a taxonomy.',
      extractionInstructionsPlaceholder: 'For example: keep users, competitors, assumptions, and constraints so they are easy to cite while writing…',
  ...
  agentStream: {
    ...
    tools: {
      ...
      wikiListSourceChunks: 'List Cited Source Chunks',
  ...
  agentEditor: {
    ...
    tools: {
      ...
      wikiListSourceChunks: 'List Cited Source Chunks',
      wikiListSourceChunksDesc: 'Expand a Wiki page into every original chunk it cites, without scanning the whole document',
