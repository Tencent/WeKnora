export default {
  ...
  newUserGuide: {
    ...
    steps: {
      ...
      knowledge: {
        ...
        desc: 'Everything starts here: upload documents, web pages or FAQs and {brand} parses and indexes them automatically. Click here to open knowledge bases.'
      },
      chat: {
  ...
  settings: {
    ...
    sandbox: {
      ...
      backendDescriptions: {
        ...
        docker: 'Run every script in a short-lived container on this SAI host',
        local: 'Run scripts directly in the SAI server process environment',
      },
      ...
      localRuntimeWarning: 'Local process runs skill scripts directly on the SAI server without container or MicroVM isolation. Use only in a trusted development workspace.',
      ...
      localRuntimeSummary: 'SAI server process',
      ...
      templateLoadHint: 'Enter the cluster connection and refresh. SAI creates its standard template when missing.',
      ...
      templateStepHint: 'SAI automatically creates its standard template when missing. You can continue after a template is ready.',
  ...
  createChat: {
    title: 'Hi, I am {brand} — your knowledge, within reach',
