export default {
  workbench: {
    ...
    states: { bound: 'Bound', ready: 'Ready', available: 'Available', disabled: 'Workbench is disabled', unbound: 'No sandbox bound', policy_denied: 'Blocked by workspace policy', unavailable: 'Workbench unavailable', unsupported: 'Sandbox not supported' },
