export default {
  ...
  knowledgeBase: {
    ...
    statusFailed: 'Failed',
    parseStatsCompleted: 'Completed',
    parseStatsProcessing: 'Processing',
    parseStatsFinalizing: 'Optimizing',
    parseStatsPending: 'Pending',
    parseStatsFailed: 'Failed',
    parseStatsCancelled: 'Cancelled',
