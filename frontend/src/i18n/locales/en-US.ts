...
\
  ...
  datasource: {
    ...
    prereqBarText: 'First time? Click to see Feishu app setup guide',
      ...
      prereqStep1Desc_dingtalk: 'Sign in to DingTalk Open Platform → App Development → Create Enterprise Internal App',
      prereqStep2Brief_dingtalk: 'Grant knowledge base document read permissions',
      prereqStep2Desc_dingtalk: 'Enable knowledge base read and document read permissions in the app permission management',
      prereqStep3Brief_dingtalk: 'Get AppKey and AppSecret',
      prereqStep3Desc_dingtalk: 'Find AppKey and AppSecret on the app Credentials & Basics page',
