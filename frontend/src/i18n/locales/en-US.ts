...
\
  ...
  datasource: {
    ...
    field: {
      ...
      operatorUnionIdHint: 'DingTalk Docs APIs require the operator unionId. This user must have access to the wiki being synced.',
    ...
    prereqStep2Desc_dingtalk: 'Grant at least Wiki.Workspace.Read, Wiki.Node.Read, and Storage.File.Read',
    prereqStep3Brief_dingtalk: 'Enter the operator unionId',
    prereqStep3Desc_dingtalk: 'The operator must be able to access the DingTalk wiki. Documents are read as this user.',
