export default {
  ...
  settings: {
    ...
    eventWebhooks: {
      ...
      payloadLabel: 'Payload examples',
      payloadDesc: 'Inspect the real body shape per event type (samples are redacted).',
      payloadHintCreated: 'Emitted right after create; usually not searchable yet — use the download ticket for the source file.',
      payloadHintParsed: 'Parse completed and searchable. May arrive before created.',
      payloadHintParseFailed: 'Parse failed; see data.error_message.',
      payloadHintDeleted: 'A single knowledge item was deleted.',
      payloadHintBatchDeleted: 'Batch delete in one KB; chunks of 100 share delete_batch_id.',
      payloadHintKbCreated: 'Knowledge base created.',
      payloadHintKbDeleted: 'Whole KB deleted; cascade_knowledge=true — do not wait for per-doc knowledge.deleted.',
      payloadHintMemberAdded: 'A member joined this workspace.',
      payloadHintMemberRemoved: 'A member was removed or left this workspace.',
      payloadHintTest: 'From Settings → Send test; data can be ignored.',
      copy: 'Copy',
      copied: 'Copied',
      copyFailed: 'Copy failed',
    },
