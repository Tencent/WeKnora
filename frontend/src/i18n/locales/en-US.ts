export default {
  ...
  organization: {
    ...
    settings: {
      ...
      permissionCalcFormula: 'Space permission is assigned to the space when sharing; my effective permission = min(space permission, my role in this space); knowledge bases brought in by a shared agent must be removed from the agent configuration.',
      ...
      directKbSource: 'Directly shared',
      agentKbSource: 'Brought in by the {name} agent',
      directAndAgentKbSource: 'Directly shared and brought in by the {name} agent',
