export default {
  ...
  datasource: {
    ...
    gitRepo: {
      ...
      webhookDesc: 'Add this URL as a webhook (Push events) in your GitLab / GitHub repository settings to trigger an incremental sync on every push. The secret token is set by the administrator (data source webhook_secret or the GIT_REPO_WEBHOOK_SECRET environment variable).',
    },
