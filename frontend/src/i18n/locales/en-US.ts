export default {
  ...
  settings: {
    ...
    pluginServiceDesc: 'External plugins are scanned once at service startup. After adding, modifying, or removing plugins, click the "Refresh Plugins" button to trigger a rescan without restarting the service.',
    refreshPlugins: 'Refresh Plugins',
    refreshPluginsFailed: 'Refresh failed',
    rescanSummaryAdded: 'Added {count}',
    rescanSummarySkipped: 'Already loaded {count}',
    rescanSummaryChanged: 'Changed {count}',
    rescanSummaryErrors: 'Errors {count}',
    rescanSummaryEmpty: 'No plugin directories configured',
    pluginTrustLevel: 'Run mode',
    pluginTrustOffline: 'Offline (no network)',
    pluginTrustTrusted: 'Trusted (declared network)',
    pluginTrustIsolated: 'Isolated (container)',
    pluginTrustSaved: 'Saved. Takes effect after refreshing plugins.',
    pluginTrustSaveFailed: 'Save failed',
    pluginRestart: 'Restart plugin',
    pluginRestartConfirmTitle: 'Restart plugin',
    pluginRestartConfirmBody: 'Restarting will interrupt in-flight requests handled by "{name}". Continue?',
    pluginRestarted: '"{name}" restarted',
    pluginRestartFailed: 'Restart failed',
    pluginAllEffective: 'All plugin configs are in effect',
    pluginPendingTip: 'Pending config changes for: {names}',
    pluginEmpty: 'No plugins loaded',
    pluginState_running: 'Running',
    pluginState_stopped: 'Stopped',
    pluginState_failed: 'Failed',
    pluginState_unhealthy: 'Unhealthy',
    pluginState_degraded: 'Degraded',
    pluginState_starting: 'Starting',
    pluginState_draining: 'Draining',
    pluginState_discovered: 'Discovered',
