export default {
  feedback: {
    ...
    effectiveWeight: 'Current effective retrieval weight',
    storedWeight: 'Stored audit snapshot',
    ...
    governance: {
      ...
      description: 'Review feedback quality signals, current policy weights, and reset history.',
      searchPlaceholder: 'Search chunk content or document title',
      ...
      needsOptimization: 'Needs optimization',
      viewDetail: 'Details',
      detailTitle: 'Chunk feedback details',
      chunkContent: 'Chunk content',
      dislikeReasons: 'Dislike reasons',
      noReasons: 'No dislike reasons',
      history: 'Weight and reset history',
      reset: 'Reset feedback',
      resetConfirm: 'Reset current feedback aggregates for this chunk?',
      loadFailed: 'Could not load feedback governance data',
      status: { all: 'All', rated: 'Rated', high: 'High', normal: 'Normal', low: 'Low', unrated: 'Unrated' },
      optimization: { all: 'All quality states', yes: 'Needs optimization', no: 'Healthy' },
      columns: {
        document: 'Document', content: 'Chunk', ratings: 'Ratings', weights: 'Weights',
        status: 'Status', time: 'Time', trigger: 'Trigger', change: 'Stored weight change',
      },
    },
  },
  menu: {
