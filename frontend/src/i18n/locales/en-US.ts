  ...
  integrations: {
    ...
    mcpserver: {
      ...
      tools: {
        ...
        ask: 'Ask',
        askDesc: 'Run the default or a named agent and return a cited answer; supports follow-up turns',
      ...
      defaultAgentHint: 'Used by the ask tool when the caller does not pass agent_id.',
      ...
      showSnippets: 'Show client configuration',
