export default {
  ...
  settings: {
    ...
    skills: {
      ...
      upgradeDrawerDesc: 'Upgrade {name} on the selected sandboxes to the catalog version. Each upgrade reinstalls the skill, and it is unavailable on that sandbox until the reinstall finishes.',
      ...
      upgradeRowHint: 'This sandbox runs a different version from the catalog. Upgrading reinstalls the skill, and it is unavailable here until the reinstall finishes.',
      upgradeRowHintVersions: 'This sandbox runs {from}; the catalog has {to}. Upgrading reinstalls the skill, and it is unavailable here until the reinstall finishes.',
