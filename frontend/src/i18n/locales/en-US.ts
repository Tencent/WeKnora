export default {
  ...
  integrations: {
    ...
    api: {
      ...
      allKnowledgeBases: 'All knowledge bases',
      editApiKeyScope: 'Edit knowledge base scope',
      editApiKeyScopeDesc: 'Change which knowledge bases API key "{name}" can access.',
      editApiKeyScopeHint: 'Leave empty to allow all knowledge bases in this workspace. Changes take effect immediately.',
      updateApiKeyScopeSuccess: 'Knowledge base scope updated',
      updateApiKeyScopeFailed: 'Failed to update knowledge base scope',
      createdAt: 'Created',
      actions: 'Actions',
      deleteApiKey: 'Delete',
