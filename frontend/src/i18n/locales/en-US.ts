...
\
  ...
  datasource: {
    ...
    field: {
      ...
      operatorIdHint: 'DingTalk wiki APIs require a real user identity. Enter the unionId (not userId) of a user who can access the target knowledge base.',
      dingtalkBaseUrlHint: 'Leave empty for https://api.dingtalk.com. For dedicated / private DingTalk deployments, enter the API host.',
    ...
    prereqBarText_dingtalk: 'First time? Click to see the DingTalk Docs setup guide',
    prereqStep1Brief_dingtalk: 'Create an internal app and get credentials',
    prereqStep1Desc_dingtalk: 'Open DingTalk Developer Console → App Development → create an internal app → copy AppKey / AppSecret from Credentials',
    prereqStep2Brief_dingtalk: 'Grant knowledge-base read permissions',
    prereqStep2Desc_dingtalk: 'Enable at least Document.Workspace.Read, Document.WorkspaceDocument.Read, Wiki.Node.Read, then publish the app',
    prereqStep3Brief_dingtalk: 'Provide operator unionId',
    prereqStep3Desc_dingtalk: 'Use the unionId of a user who can access the target knowledge base (not userId)',
    prereqOpenConsole_dingtalk: 'Open DingTalk Developer Console',
    noResourcesDesc_dingtalk: 'The app needs knowledge-base access, and the operator unionId must be able to read the target spaces',
    guideStep1_dingtalk: 'Confirm the app has the required read scopes and is published',
    guideStep2_dingtalk: 'Confirm operator_id is a permitted user unionId',
    guideStep3_dingtalk: 'Add the app or that user to the target knowledge base, then reload here',
