...
\
  ...
  agentStream: {
    userInput: {
	  ...
	  dynamicProgress: '{completed} completed / {remaining} remaining',
      other: 'Other',
      otherPlaceholder: 'Describe another situation',
      skip: 'Skip',
      continue: 'Continue',
      continuing: 'Submitted. Resuming…',
      answered: 'Answered',
      answeredWith: 'Answered: {answer}',
      skipped: 'Skipped',
      timedOut: 'This question timed out. Ask it again to continue.',
      canceled: 'This question was canceled. Ask it again to continue.',
