export default {
  ...
  knowledgeEditor: {
    ...
    wikiBrowser: {
      ...
      citationOpen: 'View citation {label}',
      citationDrawerTitle: 'Citation {label}',
      citationLoading: 'Loading citation chunk...',
      citationNotFound: 'Citation chunk not found',
      citationLoadFailed: 'Failed to load citation chunk',
