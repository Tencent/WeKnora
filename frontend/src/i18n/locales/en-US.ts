export default {
  ...
  agent: {
    ...
    editor: {
      ...
      skillsConfig: 'Skills',
      skillsConfigDesc: 'Choose the sandbox that runs skill scripts, then pick which Skills from that sandbox the Agent can use. The Skill list follows the selected sandbox.',
      skillsSelection: 'Skills Selection',
      skillsSelectionDesc: 'Choose which Skills the Agent can use. The list comes from the sandbox selected above.',
      skillsAll: 'All',
      skillsSelected: 'Selected',
      skillsNone: 'Disabled',
      selectSkills: 'Select Skills',
      selectSkillsDesc: 'Choose which Skills to enable',
      noSkillsAvailable: 'This sandbox has no preloaded Skills. Install them in Skill Sandbox settings.',
      skillsNeedSandbox: 'Select a sandbox first. Available Skills come from the skills installed in that sandbox.',
      goSandboxSettings: 'Configure in Skill Sandbox settings',
      sandboxBackend: 'Sandbox config',
      sandboxBackendDefault: 'Disable sandbox',
      sandboxBackendHint: 'Skill scripts run in the selected sandbox. They stay disabled until a config is chosen; if that config is deleted, skill execution will fail.',
  ...
  settings: {
    ...
    sandbox: {
      ...
      viewSandboxes: 'Who is using this',
      inventoryTitle: 'Who is using this',
      ...
      inventorySummary: 'This config still holds {count} sandbox(es).',
      inventoryEmpty: 'No sandboxes are running.',
      inventorySessions: 'Sessions holding a sandbox',
      inventorySessionsHint: 'Ending or deleting a session releases its sandbox.',
      inventoryAgents: 'Agents pinned to this config',
      inventoryNoAgents: 'No agents are using this config.',
      inventoryAgentWarning: 'If you delete this config, these agents will fail the next skill run.',
      inventoryOpenSession: 'Open',
