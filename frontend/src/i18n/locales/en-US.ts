...
\
  ...
  datasource: {
    ...
    noResourcesDesc_nutstore: 'Please verify the root directory path is correct and contains files',
    retryLoadResources: 'Retry',
    guideStep1: 'Create a group chat in Feishu, then add your app as a bot in the group settings',
    guideStep1_nutstore: 'Generate an app password in Nutstore "Settings > Security > Third-party App Management"',
    guideStep2: 'Open wiki "Settings" > "Member Settings" > "Add Member", search for the group chat and add it',
    guideStep2_nutstore: 'Enter the correct account (email) and app password, then click "Test Connection"',
    ...
    guideStep3_nutstore: 'Verify the root directory path exists and is spelled correctly, then click Retry',
    ...
    connectorDesc: {
      ...
      nutstore: 'Sync documents and files from Nutstore via WebDAV',
    },
    field: {
      appId: 'App ID',
