...
\
  ...
  datasource: {
    ...
    prereqStep1Desc_dingtalk: 'Log in to DingTalk Open Platform → Create App → Get Client ID and Client Secret',
    prereqStep2Brief_dingtalk: 'Grant document permissions',
    prereqStep2Desc_dingtalk: 'Enable read permissions for DingTalk Document APIs',
    prereqStep3Brief_dingtalk: 'Enable DingTalk Docs MCP at DingTalk AI Hub',
    prereqStep3Desc_dingtalk: 'Log in to aihub.dingtalk.com → search "DingTalk Docs" MCP → enable it and copy the MCP Server URL into the credentials',
    prereqStep4Brief_dingtalk: 'Look up your User ID in the enterprise admin portal',
    prereqStep4Desc_dingtalk: 'Log in to oa.dingtalk.com → Contacts → click your profile → copy the "userid" value into the credentials',
