export default {
  ...
  agentStream: {
    ...
    skillCards: {
      ...
      temporaryNotice: "{name} was only loaded into this conversation's sandbox. It is not installed in the workspace: it is not in the skill list, other conversations cannot use it, and it is gone when the sandbox is rebuilt.",
      temporaryNoticeUnnamed: "This skill was only loaded into this conversation's sandbox. It is not installed in the workspace: it is not in the skill list, other conversations cannot use it, and it is gone when the sandbox is rebuilt.",
      official: 'Official',
