export default {
  ...
  agentEditor: {
    ...
    im: {
      ...
      replyLanguageFixed: 'Fixed language',
      replyLanguageFollowUser: 'Follow the user',
      replyLanguageFollowHint: 'Detect the language of each message. Short or unclear messages use the last detected language in this conversation, then the deployment default.',
