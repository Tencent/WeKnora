export default {
  ...
  kbFeedback: {
    ...
    description: "Per-chunk like/dislike statistics from answer feedback and recall weight changes",
    entryTooltip: "Feedback stats",
    tabStats: "Chunk Stats",
    tabWeightLogs: "Weight Logs",
    needsOptOnly: "Needs optimization only",
    rateFilterAll: "All rates",
    rateFilterLow: "Low rate (<50%)",
    rateFilterHigh: "High rate (>=80%)",
    resetAction: "Reset feedback data",
    resetConfirm: "This clears all like/dislike counters and recall weights of this knowledge base; past ratings stop counting toward stats. Reset?",
    resetSuccess: "Reset feedback data of {count} chunks",
    resetFailed: "Reset failed, please try again",
    loadFailed: "Failed to load feedback data",
    needsOptTag: "Needs optimization",
    colChunk: "Chunk",
    colDocument: "Document",
    colLikes: "Likes",
    colDislikes: "Dislikes",
    colRate: "Rate",
    colWeight: "Weight",
    colNeedsOpt: "Status",
    colReasons: "Dislike Reasons",
    colSessions: "Sessions",
    colChunkId: "Chunk ID",
    colWeightChange: "Weight Change",
    colTrigger: "Trigger",
    colTime: "Time",
    trigger: {
  ...
  retrievalSettings: {
    feedback: {
      enabledLabel: "Feedback-based ranking",
      enabledDescription: "When enabled, chunk recall weights derived from answer likes/dislikes influence retrieval candidate ordering: well-rated chunks rank higher, poorly-rated chunks are less likely to be selected.",
      boostThresholdLabel: "Boost rate threshold",
      boostThresholdDescription: "Chunks whose positive rate reaches this threshold get a boosted recall weight",
      penaltyThresholdLabel: "Penalty rate threshold",
      penaltyThresholdDescription: "Chunks whose positive rate falls below this threshold get a reduced recall weight",
      boostFactorLabel: "Boost factor",
      penaltyFactorLabel: "Penalty factor",
      minSamplesLabel: "Minimum ratings",
      minSamplesDescription: "Weight adjustment only kicks in after a chunk accumulates this many ratings, so a single rating cannot swing retrieval",
      needsOptThresholdLabel: "Needs-optimization threshold",
      needsOptThresholdDescription: "Chunks whose positive rate falls below this threshold are automatically flagged for manual review",
    },
