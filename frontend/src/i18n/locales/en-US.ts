export default {
  ...
  chat: {
    ...
    navigateToDocument: 'Preview document',
  ...
  agentEditor: {
    ...
    tools: {
      ...
      wikiSourcePreviewLabel: 'Source document preview',
      wikiSourcePreviewDesc: 'Show preview entries for accessible source documents in Wiki reading results',
