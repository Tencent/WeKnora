export default {
  ...
  knowledgeBase: {
    ...
    urlPlaceholder: 'One or more links, one per line, e.g.\nhttps://example.com/article\nhttps://youtu.be/VIDEO_ID',
    urlTip: 'Paste one or more links, one per line. Webpages are fetched and parsed; YouTube video and playlist links are imported from their captions, or transcribed with speech recognition when a video has none',
