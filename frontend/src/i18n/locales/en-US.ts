export default {
  ...
  knowledgeBase: {
    ...
    columnName: 'Name',
    columnTag: 'Tag',
    columnJournalRank: 'Journal ranks',
    columnSize: 'Size',
    columnType: 'Type',
    columnSource: 'Source',
    columnStatus: 'Status',
    ...
    contentTypeUnclassified: 'Unclassified',
    editContentType: 'Set content type',
    batchSetContentType: 'Set content type',
    contentTypePlaceholder: 'Select a content type',
    contentTypeRequired: 'Please select a content type',
    contentTypeUpdateSuccess: 'Content type updated',
    contentTypeUpdateFailed: 'Failed to update content type',
    batchContentTypeSuccess: 'Updated content type for {count} documents',
    renameDocument: 'Rename',
    renamePlaceholder: 'Enter a new name',
    renameRequired: 'Name is required',
    renameInvalid: 'Name is too long or contains invalid characters',
    renameSuccess: 'Renamed successfully',
    renameFailed: 'Rename failed',
    contentTypes: {
      article: 'Article', book: 'Book', webpage: 'Webpage', meeting_notes: 'Meeting notes',
      report: 'Report', presentation: 'Presentation', spreadsheet: 'Spreadsheet', manual: 'Manual', other: 'Other',
    },
  ...
  knowledgeStages: {
    ...
    retry: 'Retry parsing',
    rebuild: 'Rebuild',
    rebuildDialogTitle: 'Choose rebuild scope',
    rebuildSubmit: 'Submit rebuild',
    rebuildFull: 'Full rebuild',
    rebuildPartial: 'Partial rebuild',
    rebuildSelectOne: 'Select at least one rebuild stage',
    rebuildSubmitted: 'Rebuild task submitted',
    rebuildFailed: 'Failed to submit rebuild',
    stageEmbedding: 'Embedding index',
    stageSummary: 'Summary',
    stageQuestions: 'Question generation',
    stageGraph: 'Knowledge graph',
    stageWiki: 'Wiki',
    stageJournalRank: 'Journal ranking',
    stageContentType: 'Content type',
    refresh: 'Refresh now',
    copy: 'Copy',
  ...
  settings: {
    ...
    parser: {
      ...
      easyScholarSection: 'Journal ranking (EasyScholar)',
  ...
  webSearchSettings: {
    ...
    serpApiEngineLabel: 'Search engine',
    serpApiEngineHelp: 'Choose the SerpApi result type. Google Web is used by default.',
    serpApiEngines: {
      google: 'Google Web',
