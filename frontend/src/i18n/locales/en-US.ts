export default {
  ...
  evaluationSettings: {
    ...
    total: '{count} runs', pageStatus: 'Page {current} of {total}', empty: 'No evaluation runs yet.', selectCompare: 'Select for comparison',
    ...
    repeatSummary: 'Repeated-run summary', repeatSummaryHint: 'Only successful runs with identical code, data, configuration, knowledge base, model fingerprints, and call workloads are aggregated.',
    repeatCount: '{count} matched runs', medianRecall: 'Median recall', medianDuration: 'Median duration', p95Duration: 'P95 duration',
    medianTokens: 'Median tokens', medianCacheHitRate: 'Median cache hit rate', medianCost: 'Median cost', latencyDistribution: 'Median and P95 latency comparison', medianShort: 'Median',
  ...
  modelSettings: {
    ...
    usage: {
      ...
      cacheCoverage: 'Reporting coverage',
      ...
      rangeAll: 'All retained data',
      details: 'Purpose details',
      hideDetails: 'Hide details',
      partial: 'Partial pricing',
      partialCost: 'Includes only calls with configured pricing and is not the total cost',
      embeddingCache: 'Vector cache',
      embeddingCacheHint: 'Share of embedding inputs served directly from memory or persistent cache',
      embeddingAvoided: 'Computations avoided',
      embeddingAvoidedHint: 'Embedding computations avoided through cache hits and in-batch deduplication',
      wikiSummary: 'Wiki summary',
      loading: 'Refreshing model usage…',
      loadFailed: 'Model usage could not be loaded. Model configuration is unaffected.',
      retry: 'Retry',
      noData: 'No model-call or vector-cache data in the selected period.',
      purposes: {
