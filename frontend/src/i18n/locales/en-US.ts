export default {
  ...
  knowledgeBase: {
    ...
    invalidURLsSkipped: '{count} entries are not valid links and were skipped',
    ...
    urlPlaceholder: 'One or more webpage links, one per line, e.g.\nhttps://example.com/article',
    urlTip: 'Paste one or more webpage links, one per line. The system extracts and parses the text of each page. To import YouTube videos or playlists, use Import from YouTube',
    youtubeImporting: 'Importing {count} YouTube link(s)…',
    youtubeImportSuccess: 'Queued {count} YouTube video(s)',
    youtubeImportDuplicates: '{count} video(s) are already in this knowledge base',
    youtubeImportFailures: '{count} link(s) or video(s) could not be imported',
    youtubeImportTruncated: 'The import video limit was reached; only the first videos were imported',
    youtubeImportFailed: 'YouTube import failed',
    importYouTube: 'Import from YouTube',
    importYouTubeTitle: 'Import from YouTube',
    youtubeUrlLabel: 'YouTube links',
    youtubeUrlPlaceholder: 'One YouTube link per line, e.g.\nhttps://www.youtube.com/watch?v=VIDEO_ID\nhttps://www.youtube.com/playlist?list=PLAYLIST_ID',
    youtubeUrlTip: 'Only YouTube video and playlist links are supported. Paste one link per line; each video becomes its own document, and each playlist is imported into a folder named after the playlist. A video link that includes &list= imports only that video — use the playlist link to import the whole playlist. Captions are used when available; otherwise the audio is transcribed with the knowledge base\'s speech recognition model',
    noYouTubeURLs: 'Please enter at least one YouTube video or playlist link',
    nonYouTubeURLsSkipped: '{count} line(s) are not YouTube links and were skipped',
    typeURL: 'URL',
    typeManual: 'Manual',
    typeFile: 'File',
