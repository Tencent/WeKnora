export default {
  ...
  datasource: {
    ...
    noResourcesDesc_dingtalk: 'The DingTalk app needs wiki and document read permissions before spaces can be listed',
    ...
    guideStep1_dingtalk: 'Open DingTalk Developer Console and create or select an internal app',
    guideStep2_dingtalk: 'Grant wiki workspace, wiki node and file content read permissions, then publish the app',
    guideStep3_dingtalk: 'Confirm the app can access the target wiki spaces, then come back and click Retry',
    permissionDocLink: 'View Feishu wiki permission docs',
    permissionDocLink_yuque: 'View Yuque token docs',
    permissionDocLink_dingtalk: 'View DingTalk permission docs',
    ...
    connectorDesc: {
      ...
      dingtalk: 'Sync documents from DingTalk Wiki'
    },
    field: {
      appId: 'App ID',
      ...
      operatorIdHint: 'Enter the unionId of a DingTalk user who can read the target wiki spaces.',
    ...
    prereqStep1Brief_dingtalk: 'Create or select an internal DingTalk app',
    prereqStep1Desc_dingtalk: 'Open DingTalk Developer Console, then copy the app Client ID and Client Secret.',
    prereqStep2Brief_dingtalk: 'Grant the required Wiki and document permissions',
    prereqStep2Desc_dingtalk: 'Enable Wiki.Workspace.Read, Wiki.Node.Read and Storage.File.Read, then publish the app.',
    prereqStep3Brief_dingtalk: 'Prepare an operator UnionID',
    prereqStep3Desc_dingtalk: 'Use a DingTalk user unionId that can read the target wiki spaces.',
