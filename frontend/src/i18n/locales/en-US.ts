export default {
  ...
  knowledgeBase: {
    folders: 'Folders',
    folderRoot: 'All documents',
    folderCreate: 'New folder',
    folderCreateRoot: 'New root folder',
    folderCreateChild: 'New subfolder',
    folderRename: 'Rename',
    folderRelocate: 'Move folder',
    folderRelocateTitle: 'Choose parent folder',
    folderMoved: 'Folder moved',
    folderMoveFolderFailed: 'Failed to move folder',
    folderNamePlaceholder: 'Enter a folder name',
    folderAsk: 'Ask this folder',
    folderItemCount: '{count} items',
    folderReparseAll: 'Reparse all',
    folderDeleteAll: 'Delete all',
    folderReparseTitle: 'Reparse folder',
    folderReparseConfirm: 'Reparse {count} items in “{name}” and all subfolders?',
    folderReparseSubmitted: 'Submitted {count} items for reparsing',
    folderReparseFailed: 'Failed to submit folder reparse task',
    folderDeleteRecursiveTitle: 'Delete folder and contents',
    folderDeleteRecursiveConfirm: 'Delete “{name}”, all subfolders, and {count} contained items? This cannot be undone.',
    folderDeleteRecursiveSubmitted: 'Submitted {count} items for deletion',
    folderDeleteRecursiveFailed: 'Failed to delete folder',
    folderEmpty: 'No folders yet',
    folderSaved: 'Folder saved',
    folderSaveFailed: 'Failed to save folder',
    folderUploadDepthExceeded: 'The uploaded directory exceeds the 10-level folder limit',
    folderLoadFailed: 'Failed to load folders',
    folderDeleteTitle: 'Delete folder',
    folderDeleteConfirm: 'Delete folder “{name}”? The folder must be empty.',
    folderDeleted: 'Folder deleted',
    folderDeleteFailed: 'Failed to delete folder',
    folderMove: 'Move to folder',
    folderMoveTitle: 'Move selected documents',
    folderMoveSuccess: 'Documents moved',
    folderMoveFailed: 'Failed to move documents',
