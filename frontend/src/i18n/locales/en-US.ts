export default {
  ...
  settings: {
    ...
    sandbox: {
      ...
      replaceStandardTemplateConfirm: 'This deletes the WeKnora standard template on the cluster and rebuilds it with the current settings, including DNS. Sandboxes already using that template may no longer start.',
