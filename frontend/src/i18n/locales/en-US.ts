export default {
  ...
  knowledgeBase: {
    ...
    confirmDeleteDocument: 'Delete document "{fileName}"? Pending file updates will also be cancelled. This cannot be undone.',
    ...
    statusReplacing: 'Replacing file',
    fileUpdateActive: 'Updating file',
    fileUpdatePending: 'Update pending v{version}',
    fileUpdateFailed: 'File update failed',
    retryFileUpdate: 'Retry latest version',
    retryFileUpdateSubmitted: 'File update resubmitted',
    retryFileUpdateFailed: 'Failed to retry file update',
    discardFileUpdate: 'Discard pending update',
    discardFileUpdateConfirm: 'Discard the failed version and its latest pending file?',
    discardFileUpdateSubmitted: 'Pending update discarded',
    discardFileUpdateFailed: 'Failed to discard pending update',
    statusFailed: 'Failed',
    ...
    parseStatusReplacing: 'Replacing file',
