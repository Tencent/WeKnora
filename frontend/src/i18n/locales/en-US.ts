export default {
  ...
  knowledgeBase: {
    ...
    folderTreeTitle: 'Folders',
    folderAll: 'All Documents',
    newFolder: 'New Folder',
    folderEmpty: 'No folders',
    ...
    createUnderRoot: 'Creating under: Root',
    createUnderFolder: 'Creating under: {name}',
    moveFolder: 'Move folder',
    moveFolderTitle: 'Move folder',
    moveFolderBody: 'Move "{name}" to:',
    moveFolderRoot: 'Root (top level)',
    moveFolderSuccess: 'Folder moved',
    moveFolderFailed: 'Failed to move folder',
    moveFolderIntoSelf: 'Cannot move into itself or a descendant',
    moveFolderConfirm: 'Move',
  },
