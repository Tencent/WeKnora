export default {
  ...
  settings: {
    ...
    sandbox: {
      ...
      templateLoadHint: 'Enter the cluster connection and refresh. Missing WeKnora CLI or desktop templates are built from the official Hub images. After changing DNS or the image, rebuild from that card.',
      ...
      templateStepHint: 'This step lists cluster templates and builds the official CLI and desktop images if they are missing. After changing DNS or the image, rebuild that card. You can continue after a template is ready.',
