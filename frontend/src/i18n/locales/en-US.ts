export default {
  ...
  backup: {
    ...
    description: 'Full-instance backup: database, uploaded files and configuration. System admin only.',
    privacyNotice: "Archives contain every workspace's data and encrypted credentials (model API keys etc.). Store backup files safely.",
    ...
    restoreConfirmBtn: 'Restore now',
    cancel: 'Cancel',
    restoreWarning: 'Restore replaces the entire database (current data is overwritten) and takes an automatic rollback snapshot first; a restart is required afterwards.',
    restoreDone: 'Restore finished — restart the instance to apply',
    rollbackPoint: 'Rollback snapshot',
