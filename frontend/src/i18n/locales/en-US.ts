export default {
  ...
  webSearchSettings: {
    ...
    configFields: {
      ...
      metasoScope: 'Search scope',
      metasoScopeDesc: 'Select the Metaso search scope.',
      metasoScopeWebpage: 'Webpage',
      metasoScopeDocument: 'Document',
      metasoScopeScholar: 'Scholar',
      metasoScopeImage: 'Image',
      metasoScopeVideo: 'Video',
      metasoScopePodcast: 'Podcast',
      metasoConciseSnippet: 'Return concise snippet',
      metasoConciseSnippetDesc: 'When enabled, returns concise matched-snippet text; disabled returns the full snippet.',
      metasoIncludeSummary: 'Recall enhancement via page summary',
      metasoIncludeSummaryDesc: 'When enabled, enhances recall using webpage summary information.',
    },
    toasts: {
