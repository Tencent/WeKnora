export default {
  ...
  knowledgeFolder: {
    ...
    folderUpdatedSuccess: 'Folder updated successfully',
    folderUpdatedFailed: 'Failed to update folder',
    folderDeletedSuccess: 'Folder deleted',
    folderDeletedFailed: 'Failed to delete folder',
    folderMovedSuccess: 'Folder moved',
    folderMovedFailed: 'Failed to move folder',
    confirmDeleteFolder: 'Are you sure you want to delete folder "{name}"?',
    confirmDeleteFolderWithContent: 'Folder "{name}" contains {count} items. Deleting the folder moves its content to the root. Continue?',
    forceDelete: 'Delete folder and move content to root',
    batchMoveSuccess: 'Moved {count} files',
    batchMoveFailed: 'Failed to batch move',
    viewModeList: 'List View',
    viewModeGrid: 'Grid View',
    navigationHint: 'Double click to enter folder',
    selectFolderHint: 'Select a target folder, or choose "Root Folder" to move to top level',
    folderPathSeparator: ' / ',
    loading: 'Loading...',
    loadingFolders: 'Loading folders...',
    loadingBreadcrumb: 'Loading path...',
    cannotMoveToSelf: 'Cannot move to itself or its subfolders',
    cannotMoveToDescendant: 'Cannot move to its own subfolder',
    folderNameRequired: 'Please enter folder name',
    folderNameTooLong: 'Folder name cannot exceed 255 characters',
