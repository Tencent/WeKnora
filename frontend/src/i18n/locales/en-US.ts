...
export default {
  ...
  evaluation: {
    ...
    dataset: 'Dataset',
    datasetPlaceholder: 'Dataset ID',
    datasetVersion: 'Dataset version',
    versionPlaceholder: 'Version ID',
    model: 'Model',
    ...
    selectRun: 'Select run {id}',
    runsCompared: 'runs compared',
    comparison: 'Comparison',
    backToDetail: 'Back to run detail',
    parameterDifferences: 'Stable parameter differences',
    parameter: 'Parameter',
    missing: 'Missing',
    metricDifferences: 'Metric differences',
    questionSuccess: 'Question success',
    ...
    loadingQuestions: 'Loading question evidence…',
    noQuestions: 'No question results are available.',
    ...
    savingRating: 'Saving…',
    noRatings: 'No human rating revisions.',
    ratingSaved: 'Rating revision appended',
    loadMoreQuestions: 'Load more questions',
    detailEmpty: 'Select an experiment run',
    detailEmptyHint: 'Run provenance, metrics, question evidence, and export controls appear here.',
    loadingDetail: 'Loading run detail…',
    selectAtMostTen: 'Select at most 10 runs.',
    selectAtLeastTwo: 'Select at least 2 runs.',
    labelsSaved: 'Labels saved',
    unknownError: 'The evaluation request failed.',
    status: {
      pending: 'Pending',
      running: 'Running',
      success: 'Success',
  ...
  modelSettings: {
    ...
    observability: {
      cachePricingTitle: "Cache token pricing (optional)",
      cacheReadPrice: "Cache read / million",
      cacheWrite5mPrice: "Cache write · 5 min / million",
      cacheWrite1hPrice: "Cache write · 1 hour / million",
      cachePricingHint: "Leave blank for unknown pricing; enter 0 for free. Units match the base input/output prices.",
  ...
  organization: {
    ...
    avatarClear: 'Clear',
    avatarPickerHint: 'Choose a shared space icon',
