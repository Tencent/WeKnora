export default {
  ...
  agentEditor: {
    ...
    im: {
      ...
      messageStorage: 'Automatically save each Q&A round to a knowledge base',
      messageStorageHint: 'Text, files, and images follow the normal Q&A flow, then are saved asynchronously after the answer is complete.',
      fileKnowledgeBase: 'Target knowledge base',
      fileKnowledgeBasePlaceholder: 'Select a knowledge base',
      fileKnowledgeBaseHint: 'The target is retained as a preset and is used only when message storage is enabled.',
      fileKnowledgeBaseRequired: 'Select a target knowledge base to enable message storage',
