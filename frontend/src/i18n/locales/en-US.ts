export default {
  ...
  auth: {
    ...
    loginIdentifier: 'Account or Email',
    loginIdentifierPlaceholder: 'Enter email or username',
    loginIdentifierRequired: 'Enter account or email',
    ...
    loginError: 'Login error, please check account or password',
