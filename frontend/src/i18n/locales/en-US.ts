export default {
  ...
  knowledgeBase: {
    ...
    uploadingFolder: 'Preserving the folder structure and uploading {total} files...',
    uploadPreparingFolders: 'Preparing folder structure',
    uploadBatchRunning: 'Uploading files',
    uploadBatchComplete: 'Upload complete',
    uploadBatchProgress: 'Processed {completed} / {total}',
    uploadBatchSuccessCount: '{count} succeeded',
    uploadBatchSkippedCount: '{count} skipped',
    uploadBatchFailedCount: '{count} failed',
    uploadBatchCancelledCount: '{count} cancelled',
    uploadCancel: 'Cancel remaining uploads',
    uploadCancelling: 'Cancelling...',
    uploadCancelledItem: 'Upload cancelled',
    uploadCancelledSummary: 'Remaining uploads stopped: {success} succeeded, {cancelled} cancelled',
    uploadAllSkippedSummary: '{count} file(s) skipped by the selected strategy; nothing was uploaded',
    uploadBatchAlreadyRunning: 'An upload is already running. Wait for it to finish or cancel it first.',
    ...
    folderBrowseHint: 'Open a folder to view documents at that level',
    folderDirectDocuments: '{count} documents at this level',
    folderContainsSubfolders: 'Has subfolders',
    folderSearchResultCount: '{count} matches',
    folderSearchEmpty: 'No matching folders',
    folderLoadMore: 'Load more folders',
    folderNoSubfoldersHint: 'You can still store documents directly in this location.',
    folderNoDocumentsTitle: 'No documents in this folder',
    folderListLabel: 'Folders',
    noFolders: 'No folders',
    newFolder: 'New Folder',
    uploadHere: 'Upload Here',
    uploadToRoot: 'Upload to Root',
    folderNamePlaceholder: 'Enter a folder name',
    folderNameTooLong: 'Folder name exceeds 255 bytes ({count} bytes entered)',
    retry: 'Retry',
    loadFoldersFailed: 'Failed to load folders',
    createFolderFailed: 'Failed to create folder',
    createFolderSuccess: 'Folder created',
    folderUploadPrepareFailed: 'Could not create folders for "{path}": {error}',
    folderUploadConflictSkipped: 'An existing folder has the same name, so this subtree was skipped by the selected strategy',
    rename: 'Rename',
    ...
    deleteFolderWithName: 'Delete “{name}”',
    deleteFolderImpactSummary: '{folders} folders · {documents} documents',
    deleteFolderChooseMode: 'Choose how to delete this folder',
    deleteFolderKeepDocuments: 'Delete folders, keep documents',
    deleteFolderKeepDocumentsDescription: 'The selected folder and all nested folders will be deleted. {count} documents will move to the knowledge base root.',
    deleteFolderStructureLost: 'The existing folder structure will be lost.',
    deleteFolderDeleteAll: 'Delete everything permanently',
    deleteFolderDeleteAllDescription: 'Permanently delete all folders, documents, chunks, and vector data.',
    deleteFolderIrreversible: 'This action cannot be undone.',
    deleteFolderDocumentsProcessing: '{count} documents are still being processed. Wait for processing to finish before keeping them, or choose permanent deletion.',
    deleteFolderEmptyTreeConfirm: 'Delete all {count} folders in this empty folder tree? It contains no documents.',
    deleteFolderConfirmAction: 'Delete folders, keep documents',
    deleteFolderDeleteAllAction: 'Delete permanently',
    deleteFolderTaskSubmitted: 'Deletion started. This view will refresh when it finishes.',
    deleteFolderFailed: 'Delete failed',
    deleteFolderSuccess: 'Folder deleted',
    renameFailed: 'Rename failed',
    currentLocation: 'Current location',
    documentCount: '{count} documents',
    folderTreeTitle: 'Folder navigation',
    showFolderTree: 'Show folder tree',
    hideFolderTree: 'Hide folder tree',
    folderTreeSearchPlaceholder: 'Search all folders',
    documentScopeLabel: 'Document scope',
    documentScopeCurrent: 'Current folder',
    folderMentionTitle: 'Choose a folder scope',
    folderMentionDescription: 'The scope automatically includes documents in every nested folder.',
    folderMentionChooseKb: 'Choose a document knowledge base first',
    folderMentionChooseKbHint: 'Then browse its folders one level at a time.',
    folderMentionUseCurrent: 'Use this folder',
    folderMentionUseCurrentHint: 'Includes this folder and all nested folders.',
    folderMentionRootHint: 'Choose a specific folder for the question scope.',
    folderMentionEmpty: 'No subfolders in this location',
    folderMentionBackToKb: 'Back to knowledge bases',
  ...
  uploadConfirm: {
    ...
    folderStructureHint: 'Preserve the structure and create or reuse {count} folder(s) under "{destination}"',
    folderConflictTitle: 'When a folder already exists',
    folderConflictMerge: 'Merge',
    folderConflictSkip: 'Skip',
    folderConflictRename: 'Rename',
    folderConflictMergeHint: 'Reuse the matching folder and create any missing descendants',
    folderConflictSkipHint: 'Skip the entire uploaded subtree that conflicts with an existing folder',
    folderConflictRenameHint: 'Create a separate folder such as "Folder (1)" instead of mixing contents',
    emptyFoldersNotPreserved: 'Browsers do not expose empty folders, so empty-only directory levels cannot be uploaded',
    duplicateStrategyHint: 'Duplicate files are skipped without overwriting existing documents and remain visible in the result list',
  ...
  mentionDetail: {
    unifiedSearchTitle: 'Search reference scope',
    unifiedSearchHint: 'Matches knowledge bases, folders, and files together',
    searchingAllTypes: 'Searching all resource types...',
    typeKnowledgeBase: 'Knowledge base',
    typeFolder: 'Folder',
    typeFile: 'File',
    typeTag: 'Tag',
  ...
  input: {
    ...
    placeholderWithContext: 'Enter your question, will answer based on selected knowledge bases/folders/files above',
    ...
    messages: {
      ...
      folderCapabilityUnavailable: 'Folder Q&A is unavailable until the rolling upgrade completes. Remove the selected folder or try again later.',
      folderUnsupportedInSmartReasoning: 'Intelligent Reasoning does not support folder scope yet. Switch to Quick Q&A or remove the selected folder.',
