export default {
  ...
  knowledgeBase: {
    ...
    batchMoveToFolder: 'Move to folder',
    moveToFolder: 'Move to folder',
    moveToFolderHeading: 'Move to folder',
    moveToFolderSubtitle: 'Move {count} selected document(s) into a folder',
    moveToFolderPickHint: 'Pick a destination folder',
    folderPanelTitle: 'Folders',
    folderExpandPanel: 'Expand folder panel',
    folderCollapsePanel: 'Collapse folder panel',
    folderNewRoot: 'New folder',
    folderNewChild: 'New subfolder',
    folderRename: 'Rename',
    folderDelete: 'Delete folder',
    folderActions: 'Folder actions',
    folderAllDocuments: 'All documents',
    folderUnfiled: 'Unfiled',
    folderNamePlaceholder: 'Folder name',
    folderSearchPlaceholder: 'Search folders',
    folderSearchEmpty: 'No matching folder',
    folderEmptyHint: 'No folders yet. Create one from the button above.',
    folderIncludeSubfolders: 'Include subfolders',
    folderDeleteConfirm: 'Delete folder “{name}”?',
    folderDeleteNotEmpty: 'This folder holds {count} document(s). They will be moved up to the parent folder; the documents themselves are not deleted.',
    folderDeleteReparent: 'Delete and move documents up',
    ...
    folderMoveIntoSelf: 'A folder cannot be moved into itself or its own subfolder',
    folderMoveSuccess: 'Folder moved',
    folderMoveFailed: 'Failed to move folder',
    folderMoveDocsSuccess: 'Moved {count} document(s)',
    folderMoveDocsFailed: 'Failed to move documents',
