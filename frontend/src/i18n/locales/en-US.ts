export default {
  ...
  knowledgeBase: {
    ...
    urlLabel: 'Links',
    urlPlaceholder: 'One link per line, e.g.\nhttps://example.com/article\nhttps://www.youtube.com/watch?v=VIDEO_ID\nhttps://www.youtube.com/playlist?list=PLAYLIST_ID',
    urlTip: 'Paste web page or YouTube links, one per line. Web pages are fetched and parsed. Each YouTube video becomes its own document built from its captions, or from speech recognition when it has none, and each YouTube playlist is imported into a folder named after it. A video link that includes &list= imports only that video; use the playlist link to import the whole playlist',
    urlPreviewWebPages: '{count} web page(s)',
    urlPreviewYouTubeVideos: '{count} YouTube video(s)',
    urlPreviewYouTubePlaylists: '{count} YouTube playlist(s), each into its own folder',
    urlPreviewInvalid: '{count} invalid line(s), will be skipped',
