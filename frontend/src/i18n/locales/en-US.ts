export default {
  ...
  knowledgeEditor: {
    ...
    wikiBrowser: {
      ...
      profileEmpty: 'No evidence yet. Browse, cite or like to build your knowledge profile.',
      profileExport: 'Export HTML',
      profileExportSuccess: 'Profile exported',
      profileExportFailed: 'Export failed',
      profileDelete: 'Delete profile',
      profileDeleteConfirm: 'This clears your entire personal knowledge state and resets the graph. It does not affect knowledge base content, other users, or retrieval personalization. This cannot be undone. Continue?',
