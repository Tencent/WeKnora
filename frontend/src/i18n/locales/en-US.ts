export default {
  ...
  uploadConfirm: {
    ...
    overviewDesc: 'Review the parsing settings below, then start the upload',
    basicSettings: 'Common settings',
    advancedSettings: 'Advanced capabilities',
  ...
  feedback: {
    like: 'Like',
    dislike: 'Dislike',
    dislikeHeader: 'Tell us what can be improved',
    dislikeHint: 'Select why this answer fell short. Add details if helpful:',
    commentPlaceholder: 'Add more detail (optional)',
    commentRequiredWhenOther: 'Please provide details when selecting "Other"',
    saveSuccess: 'Feedback saved',
    cancelSuccess: 'Feedback cleared',
    saveError: 'Could not save feedback, please retry',
    reasons: {
    ...
    kbStats: {
      ...
      lowQualityOnly: 'Show only low-quality chunks',
      reset: 'Reset feedback',
      resetConfirm: 'Reset all feedback for this knowledge base? Historical ratings will no longer count toward statistics but are not deleted.',
      resetSuccess: 'Feedback reset',
      sortPositiveRateAsc: 'Positive rate (ascending)',
      sortPositiveRateDesc: 'Positive rate (descending)',
      sortFeedbackCountDesc: 'Feedback count (descending)',
      sortLastFeedbackDesc: 'Latest feedback (most recent)',
      columnChunk: 'Chunk',
      columnLikeCount: 'Likes',
      columnDislikeCount: 'Dislikes',
      columnSessionCount: 'Sessions',
      columnPositiveRate: 'Positive rate',
      columnLastFeedback: 'Last feedback',
      columnDislikeReasons: 'Dislike reasons',
      weightLogTitle: 'Weight change log',
      needsOptimization: 'Needs optimization',
      lowQuality: 'Low quality',
    },
    retrieval: {
      sectionTitle: 'Feedback-driven ranking',
      enable: 'Enable feedback-driven recall ranking',
      description: 'Automatically re-rank knowledge chunks based on user like / dislike of past answers.',
      boostThreshold: 'Positive rate boost threshold',
      penaltyThreshold: 'Positive rate penalty threshold',
      boostFactor: 'Boost factor',
      penaltyFactor: 'Penalty factor',
      minSamples: 'Minimum feedback samples',
      needsOptimizationThreshold: 'Needs-optimization threshold',
      validationError: 'Invalid feedback policy: {message}',
      recomputing: 'Recomputing feedback weights…',
      recomputeSuccess: 'Feedback weights recomputed ({count} chunks)',
    },
  },
  file: {
    upload: 'Upload File',
