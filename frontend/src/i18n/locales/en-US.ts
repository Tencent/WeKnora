...
\
  ...
  datasource: {
    ...
    connectorDesc: {
      ...
      dingtalk: 'Sync online documents from DingTalk Wiki',
    ...
    field: {
      ...
      dingtalkAppSecret: 'Client Secret',
    ...
    prereqStep1Desc_dingtalk: 'Open the internal app in DingTalk Open Platform, then copy Client ID / AppKey and Client Secret',
    prereqStep2Brief_dingtalk: 'Grant Docs and Wiki read permissions',
    prereqStep2Desc_dingtalk: 'Grant member info read permission, Wiki.Workspace.Read, Wiki.Node.Read, and Storage.File.Read',
    prereqStep3Brief_dingtalk: 'Enter the operator userId',
    prereqStep3Desc_dingtalk: 'The operator must be able to access the DingTalk wiki. The system will look up unionId from userId, then read documents as this user.',
