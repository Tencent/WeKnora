export default {
  ...
  datasource: {
    ...
    field: {
      ...
      operatorId: 'Operator ID (unionId)',
      operatorIdHint: 'Find the unionId in DingTalk admin console → Contacts → member details, or obtain it via API.'
    },
    ...
    prereqBarText_dingtalk: 'First time? Click to see DingTalk app setup guide',
    prereqStep1Brief_dingtalk: 'Create a DingTalk enterprise internal app',
    prereqStep1Desc_dingtalk: 'DingTalk Open Platform → App Development → Enterprise Internal App → Create App',
    prereqStep2Brief_dingtalk: 'Grant knowledge base permissions',
    prereqStep2Desc_dingtalk: 'Enable: Knowledge base read, Knowledge base node read, Enterprise storage file read',
    prereqStep3Brief_dingtalk: 'Get Client ID, Client Secret and operator unionId',
    prereqStep3Desc_dingtalk: 'Get Client ID and Client Secret from app credentials page; get unionId from Contacts member details.',
