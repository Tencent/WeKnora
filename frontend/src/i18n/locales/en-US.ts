export default {
  ...
  integrations: {
    ...
    api: {
      ...
      kbPermissionPerKB: "Per knowledge base",
      kbPermissionUniform: "Uniform permissions",
      kbPermissionHint: "Each level is limited by this key’s capabilities and the workspace’s current sharing permissions. Managing a shared KB does not grant ownership or sharing rights.",
      kbPermissionSelect: "Select owned or shared knowledge bases",
      kbPermissionEmpty: "No knowledge base access",
      kbPermissionRead: "Read / search",
      kbPermissionWrite: "Read + write content",
      kbPermissionManage: "Manage knowledge base",
      kbPermissionOwn: "Current workspace",
      kbPermissionUnavailable: "Unavailable or no longer shared; remove this entry to save.",
      kbPermissionUniformHint: "The same capabilities apply to every selected owned KB. An empty selection keeps the existing unrestricted scope. Use per-KB permissions to explicitly authorize shared KBs.",
      kbPermissionLoadFailed: "Some knowledge base options could not be loaded. Please retry before changing permissions.",
