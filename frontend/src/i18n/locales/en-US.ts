export default {
  ...
  settings: {
    ...
    skills: {
      ...
      addStepRegisterDesc: "Add a skill from a link, ZIP or installation instructions.",
      addMethodSource: "Source link",
      addMethodFile: "Upload ZIP",
      addMethodPrompt: "Prompt install",
      promptInstructions: "Instructions",
      promptInstallDesc: "Choose sandbox targets to start. Follow progress, send guidance or retry.",
      promptTitle: "Enter installation instructions",
      promptHint: "Enter a skill name, installation docs, command or requirement. After you choose sandboxes, the agent reads the docs, prepares tools, acquires the skill and verifies installation.",
      promptPlaceholder: "For example: Install a skill by ID following its documentation; check the CLI first and install it if missing.",
