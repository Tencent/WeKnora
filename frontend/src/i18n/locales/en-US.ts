export default {
  ...
  knowledgeBase: {
    ...
    searchWholeKb: 'Searching all: {q}',
    folderBreadcrumbLabel: 'Folder path',
    breadcrumbCollapsedItems: '{count} collapsed levels',
    emptyFolderTree: 'No folders yet',
    emptyFolderTreeHint: 'Folders you create will appear here',
    // Task 9: search-mode filter hint and empty-state copy
    searchFiltersApplyOnlyToDocs: 'Other filters apply only to files',
    emptyFolderHint: 'This folder is empty',
    searchNoResults: 'No results found',
    emptyRootViewer: 'This knowledge base has no content yet',
    newFolder: 'New folder',
    folderActions: 'Folder actions',
    folderActionAddSubfolder: 'New subfolder',
    folderActionRename: 'Rename',
    folderActionDelete: 'Delete',
    folderActionMoveTo: 'Move to folder…',
    folderActionDeleteConfirm: 'Delete folder "{name}"? This will also delete all its subfolders and documents.',
    folderDocumentCount: '{count} documents',
    folderCardType: 'Folder',
    // Inline folder editing (Task 6): UX pre-validation + backend error mapping.
    folderNameRequired: 'Please enter a folder name',
    folderNameInvalid: 'Folder name cannot be ".", "..", or contain "/" or "\\"',
    folderNameConflict: 'A folder with this name already exists. Choose another name.',
    folderDepthExceeded: 'Folder depth limit reached. Cannot create a folder here.',
    folderActionFailed: 'Folder operation failed. Please try again.',
    expandFolder: 'Expand',
    collapseFolder: 'Collapse',
    // Move-to-folder picker (Task 7): same-KB move + cross-KB transfer split.
    transferToKnowledgeBase: 'Transfer to another knowledge base…',
    folderPickerTitle: 'Move to folder',
    folderPickerTargetLabel: 'Destination',
    folderPickerSelectHint: 'Select a destination folder',
    folderPickerDisabledHint: 'Cannot move to this folder',
    folderPickerConfirm: 'Move here',
    folderPickerEmpty: 'No folders to select',
    folderMoveSuccess: 'Moved to the selected folder',
    folderMoveFailed: 'Move failed. Please try again.',
    // Recursive folder delete (Task 8): impact display + submitted (not done) messaging.
    folderDeleteTitle: 'Delete Folder',
    folderDeleteEmptyConfirm: 'Delete folder "{name}"? The folder is empty; only the folder itself will be removed.',
    folderDeleteRecursiveConfirm: 'Deleting folder "{name}" will also delete all of its subfolders and documents. Continue?',
    folderDeleteImpact: 'This will also delete {folderCount} subfolders and {docCount} documents',
    folderDeleteImpactFolders: 'This will also delete {folderCount} subfolders',
    folderDeleteAsyncNote: 'Deletion runs asynchronously in the background; the list refreshes automatically when done.',
    folderDeleteSubmitted: 'Deletion submitted; the background task is processing',
    folderDeleteFailed: 'Delete failed. Please try again.',
    folderReparseLimit: 'Up to 200 documents can be reprocessed at once; reduce the selection.',
    reparseFolderUnsupported: 'Reparse supports documents only; deselect folders first.',
    // Folder load errors + invalid folder_id recovery (spec §4.1 / §12)
    folderLoadFailed: 'Failed to load folder',
    folderRetry: 'Retry',
    folderNotFoundTitle: 'Folder unavailable',
    folderNotFoundHint: 'This folder may have been deleted or moved. You have been returned to the root folder.',
    folderTreeLoadFailed: 'Failed to load folder tree',
    folderTreeRetry: 'Retry',
