export default {
  ...
  knowledgeEditor: {
    ...
    feedback: {
      ...
      statsOverviewDesc: 'Refresh feedback counts for chunks with feedback.',
      totalChunks: 'Chunks with Feedback',
      ...
      viewDetails: 'View',
      reset: 'Reset',
      resetConfirm: 'Reset this chunk feedback stats and historical references?',
