export default {
  ...
  settings: {
    ...
    sandbox: {
      ...
      disableScripts: 'Disable script execution',
      enableScripts: 'Enable script execution',
      disableScriptsConfirm: 'Agents without a named sandbox backend will no longer execute skill scripts (they can still read skill content). Agents explicitly pointed at a Cube/E2B config are unaffected. Continue?',
      scriptsDisabled: 'Default script execution disabled for this workspace',
      scriptsEnabled: 'Default script execution restored for this workspace',
      policySaveFailed: 'Failed to update script execution policy',
      ...
      inheritedValue: 'Global default: {value}',
      inheritedSecret: 'A global key is configured; leave empty to inherit it',
      backends: {
        disabled: 'Disabled',
        local: 'Local process',
        docker: 'Docker',
      ...
      defaultTimeoutHint: '0 inherits the global default',
