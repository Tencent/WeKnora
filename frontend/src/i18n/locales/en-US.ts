export default {
  ...
  settings: {
    ...
    storageBackend: {
      ...
      signatureVersionLabel: 'Signature version',
      signatureVersionDesc: 'Choose V1 for private/on-premise OSS that does not support V4 signing',
      signatureVersionV1: 'V1 (private/on-premise compatible)',
      signatureVersionV4: 'V4 (default)',
      testConnection: 'Test connection',
