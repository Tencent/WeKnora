export default {
  ...
  knowledgeFolder: {
    ...
    createTopLevel: 'New top-level folder',
    createChild: 'New subfolder',
    rename: 'Rename',
    delete: 'Delete',
    startKnowledgeBaseChat: 'Chat with this knowledge base',
    startFolderChat: 'Chat with this folder',
    folderNamePlaceholder: 'Enter a folder name',
    deleteConfirm: 'Delete folder “{name}”?',
    notEmpty: 'This folder still contains files or subfolders. Empty it before deleting.',
    ...
    retry: 'Retry',
    resizeLabel: 'Resize folder sidebar',
    breadcrumbLabel: 'Folder path',
    ensurePathsFailed: 'Failed to create folder paths',
    expandFolder: 'Expand {name}',
    collapseFolder: 'Collapse {name}',
  },
  knowledgeScope: {
    selectedCount: 'Selected: {count}',
    fileOwnershipUnavailable: 'Could not confirm the knowledge base for the selected files. Reselect the files and try again.',
  },
  knowledgeBase: {
