export default {
  menu: {
    ...
    knowledgeProcessing: 'Processing Dashboard',
    agents: 'Agents',
  ...
  processingDashboard: {
    title: 'Knowledge Processing Dashboard',
    subtitle: 'Monitor active and waiting knowledge processing by stage',
    primaryGroup: 'Primary Pipeline',
    enrichmentGroup: 'Content Enrichment',
    running: 'Running',
    queued: 'Queued',
    retrying: 'Retrying',
    viewQueue: 'View queue',
    noRunning: 'No knowledge is currently running',
    noActiveTasks: 'No knowledge is currently running or waiting',
    updatedAt: 'Generated at',
    queueDataUnavailable: 'Queue data is unavailable; stage progress still comes from processing traces',
    queueDataPartial: 'Queue backlog is large; counts are approximate',
    autoRefresh: 'Auto refresh',
    manualRefresh: 'Refresh',
    filterKnowledgeBase: 'Filter knowledge base',
    searchPlaceholder: 'Search title or filename',
    refresh: { off: 'Off' },
    stage: {
      docreader: { title: 'Document Parsing', description: 'Read the source document and extract text' },
      chunking: { title: 'Document Chunking', description: 'Split text into indexable units' },
      embedding: { title: 'Index Building', description: 'Write vector and keyword search indexes' },
      multimodal: { title: 'Multimodal Recognition', description: 'Recognize image text and semantics' },
      postprocess: { title: 'Post-process Orchestration', description: 'Fan out summary, question, graph, and Wiki tasks' },
      summary: { title: 'Summary Generation', description: 'Generate knowledge summaries' },
      question: { title: 'Question Generation', description: 'Generate searchable questions' },
      graph: { title: 'Graph Extraction', description: 'Extract entities and relationships' },
      wiki: { title: 'Wiki Synthesis', description: 'Synthesize Wiki pages and hierarchy' },
    },
    state: {
...
\
  ...
  commandPalette: {
    ...
    quick: {
      ...
      knowledgeProcessing: 'Open processing dashboard',
      agents: 'Open agents',
