  ...
  knowledgeEditor: {
    ...
    wikiBrowser: {
      ...
      statistics: {
        ...
        averageLikeRate: 'Avg Like Rate',
        pendingOptimization: 'Pending Optimization',
        searchPlaceholder: 'Search by content...',
        filterByPending: 'Filter by status',
        pendingOnly: 'Pending optimization only',
        sortBy: 'Sort by',
        sortByLikeRate: 'Like rate',
        sortByLikeCount: 'Like count',
        sortByDislikeCount: 'Dislike count',
        sortByWeight: 'Recall weight',
        batchAdjust: 'Batch Adjust Weights',
        likes: 'Likes',
        dislikes: 'Dislikes',
        likeRate: 'Like Rate',
        weight: 'Weight',
        ...
        normal: 'Normal',
        pendingOptimizationTag: 'Pending Optimization',
        ...
        createdAt: 'Time',
        noDislikeReasons: 'No dislike reasons recorded',
        reasonInaccurate: 'Inaccurate',
        reasonIncomplete: 'Incomplete',
        reasonIrrelevant: 'Irrelevant',
        reasonOther: 'Other',
        triggerUserFeedback: 'User Feedback',
        triggerAutoAdjust: 'Auto Adjust',
        triggerManualReset: 'Manual Reset',
        triggerBatchUpdate: 'Batch Update',
        loadFailed: 'Failed to load statistics',
        resetSuccess: 'Chunk reset successfully',
        resetFailed: 'Failed to reset chunk',
        adjustSuccess: 'Weights adjusted successfully',
        adjustFailed: 'Failed to adjust weights',
      },
