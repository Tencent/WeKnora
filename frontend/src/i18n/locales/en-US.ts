...
\
  ...
  taskCenter: {
    title: 'Task Center',
    subtitle: 'Track user-triggered jobs, retry failed work, and inspect execution history.',
    searchPlaceholder: 'Search task name or ID',
    empty: 'No tasks found',
    retryAllConfirm: 'Retry all replayable failed or canceled tasks in the current filter?',
    cancelConfirm: 'Cancel this task?',
    deleteRecordsConfirm: 'Delete terminal task records older than 30 days?',
    summary: {
      queued: 'Queued',
      processing: 'Processing',
      succeeded: 'Completed',
      failedOrCanceled: 'Failed / Canceled',
    },
    tabs: {
      all: 'All',
      queued: 'Queued',
    ...
    kind: {
      ...
      upload: 'Upload',
      reparse: 'Reparse',
      datasource_sync: 'Data source sync',
      datasourceSync: 'Data source sync',
      rebuild_wiki: 'Rebuild wiki',
    ...
    messages: {
      ...
      detailFailed: 'Failed to load task details',
      retryStarted: 'Retry started',
      retryAllStarted: 'Retry started for {count} task(s)',
      retryFailed: 'Retry failed',
      cancelled: 'Task canceled',
      cancelFailed: 'Cancel failed',
      deleted: 'Deleted {count} record(s)',
      deleteFailed: 'Failed to clean records',
    },
  },
}
