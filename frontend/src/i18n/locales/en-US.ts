export default {
  ...
  integrations: {
    ...
    api: {
      ...
      apiKeyKnowledgePermissionsHint: 'Defaults follow the Read / Edit / Manage capabilities checked above. Uncheck per knowledge base to narrow them; unchecking Read removes that knowledge base from the list.',
      kbPermissionRead: 'Read',
      kbPermissionEdit: 'Edit',
      kbPermissionManage: 'Manage',
      apiKeyKnowledgeScopeSummary: '{total} ({editable} editable / {manageable} manageable)',
      allKnowledgeBases: 'All knowledge bases',
