export default {
  sandboxBrowser: {
    ...
    unavailableHint: "This sandbox does not provide the browser skill. Select a sandbox configuration with browser support.",
    reconnectHint: "The browser connection was interrupted. You can retry starting it.",
    ...
    "previewHint": "Preview refreshes every two seconds. The agent waits during takeover; closing the panel releases control.",
    "address": "Page address",
    "go": "Go",
    "viewport": "Sandbox browser preview",
    "emptyHint": "The browser has not started. Use the button below to start this session’s sandbox and browser.",
    "start": "Start browser",
    "textHint": "Focus a field on the page, then enter text here",
    "insert": "Insert",
    "commandFailed": "Browser command failed"
},
  skillDiscovery: {
    cardBuiltins: "Preinstalled",
    cardInstalled: "User-installed",
    cardUnknown: "Preinstalled information unknown",
    cardNone: "None",
    cardLoadFailed: "Could not load installations",
    cardIncompatible: "{count} more have incompatible versions",
    cardCollapse: "Collapse",
    cardExpand: "Show all skills",
    cardDisabled: "Disabled",
    cardAvailabilityUnknown: "Availability unknown",
    cardNotInImage: "Unavailable in current image",

    canInstallManually: "No preinstallation identified · manual install available",
    alreadyInstalled: "A skill with this name is installed",
    preinstalledShort: 'Preinstalled',
    preinstalledOnName: 'Preinstalled · {name}',
    preinstalledSandboxCount: 'Preinstalled in {count} sandboxes',
    alreadyPreinstalled: "Preinstalled · ready to use",
    checkingPreinstalled: "Reading preinstalled information…",
    includedWithTemplate: "Included with templates",
    invalidManifest: "Invalid manifest. Select the publisher’s skill manifest JSON.",
    clearManifest: "Remove declaration",
    importManifest: "Import manifest",
    cloudManifestHint: "If the cloud provider does not expose a skill manifest, import the image publisher’s declaration. Only metadata is saved, bound to this template revision.",
    preinstalledUnknown: "Preinstalled information is unknown. No sandbox will be started or packages installed.",
    preinstalledMismatch: "Some skills do not match this application release and are unavailable.",
    ...
    activationTitle: "Choose sandbox configurations for {name}",
    ...
    activationAccepted: "Enabling skill",
    localBrowser: "Local browser · extension required",
    "title": "Discover skills",
    "mySkills": "My skills",
    "search": "Search skills, use cases or publishers",
    "runtimeHint": "Built-in skills work directly with preloaded templates. You can also install them into other sandboxes here.",
    "retry": "Retry",
    "builtins": "Built-in skills",
    "recommended": "Selected recommendations",
    "builtinHint": "Office, data analysis, and browser skills. Use a preloaded template or install into another sandbox.",
    "externalHint": "References from external publishers. Links only: no bundled code, sandbox installation or automatic instruction injection.",
    ...
    "addFailed": "Could not add skill",
    "migrateTitle": "Upgrade an older sandbox",
    "migrateHint": "Create a configuration using the newer image, then migrate skills at their original versions.",
    "migrate": "Migrate skills",
    "migrateDetails": "First create a configuration using the newer image in sandbox settings. This flow verifies original archives and installs them on the target, preserving the source and existing sessions. After installation, select the new configuration in agent settings and verify it in a new conversation.",
    "configureSandbox": "Open sandbox settings",
    "sourceSandbox": "Source configuration",
    "targetSandbox": "New configuration",
    "preview": "Check migration",
    "startMigration": "Migrate available skills",
    "readyToMigrate": "Original archive verified",
    "noSkillsToMigrate": "No skills on the source configuration",
    "migrationStarted": "{count} installations submitted. Follow progress in My skills. Check credentials and user environment variables separately on the new configuration.",
    ...
    "blockers": {
        "source_not_ready": "Source installation is not ready",
        "source_disabled": "Disabled on source; will remain disabled",
        "target_name_conflict": "Target has this name; it will be preserved",
        "missing_digest": "Legacy record has no digest; import the original archive",
        "missing_original_archive": "Original archive unavailable; a newer version will not be substituted"
    }
},
  menu: {
  ...
  agent: {
    ...
    editor: {
      ...
      skillsConfig: 'Skills',
      skillsConfigDesc: 'Select a sandbox, then choose its skills. Preinstalled skills are ready to use; other catalog skills can be installed.',
      skillsSelection: 'Skill list',
      skillsSelectionDesc: 'Available skills include preinstalled and user-installed skills.',
      skillsAll: 'All',
      skillsSelected: 'Selected',
      skillsNone: 'Disabled',
      selectSkills: 'Select skills',
      selectSkillsDesc: 'Choose the skills this agent can use. Preinstalled skills need no additional installation.',
      skillsAllListHint: 'Use all available preinstalled and installed skills in this sandbox.',
      skillsGroupAvailable: 'Available',
      skillsGroupUnavailable: 'Unavailable',
      noSkillsAvailable: 'This sandbox has no available skills and the workspace catalog is empty.',
