export default {
  skillDiscovery: {
    ...
    alreadyInstalled: "This skill is already installed",
    ...
    "builtinHint": "Office and data analysis skills. Use a preloaded template or install into another sandbox.",
