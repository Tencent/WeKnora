export default {
  ...
  knowledgeEditor: {
    ...
    wikiBrowser: {
      ...
      sourceFallbackMissingSources: 'Some fact blocks have no supporting source; showing the complete page.',
      sourceSomeUnavailable: 'Some source documents or chunks are no longer available; the complete page remains visible and affected sources are marked.',
      sourceFallbackUnknownError: 'unknown error',
