export default {
  ...
  knowledgeBase: {
    ...
    batchMetadataDialogHeading: 'Edit metadata in batch',
    batchMetadataSubtitle: 'Replace custom metadata for {count} selected documents',
    batchMetadataHint: 'The metadata below replaces existing custom metadata on every selected document. Leave it empty to clear all fields.',
    batchMetadataEmpty: 'No metadata fields. Add one or save to clear metadata.',
    batchMetadataSuccess: 'Metadata updated for {count} documents',
    batchMetadataFailed: 'Batch metadata update failed',
