export default {
  ...
  knowledgeBase: {
    ...
    sort: {
      title: 'Sort',
      updatedTime: 'Updated time',
      updatedTimeDescription: 'Default. Files that are reparsed, edited, or change status appear first.',
      createdTime: 'Upload/created time',
      createdTimeDescription: 'Review the newest additions or the earliest accumulated material.',
      fileName: 'File name',
