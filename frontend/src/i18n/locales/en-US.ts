  ...
  knowledgeEditor: {
    ...
    advanced: {
      ...
      multimodal: {
        ...
        vllmChainLabel: 'VLLM Model Order',
        vllmChainDescription: 'Try image understanding models in order; when one fails, times out, or returns an empty response, the next one is used automatically',
        vllmChainPrimaryLabel: 'Primary VLLM Model',
        vllmChainFallbackLabel: 'Fallback Model',
        fallbackVllmPlaceholder: 'Select a fallback VLLM model',
        vllmChainAdd: 'Add Fallback Model',
        vllmChainHint: 'Tried in order, up to {max} models; errors, timeouts, or empty responses fall through to the next model',
        vllmChainMoveUp: 'Move Up',
        vllmChainMoveDown: 'Move Down',
        vllmChainRemove: 'Remove',
        vllmChainDuplicate: 'This VLLM model is already in the chain',
