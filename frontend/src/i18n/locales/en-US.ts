...
\
  ...
  datasource: {
    ...
    feishu: {
      authModeApp: 'App identity',
      authModeUser: 'Personal identity',
      authModeAppHint: 'Read as the self-built app — reaches only wikis and documents explicitly shared with the app.',
      authModeUserHint: 'Read as yourself — can export everything your Feishu account can access (complete the authorization below).',
      authorize: 'Authorize with Feishu',
      reauthorize: 'Re-authorize',
      authorized: 'Feishu personal authorization complete',
      authorizeHint: 'Opens the Feishu consent page; sign in as yourself and approve. Fill in App ID and App Secret above first.',
      authSuccess: 'Feishu authorization succeeded',
      authFailed: 'Feishu authorization failed, please retry',
      authRequired: 'Please complete Feishu personal authorization first',
      appCredsRequired: 'Please fill in App ID and App Secret first',
      popupBlocked: 'Popup blocked by the browser — allow popups and retry',
    },
    ...
    prereqOAuthCallbackBrief_feishu: 'Configure personal authorization callback URL',
    prereqOAuthCallbackDesc_feishu: 'In Feishu Open Platform > Security Settings > Redirect URL, add this exact URL:',
