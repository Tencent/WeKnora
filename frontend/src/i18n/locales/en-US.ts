export default {
  ...
  knowledgeBase: {
    ...
    folder: {
      ...
      createUnder: 'Will be created under "{name}"',
      created: 'Folder created',
      renamed: 'Folder renamed',
      moved: 'Folder moved',
      deleted: 'Folder deleted',
      deleteConfirm: 'Delete folder "{name}"?',
      deletePromote: 'Move its documents and subfolders to the parent (no documents are deleted)',
      deleteNotEmpty: 'Folder is not empty; move its contents out or enable promotion first',
      organizeByPath: 'Organize pathed files',
      organizeConfirm: 'Files whose names carry a relative path are filed into matching folders. Safe to re-run.',
      organizeResult: 'Organized {organized} documents into {folders} new folders',
      askInFolder: 'Ask within this folder',
      pickTarget: 'Choose a folder',
      noFolders: 'No folders yet',
      moveDocsTo: 'Move {count} documents to…',
      movedDocs: 'Moved {count} documents',
      searchPlaceholder: 'Search folders',
      newSubfolder: 'New subfolder',
      moveIntoSelf: 'Cannot move a folder into itself or its descendants',
      moveConfirmTitle: 'Confirm move',
      moveConfirm: 'Move this folder to "{target}"?',
      noMatchedFolders: 'No matching folders',
    },
