export default {
  ...
  knowledgeBase: {
    ...
    crawlEnabledLabel: 'Auto-crawl sub-pages',
    crawlDepthLabel: 'Crawl depth',
    crawlDepth1: 'Level 1 (current page only)',
    crawlDepth2: 'Level 2 (first-hop links)',
    crawlDepth3: 'Level 3 (second-hop links)',
    crawlTip: 'Crawling sub-pages will automatically extract links from the page and fetch content, up to the specified depth level',
    crawlingPages: 'Crawling sub-pages...',
    crawlFailed: 'Crawl failed, falling back to importing only the current page',
    crawlCompleted: 'Crawl completed, {count} pages found',
    typeURL: 'URL',
    typeManual: 'Manual',
    typeFile: 'File',
