export default {
  ...
  knowledgeBase: {
    ...
    feedbackOnlyWithFeedback: 'Only with feedback',
    feedbackOnlyNeedsOptimization: 'Only needs optimization',
    feedbackSortDefault: 'Default sort',
    feedbackSortLowPositiveRate: 'Lowest positive rate first',
    feedbackSortMostLikes: 'Most likes',
    feedbackSortMostDislikes: 'Most dislikes',
    feedbackSortRecent: 'Most recent feedback',
    feedbackLikes: 'Likes',
    feedbackDislikes: 'Dislikes',
    feedbackPositiveRate: 'Positive rate',
    feedbackRecallWeight: 'Weight',
    feedbackSessionCount: 'Related sessions',
    feedbackDislikeReasons: 'Dislike reasons',
    feedbackNeedsOptimization: 'Needs optimization',
    feedbackReset: 'Reset',
    feedbackResetTitle: 'Reset chunk feedback',
    feedbackResetConfirmBody: 'This will clear accumulated likes, dislikes, positive rate, and the needs-optimization flag for this chunk, and restore the recall weight to the default value.',
    feedbackResetSuccess: 'Feedback statistics reset',
    feedbackWeightLogs: 'Weight logs',
    feedbackWeightLogTitle: 'Weight change logs',
    feedbackWeightLogsRefreshed: 'Weight logs refreshed',
    feedbackCurrentWeight: 'Current weight',
    feedbackNoWeightLogs: 'No weight change records yet',
    feedbackTriggerAdminReset: 'Admin reset',
    feedbackTriggerUserFeedback: 'User feedback',
    feedbackRefreshLogs: 'Refresh logs',
