export default {
  ...
  knowledgeEditor: {
    ...
    wikiBrowser: {
      ...
      issueOrphanPage: 'Orphan page',
      issueEmptyContent: 'Thin content',
      issueStaleRef: 'Stale reference',
      issueMissingCrossRef: 'Missing cross-ref',
      issueLintScan: 'Rule scan',
      healthDrawerFilterType: 'Issue type',
      healthDrawerFilterTypeAll: 'All types',
      healthDrawerFilterSource: 'Source',
      healthDrawerFilterSourceAll: 'All sources',
      healthDrawerFilterSourceLint: 'Rule scan',
      healthDrawerFilterSourceAgent: 'AI review',
      healthDrawerFilterStatus: 'Status',
      healthDrawerFilterStatusActionable: 'Open',
      healthDrawerFilterStatusIgnored: 'Ignored',
      healthDrawerFilterStatusResolved: 'Resolved',
      healthStatsPages: '{count} pages',
      healthStatsLinks: '{count} links',
      healthStatsOrphans: '{count} orphans',
      healthMetricPages: 'Pages',
      healthMetricLinks: 'Links',
      healthMetricOrphans: 'Orphans',
      healthCardViewPage: 'View page',
      healthDrawerActiveRepairs: '{count} repairs in progress',
      healthDrawerViewRepair: 'View progress',
      issueSeverityError: 'Critical',
      issueSeverityWarning: 'Warning',
      issueSeverityInfo: 'Info',
      issueRepairModeDeterministic: 'Rule auto',
      issueRepairModeAgent: 'AI repair',
      issueRepairModeManual: 'Manual only',
      issueEvidenceTarget: 'Related target',
      issueLastSeen: 'Last seen {time}',
      issueOccurrenceCount: 'Seen {count} times',
      issueDetectedVersion: 'Detected at v{version}',
      healthDrawerResolvedEmptyTitle: 'No resolved issues',
      healthDrawerResolvedEmptyHint: 'Issues fixed or no longer detected by scans appear here.',
      lintRuleVersion: 'Rules {version}',
      lintFinishedAt: 'Finished {time}',
      lintDuration: '{seconds}s elapsed',
      healthDrawerSelectAll: 'Select all',
      healthDrawerBatchIgnore: 'Ignore selected',
      healthDrawerBatchRepair: 'Repair selected',
      healthDrawerBatchIgnoreAll: 'Ignore all',
      healthDrawerBatchRestore: 'Restore selected',
      healthDrawerBatchRestoreAll: 'Restore all',
      healthDrawerIgnoreAllConfirmTitle: 'Ignore all matching issues?',
      healthDrawerIgnoreAllConfirmBody: 'This will ignore {count} issues under the current filters. This cannot be undone.',
      healthDrawerBatchIgnoreDone: 'Ignored {count} issues',
      healthDrawerBatchIgnoreFailed: 'Batch ignore failed. Please try again.',
      healthDrawerRestoreAllConfirmTitle: 'Restore all ignored issues?',
      healthDrawerRestoreAllConfirmBody: 'This will restore {count} issues under the current filters to open.',
      healthDrawerBatchRestoreDone: 'Restored {count} issues',
      healthDrawerBatchRestoreFailed: 'Batch restore failed. Please try again.',
      healthDrawerIgnoredEmptyTitle: 'No ignored issues',
      healthDrawerIgnoredEmptyHint: 'Ignored issues appear here. You can restore them to open at any time.',
      healthDrawerViewIgnored: 'View ignored issues',
      healthDrawerBatchRepairHint: 'Started the first repair; process the remaining {count} items one by one.',
      healthDrawerLoadingMore: 'Loading more…',
      healthDrawerAllLoaded: 'All {count} issues loaded',
      ...
      lintCompleted: 'Rule scan completed',
      lintFailed: 'Lint run failed',
      lintCompletedClean: 'Rule scan completed with no new issues',
      lintFindings: '{count} open issues found',
      lintFindingsPartial: '{detected} issues scanned, {actionable} open for action',
      lintFindingsAllIgnored: '{count} issues scanned; all were already ignored',
      healthDrawerAllIgnoredTitle: 'Scanned issues are all ignored',
      healthDrawerAllIgnoredHint: 'This rule scan re-detected {count} known issues that were previously ignored. Use the button below or switch to Ignored to review and restore them.',
      loadMoreIssues: 'Load more ({loaded}/{total})',
      issueFixSuggestions: 'Content Optimization Suggestions ({count})',
      pageIssuesTitle: 'Page Issues ({count})',
      pageIssuesSubtitle: 'Content issues found by rule inspection with suggested actions',
      issueSourceLintReport: 'Rule inspection',
      issueRepairManualOnly: 'This issue cannot be auto-repaired; please fix it manually',
      issueOrphanManualHint: 'Orphan pages need inbound links from other Wiki pages; AI one-click repair is not available',
      issueFixSingle: 'Fix',
