export default {
  ...
  auth: {
    ...
    bootstrapAdmin: 'Set up system administrator',
    bootstrapFirstTime: 'First deployment?',
    bootstrapHint: 'Create the configured system administrator account to start managing this deployment.',
    bootstrapping: 'Setting up...',
    bootstrapSuccess: 'System administrator created. Welcome to WeKnora',
    bootstrapFailed: 'System administrator setup failed',
