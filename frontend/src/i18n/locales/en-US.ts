export default {
  ...
  knowledgeEditor: {
    ...
    wikiBrowser: {
      ...
      runLint: 'Run full Wiki lint',
      lintNotRun: 'No lint run yet',
      lintQueued: 'Lint run queued',
      lintRunning: 'Scanning and validating issues',
      lintCompleted: 'Lint run completed',
