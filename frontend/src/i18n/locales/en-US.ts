...
\
  ...
  datasource: {
    ...
    noResourcesDesc_dingtalk: 'The DingTalk app needs document access permissions before it can fetch content',
    ...
    guideStep1_dingtalk: 'Open the DingTalk documents or workspace you want to sync',
    guideStep2_dingtalk: 'Grant your DingTalk app document read permissions in the Open Platform',
    guideStep3_dingtalk: 'Return here and click Retry after publishing or enabling the app',
    permissionDocLink: 'View Feishu wiki permission docs',
    permissionDocLink_dingtalk: 'View DingTalk document permission docs',
    ...
    field: {
      ...
      dingtalkBaseUrl: 'Base URL (optional)',
      dingtalkBaseUrlHint: 'Leave empty to use DingTalk OpenAPI (https://api.dingtalk.com).',
      dingtalkOperatorId: 'Operator Union ID',
      dingtalkOperatorIdHint: 'UnionId of the DingTalk user used to list and read workspaces. DingTalk wiki APIs require this operator identity.',
      feedUrls: 'Feed URLs',
    ...
    prereqStep1Desc_dingtalk: 'Open DingTalk Open Platform, create or select an internal app, then copy its App Key and App Secret.',
    prereqStep2Brief_dingtalk: 'Grant document read permissions',
    prereqStep2Desc_dingtalk: 'Enable document workspace and document content read permissions for the app, then publish or enable the app.',
    prereqStep3Brief_dingtalk: 'Confirm document access scope',
    prereqStep3Desc_dingtalk: 'Make sure the app can access the DingTalk documents or workspaces you want to sync.',
