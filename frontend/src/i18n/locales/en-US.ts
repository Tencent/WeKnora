export default {
  ...
  knowledgeBase: {
    ...
    folder: {
      ...
      organizeByPath: 'Organize by upload path',
      organizeConfirm: 'Files at the root whose names carry a relative path (from folder uploads) will be filed into folders derived from that path. Safe to run repeatedly.',
