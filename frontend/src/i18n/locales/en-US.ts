export default {
  ...
  agent: {
    ...
    editor: {
      ...
      promptsConfig: 'Instructions & Behavior',
      promptsConfigDesc: 'Configure business instructions and structured behavior; retrieval, tools, and output protocols are system-managed',
      ...
      webSearchConfigDesc: 'Configure web source availability and quick-answer retrieval policy',
      webSearchModeOff: 'Off',
      webSearchModeOnDemand: 'On demand (recommended)',
      webSearchModeAlways: 'Always combine',
...
\
  ...
  agentEditor: {
    ...
    promptProtocol: {
      managedNotice: 'System-managed prompt protocol v{version} is active. Upgrades apply automatically; agent instructions can no longer override retrieval routing, tool use, safety, citations, or output contracts.',
      userInstructions: 'User instructions',
      userInstructionsDesc: 'Define role, tone, audience, answer preferences, and business rules. These instructions cannot override the managed protocol.',
      userInstructionsPlaceholder: 'For example: You help new employees. Lead with the conclusion, then list the steps, and briefly explain each term on first use.',
      managedFallback: 'Model fallback decisions and generation are system-managed and upgrade with the prompt protocol.',
    },
    selection: {
      all: 'All',
      selected: 'Selected',
    ...
    desc: {
      ...
      conversationSection: 'Configure multi-turn conversation and system-managed query rewriting',
      ...
      queryUnderstandModel: 'Model used for query understanding (rewriting and retrieval routing). Leave empty to reuse the main chat model.',
      ...
      webSearch: 'Quick answer may use web sources on demand; explicit knowledge-base requests remain KB-only',
