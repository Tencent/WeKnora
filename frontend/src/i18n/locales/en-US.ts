export default {
  ...
  modelSettings: {
    ...
    analytics: {
      ...
      callsUnit: 'calls',
      compositionUnavailable: 'Call breakdown does not match the total and cannot be displayed.',
      inputDetail: 'Input {value}',
      outputDetail: 'Output {value}',
      observedCoverage: 'Observed {observed} / {applicable} calls',
      notObserved: 'Not observed',
      usageTrend: 'Usage Trend',
      trendDescription: 'Server-aggregated model usage by creation time',
      tokens: 'Tokens',
      latency: 'Latency',
      noMetricData: 'No observed data for this metric.',
      promptCache: 'Prompt Cache',
      providerCache: 'Provider prompt cache',
      callHitRate: 'Call Hit Rate',
      tokenCacheRatio: 'Token Cache Ratio',
      promptCacheDetail: 'Hits {hit} · Misses {miss} · Eligible {eligible}',
      embeddingCache: 'Embedding Cache',
      weknoraCache: 'WeKnora embedding cache',
      inputHitRate: 'Input Hit Rate',
      embeddingCacheDetail: 'Hits {hit} · Misses {miss} · Eligible inputs {eligible}',
      loadFailed: 'Failed to load model usage analytics',
      retry: 'Retry',
      empty: 'No model usage data for this time range.',
      modelsLoadFailed: 'The model filter is unavailable. Analytics for all models is still available.'
    },
    typeShort: {
      chat: 'Chat',
      embedding: 'Embedding',
