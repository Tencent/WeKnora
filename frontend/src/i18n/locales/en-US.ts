...
\
  ...
  datasource: {
    ...
    noResourcesDesc_dingtalk: 'This UnionId cannot access any DingTalk knowledge spaces, or the app lacks document read permissions',
    ...
    guideStep1_dingtalk: 'Ensure the app has the DingTalk Docs read APIs enabled and has been published',
    guideStep2_dingtalk: 'Ensure you entered the operator UnionId, not an organization-scoped userId',
    guideStep3_dingtalk: 'Ensure the operator can access the target knowledge space, then come back and click Retry',
    ...
    connectorDesc: {
      ...
      dingtalk: 'Sync online documents from DingTalk knowledge spaces',
    ...
    field: {
      ...
      operatorUnionId: 'Operator UnionId',
      operatorUnionIdHint: 'Enter the UnionId of a DingTalk user who can access the target spaces; do not use an organization-scoped userId.',
    ...
    prereqStep1Brief_dingtalk: 'Create and publish an internal app',
    prereqStep1Desc_dingtalk: 'Create an internal app in DingTalk Open Platform, obtain its AppKey and AppSecret, and publish an app version.',
    prereqStep2Brief_dingtalk: 'Grant read-only document permissions',
    prereqStep2Desc_dingtalk: 'Grant the read-only APIs for related knowledge spaces, space directory nodes, and document blocks.',
    prereqStep3Brief_dingtalk: 'Prepare an operator UnionId with access',
    prereqStep3Desc_dingtalk: 'The operator must be able to access the spaces being synced. Enter their UnionId, not an organization-scoped userId.',
