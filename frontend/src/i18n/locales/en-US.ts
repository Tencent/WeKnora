export default {
  ...
  knowledgeStages: {
    ...
    detail: {
      ...
      graphSummary: 'Knowledge graph result',
      graphPartialHint: 'Some entities or relationships failed; the remaining valid data was preserved and written.',
      graphNodes: 'Entities',
      graphRelations: 'Relationships',
      graphSucceeded: 'Succeeded',
      graphFailed: 'Failed',
      graphFailureDetails: 'Failure details ({n})',
      graphNoFailureDetails: 'No item-level detail was recorded. Check the server logs for more information.',
      graphChunk: 'Chunk #{n}',
      graphItem: 'Item {n}',
      graphItemUnknown: 'Unknown item',
      graphValidation: 'Validation',
      graphWrite: 'Neo4j write',
      graphChunkFailure: 'Chunk task',
      graphUnknownStage: 'Unknown stage',
      graphUnknownReason: 'No failure reason recorded',
    },
    stage: {
  ...
  knowledgeEditor: {
    ...
    wikiBrowser: {
      ...
      logActionManualCreate: 'Created manually',
      logActionManualEdit: 'Edited manually',
      logActionManualDelete: 'Deleted manually',
      logActionRevert: 'Reverted',
      newPageBtn: 'New page',
