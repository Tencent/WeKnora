...
\
  ...
  datasource: {
    ...
    noResourcesDesc_dingtalk: 'The app needs DingTalk document space access before it can fetch content',
    ...
    guideStep1_dingtalk: 'Create an internal enterprise app in DingTalk Open Platform and copy its App Key and App Secret',
    guideStep2_dingtalk: 'Grant the app DingTalk document space and document content read permissions, then publish it to the target organization',
    guideStep3_dingtalk: 'Make sure the app organization can access the target document space, then come back and click Retry',
    ...
    connectorDesc: {
      ...
      dingtalk: 'Sync DingTalk documents, folders, and document spaces',
    ...
    field: {
      ...
      dingtalkBaseUrlHint: 'Leave empty to use DingTalk Open Platform (https://api.dingtalk.com). For private deployments or proxies, enter a custom API base URL.',
      feedUrls: 'Feed URLs',
    ...
    prereqStep1Brief_dingtalk: 'Create a DingTalk internal enterprise app',
    prereqStep1Desc_dingtalk: 'Sign in to DingTalk Open Platform > App Development > Internal Enterprise App > Create App, then copy the App Key and App Secret',
    prereqStep2Brief_dingtalk: 'Grant document read permissions',
    prereqStep2Desc_dingtalk: 'Grant the app DingTalk document space and document content read permissions, then publish it to the target organization',
    prereqStep3Brief_dingtalk: 'Confirm document space access',
    prereqStep3Desc_dingtalk: 'Make sure the app organization can access the target document space, then test the connection and select a sync scope here.',
    ...
    resourceType: {
      ...
      book: 'Yuque Book',
      docSpace: 'DingTalk Document Space',
      folder: 'Folder',
      document: 'Document',
    },
