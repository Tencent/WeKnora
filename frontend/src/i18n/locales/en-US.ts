export default {
  ...
  datasource: {
    ...
    connectorDesc: {
      ...
      jira: 'Sync issues and comments from Jira projects',
    ...
    field: {
      ...
      jiraEdition: 'Edition',
      jiraEditionServer: 'Server / Data Center',
      jiraEditionCloud: 'Cloud',
      jiraBaseUrl: 'Jira URL',
      jiraUsername: 'Username or email',
      jiraPassword: 'Server/DC password or PAT',
      jiraApiToken: 'Cloud API token',
      jiraJql: 'Additional JQL Filter (optional)',
      jiraJqlHint: 'e.g. status in (Resolved, Closed) or priority = High, combined with selected projects',
      jiraIncludeComments: 'Sync Issue Comments',
      jiraIncludeCommentsHint: 'Includes discussion and resolution comments from tickets',
