export default {
  ...
  knowledgeBase: {
    ...
    retryFailedDocumentsCounting: 'Counting failed documents',
    retryFailedDocumentsDisabled: 'No failed documents',
    retryFailedDocumentsCountTip: '{count} failed document(s)',
    retryFailedDocumentsConfirmTitle: 'Retry Failed Documents',
    retryFailedDocumentsConfirm: 'This knowledge base has {count} failed document(s). Submit retry tasks now?',
    retryFailedDocumentsConfirmButton: 'Retry',
    retryFailedDocumentsNoFailed: 'No failed documents to retry',
    retryFailedDocumentsSubmittedStart: 'Retry submission started',
    retryFailedDocumentsSubmitted: 'Retry tasks submitted for {count} failed document(s)',
    retryFailedDocumentsPartial: 'Retry submission completed: {processed} submitted, {skipped} skipped, {failed} failed',
    retryFailedDocumentsFailed: 'Failed to submit retry tasks',
    retryFailedDocumentsProgressTitle: 'Retry Submission Progress',
    retryFailedDocumentsProgressText: 'Submitting retry tasks: {done}/{total}',
    retryFailedDocumentsProcessed: 'Submitted {count}',
    retryFailedDocumentsSkipped: 'Skipped {count}',
    retryFailedDocumentsSubmitFailed: 'Failed {count}',
