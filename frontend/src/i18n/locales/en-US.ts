export default {
  ...
  knowledgeBase: {
    ...
    channelFeishuLinks: 'Feishu Links',
    channelLarkLinks: 'Lark Links',
  ...
  datasource: {
    ...
    guideStep1_feishu_links: 'Open the Feishu document, Share → Add collaborators, search for your app, and grant Can view',
    guideStep2_feishu_links: 'Copy the document link (wiki copylink or /docx/ URL)',
    guideStep3_feishu_links: 'Paste the links and click Parse links',
    guideStep1_lark_links: 'Open the Lark document, Share → Add collaborators, search for your app, and grant Can view',
    guideStep2_lark_links: 'Copy the document link (wiki copylink or /docx/ URL)',
    guideStep3_lark_links: 'Paste the links and click Parse links',
    ...
    connector: {
      ...
      feishu_links: 'Feishu Links',
      lark_links: 'Lark Links',
      notion: 'Notion',
    ...
    connectorDesc: {
      ...
      feishu_links: 'Sync individual Feishu wiki or Drive documents from a list of URLs',
      lark_links: 'Sync individual Lark wiki or Drive documents from a list of URLs (Feishu international)',
    ...
    links: {
      ...
      hint: 'One Feishu document URL per line. The bot needs Can view or Can edit on that document. Only the linked document is synced — not the wiki tree or Drive folder.',
      placeholder: 'https://xxx.feishu.cn/wiki/...\nhttps://xxx.feishu.cn/docx/...',
      parse: 'Parse links',
      urlsRequired: 'Paste at least one Feishu document URL',
      noneResolved: 'No documents could be resolved. Check the URLs and that the app can read them',
      deduped: 'Removed {n} duplicate link(s)',
      resolvedCount: 'Resolved {n} document(s)',
      error: {
        wiki_space: 'This is a wiki space URL. Use the Feishu connector, or paste a single /wiki/ document link',
        drive_folder: 'This is a Drive folder URL. Use the Feishu Drive connector',
        unrecognized: 'Unrecognized URL. Paste a Feishu /wiki, /docx, /docs, /sheets, /base, or /file link',
        unsupported_type: 'This document type is not supported (for example mind notes or slides)',
        no_permission: 'The app cannot read this document. Add the app as a collaborator (Can view is enough)',
        not_found: 'Document does not exist or has been deleted',
        resolve_failed: 'Failed to resolve the link. Check the URL and app permissions',
      },
    },
    field: {
      appId: 'App ID',
    ...
    prereqBarText_feishu_links: 'First time? Click to see Feishu app setup guide',
    prereqStep1Brief_feishu_links: 'Create Feishu custom app',
    prereqStep1Desc_feishu_links: 'Login Feishu Open Platform → Create enterprise custom app',
    prereqStep2Brief_feishu_links: 'Add bot capability',
    prereqStep2Desc_feishu_links: 'Open Platform → Your app → Add app capability → Bot',
    prereqStep3Brief_feishu_links: 'Configure app permissions',
    prereqStep3Desc_feishu_links: 'Enable wiki:wiki:readonly, drive:drive.metadata:readonly (or drive:drive), drive:drive:readonly, drive:export:readonly, docx:document:readonly permissions',
    prereqBarText_lark_links: 'First time? Click to see Lark app setup guide',
    prereqStep1Brief_lark_links: 'Create Lark custom app',
    prereqStep1Desc_lark_links: 'Login Lark Open Platform → Create enterprise custom app',
    prereqStep2Brief_lark_links: 'Add bot capability',
    prereqStep2Desc_lark_links: 'Open Platform → Your app → Add app capability → Bot',
    prereqStep3Brief_lark_links: 'Configure app permissions',
    prereqStep3Desc_lark_links: 'Enable wiki:wiki:readonly, drive:drive.metadata:readonly (or drive:drive), drive:drive:readonly, drive:export:readonly, docx:document:readonly permissions',
