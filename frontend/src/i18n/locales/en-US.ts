export default {
  ...
  embedPublish: {
    ...
    description: 'Create an embed channel to mount this knowledge base chat on external sites via iframe or floating widget.',
    ...
    sessionFailed: 'Failed to start chat',
    loading: 'Loading...',
    tabIframe: 'iframe',
    tabWidget: 'Widget',
  },
