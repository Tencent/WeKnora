export default {
  ...
  agent: {
    ...
    toolStatus: {
      ...
      callSuccess: 'Called {tool}',
      callFailed: 'Call {tool} failed',
      searchKnowledge: {
        success: 'Searching knowledge base',
        failure: 'Knowledge base search failed'
      },
      webSearch: {
        success: 'Web search',
      ...
      getDocumentInfo: {
        ...
        failure: 'Get document info failed'
      },
      thinking: {
        success: 'Thinking completed',
        failure: 'Thinking failed'
      },
      todoWrite: {
        success: 'Update task list',
        failure: 'Update task list failed'
      }
    },
    searchResults: {
      none: 'No matching results found',
      summary: 'Found {count} results',
      kbSummary: 'Found {count} results from {kbCount} files'
    },
    webSearchResults: {
      summary: 'Found {count} web search result(s)'
    },
    grepResults: {
      none: 'No matching results found',
      summary: 'Found {count} matches',
      shown: ' (showing {count})'
    },
    manual: {
      emptyQuestion: '(No question provided)',
      emptyAnswer: '(No answer provided)',
      title: 'Conversation Excerpt'
    },
    answerMessages: {
      emptyAnswerCopy: 'The answer is empty and cannot be copied',
      copiedToClipboard: 'Copied to clipboard',
      copyFailed: 'Copy failed, please copy manually',
      emptyAnswerSave: 'The answer is empty and cannot be saved to the knowledge base',
      openedEditor: 'Editor opened. Please select a knowledge base before saving'
    },
    messages: {
    ...
    editor: {
      ...
      builtinAgentNotice: 'This is a built-in agent. Name and description are read-only, but configuration can be adjusted.',
      ...
      name: 'Name',
      nameDesc: 'Set a recognizable name for the agent',
      ...
      descriptionDesc: 'Briefly describe the agent’s purpose and traits',
      baseType: 'Base Type',
      ...
      systemPromptDesc: 'Customize the system prompt to define agent behavior and role',
      builtinDefaultHint: ' (leave blank to use the system default)',
      ...
      placeholderHintWithClick: "Click to insert, or type {'{{'} to open the list",
      placeholderInsertHint: '(click to insert)',
      temperature: 'Temperature',
      temperatureDesc: 'Controls randomness in outputs. 0 is most deterministic; 1 is most random',
      thinking: 'Thinking Mode',
      thinkingDesc: 'Enable extended thinking capability (model must support it)',
      ...
      webSearchDesc: 'Allow the agent to search the web for information',
      webSearchMaxResultsDesc: 'Maximum results returned per search',
      knowledgeBases: 'Knowledge Bases',
      knowledgeBasesDesc: 'Select the knowledge base scope this agent can access',
      ...
      selectKnowledgeBasesDesc: 'Select the knowledge bases to associate',
      ...
      maxIterationsDesc: 'Maximum reasoning steps when the agent executes tasks',
      allowedTools: 'Allowed Tools',
      allowedToolsDesc: 'Select the tools the agent can use',
      toolDisabledHint: '(knowledge base required)',
      mcpServiceLabel: 'MCP Services',
      mcpServiceDesc: 'Select MCP services the agent can call',
      mcpServiceAll: 'All',
      mcpServiceSelected: 'Selected',
      mcpServiceNone: 'Disabled',
      mcpServiceSelectLabel: 'Select MCP Services',
      mcpServiceSelectDesc: 'Choose the MCP services to enable',
      mcpServiceSelectPlaceholder: 'Select MCP services',
      supportedFileTypesLabel: 'Supported File Types',
      supportedFileTypesDesc: 'Limit selectable file types; leave empty to allow all',
      supportedFileTypesPlaceholder: 'All types',
      faqStrategyTitle: 'FAQ Priority Strategy',
      faqStrategyTooltip: 'When FAQ knowledge bases are present, prioritize FAQ answers over documents',
      faqPriorityEnabledLabel: 'Enable FAQ Priority',
      faqPriorityEnabledDesc: 'FAQ answers are prioritized over document content to improve accuracy',
      faqDirectAnswerThresholdLabel: 'Direct Answer Threshold',
      faqDirectAnswerThresholdDesc: 'Use the FAQ answer directly when similarity exceeds this value',
      faqScoreBoostLabel: 'FAQ Score Boost',
      faqScoreBoostDesc: 'Multiply FAQ relevance scores to rank them higher',
      multiTurn: 'Multi-turn Conversation',
      historyTurns: 'History Turns',
      conversationSettingsDesc: 'Configure multi-turn conversation and query rewrite parameters',
      multiTurnDesc: 'Keep conversation history context when enabled',
      historyTurnsDesc: 'Keep the most recent turns as context',
      enableRewriteDesc: 'Automatically rewrite user queries in multi-turn chat',
      rewritePromptSystemDesc: 'System prompt for query rewriting (leave empty to use default)',
      rewritePromptUserDesc: 'User prompt template for query rewriting (leave empty to use default)',
      // Retrieval Strategy
      retrievalStrategy: 'Retrieval Strategy',
      retrievalStrategyDesc: 'Configure knowledge base retrieval and ranking parameters',
      embeddingTopK: 'Embedding Top K',
      embeddingTopKDesc: 'Maximum results returned by vector retrieval',
      ...
      rerankTopKDesc: 'Maximum results retained after reranking',
      rerankThreshold: 'Rerank Threshold',
      rerankThresholdDesc: 'Minimum relevance score after reranking',
      ...
      contextTemplateDesc: 'Define how retrieved content is formatted before passing to the model',
      ...
      maxCompletionTokensDesc: 'Maximum number of tokens the model can generate',
      fallbackStrategy: 'Fallback Strategy',
      fallbackStrategyDesc: 'How to respond when no relevant knowledge is found',
      fallbackStrategyFixed: 'Fixed Response',
      fallbackStrategyModel: 'Model Generated',
      fallbackResponse: 'Fixed Response',
      fallbackResponseDesc: 'Fixed text returned when no answer is found',
      fallbackResponsePlaceholder: 'Sorry, I cannot answer this question.',
      fallbackPrompt: 'Fallback Prompt',
      fallbackPromptDesc: 'Prompt that guides the model when no answer is found',
      fallbackPromptPlaceholder: 'Leave empty to use default prompt',
      tools: {
        thinking: { label: 'Thinking', desc: 'Reflective reasoning tool for problem solving' },
        todoWrite: { label: 'Plan Tasks', desc: 'Create structured task plans' },
        grepChunks: { label: 'Keyword Search', desc: 'Find documents and chunks by keywords' },
        knowledgeSearch: { label: 'Semantic Search', desc: 'Find semantically relevant content' },
        listKnowledgeChunks: { label: 'List Document Chunks', desc: 'View full document chunk content' },
        queryKnowledgeGraph: { label: 'Query Knowledge Graph', desc: 'Query relationships from the knowledge graph' },
        getDocumentInfo: { label: 'Get Document Info', desc: 'View document metadata' },
      ...
      fileTypes: {
        ...
        docx: { label: 'Word', desc: 'Word documents (.docx/.doc)' },
        txt: { label: 'Text', desc: 'Plain text files (.txt)' },
        md: { label: 'Markdown', desc: 'Markdown documents' },
        csv: { label: 'CSV', desc: 'Comma-separated values files' },
        xlsx: { label: 'Excel', desc: 'Excel spreadsheets (.xlsx/.xls)' },
        jpg: { label: 'Images', desc: 'Image files (.jpg/.jpeg/.png)' },
      },
    },
    selector: {
      title: 'Select Agent',
...
\
  ...
  model: {
    ...
    builtinDescription: 'Built-in models are visible to all tenants, sensitive info is hidden, and cannot be edited or deleted.',
    builtinGuide: 'View Built-in Model Management Guide',
