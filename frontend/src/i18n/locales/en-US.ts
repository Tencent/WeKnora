export default {
  ...
  knowledgeEditor: {
    ...
    feedback: {
      title: 'Chunk Feedback Statistics',
      description: 'Review like/dislike feedback, approval rates and recall weights of knowledge base chunks in Q&A, filter low-quality chunks and manage automatic weight adjustment.',
      retry: 'Retry',
      loadFailed: 'Failed to load chunk feedback',
      keywordPlaceholder: 'Search chunk content',
      approvalPlaceholder: 'Approval rate',
      approvalAll: 'All chunks',
      approvalHigh: 'Approval ≥ 80%',
      approvalNormal: 'Approval 50% - 80%',
      approvalLow: 'Approval < 50%',
      approvalNeedsOptimization: 'Needs optimization only',
      apply: 'Filter',
      resetSelected: 'Reset selected',
      reset: 'Reset',
      detail: 'Details',
      totalCount: '{count} chunks in total',
      empty: 'No chunk feedback data yet',
      statusNeedsOptimization: 'Needs optimization',
      statusNormal: 'Normal',
      sortApprovalRate: 'By approval rate',
      sortLikeCount: 'By likes',
      sortDislikeCount: 'By dislikes',
      sortRecallWeight: 'By recall weight',
      sortSessionCount: 'By related sessions',
      sortFeedbackCount: 'By feedback count',
      columns: {
      ...
      drawer: {
        title: 'Chunk feedback details',
        summary: 'Overview',
        dislikeReasons: 'Dislike reasons',
        relatedSessions: 'Related Q&A sessions',
        noReasons: 'No dislike reasons yet',
        noSessions: 'No related Q&A sessions',
        sessionMessages: '{count} messages'
      },
      resetConfirmTitle: 'Reset chunk feedback',
      resetConfirmBody: 'Reset the selected {count} chunks? This clears like/dislike data and restores the recall weight to 1.0. This action cannot be undone.',
      resetConfirm: 'Reset',
      resetSuccess: 'Chunk feedback has been reset',
      resetFailed: 'Reset failed',
      config: {
        title: 'Weight auto-adjustment',
        description: 'Automatically adjust the recall weight based on chunk approval rate; higher approval boosts recall, very low approval marks the chunk for optimization.',
        tenantHint: 'This configuration applies to all knowledge bases in the current workspace.',
        save: 'Save',
        saved: 'Configuration saved',
        saveFailed: 'Failed to save configuration',
        loadFailed: 'Failed to load configuration',
        boostThreshold: 'Boost threshold',
        boostThresholdTip: 'Boost recall weight when approval rate ≥ this value',
        degradeThreshold: 'Degrade threshold',
        degradeThresholdTip: 'Lower recall weight when approval rate < this value',
        optimizeThreshold: 'Optimization threshold',
        optimizeThresholdTip: 'Mark for optimization when approval rate < this value',
        minVotes: 'Min votes',
        minVotesTip: 'Only adjust weight after this many ratings',
        weightStep: 'Weight step',
        weightStepTip: 'Amount added or removed on each adjustment',
        maxWeight: 'Max weight',
        maxWeightTip: 'Upper bound of the recall weight',
        minWeight: 'Min weight',
        minWeightTip: 'Lower bound of the recall weight'
      },
      logs: {
        title: 'Weight change logs',
        description: 'Review the adjustment history of chunk recall weights and their sources.',
        loadFailed: 'Failed to load weight logs',
        empty: 'No weight change records yet',
        sourceAll: 'All sources',
        sourceFeedback: 'User feedback',
        sourceManualReset: 'Manual reset',
        sourceManualAdjust: 'Manual adjust',
        columns: {
          time: 'Time',
          chunk: 'Chunk',
    ...
    sidebar: {
      feedback: 'Chunk Feedback Statistics',
  ...
  chat: {
    feedback: {
      rateHelpful: 'Rate this answer',
      rateUnhelpful: 'Flag this answer',
      rated: 'Rated',
      dislikeTitle: 'What\'s wrong with this answer?',
      submit: 'Submit',
      otherReason: 'Other',
      reasonPlaceholder: 'Briefly describe the issue (optional)',
      reasonInaccurate: 'Inaccurate content',
      reasonOutdated: 'Outdated content',
      reasonIrrelevant: 'Off-topic answer',
      reasonIncomplete: 'Incomplete answer',
      reasonNoReference: 'Missing references',
      reasonRequired: 'Please select or enter a reason',
      cancelled: 'Rating cancelled',
      likeSuccess: 'Thanks for your feedback',
      dislikeSuccess: 'Thanks for your feedback, we will keep improving',
