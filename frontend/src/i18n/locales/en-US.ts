export default {
  ...
  knowledgeEditor: {
    ...
    wikiBrowser: {
      ...
      sourceDrawerTitle: 'Page sources',
      paragraphSourceCount: '{count} sources on this page',
      openParagraphSource: 'View source [{number}]',
      tableRowSource: 'Table row {index}',
      listItemSource: 'List item {index}',
      blockProvenanceComplete: 'Source coverage: complete',
      blockProvenancePartial: 'Source coverage: partial',
      blockProvenanceUnsupported: 'No block-level source coverage',
      blockProvenanceLegacy: 'Legacy inferred sources',
      blockProvenancePending: 'Source coverage pending',
      blockSourceManual: 'Manual edit',
      blockSourceAgent: 'Agent edit',
      sourceChunk: 'Evidence chunk {chunk}',
      sourceEvidenceUnavailable: 'No evidence excerpt is available',
      openSourceDocument: 'Open source document',
      sourceStatusVerified: 'Verified',
      sourceStatusLocated: 'Evidence located',
      sourceStatusInvalid: 'Source is no longer current',
      sourceStatusPartial: 'Partially supported',
      sourceStatusUnsupported: 'Unsupported',
      sourceStatusPending: 'Pending verification',
