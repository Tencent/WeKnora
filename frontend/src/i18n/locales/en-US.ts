...
\
  ...
  datasource: {
    ...
    noResourcesDesc_dingtalk: 'Grant the DingTalk app wiki/document read permissions and ensure the operator can read the target workspace.',
    ...
    guideStep1_dingtalk: 'Create or select an internal app in DingTalk Open Platform',
    guideStep2_dingtalk: 'Grant workspace, node, and file read permissions, then publish an app version',
    guideStep3_dingtalk: 'Ensure the operator can access the target wiki, then reload resources here',
    permissionDocLink: 'View Feishu wiki permission docs',
    permissionDocLink_dingtalk: 'View DingTalk Open Platform documentation',
    ...
    syncError: {
      ...
      dingtalk_auth_or_permission: 'DingTalk authentication or permission error; check credentials, app scopes, and operator access',
      ...
      dingtalk_server_unavailable: 'DingTalk service temporarily unavailable; will retry on the next sync',
    ...
    connectorDesc: {
      ...
      dingtalk: 'Sync online documents from DingTalk wikis',
    },
    field: {
      appId: 'App ID',
      ...
      operatorIdHint: 'Use the unionId of a user who can read the target DingTalk wiki; the wiki APIs require this operator parameter.',
    ...
    prereqStep1Brief_dingtalk: 'Create an internal DingTalk app',
    prereqStep1Desc_dingtalk: 'Open the app in DingTalk Open Platform and copy its Client ID and Client Secret.',
    prereqStep2Brief_dingtalk: 'Grant wiki and document read permissions',
    prereqStep2Desc_dingtalk: 'Enable Wiki.Workspace.Read, Wiki.Node.Read, and Storage.File.Read, then publish an app version.',
    prereqStep3Brief_dingtalk: 'Prepare an operator UnionID',
    prereqStep3Desc_dingtalk: 'Use a user unionId that can read the target wiki workspace and documents.',
