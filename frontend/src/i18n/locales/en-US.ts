export default {
  ...
  agentStream: {
    ...
    skillCards: {
      ...
      resolved: 'Resolved skill {name}',
      notFound: 'No matching skill found',
      unavailable: '{sources} unreachable',
      temporaryNotice: '{name} was only loaded for this conversation. It is not installed in the workspace: it is not in the skill list, and other conversations cannot use it.',
      temporaryNoticeUnnamed: 'This skill was only loaded for this conversation. It is not installed in the workspace: it is not in the skill list, and other conversations cannot use it.',
      official: 'Official',
      ...
      sourceCopied: 'Skill source copied',
      viewSource: 'View details',
      adminOnly: 'A workspace admin has to install this. Copy the source and send it to them.',
      noSandbox: 'This conversation has no sandbox to install skills on',
      alreadyInstalled: 'A skill with this name is already installed on this sandbox; installing replaces it',
      alreadyInstalling: 'A skill with this name is being installed on this sandbox',
      sameNameInCatalog: 'The workspace already has a skill with this name; installing replaces it with this source',
      installing: 'Installing {percent}%',
      ready: 'Installed. Available from your next message',
      readyNewSession: 'Installed. Available in new conversations',
      selectInAgent: 'This agent only uses selected skills; select it in the agent settings to use it',
      failed: 'Installation failed',
      failedWithReason: 'Installation failed: {reason}',
      installerModelRequired: 'Choose a model for skill installation first',
      confirmTitle: 'Install skill "{name}"?',
      confirmBody: "This third-party skill will be fetched from {source} and installed into the sandbox this conversation uses. Installing runs code that ships with the skill, and every conversation on that sandbox can use it afterwards. This conversation's sandbox then restarts, and temporary files in /workspace are lost. Continue only if you trust this source.",
      confirmBodyNewSession: "This third-party skill will be fetched from {source} and installed into the sandbox this conversation uses. Installing runs code that ships with the skill. Under this sandbox's update policy, only conversations started afterwards can use it; conversations already running are unchanged. Continue only if you trust this source."
    },
    skillFiles: {
      heading: 'Skill files',
      script: 'script',
