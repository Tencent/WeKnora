export default {
  ...
  knowledgeBase: {
    ...
    buildProgress: 'Knowledge build progress',
    buildProgressAria: 'Knowledge build progress {percentage}%, {settled} of {total} settled',
    buildProgressTotal: '{settled} of {total} settled',
    batchStatusInFlight: '{count} in progress',
    batchStatusCompleted: '{count} completed',
    batchStatusFailed: '{count} failed',
    batchStatusCancelled: '{count} cancelled',
    batchStatusDraft: '{count} draft',
    batchCancelParse: 'Stop parsing',
    confirmBatchCancelParse: 'Stop {count} selected parsing tasks? Already-written chunks will be kept.',
    batchCancelParseSuccess: 'Stopped {count} parsing tasks',
    batchCancelParseFailed: 'Failed to stop parsing tasks',
    batchCancelParseSkipped: '{count} tasks changed state or could not be stopped',
