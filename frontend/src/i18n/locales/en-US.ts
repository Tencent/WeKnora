export default {
  ...
  datasource: {
    ...
    deleteConfirmOneDrive: 'Delete this OneDrive data source and the knowledge it synced? This cannot be undone.',
    ...
    connected: 'Connected',
    connectionFailed: 'Connection failed',
    oauthAuthorization: 'Microsoft authorization',
    oauthAuthorized: 'OneDrive authorized',
    oauthUnauthorized: 'OneDrive is not connected',
    oauthReauthorizationRequired: 'Authorization expired. Reauthorize to continue.',
    oauthConnect: 'Connect OneDrive',
    oauthReconnect: 'Reauthorize',
    oauthConnecting: 'Waiting for authorization…',
    oauthConnected: 'OneDrive connected',
    oauthNotCompleted: 'OneDrive authorization was not completed',
    oauthDisconnect: 'Disconnect',
    oauthDisconnected: 'OneDrive disconnected',
    oauthDisconnectFailed: 'Failed to disconnect OneDrive',
    oauthDisconnectConfirm: 'Disconnecting pauses sync, clears the selection, and deletes knowledge synced by this connection. Continue?',
    oauthReplaceAccount: 'Change account',
    oauthReplaceConfirm: 'Changing account resets the cursor and deletes the old connection index and its synced knowledge. Continue?',
    oauthPopupFallback: 'Authorization window did not open? Continue here',
    oauthPermissionHint: 'Only file-read and offline renewal permissions are requested. WeKnora cannot write to OneDrive.',
    ...
    connectorDesc: {
      ...
      onedrive: 'Sync selected OneDrive folders and files through Microsoft authorization',
    ...
    prereqBarText_onedrive: 'First time? View the OneDrive authorization requirements',
    prereqStep1Brief_onedrive: 'Register a Microsoft Entra app',
    prereqStep1Desc_onedrive: 'The redirect URI must exactly match the server ONEDRIVE_REDIRECT_URL',
    prereqStep2Brief_onedrive: 'Configure minimum delegated permissions',
    prereqStep2Desc_onedrive: 'Only Files.Read is needed; offline_access renews scheduled authorization',
    prereqStep3Brief_onedrive: 'Complete sign-in and MFA at Microsoft',
    prereqStep3Desc_onedrive: 'WeKnora never reads or stores passwords or Authenticator codes',
