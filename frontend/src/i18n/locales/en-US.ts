export default {
  ...
  knowledgeEditor: {
    ...
    desensitization: {
      ...
      engineLabel: 'Engine',
      engineDescription: 'The built-in engine uses regex and checksums. Presidio can be selected later once the sidecar is available.',
      ...
      addRule: 'Add rule',
      previewLabel: 'Try it',
      previewDescription: 'Run the current presets and custom rules on sample text.',
