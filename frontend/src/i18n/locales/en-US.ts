export default {
  ...
  knowledgeBase: {
    ...
    batchDownloadHint: 'Download a ZIP of up to 200 documents and 512 MiB of original content per batch. Select all includes loaded documents only.',
    batchDownloadStarted: 'ZIP saving started. Extract it before uploading the files.',
