export default {
  ...
  settings: {
    ...
    sandbox: {
      ...
      skillUploadHint: 'Upload installs the skill onto the current image and takes a new snapshot. This can take several minutes. Open sessions rebuild their sandbox on the next use; in-progress tool calls may be interrupted and the session workspace scratch is cleared.',
      ...
      skillDeleteHint: 'Delete removes the skill directory from the image and takes a new snapshot. Open sessions rebuild their sandbox on the next use; in-progress tool calls may be interrupted and the session workspace scratch is cleared.',
