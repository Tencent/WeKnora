export default {
  ...
  newUserGuide: {
    ...
    steps: {
      ...
      knowledge: {
        ...
        desc: 'Everything starts here: upload documents, web pages or FAQs and SAI parses and indexes them automatically. Click here to open knowledge bases.'
      },
      chat: {
  ...
  settings: {
    ...
    sandbox: {
      ...
      backendDescriptions: {
        ...
        docker: 'Keep a long-lived container per session on this SAI host; scripts and files stay in that container',
      },
      ...
      dockerHostRisk: 'Empty or unix:// uses the Docker daemon on the SAI host, which is equivalent to root on that machine. Use this only for a private single-node install. Prefer Cube or E2B when multiple workspaces share a host. Remote tcp:// endpoints require a TLS certificate directory.',
      ...
      templateLoadHint: 'Enter the cluster connection and refresh. If there is no SAI standard template, click Create; after changing DNS or the image, click Delete and rebuild.',
      ...
      templateStepHint: 'This step only lists templates already on the cluster; it does not create one automatically. Click Create SAI standard template if none exists, or Delete and rebuild after changing DNS or the image. You can continue after a template is ready.',
      ...
      templateUntaggedHint: 'The builds finished but none carries the default tag, so sandbox creation cannot resolve this template. Delete it in E2B and refresh; SAI will rebuild it.',
      templateFailedReason: 'Build failed: {reason}',
      noTemplates: 'No templates were returned by this cluster.',
      weknoraStandardTemplate: 'SAI standard template',
      ...
      replaceStandardTemplateConfirm: 'Rebuild the SAI standard template with the current settings, including DNS. The previous spawnable template is not deleted until the replacement is ready.',
    ...
    weknoraCloud: {
      title: 'SAI Cloud',
      description: 'Configure SAI Cloud APPID and APPSECRET credentials. Credentials are used for model services and document parsing engine.',
      viewDocs: 'View Docs',
      unconfigured: 'Credentials not configured. Please fill in APPID and APPSECRET.',
      configured: 'Credentials configured and working.',
      expired: 'SAI Cloud credentials expired',
      ...
      appIdLabel: 'APPID',
      appIdDesc: 'SAI Cloud application ID',
      appIdPlaceholder: 'Enter APPID',
      appSecretLabel: 'APPSECRET',
      appSecretDesc: 'SAI Cloud application secret',
      ...
      credentialConfigured: 'SAICloud credentials configured.',
      credentialExpired: 'Credentials expired. Please reconfigure.',
      credentialUnconfigured: 'SAICloud credentials not configured. Please set up APPID and APPSECRET first.',
      checkingStatus: 'Checking credential status...',
      goToSettings: 'Go to Settings',
      modelHintConfigured: 'SAICloud credentials configured. See supported models in',
      modelHintDocsLink: 'API docs',
      modelsSection: {
        title: 'Cloud Models',
        descReady: 'Register the four standard SAI Cloud models for chat, retrieval, reranking, and vision.',
  ...
  envVarSettings: {
    ...
    description: 'Personal keys for skills and sandboxes, not SAI system or deployment settings.',
  ...
  createChat: {
    title: 'Hi, I am SAI — your knowledge, within reach',
  ...
  system: {
    ...
    versionDescription: 'Version of the application service',
    frontendVersionLabel: 'UI Version',
    frontendVersionDescription: 'Build version of the UI',
  ...
  kbSettings: {
    ...
    parser: {
      ...
      engines: {
        ...
        weknoracloud: {
          name: 'SAI Cloud',
          desc: 'Document parsing via SAI Cloud'
        },
        markitdown: {
          name: 'MarkItDown',
  ...
  integrations: {
    ...
    api: {
      ...
      capabilityManageModelsHint: 'Manage model definitions, credentials, connectivity checks, and SAICloud credentials.',
      ...
      hmacSecretDesc: 'Same secret stored in SAI; used only on your backend to sign JWTs—never send it as a request header.',
    ...
    chrome: {
      ...
      subtitle: 'For self-hosted SAI: ask questions in a sidebar, clip web pages, and save Markdown notes into your knowledge bases while you browse.',
      ...
      steps: {
        ...
        port: {
          ...
          desc: 'On SAI Desktop, set a fixed API port (e.g. 37841) in API Info so the URL stays stable across restarts.'
        },
        install: {
    ...
    claw: {
      title: 'SAI Skill',
      subtitle: 'Import documents and run hybrid retrieval (vector + keyword) via the SAI REST API—for uploads, URL imports, Markdown entries, and cross-KB search.',
      ...
      installCtaHint: 'Install SAI Skill · opens in a new tab',
