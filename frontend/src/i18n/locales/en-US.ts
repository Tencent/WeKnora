...
\
  ...
  agentEditor: {
    ...
    im: {
      ...
      fileStrategyDirect: 'Direct to Conversation',
      fileStrategyKB: 'Upload to Knowledge Base',
      fileProcessingStrategyHint: 'Direct: parse file content and inject into the current conversation for analysis; Upload: save file to a knowledge base for async processing',
      fileKnowledgeBaseRequired: 'A knowledge base must be selected when using the Upload strategy',
