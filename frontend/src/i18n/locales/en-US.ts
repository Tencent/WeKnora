export default {
  ...
  settings: {
    ...
    intentPolicy: {
      ...
      description:
        "IntentGate policies judge whether an agent tool call aligns with the user's intent and these constraints. New policies start in observe mode (record only, never block).",
      empty: 'No intent policies yet',
      ...
      editor: {
        createTitle: 'New intent policy',
        editTitle: 'Edit policy (save as v{version})',
      },
      form: {
        scopeType: 'Scope',
        scopeRef: 'Scope reference',
        constraintText: 'Constraint (natural language)',
        constraintPlaceholder: 'e.g. Refunds must not exceed 75 per transaction',
        ruleExpr: 'Rule expression (optional)',
        ruleExprPlaceholder: 'e.g. value <= 75 - compilable constraints skip the LLM judge entirely',
        argPath: 'Argument path (optional)',
        riskTier: 'Risk tier',
        mode: 'Mode',
      },
      scopeRefHints: {
        tool: 'service_id:tool_name; wildcard prefix like *:wiki_* is supported',
        service: 'MCP service id',
        agent: 'Agent id',
        workspace: 'Workspace id',
      },
      enforceConfirm: {
        title: 'Switch to enforce mode?',
        body: 'Enforce mode really blocks tool calls that violate this policy: the agent sees the denial and can correct itself. Observe mode only records verdicts. Continue?',
        confirm: 'Enforce',
      },
      toasts: {
        loadFailed: 'Failed to load intent policies',
        enabled: 'Policy enabled',
        disabled: 'Policy disabled',
        toggleFailed: 'Failed to update policy state',
        created: 'Policy created',
        updated: 'New version saved',
        saveFailed: 'Failed to save policy',
        constraintRequired: 'Constraint text is required',
        scopeRefRequired: 'Scope reference is required for this scope type',
      },
    },
