export default {
  ...
  knowledgeBase: {
    ...
    chunkStats: {
      tab: 'Chunk stats',
      title: 'Chunk stats',
      maxPositiveRate: 'Max positive rate',
      onlyNeedsOptimization: 'Only needs optimization',
      needsOptimization: 'Needs optimization',
      ok: 'OK',
      noReasons: 'None',
      viewLogs: 'Logs',
      reset: 'Reset',
      resetConfirm: 'Reset likes/dislikes and recall weight for this chunk?',
      editWeight: 'Edit weight',
      editWeightTitle: 'Edit chunk weight',
      editWeightLabel: 'Weight value (0.5 ~ 2.0)',
      weightUpdated: 'Weight updated',
      logsTitle: 'Recall weight logs',
...
\
  ...
  chat: {
    ...
    like: 'Like',
    dislike: 'Dislike',
    dislikeReasonTitle: 'Reason for dislike',
    dislikeReasonsLabel: 'Select reasons (multiple)',
    dislikeReasonInaccurate: 'Inaccurate answer',
    dislikeReasonOutdated: 'Outdated info',
    dislikeReasonIrrelevant: 'Irrelevant',
    dislikeReasonIncomplete: 'Incomplete answer',
    dislikeReasonCiteError: 'Citation error',
    dislikeReasonOther: 'Other',
    dislikeSupplementLabel: 'Additional notes (optional)',
    dislikeSupplementPlaceholder: 'Add more details (max 200 chars)',
    dislikeReasonRequired: 'Please select at least one reason or add notes',
    feedbackSaved: 'Feedback submitted',
    feedbackCanceled: 'Feedback removed',
