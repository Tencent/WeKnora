export default {
  ...
  datasource: {
    ...
    prereqStep3Desc_feishu_links: 'Enable wiki:wiki:readonly, drive:drive:readonly, drive:export:readonly, docx:document:readonly permissions',
    ...
    prereqStep3Desc_lark_links: 'Enable wiki:wiki:readonly, drive:drive:readonly, drive:export:readonly, docx:document:readonly permissions',
