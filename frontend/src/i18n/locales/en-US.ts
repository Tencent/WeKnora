export default {
  learning: {
    newPractice: 'New practice', previousPractice: 'Previous practice', yourAnswer: 'Your answer',
    tools: {
      profile: 'Learning overview', profileDesc: 'Read your personal learning overview for an owned Wiki knowledge base.',
      recommend: 'Recommend practice', recommendDesc: 'Recommend topics using your practice history and source-backed Wiki pages.',
      quiz: 'Prepare practice quiz', quizDesc: 'Prepare a source-backed quiz. Answers are submitted only through the learning panel.',
    },
    title: 'Guided learning', consent: 'Personal learning history', enabled: 'On', disabled: 'Off',
    overview: 'Overview', topicCount: '{count} topics', recommendations: 'Recommended practice',
    noRecommendations: 'No recommendations yet', practice: 'Practice', startPractice: 'Practice this page',
    openPage: 'Open page', pending: 'Quiz queued', running: 'Preparing quiz', cancelPolling: 'Stop waiting',
    paused: 'Status checks paused', checkAgain: 'Check again', failed: 'Quiz preparation failed',
    sourceStale: 'Sources changed. A fresh quiz is required.', regenerate: 'Prepare fresh quiz',
    refresh: 'Refresh', retry: 'Retry', submit: 'Submit answer', retryAnswer: 'Retry submission',
    correct: 'Correct', incorrect: 'Incorrect', correctAnswer: 'Correct answer', answered: 'Answered',
    source: 'Source {index}', noQuestions: 'No questions available',
    familiar: 'Familiar', familiarTooltip: 'Reading and source use indicate familiarity, not mastery.',
    masteryLegend: 'Mastery from assessed answers',
    masteryTooltip: '{count} assessed answers. Model estimate: {probability}% (uncalibrated).',
    privacy: 'Learning data', exportKB: 'Export this knowledge base (JSON)', exportAll: 'Export all learning data (JSON)',
    clearKB: 'Clear this knowledge base', clearAll: 'Clear all learning data', clearTitle: 'Clear learning data?',
    clearKBConfirm: 'Permanently delete your practice history, quizzes and mastery for this knowledge base?',
    clearAllConfirm: 'Permanently delete all your practice history, quizzes and mastery in this workspace?',
    confirmClear: 'Delete permanently', cancel: 'Cancel',
    cleared: 'Deleted {attempts} answers, {topics} topic records and {quizzes} quizzes.',
    states: { unseen: 'Unassessed', learning: 'Learning', mastered: 'Mastered', review_due: 'Review due' },
    reasons: {
      practice: 'Needs practice', source_changed: 'Sources changed', source_backed: 'Backed by sources', explore: 'Explore a new topic',
      review_due: 'Review due', review_need: 'Needs review', graph_frontier: 'Related topic',
      interest_match: 'Matches your interests', content_quality: 'Source quality',
      cold_start: 'Starting topic', exploration: 'Explore a new topic', related_topic: 'Related topic',
    },
    errors: {
      request: 'Learning data could not be loaded.', unavailable: 'Learning is unavailable for this context.',
      disabled: 'Learning is off.', notFound: 'This learning item is no longer available.',
      stale: 'Sources changed. Prepare a fresh quiz.', conflict: 'This answer was already submitted. Refresh to see the saved result.',
      busy: 'Learning is busy. Try again shortly.', evidence: 'Not enough validated source evidence for a quiz.',
      notReady: 'The quiz is not ready yet.',
    },
  },
  localBrowser: {
