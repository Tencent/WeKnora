export default {
  ...
  agent: {
    ...
    editor: {
      ...
      sandboxNoConfigs: 'This workspace has no sandbox yet, so skill scripts will not run. Add one under Settings - Code Sandbox.',
  ...
  settings: {
    ...
    sandbox: {
      ...
      pageHintTitle: 'What is a code sandbox?',
      pageHint: 'A code sandbox is the isolated environment where agent skill scripts run. A workspace can have several configs (Docker, E2B, CubeSandbox, or a local process); each agent picks one. Scripts stay disabled until a config is selected.',
