...
type NormalizeLegacyDocRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	FileContent   []byte                 `protobuf:"bytes,1,opt,name=file_content,json=fileContent,proto3" json:"file_content,omitempty"`
	FileName      string                 `protobuf:"bytes,2,opt,name=file_name,json=fileName,proto3" json:"file_name,omitempty"`
	unknownFields protoimpl.UnknownFields
...
func (x *NormalizeLegacyDocRequest) Reset() {
	*x = NormalizeLegacyDocRequest{}
	mi := &file_docreader_proto_msgTypes[9]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *NormalizeLegacyDocRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*NormalizeLegacyDocRequest) ProtoMessage() {}

func (x *NormalizeLegacyDocRequest) ProtoReflect() protoreflect.Message {
	mi := &file_docreader_proto_msgTypes[9]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use NormalizeLegacyDocRequest.ProtoReflect.Descriptor instead.
func (*NormalizeLegacyDocRequest) Descriptor() ([]byte, []int) {
	return file_docreader_proto_rawDescGZIP(), []int{9}
}

func (x *NormalizeLegacyDocRequest) GetFileContent() []byte {
	if x != nil {
		return x.FileContent
	}
	return nil
...
func (x *NormalizeLegacyDocRequest) GetFileName() string {
	if x != nil {
		return x.FileName
	}
	return ""
...
type NormalizeLegacyDocResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	FileContent   []byte                 `protobuf:"bytes,1,opt,name=file_content,json=fileContent,proto3" json:"file_content,omitempty"`
	FileName      string                 `protobuf:"bytes,2,opt,name=file_name,json=fileName,proto3" json:"file_name,omitempty"`
...
func (x *NormalizeLegacyDocResponse) Reset() {
	*x = NormalizeLegacyDocResponse{}
	mi := &file_docreader_proto_msgTypes[10]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *NormalizeLegacyDocResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*NormalizeLegacyDocResponse) ProtoMessage() {}

func (x *NormalizeLegacyDocResponse) ProtoReflect() protoreflect.Message {
	mi := &file_docreader_proto_msgTypes[10]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use NormalizeLegacyDocResponse.ProtoReflect.Descriptor instead.
func (*NormalizeLegacyDocResponse) Descriptor() ([]byte, []int) {
	return file_docreader_proto_rawDescGZIP(), []int{10}
}

func (x *NormalizeLegacyDocResponse) GetFileContent() []byte {
	if x != nil {
		return x.FileContent
	}
	return nil
...
func (x *NormalizeLegacyDocResponse) GetFileName() string {
	if x != nil {
		return x.FileName
	}
	return ""
...
func (x *NormalizeLegacyDocResponse) GetContentType() string {
	if x != nil {
...
const file_docreader_proto_rawDesc = "" +
	...
	"\aengines\x18\x01 \x03(\v2\x1b.docreader.ParserEngineInfoR\aengines\"[\n" +
	"\x19NormalizeLegacyDocRequest\x12!\n" +
	"\ffile_content\x18\x01 \x01(\fR\vfileContent\x12\x1b\n" +
	"\tfile_name\x18\x02 \x01(\tR\bfileName\"\x7f\n" +
	"\x1aNormalizeLegacyDocResponse\x12!\n" +
	"\ffile_content\x18\x01 \x01(\fR\vfileContent\x12\x1b\n" +
	"\tfile_name\x18\x02 \x01(\tR\bfileName\x12!\n" +
	"\fcontent_type\x18\x03 \x01(\tR\vcontentType2\xc4\x02\n" +
	"\tDocReader\x12c\n" +
	"\x12NormalizeLegacyDoc\x12$.docreader.NormalizeLegacyDocRequest\x1a%.docreader.NormalizeLegacyDocResponse\"\x00\x129\n" +
...
var file_docreader_proto_goTypes = []any{
	...
	(*NormalizeLegacyDocRequest)(nil),  // 9: docreader.NormalizeLegacyDocRequest
	(*NormalizeLegacyDocResponse)(nil), // 10: docreader.NormalizeLegacyDocResponse
...
var file_docreader_proto_depIdxs = []int32{
	...
	13, // 4: docreader.ReadStreamMeta.metadata:type_name -> docreader.ReadStreamMeta.MetadataEntry
	...
	14, // 7: docreader.ListEnginesRequest.config_overrides:type_name -> docreader.ListEnginesRequest.ConfigOverridesEntry
	7,  // 8: docreader.ListEnginesResponse.engines:type_name -> docreader.ParserEngineInfo
	9,  // 9: docreader.DocReader.NormalizeLegacyDoc:input_type -> docreader.NormalizeLegacyDocRequest
	1,  // 10: docreader.DocReader.Read:input_type -> docreader.ReadRequest
	1,  // 11: docreader.DocReader.ReadStream:input_type -> docreader.ReadRequest
	6,  // 12: docreader.DocReader.ListEngines:input_type -> docreader.ListEnginesRequest
	10, // 13: docreader.DocReader.NormalizeLegacyDoc:output_type -> docreader.NormalizeLegacyDocResponse
	3,  // 14: docreader.DocReader.Read:output_type -> docreader.ReadResponse
	5,  // 15: docreader.DocReader.ReadStream:output_type -> docreader.ReadStreamResponse
	8,  // 16: docreader.DocReader.ListEngines:output_type -> docreader.ListEnginesResponse
