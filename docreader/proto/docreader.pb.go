...
type ReadConfig struct {
	...
	EnableTableStructure    bool                   `protobuf:"varint,4,opt,name=enable_table_structure,json=enableTableStructure,proto3" json:"enable_table_structure,omitempty"`
	TableStructureFileTypes []string               `protobuf:"bytes,5,rep,name=table_structure_file_types,json=tableStructureFileTypes,proto3" json:"table_structure_file_types,omitempty"`
...
func (x *ReadConfig) GetEnableTableStructure() bool {
	if x != nil {
		return x.EnableTableStructure
	}
	return false
}

func (x *ReadConfig) GetTableStructureFileTypes() []string {
	if x != nil {
		return x.TableStructureFileTypes
	}
	return nil
}
...
const file_docreader_proto_rawDesc = "" +
	"\n" +
	"\x0fdocreader.proto\x12\tdocreader\"\xde\x02\n" +
	"\n" +
	"ReadConfig\x12#\n" +
	"\rparser_engine\x18\x01 \x01(\tR\fparserEngine\x12h\n" +
	"\x17parser_engine_overrides\x18\x02 \x03(\v20.docreader.ReadConfig.ParserEngineOverridesEntryR\x15parserEngineOverrides\x124\n" +
	"\x16enable_table_structure\x18\x04 \x01(\bR\x14enableTableStructure\x12;\n" +
	"\x1atable_structure_file_types\x18\x05 \x03(\tR\x17tableStructureFileTypes\x1aH\n" +
