...
const (
	DocReader_NormalizeLegacyDoc_FullMethodName = "/docreader.DocReader/NormalizeLegacyDoc"
...
type DocReaderClient interface {
	...
	NormalizeLegacyDoc(ctx context.Context, in *NormalizeLegacyDocRequest, opts ...grpc.CallOption) (*NormalizeLegacyDocResponse, error)
...
func (c *docReaderClient) NormalizeLegacyDoc(ctx context.Context, in *NormalizeLegacyDocRequest, opts ...grpc.CallOption) (*NormalizeLegacyDocResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(NormalizeLegacyDocResponse)
	err := c.cc.Invoke(ctx, DocReader_NormalizeLegacyDoc_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type DocReaderServer interface {
	// Transient DOC-to-DOCX preview only; failures use gRPC status codes.
	NormalizeLegacyDoc(context.Context, *NormalizeLegacyDocRequest) (*NormalizeLegacyDocResponse, error)
...
func (UnimplementedDocReaderServer) NormalizeLegacyDoc(context.Context, *NormalizeLegacyDocRequest) (*NormalizeLegacyDocResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method NormalizeLegacyDoc not implemented")
}
...
func _DocReader_NormalizeLegacyDoc_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(NormalizeLegacyDocRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DocReaderServer).NormalizeLegacyDoc(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: DocReader_NormalizeLegacyDoc_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DocReaderServer).NormalizeLegacyDoc(ctx, req.(*NormalizeLegacyDocRequest))
	}
...
var DocReader_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "NormalizeLegacyDoc",
			Handler:    _DocReader_NormalizeLegacyDoc_Handler,
		},
		{
			MethodName: "Read",
