...
func TestListSessionArtifacts_StripsURL(t *testing.T) {
	h := &Handler{
		...
		messageService: &stubMessageServiceForArtifacts{
			listArtifacts: func(
				_ context.Context, sessionID, cursor string, limit int,
			) (*types.SessionArtifactPage, error) {
...
func TestWorkbenchArtifactIdentityAndKind(t *testing.T) {
	h := &Handler{
		...
		messageService: &stubMessageServiceForArtifacts{listArtifacts: func(
			_ context.Context, id, cursor string, limit int,
		) (*types.SessionArtifactPage, error) {
			...
			return &types.SessionArtifactPage{
				Messages: []types.SessionArtifactMessage{
					{MessageID: "first", Artifacts: types.MessageArtifacts{
						{FileName: "one.pptx"}, {FileName: "two.html"},
					}},
					{MessageID: "empty"},
