...
type QARequest struct {
	...
	KnowledgeBaseIDByKnowledgeID map[string]string  // Parent KB hints for file mentions; used only to keep unresolved scopes fail-closed per KB
	TagScopes                    []TagScope         // Tag-constrained KB scopes from @mentions
	FolderScopes                 []FolderScope      // Folder-constrained KB scopes from @mentions (issue #1311)
