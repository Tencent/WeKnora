...
// SuggestionPlacementAfterAnswer and related constants.
const (
...
// SuggestionItems is an exported type.
...
type MessageSuggestionEvent struct {
	...
	Type            string    `json:"event_type"            gorm:"type:varchar(32);not null;index"`
