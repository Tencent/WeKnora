...
type CustomAgentConfig struct {
	...
	AttachmentParseWaitTimeoutSec int `yaml:"attachment_parse_wait_timeout_sec" json:"attachment_parse_wait_timeout_sec"`
	...
	QuestionSuggestions *QuestionSuggestionConfig `yaml:"question_suggestions" json:"question_suggestions,omitempty"`
}

// SuggestionModeKnowledge and related constants.
const (
	// SuggestionModeCurated serves only agent-authored starter/follow-up prompts.
...
type FollowUpSuggestionConfig struct {
	...
	SuppressWhenAnswerAsksQuestion bool     `yaml:"suppress_when_answer_asks_question" json:"suppress_when_answer_asks_question"` //nolint:lll // long struct tag or string
