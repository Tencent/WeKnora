...
type AgentStep struct {
	...
	Thought          string     `json:"thought"`                     // LLM's assistant content (Think phase)
	ReasoningContent string     `json:"reasoning_content,omitempty"` // DeepSeek thinking-mode reasoning content
