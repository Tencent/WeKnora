...
const (
	// ImageClassDecorative is artwork that carries no information: logos,
	// dividers, background fills, decorative icons.
...
// class; anything else becomes ImageClassOther, so an unexpected label still
// results in usable behaviour instead of a value the rest of the pipeline would
// not recognise.
