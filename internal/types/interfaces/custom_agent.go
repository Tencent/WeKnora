...
type CustomAgentService interface {
	...
	//   - Possible errors
	GetSuggestedQuestions(ctx context.Context, agentID string, kbIDs []string, knowledgeIDs []string, tagScopes []types.TagScope,
		folderIDs []string, limit int) ([]types.SuggestedQuestion, error)
	...
	GetKnowledgeSuggestedQuestions(ctx context.Context, agentID string, kbIDs []string, knowledgeIDs []string, tagScopes []types.TagScope,
		folderIDs []string, limit int) ([]types.SuggestedQuestion, error)
}
