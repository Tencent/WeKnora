...
type SessionService interface {
	...
	SearchKnowledge(ctx context.Context, knowledgeBaseIDs []string, knowledgeIDs []string, tagScopes []types.TagScope, metadataFilters []types.KBMetadataFilter, query string) ([]*types.SearchResult, error)
