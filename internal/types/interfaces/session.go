...
type SessionService interface {
	...
	SearchKnowledge(ctx context.Context, knowledgeBaseIDs []string, knowledgeIDs []string, knowledgeBaseIDByKnowledgeID map[string]string, tagScopes []types.TagScope, folderScopes []types.FolderScope, query string) ([]*types.SearchResult, error)
