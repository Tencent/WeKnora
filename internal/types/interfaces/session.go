...
type SessionService interface {
	...
	// folderScopes: folder subtrees to restrict the search to, resolved to documents internally
	SearchKnowledge(ctx context.Context, knowledgeBaseIDs []string, knowledgeIDs []string, tagScopes []types.TagScope, folderScopes []types.KnowledgeFolderScope, query string) ([]*types.SearchResult, error)
