...
type ChunkRepository interface {
	...
	// ListChunksForKnowledgeReuse lists all active chunks for incremental reparse diffing.
	ListChunksForKnowledgeReuse(ctx context.Context, tenantID uint64, knowledgeID string) ([]*types.Chunk, error)
