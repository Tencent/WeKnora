...
type ChunkRepository interface {
	...
	// HardDeleteChunksByKnowledgeID permanently deletes chunks by knowledge id.
	// Reparse uses this before inserting content-addressed stable IDs; soft
	// deleted rows would otherwise keep the primary keys occupied.
	HardDeleteChunksByKnowledgeID(ctx context.Context, tenantID uint64, knowledgeID string) error
