...
type ChunkRepository interface {
	...
	// PurgeChunksByKnowledgeID permanently removes replaceable chunks before reparse.
	PurgeChunksByKnowledgeID(ctx context.Context, tenantID uint64, knowledgeID string) error
