...
func (s *sessionService) buildAgentConfig(
	...
	agentConfig := &types.AgentConfig{
		...
		WebSearchMaxCalls:           customAgent.Config.WebSearchMaxCalls,
		WebFetchMaxRetries:          customAgent.Config.WebFetchMaxRetries,
		WebFetchMaxURLs:             customAgent.Config.WebFetchMaxURLs,
		WebResearchTimeoutSec:       customAgent.Config.WebResearchTimeoutSec,
