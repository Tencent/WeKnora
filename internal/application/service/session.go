...
type sessionService struct {
	...
	documentFolderService interfaces.DocumentFolderService // Service for document folder operations (issue #1311)
}
...
func NewSessionService(cfg *config.Config,
	...
	suggestionRepo interfaces.MessageSuggestionRepository,
	documentFolderService interfaces.DocumentFolderService,
