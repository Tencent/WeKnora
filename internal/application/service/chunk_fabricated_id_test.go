...
func TestParseFabricatedChunkID(t *testing.T) {
	cases := []struct {
		...
		{"valid", "f91259e7-4f95-46c2-a928-6a558cc0d3d3_chunk_119", "f91259e7-4f95-46c2-a928-6a558cc0d3d3", 119, true},
		{"uppercase uuid", "F91259E7-4F95-46C2-A928-6A558CC0D3D3_chunk_0", "F91259E7-4F95-46C2-A928-6A558CC0D3D3", 0, true},
...
func (f *fakeChunkRepoForFallback) GetChunkByIDOnly(ctx context.Context, id string) (*types.Chunk, error) {
	f.calledByID = true
	return nil, ErrChunkNotFound
}

func (f *fakeChunkRepoForFallback) GetChunkByKnowledgeAndIndexOnly(ctx context.Context, knowledgeID string, chunkIndex int) (*types.Chunk, error) {
