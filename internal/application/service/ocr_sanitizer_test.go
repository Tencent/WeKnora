...
func TestSanitizeOCRText(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			input: "<div><h2>报告摘要</h2><p>本季度营收同比增长 15%，净利润达到 2.3 亿元。</p><table><tr><th>指标</th><th>数值</th></tr><tr><td>营收</td><td>10亿</td></tr></table></div>", //nolint:lll
			want:  "",
			// placeholder; will be checked for non-empty
		},
	}
