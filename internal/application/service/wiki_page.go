...
func (s *wikiPageService) UpdateIssueStatus(ctx context.Context, tenantID uint64, kbID string, issueID string, status string) error {
	return s.repo.UpdateIssueStatus(ctx, tenantID, kbID, issueID, status)
}
