...
description: Select statistical tests, check assumptions and report effect sizes and uncertainty.
version: 2026.09.5
license: MIT
---
...
Use `read_file` for skill resources and `shell_exec` with skill_name="statistical-analysis" for commands.
...
The locked environment includes SciPy, statsmodels and Pingouin. Bayesian modeling
packages are optional and are not installed by default.
