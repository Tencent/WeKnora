...
func TestDetect(t *testing.T) {
	for _, tt := range []struct {
		...
		{"Vietnamese", "Tôi muốn tìm thông tin về đơn hàng của mình. Bạn có thể giúp tôi kiểm tra trạng thái giao hàng không?", "Vietnamese"},
		...
		{"mixed Vietnamese and English", "This is a mixed Vietnamese English sentence nhưng tôi cần giúp đỡ về đơn hàng của mình.", ""},
	} {
