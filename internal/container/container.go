...
import (
	...
	xquikConnector "github.com/Tencent/WeKnora/internal/datasource/connector/xquik"
...
func initConnectorRegistry() (*datasource.ConnectorRegistry, error) {
	...
	if err := registry.Register(xquikConnector.NewConnector()); err != nil {
		errs = errors.Join(errs, fmt.Errorf("register xquik connector: %w", err))
	}
