...
func BuildContainer(container *dig.Container) *dig.Container {
	...
	must(container.Provide(repository.NewKnowledgeMetadataRepository))
	...
	) interfaces.KnowledgeMetadataService {
		return service.NewKnowledgeMetadataService(repo, knowledgeRepo, knowledgeBaseRepo)
	}))
	...
	must(container.Provide(service.NewMetadataAutoFillService))
	...
	must(container.Provide(handler.NewMetadataHandler))
