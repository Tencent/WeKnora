...
type RouterParams struct {
	...
	DataSourceWebhookHandler     *handler.DataSourceWebhookHandler
...
func NewRouter(params RouterParams) *gin.Engine {
	...
	// Git push webhook（公开路由，X-Gitlab-Token / X-Hub-Signature 鉴权，不走全局 Auth）
	RegisterDataSourceWebhookRoutes(r, params.DataSourceWebhookHandler)
