...
func RegisterEvaluationRoutes(r *gin.RouterGroup, handler *handler.EvaluationHandler, g *rbacGuards) {
	evaluationRoutes := r.Group("/evaluation")
	{
		...
		evaluationRoutes.POST("/datasets", g.Admin(), handler.CreateDataset)
		evaluationRoutes.GET("/datasets/:dataset_id", g.Viewer(), handler.GetDataset)
		evaluationRoutes.PUT("/datasets/:dataset_id", g.Admin(), handler.UpdateDataset)
		evaluationRoutes.DELETE("/datasets/:dataset_id", g.Admin(), handler.DeleteDataset)
		evaluationRoutes.GET("/datasets/:dataset_id/samples", g.Viewer(), handler.ListSamples)
		evaluationRoutes.POST("/datasets/:dataset_id/samples", g.Admin(), handler.CreateSample)
		evaluationRoutes.PUT("/datasets/:dataset_id/samples/:sample_id", g.Admin(), handler.UpdateSample)
		evaluationRoutes.DELETE("/datasets/:dataset_id/samples/:sample_id", g.Admin(), handler.DeleteSample)
		evaluationRoutes.GET("/runs", g.Viewer(), handler.ListRuns)
		evaluationRoutes.POST("/runs", g.Admin(), handler.CreateRun)
