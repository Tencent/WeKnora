...
type SyncTaskParams struct {
	...
	LearningService      interfaces.LearningService `optional:"true"`
}
...
func RegisterSyncHandlers(params SyncTaskParams) {
	...
	if params.LearningService != nil {
		params.Executor.RegisterHandler(types.TypeLearningGenerate, params.LearningService.Handle)
	}
