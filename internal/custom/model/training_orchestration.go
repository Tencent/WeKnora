...
type TrainingOrchestrationJob struct {
	...
	RefreshMode           string     `gorm:"type:varchar(32)" json:"refresh_mode,omitempty"`
	ChangedVideoCount     int        `gorm:"not null;default:0" json:"changed_video_count"`
	ChangedKnowledgeCount int        `gorm:"not null;default:0" json:"changed_knowledge_count"`
	ChangedEvidenceCount  int        `gorm:"not null;default:0" json:"changed_evidence_count"`
	ChangedClusterCount   int        `gorm:"not null;default:0" json:"changed_cluster_count"`
