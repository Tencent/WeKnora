// Package zhipu registers Zhipu AI's BigModel open platform.
//
...
// BaseURL is the OpenAI-compatible chat / embedding endpoint.
const BaseURL = "https://open.bigmodel.cn/api/paas/v4"

// RerankBaseURL is the rerank endpoint.
const RerankBaseURL = "https://open.bigmodel.cn/api/paas/v4/rerank"

// AnthropicBaseURL is the Anthropic Messages compatibility facade.
const AnthropicBaseURL = "https://open.bigmodel.cn/api/anthropic"
...
func init() {
	catalog.Register(&catalog.Vendor{
		...
		Description: "glm-5.3, glm-5.2, glm-4.7, embedding-3, rerank; " +
			"Anthropic-compatible facade at " + AnthropicBaseURL,
		Descriptions: map[string]string{
			"zh-CN": "glm-5.3, glm-5.2, glm-4.7, embedding-3, rerank；Anthropic 兼容接口 " + AnthropicBaseURL,
		},
