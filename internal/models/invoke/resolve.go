...
//     global-config defaults; empty means no call-level opinion.
...
//     declaration; empty means "emit no level parameter" and let the upstream
//     provider use its own default (ADR 0002).
//
