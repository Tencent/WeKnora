...
// sandbox_file_progress.go — verbatim port of v1
// internal/models/chat/sandbox_file_progress.go (deleted in e8f4bf50),
// re-homed entry-side per design §6.6 and the 2026-09-13 A4 ruling (the
// live write/edit progress payload rides StreamResponse.Data; the invoke
// entry owns feature assembly, adapters stay feature-blind).
