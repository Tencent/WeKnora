...
// json_field_extractor.go — verbatim port of v1
// internal/models/chat/json_field_extractor.go (deleted in e8f4bf50),
// re-homed entry-side per design §6.6 and the 2026-09-13 A4 ruling: the
// streaming Data payloads (sandbox write/edit progress, thinking-tool
// thought) are FEATURE machinery, not vendor knowledge, and the entry owns
// feature assembly.
