...
// 000063 knowledge multi-tags, 000088 knowledge metadata schema.
var versionedSQLiteTables = []string{
	...
	"knowledge_metadata_definitions",
	"knowledge_metadata_options",
	"knowledge_metadata_values",
	"knowledge_metadata_value_options",
	"knowledge_metadata_auto_rules",
}
