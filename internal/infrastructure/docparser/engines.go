...
const (
	...
	// WeKnoraCloudEngineName is the hosted cloud document reader.
	// TreeRAG forks keep the same engine id ("weknoracloud") for stored KB rules.
	WeKnoraCloudEngineName = "weknoracloud"
	TreeRAGCloudEngineName = WeKnoraCloudEngineName
...
func (e *weKnoraCloudEngine) Description() string { return "TreeRAGCloud document reader" }
...
func (e *paddleOCRVLEngine) CheckAvailable(_ bool, overrides map[string]string) (bool, string) {
	...
	return PingPaddleOCRVL(endpoint, apiKey)
}
