...
func (r *Repository) ListModelVersions(ctx context.Context, tenantID uint64, modelID string) ([]*SemanticModelVersion, error) {
...
func (r *Repository) FindModelVersion(ctx context.Context, tenantID uint64, versionID string) (*SemanticModelVersion, error) {
...
func (r *Repository) ListGroupMembers(ctx context.Context, tenantID uint64, groupID string) ([]*DataGroupMember, error) {
