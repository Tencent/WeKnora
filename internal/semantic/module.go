...
func CubeQueryForUser(ctx context.Context, tenantID uint64, userID string, q *PreviewQuery) (*cubeclient.LoadResponse, error) {
	e := Default()
	if e == nil || e.client == nil {
		return nil, fmt.Errorf("semantic modeling module is not enabled")
	}
...
func CubeSQLForUser(ctx context.Context, tenantID uint64, userID string, q *PreviewQuery) (*cubeclient.SQLResponse, error) {
	e := Default()
	if e == nil || e.client == nil {
		return nil, fmt.Errorf("semantic modeling module is not enabled")
	}
