# SQuAD 2.0 英文阅读理解 · 24 题

斯坦福问答开发集固定抽样，16 道可回答题、8 道针对指定原文的无答案题与 8 段额外候选原文。

本包版本为 `v1`，类型为 `evaluation`，语种为 `en`。
...
本包来源为 [https://rajpurkar.github.io/SQuAD-explorer/](https://rajpurkar.github.io/SQuAD-explorer/)，许可为 `CC-BY-SA-4.0`。`LICENSE` 与 `NOTICE` 保存许可和归属说明。文件及抽样说明以 `manifest.json` 为准。

- [dataset/dev-v2.0.json](https://raw.githubusercontent.com/rajpurkar/SQuAD-explorer/eee5fdbf62f8613a7812b03419e6b29617b74fd1/dataset/dev-v2.0.json)，版本 `eee5fdbf62f8613a7812b03419e6b29617b74fd1`，SHA-256 `80a5225e94905956a6446d296ca1093975c4d3b3260f1d6c8f68bc2ab77182d8`。
...
- [index.html](https://raw.githubusercontent.com/rajpurkar/SQuAD-explorer/e0c66cfec263165fb3c15cb76a22175e371b71d7/index.html)，版本 `e0c66cfec263165fb3c15cb76a22175e371b71d7`，SHA-256 `989f7e43f27faa490ed9fc8fb440e6f0aa791c49131346a27b8361deb4a18baf`。
...
```powershell
python scripts/prepare-public-evaluation.py --check --dataset squad2-dev
python scripts/prepare-public-evaluation.py --dataset squad2-dev --cache-dir artifacts/public-datasets/source-cache
python scripts/prepare-public-evaluation.py --dataset squad2-dev --cache-dir artifacts/public-datasets/source-cache --download
python scripts/prepare-public-evaluation.py --check --verify-source --dataset squad2-dev --cache-dir artifacts/public-datasets/source-cache
```
