CREATE TABLE resources (
    ...
    active_location_hash VARCHAR(64) GENERATED ALWAYS AS (
        CASE WHEN deleted_at IS NULL THEN location_hash ELSE NULL END
    ) STORED
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

CREATE UNIQUE INDEX idx_resources_tenant_location
    ON resources(tenant_id, active_location_hash);
