...
-- (and future KB / agent / datasource events).
...
-- user_resource_favorites mirrors migration 000047. Same
...
-- user_kb_pins mirrors migration 000050. Per-(user, tenant)
...
-- tenant_invitations mirrors migration 000048. A generated NULL marker
-- preserves the "one pending per (tenant, invitee)" partial-index guard.
