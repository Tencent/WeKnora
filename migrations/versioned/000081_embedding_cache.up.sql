-- Migration: 0000081_embedding_cache
...
Do $$ BEGIN RAISE NOTICE '[Migration: 0000081] Createing embedding_cache table';END $$;
...
DO $$ BEGIN RAISE NOTICE '[Migration 000081] embedding_cache table created successfully'; END $$;