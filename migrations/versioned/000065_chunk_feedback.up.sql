...
DO $$ BEGIN RAISE NOTICE '[Migration 000065] Adding chunk feedback aggregate columns...'; END $$;
...
DO $$ BEGIN RAISE NOTICE '[Migration 000065] Creating message chunk reference table...'; END $$;
...
DO $$ BEGIN RAISE NOTICE '[Migration 000065] Creating message feedback table...'; END $$;
...
DO $$ BEGIN RAISE NOTICE '[Migration 000065] Creating chunk feedback weight log table...'; END $$;
...
DO $$ BEGIN RAISE NOTICE '[Migration 000065] chunk feedback schema ready'; END $$;
