-- Migration: 000079_chunk_content_hash_unique
...
DO $$ BEGIN RAISE NOTICE '[Migration 000079] Applying chunk content_hash unique index'; END $$;
...
DO $$ BEGIN RAISE NOTICE '[Migration 000079] chunk content_hash unique index applied successfully'; END $$;