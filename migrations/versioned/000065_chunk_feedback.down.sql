-- Migration: 000065_chunk_feedback (rollback)
-- Description: Drop message feedback tables and chunk aggregate columns.

DO $$ BEGIN RAISE NOTICE '[Migration 000065 rollback] Dropping message feedback schema...'; END $$;
...
DO $$ BEGIN RAISE NOTICE '[Migration 000065 rollback] chunk feedback schema dropped'; END $$;
