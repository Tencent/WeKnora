DO $$ BEGIN RAISE NOTICE '[Migration 000080] Creating knowledge file update slots...'; END $$;
...
DO $$ BEGIN RAISE NOTICE '[Migration 000080] Knowledge file update slots ready'; END $$;
