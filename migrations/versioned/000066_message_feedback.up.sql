DO $$ BEGIN RAISE NOTICE '[Migration 000063] Adding message feedback and chunk recall weights...'; END $$;
...
CREATE TABLE IF NOT EXISTS message_chunk_refs (
    ...
    CONSTRAINT uq_message_chunk_refs_session_msg_chunk UNIQUE (session_tenant_id, message_id, chunk_id)
);
...
CREATE TABLE IF NOT EXISTS message_feedbacks (
    ...
    CONSTRAINT uq_message_feedbacks_current UNIQUE (session_tenant_id, user_id, message_id)
);
...
DO $$ BEGIN RAISE NOTICE '[Migration 000063] message feedback schema ready'; END $$;
