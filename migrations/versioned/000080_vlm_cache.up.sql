-- Migration: 000080_vlm_cache
-- Description: Create vlm_cache table for storing VLM OCR and Caption results.

DO $$ BEGIN RAISE NOTICE '[Migration 000080] Creating vlm_cache table'; END $$;
...
DO $$ BEGIN RAISE NOTICE '[Migration 000080] vlm_cache table created successfully'; END $$;