...
DO $$ BEGIN RAISE NOTICE '[Migration 000082] Creating wiki_doc_map_cache and graph_chunk_cache tables'; END $$;
...
DO $$ BEGIN RAISE NOTICE '[Migration 000082] wiki_doc_map_cache and graph_chunk_cache tables created successfully'; END $$;
