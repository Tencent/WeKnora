...
ALTER TABLE tenants ADD COLUMN IF NOT EXISTS api_principal_config TEXT;

ALTER TABLE mcp_oauth_tokens ADD COLUMN IF NOT EXISTS principal_type VARCHAR(32);
ALTER TABLE mcp_oauth_tokens ADD COLUMN IF NOT EXISTS principal_id VARCHAR(512);
