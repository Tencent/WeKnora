...
CREATE TABLE IF NOT EXISTS knowledge_rebuild_runs (
    ...
    parse_cache_hit BOOLEAN NOT NULL DEFAULT 0,
    ...
    summary_required BOOLEAN NOT NULL DEFAULT 0,
    wiki_reduce_required BOOLEAN NOT NULL DEFAULT 0,
    stale_cleanup_at DATETIME,
    wiki_reduce_enqueued_at DATETIME,
    commit_completed_at DATETIME,
    wiki_completed_at DATETIME,
    error_message TEXT NOT NULL DEFAULT '',
    started_at DATETIME DEFAULT CURRENT_TIMESTAMP,
    artifacts_ready_at DATETIME,
...
CREATE TABLE IF NOT EXISTS knowledge_rebuild_chunk_results (
    ...
    FOREIGN KEY(run_id) REFERENCES knowledge_rebuild_runs(id) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS knowledge_rebuild_image_results (
    ...
    ocr_cache_hit BOOLEAN NOT NULL DEFAULT 0,
    caption_cache_hit BOOLEAN NOT NULL DEFAULT 0,
    error_message TEXT NOT NULL DEFAULT '',
    created_at DATETIME DEFAULT CURRENT_TIMESTAMP,
    updated_at DATETIME DEFAULT CURRENT_TIMESTAMP,
