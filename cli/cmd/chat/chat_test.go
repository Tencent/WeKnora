...
func (f *fakeChatService) KnowledgeQAStream(ctx context.Context, sessionID string, req *sdk.KnowledgeQARequest, cb func(*sdk.StreamResponse) error, _ ...sdk.ResourceURLOptions) error {
	f.streamCalled = true
