...
11. **Session sandbox files**: List, upload, download, rename, and delete files under the session sandbox `/workspace/output` root (`ListSandboxLiveFiles`, `OpenSandboxLiveFile`, `UploadSandboxLiveFile`, `RenameSandboxLiveFile`, `DeleteSandboxLiveFile`)
